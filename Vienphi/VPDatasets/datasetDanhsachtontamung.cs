        ...
        private void bgW_LoadDataSet_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            using (Npgsql.NpgsqlCommand cmm = new Npgsql.NpgsqlCommand("",new Npgsql.NpgsqlConnection(acc)))
            {
                try
                {
                    ...
                    string sqlTb_tamungct = "select distinct * from (select ttu.mabn,bn.hoten,ttu.maql,ttu.mavaovien,ttu.quyenso,ttu.sobienlai,ttu.sotien as tiendong,ttu.ngay ngaydong,ht.sotien as hoantra,ht.ngay ngaytra, ttu.done, rv.sotien tongvienphi,rv.ngay ngayravien, (case when ba.maql is null then varchar 'Bệnh nhân không có bệnh án' else null end) as ghichu, b.hoten nguoithu from "+schema+".v_tontamung ttu left join  "+schema+".v_hoantra ht on ttu.quyenso = ht.quyenso and ttu.sobienlai = ht.sobienlai and ht.maql = ttu.maql left join  ( select sum(rvct.sotien) sotien,srv.mavaovien,max(rvct.ngay) ngay from "+schema+".v_ttrvds srv inner join "+schema+".v_ttrvct  as rvct on srv.id=rvct.id group by srv.mavaovien) rv on rv.mavaovien = ttu.mavaovien inner join medibv.btdbn bn on bn.mabn=ttu.mabn  left join medibv.benhandt ba on ba.maql = ttu.maql inner join medibv.v_dlogin b on ttu.userid= b.id group by ttu.mabn,ttu.maql,ttu.mavaovien,ttu.sotien ,ht.sotien ,ttu.quyenso,ttu.sobienlai, ht.quyenso , ht.sobienlai,ttu.done,bn.hoten,ttu.ngay,ht.ngay,ba.maql,rv.sotien,rv.ngay,b.hoten union all select ttu.mabn,bn.hoten,ttu.maql,ttu.mavaovien,ttu.quyenso,ttu.sobienlai,ttu.sotien as tiendong,ttu.ngay ngaydong,ht.sotien as hoantra,ht.ngay ngaytra, ttu.done, rv.sotien tongvienphi,rv.ngay ngayravien, (case when ba.maql is null then varchar 'Bệnh nhân không có bệnh án' else null end) as ghichu,b.hoten nguoithu from "+schema+".v_tamung ttu left join  "+schema+".v_hoantra ht on ttu.quyenso = ht.quyenso and ttu.sobienlai = ht.sobienlai and ht.maql = ttu.maql left join  ( select sum(rvct.sotien) sotien,srv.mavaovien,max(rvct.ngay) ngay from "+schema+".v_ttrvds srv inner join "+schema+".v_ttrvct  as rvct on srv.id=rvct.id group by srv.mavaovien) rv on rv.mavaovien = ttu.mavaovien inner join medibv.btdbn bn on bn.mabn=ttu.mabn  left join medibv.benhandt ba on ba.maql = ttu.maql inner join medibv.v_dlogin b on ttu.userid= b.id group by ttu.mabn,ttu.maql,ttu.mavaovien,ttu.sotien ,ht.sotien ,ttu.quyenso,ttu.sobienlai, ht.quyenso , ht.sobienlai,ttu.done,bn.hoten,ttu.ngay,ht.ngay,ba.maql,rv.sotien,rv.ngay,b.hoten)";
                    string sqlTb_tamung = "select mabn,hoten,maql,ngaynhapvien,sum(sotien) tientamung,count(*) solandong,sum(tienhoantra)tienhoantra,tienvienphi,min(done) hoantatca,ngayravien,ghichu,date_part('month',ngaynhapvien) thang,date_part('year',ngaynhapvien) nam from (select ttu.mabn,bn.hoten,ttu.maql,ba.ngay ngaynhapvien,ttu.sotien,ht.sotien as tienhoantra,rv.sotien tienvienphi, ttu.done, rv.ngay ngayravien, (case when ba.maql is null then varchar 'Bệnh nhân không có bệnh án' else null end) as ghichu from "+schema+".v_tontamung ttu left join  "+schema+".v_hoantra ht on ttu.quyenso = ht.quyenso and ttu.sobienlai = ht.sobienlai and ht.maql = ttu.maql left join  ( select sum(rvct.sotien) sotien,srv.mavaovien,max(rvct.ngay) ngay from "+schema+".v_ttrvds srv inner join "+schema+".v_ttrvct  as rvct on srv.id=rvct.id group by srv.mavaovien) rv on rv.mavaovien = ttu.mavaovien inner join medibv.btdbn bn on bn.mabn=ttu.mabn  left join medibv.benhandt ba on ba.maql = ttu.maql group by ttu.mabn,ba.ngay, ttu.done,bn.hoten,ttu.ngay,ht.ngay,ttu.maql,ba.maql,ttu.sotien,ht.sotien,rv.sotien,rv.ngay union all select ttu.mabn,bn.hoten,ttu.maql,ba.ngay ngaynhapvien,ttu.sotien,ht.sotien as tienhoantra, rv.sotien tienvienphi, ttu.done, rv.ngay ngayravien, (case when ba.maql is null then varchar 'Bệnh nhân không có bệnh án' else null end) as ghichu from "+schema+".v_tamung ttu left join  "+schema+".v_hoantra ht on ttu.quyenso = ht.quyenso and ttu.sobienlai = ht.sobienlai and ht.maql = ttu.maql left join  ( select sum(rvct.sotien) sotien,srv.mavaovien,max(rvct.ngay) ngay from "+schema+".v_ttrvds srv inner join "+schema+".v_ttrvct  as rvct on srv.id=rvct.id group by srv.mavaovien) rv on rv.mavaovien = ttu.mavaovien inner join medibv.btdbn bn on bn.mabn=ttu.mabn  left join medibv.benhandt ba on ba.maql = ttu.maql  group by ttu.mabn,ba.ngay, ttu.done,bn.hoten,ttu.ngay,ht.ngay,ttu.maql,ba.maql,ttu.sotien,ht.sotien,rv.sotien,rv.ngay) group by mabn,hoten,maql,ngaynhapvien,tienvienphi,ngayravien,ghichu";
                    //
