...
namespace Vienphi
{
	...
	public class frmDuyetbhyt : System.Windows.Forms.Form
	{
        ...
        private bool bThuchenhlechtruoc_duyettoasau = false, bLaygiamua_khi_giabh_0_giabh_nho_giamua = true, bBHYT_Traituyen_tinh_Tyle_khac = false, bTraituyen_bhtra=false, bBhyt_tra_1_congkham=false;
		...
		public bool bOk=false,bHoadon,bGiaban=false;
        ...
        public frmDuyetbhyt(LibDuoc.AccessData acc, int nhom, string kho, string nguon, string ngay, int userid, string mmyy, bool hoadon, int madoituong, int loaiba, bool admin, string tenuser, bool autoload, int _khudt)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		private void InitializeComponent()
		{
            ...
            this.dataGrid2.Size = new System.Drawing.Size(352, 408);
            ...
            this.tim2.Name = "tim2";
            this.tim2.Size = new System.Drawing.Size(358, 21);
            ...
            this.chkXML.Location = new System.Drawing.Point(148, 490);
            ...
            this.chkXem.Location = new System.Drawing.Point(47, 490);
            ...
            // chkChiphi
            // 
            this.chkChiphi.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.chkChiphi.AutoSize = true;
            this.chkChiphi.Enabled = false;
            this.chkChiphi.Location = new System.Drawing.Point(47, 473);
            ...
            this.chkChiphi.Visible = false;
            this.chkChiphi.CheckedChanged += new System.EventHandler(this.chkChiphi_CheckedChanged);
            // 
            // chkList
            // 
            this.chkList.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            ...
            // chkDonChiphi
            // 
            this.chkDonChiphi.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.chkDonChiphi.AutoSize = true;
            this.chkDonChiphi.Enabled = false;
            this.chkDonChiphi.Location = new System.Drawing.Point(47, 455);
            ...
            this.chkDonChiphi.Visible = false;
            ...
            // chkcls
            // 
            this.chkcls.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            this.chkcls.AutoSize = true;
            this.chkcls.BackColor = System.Drawing.Color.Transparent;
            this.chkcls.Enabled = false;
            ...
            // chkNhapvien
            // 
            this.chkNhapvien.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.chkNhapvien.Enabled = false;
            this.chkNhapvien.Location = new System.Drawing.Point(47, 417);
            ...
            this.chkNhapvien.Visible = false;
            ...
            this.chkKodichvu.Enabled = false;
            this.chkKodichvu.Location = new System.Drawing.Point(47, 436);
            ...
            this.chkKodichvu.Visible = false;
            this.chkKodichvu.CheckedChanged += new System.EventHandler(this.chkKodichvu_CheckedChanged);
            // 
            // chkintrongngay
            // 
            this.chkintrongngay.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.chkintrongngay.AutoSize = true;
            this.chkintrongngay.Enabled = false;
            this.chkintrongngay.Location = new System.Drawing.Point(148, 474);
            ...
            this.chkintrongngay.Visible = false;
            // 
            // butBoqua
            // 
            ...
            this.butBoqua.Location = new System.Drawing.Point(704, 461);
            ...
            this.butLuu.Location = new System.Drawing.Point(356, 461);
            ...
            this.butIn.Location = new System.Drawing.Point(201, 472);
            ...
            this.button1.Location = new System.Drawing.Point(617, 461);
            this.button1.Name = "button1";
            this.button1.Size = new System.Drawing.Size(86, 25);
            this.button1.TabIndex = 249;
            this.button1.Text = "&Đã Duyệt";
            ...
            this.btHuy38.Location = new System.Drawing.Point(443, 461);
		...
		private void dataGrid1_Click(object sender, System.EventArgs e)
		{
            try
            {
                ...
                {
                    if (v_id.IndexOf(atam) < 0) v_id += atam;
                    load_dtct();
                    foreach (DataRow r in dtct.Rows)
                        updrec_thuocbhytct(ds.Tables[0], r["mabn"].ToString(), r["ngay"].ToString(), dataGrid1[i_row, 3].ToString(), l_id, int.Parse(r["stt"].ToString()), decimal.Parse(r["sttt"].ToString()), int.Parse(r["mabd"].ToString()),
                ...
                {
                    string av_id = "";
                    foreach (string s in v_id.Trim(',').Split(','))
                        if (s != atam.Trim(',')) av_id += s + ",";
                    v_id = av_id;
		...
		private void load_grid(string mabn)
		{
            ...
            if (i_loaiba == 2) sql += "f.sothe as sothengtr,";
            else sql += "c.sothe as sothengtr,";
            sql+=" b.hoten,b.namsinh,trim(b.sonha)||' '||b.thon as diachi,b.cholam,x.tentt,y.tenquan,z.tenpxa,";
            sql += " c.mabv,a.makp,d.tenkp,a.chandoan,a.maicd,a.mabs,a.madoituong,e.mien,coalesce(e.field_gia,'gia_th') as field_gia,a.loaiba,a.ngaynghi";
            ...
            if (i_loaiba==2) sql+=" left join " + user + ".bhyt f on a.maql=f.maql ";
            ...
            if (i_loaiba == 2) sql += " and a.loaiba=" + i_loaiba;
            else
            {
            ...
            if (s_kho.Trim().Trim(',') != "") sql += " and t.makho in (" + s_kho.Trim().Trim(',') + ")";
            if (mabn != "") sql += " and a.mabn like '%" + mabn + "%'";
			
			dt=d.get_data_mmyy(sql,s_tu,s_den,songayduyet).Tables[0];
            
            foreach (DataRow r in dt.Select("id=0")) r["id"] = d.get_id_bhyt;
            bool bExit = false;
        ...
        private void load_grid_daduyet(string mabn)
        {
            v_id = "";
            sql = "select distinct a.id,a.mabn,a.maql,a.mavaovien,c.sothe,coalesce(c.traituyen,0) as traituyen,";
            if (i_loaiba == 2) sql += "f.sothe as sothengtr,";
            ...
            sql += " b.hoten,b.namsinh,trim(b.sonha)||' '||b.thon as diachi,b.cholam,x.tentt,y.tenquan,z.tenpxa,";
            sql += " c.mabv,a.makp,d.tenkp,a.chandoan,a.maicd,a.mabs,to_number('1') as madoituong,to_number('0') as mien,'' as field_gia,a.loaiba,a.ngaynghi";
            sql += " from xxx.bhytkb a inner join xxx.bhytthuoc a1 on a.id=a1.id inner join " + user + ".btdbn b on a.mabn=b.mabn ";
            sql += " left join " + user + ".btdkp_bv d on a.makp=d.makp ";
            sql += " left join xxx.bhyt c on a.maql=c.maql ";
            if (i_loaiba == 2) sql += " left join " + user + ".bhyt f on a.maql=f.maql ";
            sql += " left join " + user + ".btdtt x on b.matt=x.matt ";
            ...
            if (i_loaiba == 2) sql += " and a.loaiba=" + i_loaiba;
            sql += " and a.nhom=" + i_nhom;
            if (s_kho.Trim().Trim(',') != "") sql += " and a1.makho in (" + s_kho.Trim().Trim(',') + ")";
            if (mabn != "") sql += " and a.mabn like '%" + mabn + "%'";
            ...
            butLuu.Enabled = (dt.Rows.Count != 0 && bDsdaduyet == false);
            butIn.Enabled = butLuu.Enabled;
            dataGrid1.Focus();
            i_row = dataGrid1.CurrentRowIndex;
            load_items();
		...
		{
            DataSet dstmp, ds1;
            if (!bDsdaduyet)// hien thi thong tin thuoc chua duyet
            {
                //lấy thông tin toa thuốc
                sql = "select f.maql,f.maql as maql1,a.stt,0 as sttt,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,";
                sql += " b.tenhc,b.dang,e.ten as tenkho,f.mabs as tennguon,f.mabs as tennhomcc,";//c.ten as tennguon
                sql += " ' ' as handung,' ' as losx,ceiling(a.slyeucau) as soluong,0 as dongia,0 as sotien,0 as giaban,0 as giamua,0 as sotienmua,";
                ...
                if (i_madoituong == 1) sql += " and a.madoituong=" + i_madoituong;
                else sql += " and a.madoituong<>1 ";
            }
            else // hien thong tin thuốc đã duyệt rồi
            {
                sql = "select f.maql,f.maql as maql1,a.stt,0 as sttt,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,";
                sql += " b.tenhc,b.dang,e.ten as tenkho,f.mabs as tennguon,f.mabs as tennhomcc,";//c.ten as tennguon
                sql += " ' ' as handung,' ' as losx,a.soluong,0 as dongia,0 as sotien,0 as giaban,0 as giamua,0 as sotienmua,";
                sql += " a.cachdung,a.makho,d.manguon,0 as nhomcc,1 as done,to_char(f.ngay,'dd/mm/yyyy') as ngay,to_char(f.ngayud,'dd/mm/yyyy hh24:mi') as ngayud,f.mabn ";
                sql += " from xxx.bhytthuoc a," + user + ".d_dmbd b," + user + ".d_dmnguon c," + user + ".d_dmkho e,xxx.bhytkb f ,xxx.d_theodoi d  ";
                sql += " where a.id=f.id and a.mabd=b.id and a.sttt=d.id and d.manguon=c.id and a.makho=e.id ";
                sql += " and a.id=" + l_id;// +" order by a.stt";
		...
		private void upd_data_hoadon(bool prn)
		{
            ...
            string s_chandoan = "", s_icd = "";
			DataTable dtqs=d.get_data("select * from "+user+".v_quyenso").Tables[0];
			int i_quyenso=0;
            int maphu = 1, ma;
            decimal chitra;
            decimal d_thuoc, d_bntra = 0, d_bhyttra = 0, d_cls, d_chiphi = 0, d_congkham = d.Congkham(i_nhom), d_tcbn_ctthem_thuoc = 0, d_tcbn_ctthem_cls = 0, d_dichvu_tt = 0, d_dichvu_tt_bhchitra = 0, d_dichvu_tt_bnchitra = 0; 
            if (bQuyenso)
            {
			...
			for(int i=0;i<dr.Length;i++)
			{
				...
				if (o_id!=l_id)
				{
					...
					if (r!=null)
					{
                        ...
                        if (s_chandoan.Trim() == "")
                        {
                            get_chandoan_chinh(s_mmyy, i_loaiba, decimal.Parse(r["mavaovien"].ToString()), r["mabn"].ToString(), r["makp"].ToString(), ref s_chandoan, ref s_icd);
                        }
                        ...
                        d.upd_bhytkb(s_mmyy, l_id, i_nhom, i_quyenso, sobienlai, s_ngay, r["mabn"].ToString(), decimal.Parse(r["mavaovien"].ToString()), (r["maql"].ToString() == "0") ? decimal.Parse(dr[i]["tennhomcc"].ToString()) : decimal.Parse(r["maql"].ToString()), r["makp"].ToString(), s_chandoan, s_icd, (dr[i]["tennguon"].ToString().Trim().Length == 4) ? dr[i]["tennguon"].ToString() : r["mabs"].ToString(), (r["sothe"].ToString() == "") ? r["sothengtr"].ToString() : r["sothe"].ToString(), maphu, r["mabv"].ToString(), d_congkham, d_thuoc, d_cls, d_bntra, d_bhyttra, i_userid,int.Parse(r["loaiba"].ToString()),int.Parse(r["traituyen"].ToString()),0);
                        itable = d.tableid(s_mmyy, "bhytthuoc");
						...
						for(int j=0;j<dr1.Length;j++)
						{
                            ...
                            if (dr12 != null)
                            {
                                if (decimal.Parse(dr12["bhyt"].ToString()) != 100)
                                {
                        ...
                        d.execute_data("update " + yyy + ".bhytkb set thuoc=" + (d_thuoc + d_tcbn_ctthem_thuoc).ToString() + ",cls=" + (d_cls + d_tcbn_ctthem_cls).ToString() + 
                            ",congkham=" + d_congkham + ",bntra=" + d_bntra + ",bhyttra=" + d_bhyttra + ",maql=" + amaql + ",ngaynghi="+r["ngaynghi"].ToString()+" where id=" + l_id);
						d.execute_data_mmyy("update xxx.d_thuocbhytll set done=1 where id="+l_id,s_tu,s_den,songayduyet);
                    ...
                    //            get_data_printer(r["mabn"].ToString(), decimal.Parse(r["maql"].ToString()), r["chandoan"].ToString(), d_congkham.ToString(), r["hoten"].ToString(), r["sothe"].ToString(), maphu, "", "", "", "", r["maicd"].ToString(), r["makp"].ToString(), r["mabs"].ToString(),int.Parse(r["traituyen"].ToString()));
                    //    }
                    //    else
                    //    {
                    //        printer(l_id, d_bntra, d_bhyttra, r["mabn"].ToString(), r["hoten"].ToString(), r["namsinh"].ToString(), r["diachi"].ToString().Trim() + " " + r["tenpxa"].ToString().Trim() + " " + r["tenquan"].ToString().Trim() + " " + r["tentt"].ToString(), (r["sothe"].ToString() == "") ? r["sothengtr"].ToString() : r["sothe"].ToString(), r["chandoan"].ToString(), d_bntra + d_bhyttra, d_congkham, sobienlai, r["mabs"].ToString(),int.Parse(r["traituyen"].ToString()));//r["cholam"].ToString().Trim() + ";" +
        ...
        private void luu_in(bool prn)
        {
            ...
            //
            string _mabn = "", _xutri = "";
            bool bln_chuakham = false;
            if (!bAdmin && bDuyettoa_ketthuc && i_loaiba == 3)
            {
                foreach (DataRow r in dt.Select("chon=true and madoituong=1"))
                {
                    sql = "select b.xutri from xxx.benhanpk a left join xxx.xutrikbct b on a.maql=b.maql";
                ...
                if (_mabn.Trim() == "")
                {
                    foreach (DataRow r in dt.Select("chon=true and madoituong=1"))
                    {
                        sql = "select b.maql, c.tenkp||'-'||a.makp as tenkp from xxx.tiepdon a left join xxx.benhanpk b on a.mavaovien=b.mavaovien and a.makp=b.makp";
		...
		private void load_ck()
		{
			...
			sql+=" c.mabv,d.makp,f.tenkp,d.chandoan,d.maicd,d.mabs,d.madoituong,e.mien,case when e.field_gia is null then 'gia_th' else e.field_gia end as field_gia,3 as loaiba";
				...
				if (r!=null)
				{
                    ...
                    if (prn && dr.Length>0)
                    {
                        ...
                        else
                        {
                            ...
                            if (chkDonChiphi.Checked) get_data_printer(dr[i]["mabn"].ToString(), decimal.Parse(dr[i]["maql"].ToString()), dr[i]["chandoan"].ToString(), d_congkham.ToString(), dr[i]["hoten"].ToString(), dr[i]["sothe"].ToString(), maphu, "", "", "", "", dr[i]["maicd"].ToString(), dr[i]["makp"].ToString(), dr[i]["mabs"].ToString(),int.Parse(dr[i]["traituyen"].ToString()));
                        }
                    }                    
				}
			}
        ...
        private void get_data_printer(string mabn,decimal maql, string chandoan, string congkham, string hoten, string sothe, int imaphu, string maphu, string tenbv, string tenbs, string tenkp, string maicd, string makp, string mabs,int traituyen)
        {
            dsxmlin.Clear();
            ...
            //sql+=" from xxx.benhanpk a inner join " + user + ".btdkp_bv b on a.makp=b.makp left join " + user + ".dmbs c on a.mabs=c.ma where a.mavaovien=" + l_mavaovien + " order by a.maql";
            //binh 051108
            sql += " from xxx.bhytkb a inner join " + user + ".btdkp_bv b on a.makp=b.makp left join " + user + ".dmbs c on a.mabs=c.ma where a.mavaovien=" + mavaovien + " order by a.maql";
            //end binh 051108
            ...
            if ((bGiaban || bGia_bh_quydinh) && bchenhlech_thuoc && s_chenhlech.IndexOf(imaphu.ToString().PadLeft(2, '0')) != -1)
            {
                ...
                sql += ",i.ten as hangsx, j.ten as nuocsx ";
                sql += " from " + yyy + ".bhytthuoc a," + user + ".d_dmbd b," + user + ".d_dmnguon c," + user + ".d_dmnx d," + user + ".d_dmkho e," + yyy + ".bhytkb f," + yyy + ".d_theodoi t," + user + ".btdkp_bv h";
                sql += ", " + user + ".d_dmhang i, " + user + ".d_dmnuoc j ";
            ...
            if (bChenhlech && s_chenhlech.IndexOf(imaphu.ToString().PadLeft(2, '0')) != -1 && !chkKodichvu.Checked)
            {
                ...
                sql += ", null as hangsx, null as nuocsx ";
                sql += " from " + yyy + ".bhytcls a," + user + ".v_giavp b," + user + s_mmyy + ".bhytkb c," + user + ".btdkp_bv h  where c.id=a.id and a.mavp=b.id and c.makp=h.makp";
                ...
                sql += ", null as hangsx, null as nuocsx ";
                sql += " from " + yyy + ".bhytcls a," + user + ".v_giavp b," + user + s_mmyy + ".bhytkb c," + user + ".btdkp_bv h where c.id=a.id and a.mavp=b.id ";
            ...
            if (bIncstt)
            {
                ...
                if ((bGiaban || bGia_bh_quydinh) && bchenhlech_thuoc && s_chenhlech.IndexOf(imaphu.ToString().PadLeft(2, '0')) != -1)
                {
                    ...
                    sql += ",i.ten as hangsx, j.ten as nuocsx ";
                    sql += " from " + yyy + ".d_xuatsdct a," + user + ".d_dmbd b," + user + ".d_dmnguon c," + user + ".d_dmnx d,";
                    sql += user + ".d_dmkho e," + yyy + ".d_xuatsdll f," + yyy + ".d_theodoi t," + user + ".d_duockp g," + user + ".btdkp_bv h ";
            ...
            string ssodienthoai = "", ssokham = "";//gam 22-03-2011 thêm field số điện thoại và số khám
            foreach (DataRow r in d.get_data_mmyy(sql,s_tu,s_den,songayduyet).Tables[0].Rows)
            {
            ...
            //
            // gam08-03-2011 add thêm field tylechitra
            int atylechitra = 0;
            ...
            foreach (DataRow r in dstmp.Tables[0].Select("","madoituong"))
            {
                ...
                if (r2 != null)
                {
                    ...
                    dg2 = 0;
                    if (decimal.Parse(r2["bhyt"].ToString()) != 100 && int.Parse(r["madoituong"].ToString()) == 1)
                    {
                    ...
                    m.updrec_ravien(dsxmlin, mabn, mabn, decimal.Parse(r["maql"].ToString()), 0, hoten, ns, phai, diachi.Trim()+"^"+cholam.Trim(),int.Parse(r["madoituong"].ToString()),
                        ...
                        s_ngay,s_ngay, s_chandoan, s_maicd, int.Parse(r2["sttnhom"].ToString()),
                        ...
                        0, tamung, d_congkham, m.get_nguoinha(s_mmyy, mabn, maql), 1, (makp != "") ? m.phuongphapdieutri(makp) : 0, 0, (cstt) ? "x^" + s_soluutru + "^" + s_chandoan : "^" + s_soluutru + "^" + s_chandoan, d_dongia, bInchiphi_chandoan_bacsy, 0, "", "", "", r["hangsx"].ToString() + "^" + r["nuocsx"].ToString(), imaphu, (decimal.Parse(r["soluong"].ToString()) != 0) ? decimal.Parse(r["sotien"].ToString()) / decimal.Parse(r["soluong"].ToString()) : 0, 0, d_sotiendichvu, traituyen, int.Parse(r2["kythuat"].ToString()),a_sttbhyt,a_idnhombhyt,a_tennhombhyt );
            ...
            foreach (DataRow r in dsxmlin.Tables[0].Select("","madoituong"))
            {
                chitra = 100;
                r["idkhoa"] = isophieu;
                r["tcsotien"] = (int.Parse(r["madoituong"].ToString()) == 1) ? tc : tck;
                r["dichso"] = (int.Parse(r["madoituong"].ToString()) == 1) ? chu : chuk;
                r["tenuser"] = s_userid;
                r["chandoan"] = s_chandoan;
                r["tylechitra"] =  atylechitra == 0 ? "BHYT 100%" : atylechitra == 1 ? "BHYT 80%" : atylechitra == 2 ? "BHYT 95%" : "";
                r["sokham"] = ssokham;
                ...
                if (_sothe != "" && int.Parse(r["madoituong"].ToString())==1)
                {
                    ...
                    {
                        chitra = iTraituyen;
                        r["bhyttra"] = (tc - d_dichvu_tt) * chitra / 100 + d_dichvu_tt_BH_tra;
            ...
            //if (chkXem.Checked)
            //{
            //    frmReport f = new frmReport(d, dsxmlin.Tables[0],s_tenkp, "rpt_ttravien_bh.rpt",soban.Value);
            //    f.ShowDialog();
            //}
            //else
            //{
            ...
            try
            {
                ...
                if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy số phiếu này ?"), d.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    foreach (DataRow r1 in dtct.Rows)
                    {
                        ...
                        d.upd_eve_upd_del(s_mmyy, itable, i_userid, "del", d.fields(xxx + ".bhytthuoc", "id in (" + v_id.Trim(',')+") and stt=" + int.Parse(r1["stt"].ToString())));
                    ...
                    itable = d.tableid(s_mmyy, "bhytkb");
                    d.upd_eve_tables(s_mmyy, itable, i_userid, "del");
                    d.upd_eve_upd_del(s_mmyy, itable, i_userid, "del", d.fields(xxx + ".bhytkb", "id in (" + v_id.Trim(',') + ")"));
                    d.execute_data("delete from " + yyy + ".bhytcls where id in (" + v_id.Trim(',') + ")");
                    d.execute_data("delete from " + yyy + ".bhytthuoc where id in (" + v_id.Trim(',') + ")");
                    d.execute_data("delete from " + yyy + ".bhytkb where id in (" + v_id.Trim(',') + ")");
                    foreach (DataRow r1 in d.get_data_mmyy("select * from xxx.d_thuocbhytct where id in (" + v_id.Trim(',') + ")", s_tu, s_den, songayduyet).Tables[0].Rows)
                    ...
                    d.execute_data_mmyy("update xxx.d_thuocbhytct set slthuc=0 where id in (" + v_id.Trim(',') + ")", s_tu, s_den, songayduyet);
                    d.execute_data_mmyy("update xxx.d_thuocbhytll set done=0 where id in (" + v_id.Trim(',') + ")", s_tu, s_den, songayduyet);
                    d.delrec(dtll, "id in (" + v_id.Trim(',') + ")");
                    load_grid_daduyet("");
                }
            }
            catch (Exception ex) { }
