...
namespace Vienphi
{
	...
	public class frmDuyetcls : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butIn.Location = new System.Drawing.Point(359, 496);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(438, 496);
            ...
            this.butTim.Location = new System.Drawing.Point(288, 496);
            ...
            this.chkAll.Size = new System.Drawing.Size(50, 21);
            this.chkAll.TabIndex = 11;
            this.chkAll.Text = "Chọn cả";
            this.chkAll.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            this.toolTip1.SetToolTip(this.chkAll, "Chọn tất cả cận lâm sàng");
		...
		private void frmDuyetcls_Load(object sender, System.EventArgs e)
		{
            ...
            lan.Read_dtgrid2002_to_Xml(this.dataGrid1, this.Name.ToString() + "_" + this.dataGrid1.Name.ToString());
            lan.Change_dtgrid2002_HeaderText_to_English(this.dataGrid1, this.Name.ToString() + "_" + this.dataGrid1.Name.ToString());
        ...
        private void load_grid()
        {
            ...
            sql += " from medibvmmyy.v_chidinh a inner join " + user + ".btdbn b on a.mabn=b.mabn ";
            sql+=" left join " + user + ".btdkp_bv d on a.makp=d.makp ";
            sql+=" inner join " + user + ".v_giavp e on a.mavp=e.id ";
            sql += " left join medibvmmyy.bhyt f on a.maql=f.maql ";
            ...
            sql += " where " + m.for_ngay("a.ngay", stime) + " between to_date('" + tu.Text + "'," + stime + ") and to_date('" + den.Text + "'," + stime + ") and a.done in (0,3)";
		...
		private void chkAll_CheckedChanged(object sender, System.EventArgs e)
		{
            ...
            {
                chkAll.Text = "Hủy cả";
                this.toolTip1.SetToolTip(this.chkAll, "Bỏ chọn tất cả cận lâm sàng");
            }
            else
            {
                chkAll.Text = "Chọn cả";
        ...
        private void butIn_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                ...
                m.execute_data("update " + xxx + ".v_chidinh set done=" + i_chon + " where id=" + decimal.Parse(r["id"].ToString()));
                m.execute_data("update " + xxx + ".v_chidinh set userid_duyet=" + i_userid + " where id=" + decimal.Parse(r["id"].ToString()));
            }
