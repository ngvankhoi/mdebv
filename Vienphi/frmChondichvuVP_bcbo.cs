...
namespace Vienphi
{
	public class frmChondichvuVP_bcbo : System.Windows.Forms.Form
	{
		private LibVP.AccessData m_v;
		private string m_mabo="";
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmChondichvuVP_bcbo));
            ...
            this.tabControl1.Size = new System.Drawing.Size(782, 443);
            ...
            this.label3.Location = new System.Drawing.Point(5, 442);
            ...
            this.label2.Size = new System.Drawing.Size(3, 438);
            ...
            this.panel4.Padding = new System.Windows.Forms.Padding(3, 4, 3, 3);
            this.panel4.Size = new System.Drawing.Size(770, 36);
            ...
            this.lbStyle.Location = new System.Drawing.Point(3, 4);
            this.lbStyle.Name = "lbStyle";
            this.lbStyle.Size = new System.Drawing.Size(33, 27);
            ...
            this.butChon.Location = new System.Drawing.Point(606, 4);
            this.butChon.Name = "butChon";
            this.butChon.Size = new System.Drawing.Size(79, 27);
            this.butChon.TabIndex = 0;
            this.butChon.Text = "       Lưu";
            ...
            // butBoqua
            // 
            this.butBoqua.BackColor = System.Drawing.Color.White;
            ...
            this.butBoqua.Location = new System.Drawing.Point(685, 4);
            this.butBoqua.Name = "butBoqua";
            this.butBoqua.Size = new System.Drawing.Size(80, 27);
            ...
            this.lbTitle.Size = new System.Drawing.Size(449, 47);
            ...
            this.Name = "frmChondichvuVP_bcbo";
            this.Padding = new System.Windows.Forms.Padding(3);
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = " Chọn dịch vụ thu viện phí cần báo cáo";
            this.Load += new System.EventHandler(this.frmChondichvuVP_bcbo_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmChondichvuVP_bcbo_KeyDown);
		...
		private void f_LoadDMVienPhi()
		{
			try
			{
				...
				string asortloai="b.ten, b.stt";
				string asortgia="a.ten,a.stt";
				string sql = "", aexp="";
				if(aexp!="")
				{
					aexp="and "+aexp;
                ...
                sql = "select to_char(a.id) id, trim(a.ma) ma, trim(a.ten) ten, decode(c.ma,null,0," + m_mabo + ",1,2) chon,trim(a.dvt) dvt, nvl(a.gia_th,0) gia_th, nvl(a.gia_bh,0) gia_bh, nvl(a.gia_dv,0) gia_dv, trim(b.ten) tenloai,to_char(b.id) idloai, nvl(a.trongoi,0) trongoi from medibv.v_giavp a, medibv.v_loaivp b, medibv.dm_1021_ct c where a.id_loai=b.id and a.id=c.mavp(+) and a.ten is not null " + aexp + " order by " + asortloai + ", b.id, " + asortgia;
				...
				for(int i=0;i<m_dsgiavp.Tables[0].Rows.Count;i++)
				{
					try
					{
						...
						if(m_dsgiavp.Tables[0].Rows[i]["idloai"].ToString().Trim()==atmp)
						{
							...
							acheck.Enabled=m_dsgiavp.Tables[0].Rows[i]["chon"].ToString()!="2";
		...
		private void frmChondichvuVP_bcbo_Load(object sender, System.EventArgs e)
		{
			try
			{
		...
		private void butChon_Click(object sender, System.EventArgs e)
		{
			...
			{
				m_mavp=f_GetItem();
                m_v.execute_data("delete from medibv.dm_1021_ct where ma=" + m_mabo);
				foreach(string atmp in m_mavp.Split(','))
				{
					m_v.execute_data("insert into medibv.dm_1021_ct(ma,mavp) values(" + m_mabo + "," + atmp + ")");
				}
		...
		private void f_save_history()
		{
			try
			{
				...
				ads.WriteXml("..\\..\\option\\v_option_chonvp_multiline_list_bcbo.xml",XmlWriteMode.WriteSchema);
			}
			catch
			{
			}
		...
		private void f_load_history()
		{
			...
			{
				DataSet ads = new DataSet();
				ads.ReadXml("..\\..\\option\\v_option_chonvp_multiline_list_bcbo.xml");
		...
		private void lbStyle_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				toolTip1.SetToolTip(lbStyle,lbStyle.ImageIndex==0?"Xem nhiều dòng":"Xem một dòng");
				f_save_history();
			}
			catch
			{
		...
		private void frmChondichvuVP_bcbo_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
