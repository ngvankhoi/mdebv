...
namespace Medisoft
{
    public class frmKhambenh_ba : System.Windows.Forms.Form
    {
        //linh
        bool bRhm = false;
        ...
        private bool b_Edit = false, b_Hoten = false, bAdmin, bHiends, b_soluutru, bLuutru_Mabn, b_sovaovien, bXutri_noitru, bXutri_ngoaitru, bChuyenkhoasan, bKhamthai, bTiepdon, bDanhmuc_nhathuoc, bBacsy, bSoluutru, bSuadoituong, bSothe_mabn, bGhichu, bCapso, bTamung, bHinh, bTaikham_hen, bPhongluu_userid, bKhamsuckhoe, bBangDienPhongKham;
        ...
        private ToolStripMenuItem butVLTL;
        ...
        public frmKhambenh_ba(LibMedi.AccessData acc, string makp, string hoten, int userid, int mabv, bool sovaovien, bool soluutru, string _madoituong, string _mabs, string _nhomkho, bool _admin, int _loai, int _i_khudt, int _i_chinhanh)
        {
            InitializeComponent();
            lan = new Language();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
        ...
        public void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKhambenh_ba));
            ...
            this.butVLTL = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.label53.Location = new System.Drawing.Point(200, 366);
            ...
            this.c_hb_giadinh.Location = new System.Drawing.Point(303, 367);
            ...
            this.c_hb_giadinh.Size = new System.Drawing.Size(569, 32);
            ...
            this.c_hb_banthan.Size = new System.Drawing.Size(569, 100);
            ...
            this.label58.Location = new System.Drawing.Point(151, 388);
            ...
            this.label60.Location = new System.Drawing.Point(159, 464);
            ...
            // lblBophan
            // 
            this.lblBophan.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblBophan.ForeColor = System.Drawing.SystemColors.ControlText;
            this.lblBophan.Location = new System.Drawing.Point(158, 434);
            this.lblBophan.Name = "lblBophan";
            this.lblBophan.Size = new System.Drawing.Size(127, 16);
            this.lblBophan.TabIndex = 271;
            this.lblBophan.Text = "2. Các bộ phận :";
            ...
            this.label62.Location = new System.Drawing.Point(158, 408);
            ...
            this.c_kb_tomtat.Location = new System.Drawing.Point(303, 464);
            ...
            this.c_kb_tomtat.Size = new System.Drawing.Size(569, 33);
            ...
            this.c_kb_bophan.Location = new System.Drawing.Point(303, 433);
            ...
            this.c_kb_bophan.Size = new System.Drawing.Size(569, 30);
            ...
            this.c_kb_toanthan.Location = new System.Drawing.Point(303, 402);
            ...
            // butVLTL
            // 
            this.butVLTL.Name = "butVLTL";
            this.butVLTL.Size = new System.Drawing.Size(258, 22);
            this.butVLTL.Text = "Phiếu theo dõi vật lý trị liệu";
            this.butVLTL.Click += new System.EventHandler(this.butVLTL_Click);
            // 
            // toolStripMenuItem1
            // 
            ...
            this.label69.Location = new System.Drawing.Point(285, 437);
            ...
            this.label42.Location = new System.Drawing.Point(284, 408);
            ...
            this.label46.Location = new System.Drawing.Point(278, 408);
            ...
            this.label70.Location = new System.Drawing.Point(279, 437);
            ...
            this.butVantay.Size = new System.Drawing.Size(23, 20);
            this.butVantay.Text = "Vân tay";
            this.butVantay.ToolTipText = "Lấ dấu vân tay";
            this.butVantay.Click += new System.EventHandler(this.tbutvantay_Click);
            // 
            // frmKhambenh_ba
            // 
            ...
            this.Name = "frmKhambenh_ba";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Phiếu khám bệnh";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmKhambenh_ba_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmKhambenh_ba_FormClosing);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmKhambenh_ba_KeyDown);
        ...
        private void load_dm()
        {
            ...
            dtxutri = m.get_data("select ma,to_char(ma,'00')||'   '||ten ten from " + m.user + ".xutrikb where hide=0 order by ma").Tables[0];//linh
        ...
        private void frmKhambenh_ba_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F1:
                    if (bCaller && list.Items.Count > 0) caller();
                    else if (bBangDienPhongKham || bPhongkham_bangdien_kontum) butgoibenh_Click(sender, e);
                    break;
                case Keys.F3:
                ...
                {//linh
                    ...
                    if (rbv != null)
                    {
                        ...
                        if (s_ngoaidm == "1")
                        {
                            ...
                            {
                                while (s_lydotraituyen == "")
                                {
                                    if (MessageBox.Show("Bạn muốn chuyển sang bệnh viện ngoài danh mục thì phải có lý do", "Medisoft 2007", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1) == DialogResult.OK)
                                    {
                                        dllReportM.frmLydo flydo = new dllReportM.frmLydo();
                                        flydo.ShowDialog();
                                        s_lydotraituyen = flydo.LyDo.Trim();
                                        if (s_lydotraituyen != "")
                                        {
                                            frmGiaycv fcv = new frmGiaycv(m, s_makp, i_userid, s_mabn, 3, int.Parse(s_ngoaidm));
                                            fcv.ShowDialog();
                                            m.execute_data("update " + user + ".chuyenvien set lydotraituyen=" + s_lydotraituyen + " where maql=" + fcv.MaQuanLy.ToString());
                                        }
                                    }
                                }
                            }
        ...
        void benhan_chung()
        {
            ...
            string c01 = "", c02 = "", c03 = "", c04 = "", c05 = "", tenfile = "r42bv";
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                if (chkXml.Checked)
                {
                    ds.WriteXml("..//..//dataxml//khambenh_ba.xml", XmlWriteMode.WriteSchema);
                }
                string s_chinhanh = "";
                ...
                dllReportM.frmReport f = new dllReportM.frmReport(m, ds, tenfile, "", tenkp.Text, tenbs.Text.Trim().ToUpper(), "", m.Mabv + "/" + mabn2.Text + "/" + mabn3.Text, hoten.Text, ngaysinh.Text, (loaituoi.SelectedIndex == 0) ? tuoi.Text.Substring(1) : "000", phai.SelectedIndex.ToString(),
                    ...
                    denngay.Text, sothe.Text, qh_hoten.Text + "      +" + lan.Change_language_MessageText("Địa chỉ") + ": " + qh_diachi.Text, qh_dienthoai.Text, "", ngayvv.Text, tennhantu.Text, tendentu.Text, "1", tenkhoa.Text, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
        ...
        public void load_data()
        {
            ...
            bBangDienPhongKham = m.bGoi_khambenh && dtkp.Rows.Count == 1;
            if (pgoi.Visible = bBangDienPhongKham || bPhongkham_bangdien_kontum)
            {
            ...
            if (rkp["makpbo"].ToString() == "24")
            {
                bRhm = true;
                lblBophan.Text = "2. Bệnh chuyên khoa: ";
            }
        ...
        private void frmKhambenh_ba_Load(object sender, EventArgs e)
        {
            butLuu.Tag = "0";
            load_data();
            //linh
        ...
        private void butgoibenh_Click(object sender, EventArgs e)
        {
            ...
            if (bBangDienPhongKham) m.goi_kham(ngaysrv, makp.Text, sott, sott, true);
            string input = "";
        ...
        //khuong
        private void frmKhambenh_ba_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void butVLTL_Click(object sender, EventArgs e)
        {
            ...
            frmPhieutheodoitapVLTL f = new frmPhieutheodoitapVLTL(m, s_mabn, hoten.Text, tuoi.Text, phai.Text, sonha.Text + ", " + thon.Text + ", " + tenpxa.Text + ", " + tenquan.Text + ", " + tentinh.Text, "", cd_chinh.Text.Trim(), tendoituong.Text, mabs.Text.Trim(), decimal.Parse(l_mavaovien.ToString()), decimal.Parse(l_maql.ToString()), i_userid, ngayvv.Text, i_chinhanh);
            f.ShowDialog();
        }
        void OpenPort()
        {
