...
namespace dllVuKeHoach
{
	...
	/// </summary>
	public class frmKh141 : System.Windows.Forms.Form
	{
		...
		public frmKh141(AccessData acc,string hoten,int userid,int mabv)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmKh141));
			...
			this.Text = "Tình hình mắc chết bệnh truyền nhiễm gây dịch và bệnh quan trọng";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmKh141_Load);
		...
		private void frmKh141_Load(object sender, System.EventArgs e)
		{
            user = m.user;
			...
			load_ngay();
            dt = m.get_data("select * from " + user + ".kh_dm_141_dk").Tables[0];
			load_grid(false);
		...
		{
            if (dm) ds = m.get_data("select * from " + user + ".kh_dm_141 order by ma");
			else load_data();
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
                sql = "select a.*,b.stt,b.ten from " + user + ".kh_bieu_141 a," + user + ".kh_dm_141 b where a.ma=b.ma and a.id=" + l_id + " order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		{
            ds = m.get_data("select * from " + user + ".kh_dm_141 order by ma");
			DataRow[] dr;
            foreach (DataRow r in m.get_data("select * from " + user + ".kh_bieu_141 where id=" + l_id).Tables[0].Rows)
			{
		...
		{
            cmbNgay.DataSource = m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from " + user + ".kh_bieu_141 group by id,ngay order by ngay").Tables[0];
		}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from kh_bieu_141 where id="+l_id);
		...
		private void AddGridTableStyle()
		{
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 34);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 35);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 36);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 37);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 38);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 39);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 40);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 41);
			TextCol1.MappingName = "C39";
			TextCol1.HeaderText = "C41";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 42);
			TextCol1.MappingName = "C40";
			TextCol1.HeaderText = "C42";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 43);
			TextCol1.MappingName = "C41";
			TextCol1.HeaderText = "C43";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 44);
			TextCol1.MappingName = "C42";
			TextCol1.HeaderText = "C44";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 45);
			TextCol1.MappingName = "C43";
			TextCol1.HeaderText = "C45";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 46);
			TextCol1.MappingName = "C44";
			TextCol1.HeaderText = "C46";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 47);
			TextCol1.MappingName = "C45";
			TextCol1.HeaderText = "C47";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 48);
			TextCol1.MappingName = "C46";
			TextCol1.HeaderText = "C48";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 49);
			TextCol1.MappingName = "C47";
			TextCol1.HeaderText = "C49";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 50);
			TextCol1.MappingName = "C48";
			TextCol1.HeaderText = "C50";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 51);
			TextCol1.MappingName = "C49";
			TextCol1.HeaderText = "C51";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 52);
			TextCol1.MappingName = "C50";
			TextCol1.HeaderText = "C52";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 53);
			TextCol1.MappingName = "C51";
			TextCol1.HeaderText = "C53";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 54);
			TextCol1.MappingName = "C52";
			TextCol1.HeaderText = "C54";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 55);
			TextCol1.MappingName = "C53";
			TextCol1.HeaderText = "C55";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
			...
			TextCol1=new DataGridColoredTextBoxColumn(de, 56);
			TextCol1.MappingName = "C54";
			TextCol1.HeaderText = "C56";
			TextCol1.Width = 39;
			TextCol1.Format="# ### ###";
			TextCol1.Alignment=HorizontalAlignment.Right;
			ts.GridColumnStyles.Add(TextCol1);
...
//				if (decimal.Parse(dataGrid1[i_row,4].ToString())>decimal.Parse(dataGrid1[i_row,3].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,5].ToString())>decimal.Parse(dataGrid1[i_row,3].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,6].ToString())>decimal.Parse(dataGrid1[i_row,4].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,6].ToString())>decimal.Parse(dataGrid1[i_row,5].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,8].ToString())>decimal.Parse(dataGrid1[i_row,7].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,9].ToString())>decimal.Parse(dataGrid1[i_row,7].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,10].ToString())>decimal.Parse(dataGrid1[i_row,8].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,10].ToString())>decimal.Parse(dataGrid1[i_row,9].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,12].ToString())>decimal.Parse(dataGrid1[i_row,11].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,13].ToString())>decimal.Parse(dataGrid1[i_row,11].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,14].ToString())>decimal.Parse(dataGrid1[i_row,12].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,14].ToString())>decimal.Parse(dataGrid1[i_row,13].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,16].ToString())>decimal.Parse(dataGrid1[i_row,15].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,17].ToString())>decimal.Parse(dataGrid1[i_row,15].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,18].ToString())>decimal.Parse(dataGrid1[i_row,16].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,18].ToString())>decimal.Parse(dataGrid1[i_row,17].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,20].ToString())>decimal.Parse(dataGrid1[i_row,19].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,22].ToString())>decimal.Parse(dataGrid1[i_row,21].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,24].ToString())>decimal.Parse(dataGrid1[i_row,23].ToString())				
//					|| decimal.Parse(dataGrid1[i_row,26].ToString())>decimal.Parse(dataGrid1[i_row,25].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,25].ToString())>decimal.Parse(dataGrid1[i_row,23].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,26].ToString())>decimal.Parse(dataGrid1[i_row,24].ToString()) 
//					|| decimal.Parse(dataGrid1[i_row,28].ToString())>decimal.Parse(dataGrid1[i_row,27].ToString())
//					|| decimal.Parse(dataGrid1[i_row,30].ToString())>decimal.Parse(dataGrid1[i_row,29].ToString())
//					|| decimal.Parse(dataGrid1[i_row,29].ToString())>decimal.Parse(dataGrid1[i_row,27].ToString())
//					|| decimal.Parse(dataGrid1[i_row,30].ToString())>decimal.Parse(dataGrid1[i_row,28].ToString()))
//				{
