...
namespace tiemchung
{
	public class frmChidinhtiemchung : System.Windows.Forms.Form
    {
		...
		private int i_madoituong=2,i_loai,i_done,i_paid,i_row=0,i_userid,iChidinh,v1,v2,i_nhom,i_madoituongvao,i_tunguyen,i_loaiba,i_loaitrongoi=0;
        private int i_traituyen = 0;
		private long l_maql,l_idkhoa,l_id,l_mavaovien,l_idchidinh;
		private decimal d_soluong,d_dongia,d_vattu,idduoc=0,id_goi=0;
		...
		public frmChidinhtiemchung(LibMedi.AccessData acc,string mabn,string hoten,string tuoi,string ngay,string makp,string tenkp,int madoituong,int loai,long mavaovien,long maql,long idkhoa,int userid,string table,string thebhyt,string _nam,int loaiba,string _mabs,string _chandoan,string _maicd, int traituyen)
		{
			InitializeComponent();
        ...
        //--linh
        public frmChidinhtiemchung(LibMedi.AccessData acc, string mabn, string hoten, string tuoi, string ngay, string makp, string tenkp, int madoituong, int loai, long mavaovien, long maql, long idkhoa, int userid, string table, string thebhyt, string _nam, string loaiba, string _mabs, string _chandoan, bool badmin, int traituyen)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
        ...
        //Tu
        public frmChidinhtiemchung(LibMedi.AccessData acc, string mabn, string hoten, string tuoi, string ngay, string makp, string tenkp, int madoituong, int loai, long maql, long idkhoa, int userid, string table, string thebhyt, string _madoituong, string _mabs, string _chandoan, bool admin, long _mavaovien, int _loaiba, int _traituyen, string denngay)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
            lan.Changelanguage_to_English(this.Name.ToString(), this);
        ...
        public frmChidinhtiemchung(LibMedi.AccessData acc, string mabn, string hoten, string tuoi, string ngay, string makp, string tenkp, int madoituong, int loai, long maql, long idkhoa, int userid, string table, string thebhyt, string _madoituong, string _mabs, string _chandoan, bool admin, long _mavaovien, int _loaiba, int _traituyen, bool _chonngay)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
            lan.Changelanguage_to_English(this.Name.ToString(), this);
        ...
        public frmChidinhtiemchung(LibMedi.AccessData acc,string _mabn, string ngay, string makp, string tenkp,int _i_phieu,
            int _i_somay,int _i_makp,int _i_makhoa,string _s_makho,long _l_duyet,int _i_buoi,int _i_nhom,long _maql,long _mavaovien)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
            lan.Changelanguage_to_English(this.Name.ToString(), this);
            ...
            s_mabn = _mabn; mabn.Text = _mabn; i_nhom = _i_nhom; l_maql = _maql; l_mavaovien = _mavaovien;
            i_loai = 2;
        }
		...
		private void InitializeComponent()
		{
            ...
            this.mabn.Location = new System.Drawing.Point(50, 3);
            this.mabn.Name = "mabn";
            ...
            this.hoten.Location = new System.Drawing.Point(167, 3);
            this.hoten.Name = "hoten";
            this.hoten.Size = new System.Drawing.Size(214, 21);
            ...
            this.tuoi.Location = new System.Drawing.Point(413, 3);
            this.tuoi.Name = "tuoi";
            ...
            this.treeView1.Location = new System.Drawing.Point(661, 25);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(649, 253);
            ...
            // madoituong
            // 
            this.madoituong.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.madoituong.Location = new System.Drawing.Point(646, 310);
            ...
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(529, 21);
            this.ten.TabIndex = 6;
            ...
            this.label6.Location = new System.Drawing.Point(662, 332);
            ...
            this.soluong.Location = new System.Drawing.Point(726, 332);
            ...
            this.label7.Location = new System.Drawing.Point(423, 3);
            ...
            // tenkp
            // 
            this.tenkp.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.tenkp.Location = new System.Drawing.Point(493, 3);
            ...
            this.butLietke.Location = new System.Drawing.Point(178, 382);
            this.butLietke.Name = "butLietke";
            this.butLietke.Size = new System.Drawing.Size(114, 25);
            this.butLietke.TabIndex = 11;
            this.butLietke.Text = "    Thuốc + vật tư";
            this.butLietke.Click += new System.EventHandler(this.butLietke_Click_1);
            // 
            // butMoi
            // 
            ...
            this.butMoi.Location = new System.Drawing.Point(292, 382);
            ...
            this.butSua.Location = new System.Drawing.Point(362, 382);
            ...
            this.butLuu.Location = new System.Drawing.Point(432, 382);
            ...
            this.butBoqua.Location = new System.Drawing.Point(502, 382);
            ...
            this.butHuy.Location = new System.Drawing.Point(572, 382);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(712, 382);
            ...
            this.thuchien.Size = new System.Drawing.Size(265, 21);
            ...
            this.label10.Location = new System.Drawing.Point(616, 3);
            ...
            this.sothe.Location = new System.Drawing.Point(661, 3);
            ...
            this.butIn.Location = new System.Drawing.Point(642, 382);
            ...
            this.tong.Location = new System.Drawing.Point(661, 264);
            ...
            // chkmadt_def
            // 
            this.chkmadt_def.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            ...
            this.chandoan.Size = new System.Drawing.Size(470, 21);
            ...
            this.ghichu.Size = new System.Drawing.Size(726, 21);
            this.ghichu.TabIndex = 8;
            this.ghichu.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ghichu_KeyDown);
            // 
            // chkIntheodot
            // 
            this.chkIntheodot.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            ...
            this.butchidinh.ImageAlign = System.Drawing.ContentAlignment.TopLeft;
            this.butchidinh.Location = new System.Drawing.Point(9, 382);
            this.butchidinh.Name = "butchidinh";
            this.butchidinh.Size = new System.Drawing.Size(169, 25);
            this.butchidinh.TabIndex = 288;
            this.butchidinh.Text = "    &Câu hỏi sàng lọc tiêm chủng";
		...
		{            
            ...
            sql += "a.vattu_cs,a.chenhlech,a.gia_ksk,a.vattu_ksk,a.loaitrongoi ";
        ...
        private void AddGridTableStyle()
        {
            ...
            discontinuedCol.HeaderText = lan.Change_language_MessageText("In");
            ...
            FormattableTextBoxColumn TextCol1 = new FormattableTextBoxColumn();//1
            ...
            TextCol1 = new FormattableTextBoxColumn();//2
            TextCol1.MappingName = "tenkp";
            TextCol1.HeaderText = lan.Change_language_MessageText("Khoa/phòng");
            TextCol1.Width = 100;
            ...
            TextCol1 = new FormattableTextBoxColumn();//3
            TextCol1.MappingName = "ngay";
            TextCol1.HeaderText = lan.Change_language_MessageText("Ngày");
            TextCol1.Width = 100;
            TextCol1.ReadOnly = true;
            TextCol1.SetCellFormat += new FormatCellEventHandler(SetCellFormat);
            ts.GridColumnStyles.Add(TextCol1);
            ...
            TextCol1 = new FormattableTextBoxColumn();//4
            TextCol1.MappingName = "doituong";
            TextCol1.HeaderText = lan.Change_language_MessageText("Đối tượng");
            TextCol1.Width = 60;
            TextCol1.ReadOnly = true;
            TextCol1.SetCellFormat += new FormatCellEventHandler(SetCellFormat);
            ts.GridColumnStyles.Add(TextCol1);
            ...
            TextCol1 = new FormattableTextBoxColumn();//5
            TextCol1.MappingName = "ten";
            TextCol1.HeaderText = lan.Change_language_MessageText("Dịch vụ");
            TextCol1.Width = 200;
            TextCol1.ReadOnly = true;
            TextCol1.SetCellFormat += new FormatCellEventHandler(SetCellFormat);
            ts.GridColumnStyles.Add(TextCol1);
            ...
            TextCol1 = new FormattableTextBoxColumn();//6
            TextCol1.MappingName = "dvt";
            TextCol1.HeaderText = lan.Change_language_MessageText("ĐVT");
            TextCol1.Width = 30;
            TextCol1.ReadOnly = true;
            TextCol1.SetCellFormat += new FormatCellEventHandler(SetCellFormat);
            ts.GridColumnStyles.Add(TextCol1);
            ...
            TextCol1 = new FormattableTextBoxColumn();//7
            TextCol1.MappingName = "soluong";
            TextCol1.HeaderText = lan.Change_language_MessageText("SL");
            TextCol1.Width = 30;
            ...
            TextCol1 = new FormattableTextBoxColumn();//8
            ...
            TextCol1 = new FormattableTextBoxColumn();//9
            ...
            TextCol1 = new FormattableTextBoxColumn();//10
            ...
            TextCol1 = new FormattableTextBoxColumn();//11
            ...
            TextCol1 = new FormattableTextBoxColumn();//12
            ...
            TextCol1 = new FormattableTextBoxColumn();//13
            ...
            TextCol1 = new FormattableTextBoxColumn();//14
            ...
            TextCol1 = new FormattableTextBoxColumn();//15
            ...
            TextCol1 = new FormattableTextBoxColumn();//16
            ...
            TextCol1 = new FormattableTextBoxColumn();//17
            ...
            TextCol1 = new FormattableTextBoxColumn();//18
            ...
            TextCol1 = new FormattableTextBoxColumn();//19
            ...
            TextCol1 = new FormattableTextBoxColumn();//20
            ...
            TextCol1 = new FormattableTextBoxColumn();//21
            TextCol1.MappingName = "idduoc";
            TextCol1.HeaderText = "";
            TextCol1.Width = 0;
            ts.GridColumnStyles.Add(TextCol1);
            dataGrid1.TableStyles.Add(ts);

            TextCol1 = new FormattableTextBoxColumn();//22
            TextCol1.MappingName = "id_goi";
            TextCol1.HeaderText = "";
            TextCol1.Width = 0;
            ts.GridColumnStyles.Add(TextCol1);
            dataGrid1.TableStyles.Add(ts);

            TextCol1 = new FormattableTextBoxColumn();//23
            TextCol1.MappingName = "loaitrongoi";
            TextCol1.HeaderText = "";
            TextCol1.Width = 0;
            ts.GridColumnStyles.Add(TextCol1);
            dataGrid1.TableStyles.Add(ts);
		...
		private void load_grid()
		{
            ...
            sql += ", a.tylegiam, a.stgiam, a.lydogiam,a.hide,a.idduoc,a.id_goi,b.loaitrongoi ";
		...
		private void ref_text()
		{
			try
			{
				...
				soluong.Text=d_soluong.ToString("###,###.00");
				l_id=long.Parse(dataGrid1[i_row,1].ToString());
                ...
                idduoc = decimal.Parse(dataGrid1[i_row, 21].ToString());
                id_goi = decimal.Parse(dataGrid1[i_row, 22].ToString());
                i_loaitrongoi = int.Parse(dataGrid1[i_row, 23].ToString());
                        ...
                        if (tmp.Rows[0]["done"].ToString() == "1" && tmp.Rows[0]["paid"].ToString() == "0")//(dataGrid1[i_row, 13].ToString() == "1" && dataGrid1[i_row, 12].ToString() == "0")
                        {
                            ...
                            if (r != null)
                            {
                                if (int.Parse(r["madoituong"].ToString()) == i_tunguyen)
                                    bFound = m.getrowbyid(dt, "chenhlech=1 and id=" + long.Parse(r["mavp"].ToString())) != null;
                            }
                        }
                    }
                }
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            //
            string a_sql = "";
            a_sql = "select id,id_nhom,id_loai,id_gia as mabd,sotien,stt,soluong*"+decimal.Parse(soluong.Text.Trim())+" soluong,madoituong from medibv.v_trongoi where id_loai=-999 and id="+mavp.Text;
            //a_sql += "union all ";
            ...
            if (dtct.Rows.Count > 0)
            {
                ...
                if (!bNew)
                {
                    ...
                    bFound = true;
                    foreach (DataRow r1 in d.get_data("select a.*,b.manguon,b.giaban,b.giamua,a.soluong*b.giamua as sotien,b.gianovat,c.gia_bh from " + user + m.mmyy(s_ngay) + ".d_thucxuat a," + user + m.mmyy(s_ngay) + ".d_theodoi b," + user +".d_dmbd c where a.sttt=b.id and b.mabd=c.id a.id=" + l_id).Tables[0].Rows)
                    {
                        d.upd_tonkhoct_thucxuat(d.delete, m.mmyy(s_ngay), i_makp, i_loai, 1, long.Parse(r1["sttt"].ToString()), int.Parse(r1["makho"].ToString()), int.Parse(r1["manguon"].ToString()), int.Parse(r1["mabd"].ToString()), decimal.Parse(r1["soluong"].ToString()));
                ...
                if (l_duyet == 0)
                {
                    if (i_somay == 1)
                    {
                        ...
                        {
                            MessageBox.Show(lan.Change_language_MessageText("Ngày ") + s_ngay + lan.Change_language_MessageText("\nKhoa ") + s_tenkp + lan.Change_language_MessageText("\nPhiếu ") + "s_tenphieu" + lan.Change_language_MessageText("\nĐã nhập !"), LibMedi.AccessData.Msg);
                            return;
                        }
                    }
                    else
                    ...
                    d.upd_duyet(m.mmyy(s_ngay), l_duyet, i_nhom, s_ngay, i_loai, i_phieu, i_makp, 0, i_userid, i_makhoa);
                    foreach (DataRow r1 in m.get_data("select * from " + user + ".d_dmkho where id in (" + s_makho.Trim(',') + ")").Tables[0].Rows)
                        d.upd_duyetkho(m.mmyy(s_ngay), l_duyet, int.Parse(r1["id"].ToString()), 0);
                }
                else d.upd_duyet(m.mmyy(s_ngay), l_duyet, i_nhom, s_ngay, i_loai, i_phieu, i_makp, 0, i_userid, i_makhoa);
                ...
                if (!bNew)
                {
                    foreach (DataRow r1 in dsxoa.Tables[0].Rows)
                    {
                        ...
                        d.execute_data("delete from " + user + m.mmyy(s_ngay) + ".d_xtutrucct where id=" + l_id + " and stt=" + long.Parse(r1["stt"].ToString()));
                ...
                foreach (DataRow r1 in dtct.Rows)
                {
                    ...
                    d.upd_xtutrucct(m.mmyy(s_ngay), l_id, int.Parse(r1["stt"].ToString()),
                        ...
                        0, 1, //long.Parse(r1["idvpkhoa"].ToString()),decimal.Parse(r1["solan"].ToString())
                ...
                //}
                idduoc = l_id;
                if (!d.upd_xuatsdll(m.mmyy(s_ngay), l_id, i_nhom, mabn.Text, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, i_phieu, i_makp, i_userid, l_id, 1, i_makhoa, 0, 0, "", s_ngay))
                {
                ...
                d.get_xuatsdct_cstt(m.mmyy(s_ngay), dtct.Select("soluong>0", "stt"), i_makp, // and idvpkhoa=0
                    i_makhoa, 0, l_id, mabn.Text, l_mavaovien, l_maql, l_idkhoa, i_loai, 1, s_ngay, i_nhom, s_ngay, i_traituyen);
                if (bFound)
                {
                    ...
                    {
                        sql = "update " + user + m.mmyy(s_ngay) + ".d_tienthuoc set done=" + int.Parse(r1["done"].ToString()) + ",idttrv=" + long.Parse(r1["idttrv"].ToString());
                        ...
                        sql += " and mabd=" + long.Parse(r1["mabd"].ToString());
                        sql += " and done=0";
                        d.execute_data(sql);
                    }
                }
                ...
                decimal gia = 0;
                foreach (DataRow r1 in dtct.Select("soluong>0", "stt"))
                {
            ...
            if (dr.Length > 0)
            {
                ...
                sql += " where  a.id=" + int.Parse(mavp.Text);
                ...
                foreach (DataRow r1 in v.get_data(sql).Tables[0].Rows)
                {
                    ...
                    if (s_table == "xxx.tiepdon") upd_tiepdon(long.Parse(r1["id"].ToString()), long.Parse(r1["id_gia"].ToString()));
                }
        ...
        private void upd_detail(bool chenhlech,int i_mavp,decimal d_soluong,decimal dongia,int idtrongoi)
        {
            ...
            if (r != null)
            {
                ...
                id_cha = decimal.Parse(l_id.ToString());
                //Dong
                f_bnmien(i_mavp);
                if (ds_bnmien.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        foreach (DataRow ddr1 in m.get_data(" select mavp,done,idchidinh,dongia from " + user + m.mmyy(s_ngay) + ".v_chidinh where mavaovien=" + l_mavaovien + " and mabn='" + s_mabn + "' and idchidinh=" + l_idchidinh + " ").Tables[0].Rows)
                        {
                            m.execute_data(" update " + user + m.mmyy(s_ngay) + ".v_chidinh set tylegiam=" + int.Parse(ddr["tylemien"].ToString()) + ",stgiam=" + ddr["tylemien"].ToString() + "*" + ddr1["dongia"].ToString() + "/100 where maql=" + l_maql + " and idchidinh=" + l_idchidinh + " and mavp=" + ddr1["mavp"].ToString());
                        }
                    }
                }
                //end Dong
                m.execute_data("update "+m.user+m.mmyy(s_ngay)+".v_chidinh set idduoc="+idduoc+" where id="+l_id);
                if (chenhlech) 
                {
                ...
                {
                    l_id = v.get_id_chidinh;
                    if (!v.upd_chidinh(l_id, s_mabn, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, s_makp, int.Parse(dr1["madoituong"].ToString()), int.Parse(dr1["id_gia"].ToString()), (int)decimal.Parse(dr1["soluong"].ToString()), 0, 0, i_userid, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), 0, (s_maicd == "" && chandoan.Text != "") ? "U00" : s_maicd, chandoan.Text, mabs.Text, i_loaiba, ghichu.Text))
                    {
                        MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin chỉ định !"), LibMedi.AccessData.Msg);
                        return;
                    }
                    sql = "update " + user + m.mmyy(s_ngay) + ".v_chidinh set ";
                    if(i_loaitrongoi == 1)sql+= "paid=1,";
                    sql+="id_goi=" + id_cha + " where id=" + l_id;
                    m.execute_data(sql);
                    //r = m.getrowbyid(dt, "id=" + int.Parse(dr1["id_gia"].ToString()));
                    r11 = m.getrowbyid(dttam, "id=" + int.Parse(dr1["id_gia"].ToString()));
                    m.updrec_chidinh(ds.Tables[0], l_id, s_ngay, s_makp, s_tenkp, cl_doituong, cl_tendoituong, int.Parse(dr1["id_gia"].ToString()), r11["ten"].ToString(), r11["dvt"].ToString(), decimal.Parse(dr1["soluong"].ToString()), 0, 0, 0, 0, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), r11["ma"].ToString(), (s_maicd == "" && chandoan.Text != "") ? "U00" : s_maicd, chandoan.Text, mabs.Text, i_loaiba, ghichu.Text, 0, 0, "");
                }
            }
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
            ...
            if (id_goi != 0)
            {
                MessageBox.Show(lan.Change_language_MessageText("Không thể xóa chi tiết gói!"), LibMedi.AccessData.Msg);
                return;
            }
			try
			{
                ...
                if (m.getrowbyid(dt, "id=" + mavp.Text) == null)
                {
                    MessageBox.Show(lan.Change_language_MessageText("Dịch vụ không thuộc gói tiêm chủng, không thể xóa!") , LibMedi.AccessData.Msg);
                    return;
                }

                drduoc = m.get_data("select a.id,a.idduyet,b.done,b.makp from "+m.user+m.mmyy(s_ngay)+".d_xtutrucll a,"+m.user+m.mmyy(s_ngay)+".d_duyet b where a.idduyet=b.id and a.id="+idduoc).Tables[0].Rows[0];
                if (drduoc == null) return;
                else {
                    if (drduoc["done"].ToString() == "1")
                    {
                        MessageBox.Show(lan.Change_language_MessageText("Số liệu thuốc + vật tư đã chuyển xống kho, không thể hủy!"), LibMedi.AccessData.Msg);
                        return;
                    }
                    else if (drduoc["done"].ToString() == "2")
                    {
                        MessageBox.Show(lan.Change_language_MessageText("Số liệu thuốc + vật tư đã duyệt, không thể hủy!"), LibMedi.AccessData.Msg);
                        return;
                    }
                }
				...
				if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy '"+s_tendv+"' ?"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
				{
                    ...
                    DataTable dtct=new DataTable();
                    string s_mmyy = m.mmyy(s_ngay);
                    string xxx = m.user + s_mmyy;
                    ...
                    int itable = m.tableid(d.mmyy(s_ngay), "d_thucxuat");
                    ...
                    itable = m.tableid(d.mmyy(s_ngay), "d_xtutrucll");
                    m.upd_eve_tables(s_ngay, itable, i_userid, "del");
                    m.upd_eve_upd_del(s_ngay, itable, i_userid, "del", m.fields(xxx + ".d_xtutrucll", "id=" + idduoc));
                    itable = m.tableid(d.mmyy(s_ngay), "d_xuatsdll");
                    m.upd_eve_tables(s_ngay, itable, i_userid, "del");
                    m.upd_eve_upd_del(s_ngay, itable, i_userid, "del", m.fields(xxx + ".d_xuatsdll", "id=" + idduoc));
                    ...
                    //end xoa thuoc
                    itable = m.tableid(m.mmyy(s_ngay), "v_chidinh");
                    m.upd_eve_tables(s_ngay, itable, i_userid, "del");
                    ...
                    m.execute_data("delete from " + user + m.mmyy(s_ngay) + ".v_chidinh where id_goi=" + l_id);
                    if (tmp.Rows.Count > 0)
                    {
                        if (m.get_data("select id from " + user + ".v_giavp where chenhlech=1 and id=" + long.Parse(tmp1.Rows[0]["mavp"].ToString())).Tables[0].Rows.Count>0)
                        {
                            sql = "delete from " + user + m.mmyy(s_ngay) + ".v_chidinh where maql=" + l_maql + " and mavaovien=" + l_mavaovien;
                            sql += " and madoituong=" + i_tunguyen + " and userid=" + long.Parse(tmp1.Rows[0]["userid"].ToString());
                            sql += " and to_char(ngay,'dd/mm/yyyy')='" + s_ngaycd.Substring(0,10) + "' and hide=1 and done=1 and mavp="+long.Parse(tmp1.Rows[0]["mavp"].ToString());
                            sql += " and idchidinh=" + long.Parse(tmp1.Rows[0]["idchidinh"].ToString());
                            sql += " and idkhoa=" + long.Parse(tmp1.Rows[0]["idkhoa"].ToString());
                            sql += " and loai=" + long.Parse(tmp1.Rows[0]["loai"].ToString());
        ...
        private void butHuy_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy số phiếu này ?"),s_msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
				{
                    ...
                    foreach (DataRow r1 in d.get_data( "select a.*,b.manguon,b.giaban,b.giamua,a.soluong*b.giamua as sotien,b.gianovat from " + xxx + ".d_thucxuat a,"+xxx+".d_theodoi b where a.sttt=b.id and a.id=" + l_id).Tables[0].Rows)
					{
						d.upd_tonkhoct_thucxuat(d.delete,s_mmyy,i_makp,i_loai,1,long.Parse(r1["sttt"].ToString()),int.Parse(r1["makho"].ToString()),int.Parse(r1["manguon"].ToString()),int.Parse(r1["mabd"].ToString()),decimal.Parse(r1["soluong"].ToString()));
						d.upd_theodoicongno(d.delete,mabn.Text,l_mavaovien,l_maql,l_idkhoa,int.Parse(r1["madoituong"].ToString()),decimal.Parse(r1["sotien"].ToString()),"thuoc");
                        d.upd_tienthuoc(d.delete, s_mmyy, l_id, mabn.Text, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_makhoa, i_loai, int.Parse(r1["madoituong"].ToString()), int.Parse(r1["mabd"].ToString()), decimal.Parse(r1["soluong"].ToString()), decimal.Parse(r1["giaban"].ToString()), decimal.Parse(r1["giamua"].ToString()), decimal.Parse(r1["gianovat"].ToString()),0);
                        m.upd_eve_tables(s_ngay, itable, i_userid, "del");
		...
		private void mavp_Validated(object sender, System.EventArgs e)
		{
			if (ma.Text!="")
			{
				...
				if (r!=null)
				{
                    ...
                    i_loaitrongoi = int.Parse(r["loaitrongoi"].ToString());
                    if (!bLocdichvu && madoituong.SelectedValue.ToString() == "1")
                    {
                        sql = "id=" + long.Parse(mavp.Text) + " and bhyt<>0";
                        if (sothe.Text.Trim().Length > v1 + v2) sql += " and (locthe='' or locthe is null or locthe like '%" + sothe.Text.Trim().Substring(v1, v2) + "%' or locthe like '%" + sothe.Text.Substring(0, 2) + ",%')";
        ...
        {
            //tiemchung.frmtc f = new frmtc("",s_mabn,l_mavaovien);
            //f.ShowInTaskbar = false;
            //f.ShowDialog();
        }

        private void butLietke_Click_1(object sender, EventArgs e)
        {
            string s_mmyy = m.mmyy(s_ngay);
            long l_duyet1 = 0;
            string s_manguon = d.get_data("select nguon from " + user + ".d_dmphieu where id=" + i_loai).Tables[0].Rows[0][0].ToString();
            try
            {
                l_duyet1 = long.Parse(d.get_data("select id from " + user + s_mmyy + ".d_duyet where phieu=" + i_phieu + " and to_char(ngay,'dd/mm/yyyy')='" + s_ngay.Substring(0, 10) + "' and makp=" + i_makp + " and loai=2").Tables[0].Rows[0][0].ToString());
            }
            catch { l_duyet1 = 0; }
            //frmXtutruc f1 = new frmXtutruc(s_ngay, s_makho+",", s_makp, i_nhom, 2, i_phieu, i_makhoa, i_makp, i_userid, s_mmyy , l_duyet1, "Phiếu xuất tủ trực theo người bệnh (" + s_ngay.Trim() + ", " + s_tenkp + ")", LibMedi.AccessData.Msg, m.bDausinhton, m.iSudungthuoc, s_manguon, s_mabn, 0, s_tenkp, "", i_somay, s_mabs, s_madoituong,true);
            //f1.ShowInTaskbar = false;
            //f1.ShowDialog(this);

            frmGoiDichvu f = new frmGoiDichvu(i_nhom,i_makp,s_ngay,i_loai,i_phieu,s_mmyy,s_makho+",",s_manguon,l_duyet1,s_mabn,l_mavaovien,l_maql,l_idkhoa,i_userid,long.Parse(idduoc.ToString()),i_makhoa,s_ngayvk,"0","0",false,0,i_madoituong,s_makp,long.Parse(l_id.ToString()),"",s_maicd,s_chandoan,s_mabs,i_loaiba,false,false,0);
            f.ShowInTaskbar=false;
            f.ShowDialog();
            load_grid();
        }
