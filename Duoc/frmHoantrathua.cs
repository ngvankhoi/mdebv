...
namespace Duoc
{
	...
	public class frmHoantrathua : System.Windows.Forms.Form
	{
		...
		private int i_nhom,i_loai,i_userid,i_makp,i_thuoc,i_khudt=0;
		...
		public frmHoantrathua(AccessData acc,int nhom,string ngay,int loai,int userid,string users,string makp,string mmyy,string kho,bool giaban,int thuoc,bool thuhoi,string _userid,int _khudt)
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
            d = acc; i_nhom = nhom; i_loai = loai; i_userid = userid; s_ngay = ngay; s_makp = makp; s_userid = _userid;
            s_mmyy = mmyy; s_kho = kho; bGiaban = giaban; i_thuoc = thuoc; this.Text = users; butThuhoi.Enabled = thuhoi;
            i_khudt = _khudt;
		...
		private void InitializeComponent()
		{
            ...
            this.mabn.Location = new System.Drawing.Point(72, 3);
            this.mabn.Name = "mabn";
            ...
            this.ngay.Location = new System.Drawing.Point(208, 3);
            this.ngay.Name = "ngay";
            ...
            this.phieu.Location = new System.Drawing.Point(328, 3);
            ...
            this.treeView1.Size = new System.Drawing.Size(144, 502);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(486, 529);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(624, 518);
            ...
            this.butChoduyet.Location = new System.Drawing.Point(640, 529);
            this.butChoduyet.Name = "butChoduyet";
            this.butChoduyet.Size = new System.Drawing.Size(140, 25);
            ...
            this.butDuyet.Location = new System.Drawing.Point(206, 529);
            ...
            this.butThuhoi.Location = new System.Drawing.Point(276, 529);
            ...
            this.butIn.Location = new System.Drawing.Point(346, 529);
            ...
            this.butTim.Location = new System.Drawing.Point(416, 529);
		...
		private void frmHoantrathua_Load(object sender, System.EventArgs e)
		{
            ...
            dtphieu = d.get_data("select * from " + user + ".d_loaiphieu where id=0 order by stt").Tables[0];
			...
			sql="select a.id,mabn,b.ten as hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,a.phieu,a.makp,a.idduyet,a.makhoa from "+xxx+".d_xuatsdll a,"+user+".d_duockp b ";
		...
		private void AddGridTableStyle()
		{
			...
			TextCol.Width = (d.bHoatchat && i_thuoc==1)?200:0;
			ts.GridColumnStyles.Add(TextCol);
			dataGrid1.TableStyles.Add(ts);
...
lan.Change_language_MessageText("Nếu cần thay đổi thì vào mục khai báo hệ thống"),d.Msg);
            ...
            frmThuhoi f = new frmThuhoi(d, dtll, dtct, dtkp, dtphieu, int.Parse(makp.SelectedValue.ToString()), int.Parse(phieu.SelectedValue.ToString()), s_ngay, s_mmyy, i_nhom, i_loai, false, true, i_thuoc, s_kho, i_userid);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll.AcceptChanges();
		...
		{
            frmInphieu f = new frmInphieu(d, dtkp, dtphieu, (makp.SelectedIndex == -1) ? -1 : int.Parse(makp.SelectedValue.ToString()), (phieu.SelectedIndex == -1) ? -1 : int.Parse(phieu.SelectedValue.ToString()), s_ngay, s_mmyy, i_nhom, i_loai, s_kho, "PHIẾU HOÀN TRẢ",false, s_userid, true, i_khudt, i_userid);
			f.ShowDialog(this);
		}
