...
namespace Duoc
{
	...
	public class frmButruc : System.Windows.Forms.Form
	{
        ...
        private bool bKhoaso, bGiaban, bCongdon, bIntheocstt;
		...
		public frmButruc(AccessData acc,int nhom,string ngay,int loai,int userid,string users,string makp,string mmyy,string kho,bool giaban,bool congdon,bool thuhoi, int _khudt)
		{
			//
            ...
            d = acc; i_nhom = nhom; i_loai = loai; i_userid = userid; s_ngay = ngay; s_makp = makp; s_mmyy = mmyy; s_userid = users;
            s_kho = kho; bGiaban = giaban; bCongdon = congdon; butThuhoi.Enabled = thuhoi;
            i_khudt = _khudt;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmButruc));
            ...
            this.treeView1.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.treeView1.Location = new System.Drawing.Point(640, 48);
            this.treeView1.Name = "treeView1";
            this.treeView1.Size = new System.Drawing.Size(144, 470);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(493, 519);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(624, 501);
            ...
            this.butChoduyet.Location = new System.Drawing.Point(640, 519);
            ...
            this.butDuyet.Location = new System.Drawing.Point(213, 519);
            ...
            this.butThuhoi.Location = new System.Drawing.Point(283, 519);
            ...
            this.butIn.Location = new System.Drawing.Point(353, 519);
            ...
            this.butTim.Location = new System.Drawing.Point(423, 519);
            ...
            this.songay.Location = new System.Drawing.Point(703, 26);
            this.songay.Name = "songay";
            this.songay.Size = new System.Drawing.Size(81, 20);
            this.songay.TabIndex = 110;
		...
		private void frmButruc_Load(object sender, System.EventArgs e)
		{
            ...
            sql = "select distinct a.id,a.mabn,c.hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,a.phieu,a.makp,a.idduyet,a.makhoa from " + xxx + ".d_xuatsdll a," + xxx + ".d_bucstt b," + user + ".btdbn c, " + user + ".d_duockp d ";
			sql+="where a.id=b.id and a.mabn=c.mabn and a.makhoa=d.id and a.maql<>0 and a.loai="+i_loai+" and a.nhom="+i_nhom;
			//if (d.bUserid) 
		...
		{
			sql="select a.stt,a.sttt,'' as doituong,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,b.tenhc,b.dang,f.ten as tenkho,c.ten as tennguon,d.ten as tennhomcc,t.handung,t.losx,a.soluong,t.giamua as dongia,a.soluong*t.giamua as sotien,t.giaban,3 as madoituong,a.makho,t.manguon,t.nhomcc,'xx/xx/xxxx' as ngay ";
			sql+=" from "+xxx+".d_bucstt a,"+d.user+".d_dmbd b,"+user+".d_dmnguon c,"+user+".d_dmnx d,"+user+".d_dmkho f,"+xxx+".d_theodoi t ";
		...
		private void load_treeview()
		{
            ...
            sql = "select to_char(c.ngay,'dd/mm/yyyy') as ngay,";
            if (bIntheocstt) sql += "c.makp,";
            else sql+="c.makhoa as makp,";
            sql+="b.mabd,sum(b.slyeucau-b.slthuc) as soluong,c.loai,c.phieu, f.ten as tenphieu ";
			...
			if (s_kho!="") sql+=" and b.makho in ("+s_kho.Substring(0,s_kho.Length-1)+")";
            sql += " and c.done<>0 and b.slyeucau>b.slthuc and b.tutruc=1 ";
            sql+=" group by to_char(c.ngay,'dd/mm/yyyy'),";
            if (bIntheocstt) sql += "c.makp,";
            else sql += "c.makhoa,";
            sql+="b.mabd,c.loai,c.phieu, f.ten ";
            sql += " union all select to_char(c.ngay,'dd/mm/yyyy') as ngay,";
            if (bIntheocstt) sql += "c.makp,";
            else sql+="c.makhoa as makp,";
            sql+="b.mabd,sum(b.slyeucau-b.slthuc) as soluong ,c.loai,c.phieu, f.ten as tenphieu ";
            sql += " from xxx.d_xtutrucll a,xxx.d_xtutrucct b,xxx.d_duyet c," + user + ".d_dmbd d," + user + ".d_dmphieu e," + user + ".d_loaiphieu f," + user + ".d_duockp g ";
			sql+=" where a.id=b.id and a.idduyet=c.id and b.mabd=d.id and c.loai=e.id and c.phieu=f.id and c.makp=g.id ";
            if (i_khudt != 0) sql += " and (g.khu=0 or g.khu =" + i_khudt + ")";//binh 210411
			sql+=" and c.nhom="+i_nhom+" and c.loai="+i_loai;			
            sql += " and c.ngay between to_date('" + d1 + "','" + for_ngay + "') and to_date('" + d2 + "','" + for_ngay + "')";
			if (s_kho!="") sql+=" and b.makho in ("+s_kho.Substring(0,s_kho.Length-1)+")";
            sql += " and b.idvpkhoa=0 and c.done<>0 and b.slyeucau>b.slthuc ";
            sql+=" group by to_char(c.ngay,'dd/mm/yyyy'),";
            if (bIntheocstt) sql += "c.makp,";
            else sql+="c.makhoa,";
            sql+="b.mabd,c.loai,c.phieu, f.ten ";
...
lan.Change_language_MessageText("Nếu cần thay đổi thì vào mục khai báo hệ thống"),d.Msg);
			...
			frmDuyet f=new frmDuyet(d,dtll,i_nhom,i_loai,s_makp,s_mmyy,s_kho,this.Text,s_ngay,i_userid,false,false,1,bCongdon,s_userid,i_khudt);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll=f.dtll;
		...
		private void load_head()
		{
			...
			if (r!=null)
			{
				...
				makp.SelectedValue=r["makhoa"].ToString();
...
lan.Change_language_MessageText("Nếu cần thay đổi thì vào mục khai báo hệ thống"),d.Msg);
		...
		{
			frmInphieu f=new frmInphieu(d,dtkp,dtphieu,(makp.SelectedIndex==-1)?-1:int.Parse(makp.SelectedValue.ToString()),(phieu.SelectedIndex==-1)?-1:int.Parse(phieu.SelectedValue.ToString()),s_ngay,s_mmyy,i_nhom,i_loai,s_kho,"PHIẾU BÙ",false,s_userid,false,i_khudt, i_userid);
			f.ShowDialog(this);
		}
