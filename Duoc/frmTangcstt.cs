...
namespace Duoc
{
	...
	public class frmTangcstt : System.Windows.Forms.Form
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTangcstt));
            ...
            // label9
            // 
            this.label9.Location = new System.Drawing.Point(233, 2);
            ...
            // label10
            // 
            this.label10.Location = new System.Drawing.Point(397, 2);
            ...
            this.ngaysp.Location = new System.Drawing.Point(170, 3);
            this.ngaysp.Mask = "##/##/####";
            ...
            this.khox.Location = new System.Drawing.Point(288, 3);
            this.khox.Name = "khox";
            ...
            this.khon.Location = new System.Drawing.Point(436, 3);
            this.khon.Name = "khon";
            ...
            this.lydo.Location = new System.Drawing.Point(608, 3);
		...
		private void frmTangcstt_Load(object sender, System.EventArgs e)
		{
            ...
            dtll = d.get_data("select id,sophieu,to_char(ngay,'dd/mm/yyyy') as ngay,khox,khon,lydo,nguoinhan from " + xxx + ".d_xuatll where loai='" + s_loai + "' and userid=" + i_userid + " and nhom=" + i_nhom + " order by id").Tables[0];
		...
		{
            sql = "select a.stt,b.ma,trim(b.ten)||' '||b.hamluong as ten,nullif(b.tenhc,' ') as tenhc,b.dang,c.ten as tennguon,d.ten as tennhomcc,t.handung,t.losx,a.soluong,t.giamua as dongia,a.soluong*t.giamua as sotien,t.giaban,t.manguon,t.nhomcc,a.sttt,t.giamua,a.mabd,t.sothe,a.mabs,'' as tenbs,a.hotenbn ";
            sql += " from " + xxx + ".d_xuatct a," + user + ".d_dmbd b," + user + ".d_dmnguon c," + user + ".d_dmnx d,"+xxx+".d_theodoi t where a.sttt=t.id and a.mabd=b.id and t.manguon=c.id and t.nhomcc=d.id and a.id=" + l_id + " order by a.stt";
...
lan.Change_language_MessageText("Không cập nhật được thông tin phiếu xuất kho !"),d.Msg);
            ...
            sql = "select a.*,b.ten as tennguon,c.ten as tennhomcc,t.manguon,t.nhomcc,t.handung,t.losx,t.giamua,t.giaban from " + xxx + ".d_tonkhoct a," + user + ".d_dmnguon b," + user + ".d_dmnx c,"+xxx+".d_theodoi t where a.stt=t.id and t.manguon=b.id and t.nhomcc=c.id and a.makho=" + int.Parse(khox.SelectedValue.ToString());
            if (bQuanly_xuatban_theomavach)
                dtct = d.get_xuatct_mavach(dtct, s_mmyy, sql, l_id, s_loai, int.Parse(khox.SelectedValue.ToString()), int.Parse(khon.SelectedValue.ToString()), 0, i_nhom);
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			DataRow r1,r2;
			DataRow [] dr;
			sql="select a.stt,a.sttt,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,nullif(b.tenhc,' ') as tenhc,b.dang,c.ten as tennguon,d.ten as tennhomcc,t.handung,t.losx,a.soluong,t.giamua as dongia,a.soluong*t.giamua as sotien,t.giaban,t.manguon,t.nhomcc,e.ten as tenhang,b.manhom,f.ten as tennhom,g.ten as tennuoc,h.ten as noingoai,h.stt as sttnn, a0,nguoinhan ";
            sql += " from " + xxx + ".d_xuatll a0," + xxx + ".d_xuatct a," + user + ".d_dmbd b," + user + ".d_dmnguon c," + user + ".d_dmnx d," + user + ".d_dmhang e," + user + ".d_dmnhom f," + user + ".d_dmnuoc g," + user + ".d_nhomhang h," + xxx + ".d_theodoi t";
			...
			tongcong(dttmp);
			string tenfile="d_phieulinh_mat.rpt";
			string slydo="bổ sung cơ số tủ trực";
			if (d.bPreview)
			{
