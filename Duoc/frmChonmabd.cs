...
namespace Duoc
{
	...
	public class frmChonmabd : System.Windows.Forms.Form
	{
		...
		public frmChonmabd(AccessData acc,int nhom,string _manhom,string _nhomin)
		{
			...
			//
			InitializeComponent();
            d = acc; i_nhom = nhom; s_manhom = _manhom; s_nhomin = _nhomin;            
        ...
        public frmChonmabd(AccessData acc, int nhom, string _manhom, string _nhomin, int int_manhom)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		private void InitializeComponent()
		{
            ...
            this.butLuu.Location = new System.Drawing.Point(253, 380);
		...
		{
			dsdm.Clear();
            string sql = "select a.id,a.ma,trim(a.ten)||' '||a.hamluong as ten,a.dang,a.tenhc,b.ten as tenhang ";
            sql += " from " + user + ".d_dmbd a," + user + ".d_dmhang b,"+user+".d_dmnhom c where a.mahang=b.id and a.manhom=c.id and a.hide=0 and a.nhom=" + i_nhom;
