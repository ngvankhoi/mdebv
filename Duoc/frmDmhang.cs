...
namespace Duoc
{
	...
	public class frmDmhang : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label2.Location = new System.Drawing.Point(84, 501);
            ...
            this.ten.Location = new System.Drawing.Point(138, 501);
            this.ten.Name = "ten";
            ...
            this.label4.Location = new System.Drawing.Point(489, 501);
            ...
            this.nhomcc.Location = new System.Drawing.Point(537, 501);
            ...
            this.butImpExcel.Location = new System.Drawing.Point(492, 530);
            ...
            this.butHuy.Location = new System.Drawing.Point(422, 530);
            ...
            this.butBoqua.Location = new System.Drawing.Point(352, 530);
            ...
            this.butLuu.Location = new System.Drawing.Point(282, 530);
            ...
            this.butSua.Location = new System.Drawing.Point(212, 530);
            ...
            this.butMoi.Location = new System.Drawing.Point(142, 530);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(580, 530);
		...
		private void frmDmhang_Load(object sender, System.EventArgs e)
		{
            ...
            user = d.user; itable = d.tableid("", "d_dmhang");
			nhomcc.DisplayMember="TEN";
			nhomcc.ValueMember="ID";
			nhomcc.DataSource=d.get_data("select * from "+user+".d_nhomhang where (nhom=0 or nhom="+i_nhom+") order by stt").Tables[0];
			load_grid();
			AddGridTableStyle();
			ref_text();
		}
		...
		{
            dt = d.get_data("select a.*,b.ten as tennhom from " + user + ".d_dmhang a," + user + ".d_nhomhang b where a.loai=b.id and (a.nhom=0 or a.nhom=" + i_nhom + ") order by a.stt").Tables[0];
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			try
			{
                stt.Value = decimal.Parse(d.get_data("select max(stt) from " + user + ".d_dmhang where nhom=" + i_nhom).Tables[0].Rows[0][0].ToString()) + 1;
			}
			catch{stt.Value=1;}
			l_id=0;
			ten.Text="";
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
			...
			ena_object(true);
            if (d.get_data("select * from " + user + ".d_dmbd where mahang=" + l_id).Tables[0].Rows.Count != 0)
			{
				ten.Enabled=false;
			}
			stt.Focus();
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            if (l_id == 0)
            {
                // hien 06-06-2011 //gam comment ngay19/09/2011
                //l_id = decimal.Parse(d.i_Chinhanh_hientai.ToString() + d.get_id_dmhang.ToString().PadLeft(5, '0'));
                // end hien
            ...
            else
            {
                ...
                d.upd_eve_upd_del(itable, i_userid, "upd", d.fields(user + ".d_dmhang", "id=" + l_id));
            }
			if (!d.upd_dmhang(l_id,ten.Text,int.Parse(nhomcc.SelectedValue.ToString()),i_nhom,int.Parse(stt.Value.ToString())))
			{
...
lan.Change_language_MessageText("Không cho phép hủy !"),d.Msg);
			...
			try
			{
				if (d.get_data("select * from "+user+".d_dmbd where mahang="+decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber,3].ToString())).Tables[0].Rows.Count!=0)
				{
					MessageBox.Show(
...
lan.Change_language_MessageText("Đồng ý hủy thông tin này !"),d.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                ...
                d.upd_eve_upd_del(itable, i_userid, "del", d.fields(user + ".d_dmhang", "id=" + l_id));
				d.execute_data("delete from "+user+".d_dmhang where id="+l_id);
				if (!d.bDanhmuc) d.writeXml("d_thongso","c01","1");
				load_grid();
			}
		}
...
lan.Change_language_MessageText("Nội dung đã nhập !"),d.Msg);
        ...
        {
            frmNhap_dmhang f = new frmNhap_dmhang();
            f.ShowDialog();
            load_grid();
        }
	}
