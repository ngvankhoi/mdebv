...
namespace Duoc
{
	...
	/// </summary>
	public class rptNxt_CK_thang : System.Windows.Forms.Form
	{
        ...
        private bool bClear = true, bGiaban=false , bGiabandot = false, bTratinhVaoNhap=false;
		...
		public rptNxt_CK_thang(AccessData acc,int nhom,string kho,string mmyy,string file,bool giaban, int _userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rptNxt_CK_thang));
            ...
            this.yyyy.Location = new System.Drawing.Point(223, 4);
            ...
            this.manhom.Location = new System.Drawing.Point(273, 4);
            ...
            this.kho.Location = new System.Drawing.Point(71, 50);
            this.kho.Name = "kho";
            ...
            "Nhóm",
            "Phân loại"});
            this.tt.Location = new System.Drawing.Point(71, 184);
            this.tt.Name = "tt";
            ...
            this.chkXML.Location = new System.Drawing.Point(389, 207);
            ...
            this.gianovat.Location = new System.Drawing.Point(315, 206);
            ...
            this.chktonghop.Location = new System.Drawing.Point(71, 207);
            ...
            this.tabPage1.Controls.Add(this.chktonghop);
            this.tabPage1.Controls.Add(this.label2);
            this.tabPage1.Controls.Add(this.gianovat);
            ...
            // 
            this.chkTra_TinhvaoNhapkho.AutoSize = true;
            this.chkTra_TinhvaoNhapkho.Location = new System.Drawing.Point(16, 226);
            this.chkTra_TinhvaoNhapkho.Name = "chkTra_TinhvaoNhapkho";
            this.chkTra_TinhvaoNhapkho.Size = new System.Drawing.Size(112, 17);
            this.chkTra_TinhvaoNhapkho.TabIndex = 20;
            this.chkTra_TinhvaoNhapkho.Text = "Trả tính vào nhập";
            this.chkTra_TinhvaoNhapkho.UseVisualStyleBackColor = true;
            // 
            // tabPage2
            // 
		...
		private void rptNxt_CK_Load(object sender, System.EventArgs e)
		{
            ...
            try { ds.Tables[0].Columns.Add("gianovat", typeof(decimal)); }
            catch { }
            try { ds.Tables[0].Columns.Add("sotk"); }
            catch { }
            dsxml = ds.Copy();//
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			if (i_tt==0)//noi ngoai nhom
			{
                sql = "select a.*, b.stt as tt, b.ten as tennhom, case when f.id is null then 0 else f.id end as idnn, f.ten as noingoai,g.ma as stk ";
                ...
                if (d.bNoiNgoai_Hang(i_nhom))
                {
                    ...
                    sql += " left join " + user + ".d_nhomhang f on e.loai=f.id ";
                }
                else if (d.bNoiNgoai_Nuoc(i_nhom))
                {
                    sql += " inner join " + user + ".d_dmnuoc e on a.manuoc=e.id ";
                    sql += " left join " + user + ".d_nhomnuoc f on e.loai=f.id ";
                }
                else
                {
		...
		{
            xxx = user + d_mmyy;
            string s_gia = (gianovat.Checked) ? "c.gianovat" : "c.giamua";
			sql="select ";
            ...
            sql += "a.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia,c.manguon,sum(a.tondau) as soluong,";
            //if (gianovat.Checked) sql += "sum(a.tondau*c.gianovat) as sotien ";
            //else sql+="sum(a.tondau*c.giamua) as sotien ";
            sql += "sum(a.tondau*" + s_gia + ") as sotien ";
            ...
            if (gianovat.Checked) sql += "c.gianovat,";
            sql += "a.mabd,trunc(" + s_gia + "," + i_dongiale + "),c.manguon";
		...
		{
            xxx = user + d_mmyy;
            string s_gia = (gianovat.Checked) ? "b.dongia" : "b.giamua";
			sql="select ";
			if (i_tt==1) sql+=" a.makho,";
			if (bGiaban)
			{
            ...
            sql += "0 as loai,b.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia,a.manguon,";
			sql+="sum(b.soluong) as soluong,";
            ...
            sql += "b.mabd,trunc(" + s_gia + "," + i_dongiale + "),a.manguon";
            //
            s_gia = (gianovat.Checked) ? "d.gianovat" : "d.giamua";
            //
			if (s_khott=="")
			{
                ...
                sql += ((chkChuyenKho.Checked) ? "1" : "0") + " as loai,b.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia, d.manguon,";
				sql+="sum(b.soluong) as soluong,";
                if (gianovat.Checked)  sql += " sum(b.soluong*d.gianovat) as sotien ";
                else sql+=" sum(b.soluong*d.giamua) as sotien ";
			...
			else
			{
                ...
                //lay xuat chuyen kho + hoan tra CS tu truc --> nhap chuyen kho
				sql+=" union all select ";
				if (i_tt==1) sql+="a.khon as makho,";
				if (bGiaban)
				{
                ...
                sql += "1 as loai,b.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia, d.manguon,";
				sql+="sum(b.soluong) as soluong,";
                if (gianovat.Checked) sql+=" sum(b.soluong*d.gianovat) as sotien ";
                else sql += " sum(b.soluong*d.giamua) as sotien ";
                sql += " from " + xxx + ".d_xuatll a," + xxx + ".d_xuatct b, " + user + ".d_dmbd c," + xxx + ".d_theodoi d where a.id=b.id and b.mabd=c.id and b.sttt=d.id and a.nhom=" + i_nhom + " and a.loai in ('CK','HT','TH') and b.soluong>0";
		...
		private void get_xuat(string d_mmyy)
		{
            ...
            sql += "b.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia,d.manguon,sum(b.soluong) as soluong,";
            if (gianovat.Checked) sql += " sum(b.soluong*d.gianovat) as sotien ";
            else sql += " sum(b.soluong*d.giamua) as sotien ";
		...
		private void get_hoantra(string d_mmyy)
		{
            ...
            sql += "b.mabd,trunc(" + s_gia + "," + i_dongiale + ") as dongia,d.manguon,";
			sql+="sum(b.soluong) as soluong,";
            sql += " sum(b.soluong*" + s_gia + ") as sotien ";
            //if (gianovat.Checked) sql += " sum(b.soluong*" + s_gia + ") as sotien ";
            //else sql += " sum(b.soluong*d.giamua) as sotien ";
			...
			foreach(DataRow r in d.get_data(sql).Tables[0].Rows)
			{
				...
				if ( r1 == null )
				{
					...
					if (r3!=null)
					{
                        ...
                        {
                            r2["slnhap"] = decimal.Parse(r["soluong"].ToString());
                            r2["stnhap"] = decimal.Parse(r["sotien"].ToString());
                            r2["slxuat"] = 0;
                            r2["stxuat"] = 0;
                        }
						r2["dongia"]=r["dongia"].ToString();
		...
		private void get_data()
		{
            ...
            bTratinhVaoNhap = chkTra_TinhvaoNhapkho.Checked;
			s_manhom="";
            ...
            if (s_kho.Trim().Trim(',') == "")
            {
                foreach (DataRow drkho in dtdmkho.Rows)
                {
                    s_kho += drkho["id"].ToString() + ",";
                    //s_tenkho += dtdmkho.Rows[i]["ten"].ToString() + ",";
                }
            }
			ds.Clear();
			...
			if (d.bChuyenkho_inrieng(i_nhom))
			{
				if (ds.Tables[0].Select("slxuat_ck>0").Length>0)
				{
					...
					frmReport f1=new frmReport(d,dsxml.Tables[0],i_userid,tenreport,s_thoigian,(manguon.SelectedIndex==-1)?"":"Nguồn :"+manguon.Text,"","","","","","","","");
					f1.ShowDialog();
				}
			}
		}
