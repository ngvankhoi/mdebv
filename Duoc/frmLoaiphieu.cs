...
namespace Duoc
{
	...
	public class frmLoaiphieu : System.Windows.Forms.Form
	{
		...
		private int i_nhom;
        private bool bQuanlychinhanh = false, bNew = false;
		...
		public frmLoaiphieu(AccessData acc,int nhom,string mmyy)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(562, 531);
            ...
            this.butMoi.Location = new System.Drawing.Point(212, 531);
            ...
            this.butSua.Location = new System.Drawing.Point(282, 531);
            ...
            this.butLuu.Location = new System.Drawing.Point(352, 531);
            ...
            this.butBoqua.Location = new System.Drawing.Point(422, 531);
            ...
            this.butHuy.Location = new System.Drawing.Point(492, 531);
            ...
            this.nhomcc.Location = new System.Drawing.Point(56, 4);
            ...
            this.label1.Location = new System.Drawing.Point(664, 502);
            ...
            this.buoi.Location = new System.Drawing.Point(704, 502);
            this.buoi.Name = "buoi";
		...
		private void frmLoaiphieu_Load(object sender, System.EventArgs e)
		{
            ...
            nhomcc.DataSource = d.get_data("select * from " + user + ".d_dmphieu where id<5 order by stt").Tables[0];
			load_grid();
			AddGridTableStyle();
			ref_text();
		}
		...
		private void load_grid()
		{
			try
			{
                dt = d.get_data("select a.*,case when a.buoi=0 then 'Sáng' else 'Chiều' end as tenbuoi,b.ten as tennhom from " + user + ".d_loaiphieu a," + user + ".d_dmphieu b where a.loai=b.id and a.nhom=" + i_nhom + " and a.loai=" + int.Parse(nhomcc.SelectedValue.ToString()) + " order by a.stt").Tables[0];
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			try
			{
				stt.Value=decimal.Parse(d.get_data("select max(stt) from "+user+".d_loaiphieu where nhom="+i_nhom).Tables[0].Rows[0][0].ToString())+1;
			}
			catch{stt.Value=1;}
			l_id=0;
			ten.Text="";
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (l_id==0)
			{
				try
				{
                    if (bQuanlychinhanh)
                    {
                        l_id = decimal.Parse(d.i_Chinhanh_hientai.ToString() + d.get_capid(105).ToString().PadLeft(4, '0'));
                    }
                    else
                    {
                        l_id=decimal.Parse(d.get_data("select max(id) from " + user + ".d_loaiphieu").Tables[0].Rows[0][0].ToString()) + 1;
                    }
				}
				catch{l_id=1;}
			}
            if (!d.upd_loaiphieu(l_id, ten.Text, int.Parse(nhomcc.SelectedValue.ToString()), i_nhom, int.Parse(stt.Value.ToString()), buoi.SelectedIndex, bNew)) 
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                if (d.get_data("select * from " + user+d_mmyy + ".d_xuatsdll where phieu=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 2].ToString())).Tables[0].Rows.Count != 0)
				{
			...
			{
                d.execute_data("delete from " + user + ".d_loaiphieu where id=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 2].ToString()));
				load_grid();
			}
		}
