...
namespace Duoc
{
	...
	/// </summary>
	public class frmTontreo : System.Windows.Forms.Form
	{
       ...
       // lan.Read_Language_to_Xml(this.Name.ToString(),this);
		...
		public frmTontreo(LibDuoc.AccessData acc,int nhom,string mmyy)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTontreo));
            ...
            this.butCancel.Location = new System.Drawing.Point(117, 51);
            ...
            this.Name = "frmTontreo";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Cập nhập số lượng tồn treo=0";
            this.Load += new System.EventHandler(this.frmTontreo_Load);
		...
		private void frmTontreo_Load(object sender, System.EventArgs e)
		{
