...
namespace Duoc
{
	...
	/// </summary>
	public class frmPhieuxuat_bhyt : System.Windows.Forms.Form
	{
		...
		private string sql,s_kho,s_makho,s_tenkho,user,stime,xxx;
		...
		public frmPhieuxuat_bhyt(AccessData acc,int nhom,string kho,int _madoituong,int loai, int _uerid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPhieuxuat_bhyt));
            ...
            this.butIn.Location = new System.Drawing.Point(72, 163);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(142, 163);
            ...
            this.Name = "frmPhieuxuat_bhyt";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "In phiếu xuất";
            this.Load += new System.EventHandler(this.frmPhieuxuat_bhyt_Load);
            this.ResumeLayout(false);

		}
		#endregion

		private void frmPhieuxuat_bhyt_Load(object sender, System.EventArgs e)
		{
		...
		{
            xxx = user + s_mmyy;
			//sql="select b.mabd,round(t.giamua,"+i_dongiale+") as dongia,";
            sql = "select b.mabd,t.giamua as dongia,";
            ...
            //sql += " group by b.mabd,round(t.giamua," + i_dongiale + ")";
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
            ...
            frmReport f = new frmReport(d, dsxml.Tables[0],i_userid, "d_phieuxuat.rpt", "", tu.Text, "", "", madoituong.Text, "Xuất sử dụng", s_tenkho, doiso.Doiso_Unicode(Convert.ToInt64(d_tongcong).ToString()), "", "");
            f.ShowDialog();
		}
