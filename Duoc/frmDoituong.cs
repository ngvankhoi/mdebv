...
namespace Duoc
{
	...
	public class frmDoituong : System.Windows.Forms.Form
	{
		...
		private string table,s_nguon,s_nhom,s_makho,user,d_mmyy;
		private int i_nhom;
		...
		public frmDoituong(AccessData acc,string tab,int nhom,string mmyy)
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
            d = acc; table = tab; i_nhom = nhom; d_mmyy = mmyy;
		...
		private void InitializeComponent()
		{
            ...
            this.dataGrid1.Size = new System.Drawing.Size(568, 518);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(553, 535);
            ...
            this.ten.Location = new System.Drawing.Point(120, 507);
            this.ten.Name = "ten";
            ...
            this.butMoi.Location = new System.Drawing.Point(203, 535);
            ...
            this.butSua.Location = new System.Drawing.Point(273, 535);
            ...
            this.butLuu.Location = new System.Drawing.Point(343, 535);
            ...
            this.butBoqua.Location = new System.Drawing.Point(413, 535);
            ...
            this.butHuy.Location = new System.Drawing.Point(483, 535);
            ...
            this.stt.Location = new System.Drawing.Point(40, 507);
            this.stt.Name = "stt";
            ...
            this.nguon.Location = new System.Drawing.Point(585, 7);
            this.nguon.Name = "nguon";
            this.nguon.Size = new System.Drawing.Size(200, 109);
            this.nguon.TabIndex = 31;
            // 
            // label1
            // 
            this.label1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            this.label1.Location = new System.Drawing.Point(496, 507);
            ...
            "Giá mua",
            "Giá bán"});
            this.loai.Location = new System.Drawing.Point(584, 507);
            this.loai.Name = "loai";
            ...
            // manhom
            // 
            this.manhom.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.manhom.CheckOnClick = true;
            this.manhom.Enabled = false;
            this.manhom.Location = new System.Drawing.Point(585, 246);
            this.manhom.Name = "manhom";
            this.manhom.Size = new System.Drawing.Size(200, 259);
            ...
            this.makho.Location = new System.Drawing.Point(585, 119);
            this.makho.Name = "makho";
            this.makho.Size = new System.Drawing.Size(200, 124);
            this.makho.TabIndex = 34;
            // 
            // frmDoituong
            // 
		...
		private void frmDoituong_Load(object sender, System.EventArgs e)
		{
            ...
            user = d.user;
            dtnguon = d.get_data("select a.id, a.ten||' ['||b.ten||']' as ten, a.nhom from " + user + ".d_dmnguon a inner join " + user + ".d_dmnhomkho b on a.nhom=b.id order by a.nhom, a.stt").Tables[0];// where nhom=" + i_nhom + " 
            nguon.DataSource = dtnguon;
			nguon.DisplayMember="TEN";
			nguon.ValueMember="ID";

            dtkho = d.get_data("select a.id, a.ten||' ['||b.ten||']' as ten, a.nhom from " + user + ".d_dmkho a inner join " + user + ".d_dmnhomkho b on a.nhom=b.id where a.hide=0 order by a.nhom, a.stt").Tables[0];//where nhom=" + i_nhom + "
            makho.DataSource = dtkho;
            makho.DisplayMember = "TEN";
            makho.ValueMember = "ID";

            dtnhom = d.get_data("select a.id, a.ten||' ['||b.ten||']' as ten, a.nhom from " + user + ".d_dmnhom a inner join " + user + ".d_dmnhomkho b on a.nhom=b.id order by a.nhom, a.stt").Tables[0];//where nhom=" + i_nhom + " 
		...
		{
			dt=d.get_data("select madoituong,doituong,nguon,loai,case when loai=0 then 'Giá mua' else 'Giá bán' end as  tenloai,manhom,makho from "+user+"."+table+" order by madoituong").Tables[0];
		...
		private void ena_object(bool ena)
		{
			...
			//stt.Enabled=ena;
			nguon.Enabled=ena;
			makho.Enabled=manhom.Enabled=ena;
			ten.Enabled=ena;
			loai.Enabled=ena;
			butMoi.Enabled=!ena;
			butSua.Enabled=!ena;
		...
		{
			if (!kiemtra()) return ;
			if (!d.upd_doituong(table,int.Parse(stt.Value.ToString()),ten.Text.Trim(),s_nguon,loai.SelectedIndex,s_nhom,s_makho))
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                if (d.get_data("select * from " + user+d_mmyy + ".d_xuatsdct where madoituong=" + int.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 0].ToString())).Tables[0].Rows.Count != 0)
				{
			...
			{
                d.execute_data("delete from " + user + "." + table + " where madoituong=" + int.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 0].ToString()));
				load_grid();
			}
		}
