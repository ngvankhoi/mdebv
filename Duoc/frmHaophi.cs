...
namespace Duoc
{
	...
	public class frmHaophi : System.Windows.Forms.Form
	{
		...
		public frmHaophi(AccessData acc,int nhom,string ngay,int loai,int userid,string users,string makp,string mmyy,string kho,bool giaban,int thuoc,bool thuhoi,string _userid, int _khudt)
		{
			//
			// Required for Windows Form Designer support
			//
			InitializeComponent();
            d = acc; i_thuoc = thuoc; i_nhom = nhom; i_loai = loai; i_userid = userid; s_ngay = ngay; s_userid = _userid;
            s_makp = makp; s_mmyy = mmyy; s_kho = kho; bGiaban = giaban; this.Text = users; butThuhoi.Enabled = thuhoi;
		...
		private void InitializeComponent()
		{
            ...
            this.ngay.Location = new System.Drawing.Point(200, 4);
            this.ngay.Name = "ngay";
            ...
            this.phieu.Location = new System.Drawing.Point(312, 4);
            ...
            this.makp.Location = new System.Drawing.Point(528, 4);
            this.makp.Name = "makp";
            ...
            this.treeView1.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.treeView1.Location = new System.Drawing.Point(640, 26);
            this.treeView1.Name = "treeView1";
            this.treeView1.Size = new System.Drawing.Size(144, 488);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(506, 516);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(624, 504);
            ...
            this.butChoduyet.Location = new System.Drawing.Point(640, 516);
            ...
            this.butDuyet.Location = new System.Drawing.Point(226, 516);
            ...
            this.butThuhoi.Location = new System.Drawing.Point(296, 516);
            ...
            this.butIn.Location = new System.Drawing.Point(366, 516);
            ...
            this.butTim.Location = new System.Drawing.Point(436, 516);
		...
		private void frmHaophi_Load(object sender, System.EventArgs e)
		{
			...
			sql="select a.id,a.mabn,b.ten as hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,a.phieu,a.makp,a.idduyet,a.makhoa from "+xxx+".d_xuatsdll a,"+user+".d_duockp b ";
		...
		private void load_treeview()
		{
            ...
            sql += " from " + xxx + ".d_haophill a," + xxx + ".d_haophict b," + xxx + ".d_duyet c," + user + ".d_dmbd d," + user + ".d_dmphieu e," + user + ".d_loaiphieu f," + user + ".d_duockp g ";
...
lan.Change_language_MessageText("Nếu cần thay đổi thì vào mục khai báo hệ thống"),d.Msg);
            ...
            frmDuyet f = new frmDuyet(d, dtll, i_nhom, i_loai, s_makp, s_mmyy, s_kho, this.Text, s_ngay, i_userid, false, false, i_thuoc, false, s_userid, i_khudt);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll=f.dtll;
...
lan.Change_language_MessageText("Nếu cần thay đổi thì vào mục khai báo hệ thống"),d.Msg);
            ...
            frmThuhoi f = new frmThuhoi(d, dtll, dtct, dtkp, dtphieu, int.Parse(makp.SelectedValue.ToString()), int.Parse(phieu.SelectedValue.ToString()), s_ngay, s_mmyy, i_nhom, i_loai, false, false, i_thuoc, s_kho, i_userid);
			f.ShowDialog(this);
			if (f.bOk)
			{
				dtll.AcceptChanges();
