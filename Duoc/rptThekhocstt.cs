...
namespace Duoc
{
	...
	/// </summary>
	public class rptThekhocstt : System.Windows.Forms.Form
	{
		...
		private string sql,s_rpt,s_tu,s_den,s_yy,s_kho,s_makp,user,xxx;
		private DataRow []dr;
		...
		public rptThekhocstt(AccessData acc,int nhom,string kho,string mmyy,string rpt,string title,string makp, int _userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rptThekhocstt));
            ...
            // label12
            // 
            this.label12.Location = new System.Drawing.Point(440, 5);
            ...
            this.tim.Location = new System.Drawing.Point(6, 349);
            this.tim.Name = "tim";
            this.tim.Size = new System.Drawing.Size(410, 21);
            this.tim.TabIndex = 8;
            ...
            this.Name = "rptThekhocstt";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Sổ chi tiết";
            this.Load += new System.EventHandler(this.rptThekhocstt_Load);
		...
		private void rptThekhocstt_Load(object sender, System.EventArgs e)
		{
            user = d.user;
            ...
            ds.Tables[0].Columns.Add("ngaysp", typeof(decimal)).DefaultValue = 0;
            dsxml = ds.Copy();//
			load_grid();
			AddGridTableStyle();
		...
		private void load_grid()
		{
			...
			for(int i=int.Parse(s_tu);i<=int.Parse(s_den);i++)
			{
                if (d.bMmyy(i.ToString().PadLeft(2, '0') + s_yy))
                {
                    ...
                    sql = "select a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,b.tenhc,b.dang,c.ten as tenhang,a.tondau+a.slnhap-a.slxuat as toncuoi,e.stt from "+xxx+".d_tutructh a," + user + ".d_dmbd b," + user + ".d_dmhang c," + user + ".d_dmnhom d," + user + ".d_nhomin e where (a.mabd=b.id and b.mahang=c.id and b.manhom=d.id and d.nhomin=e.id and a.makp=" + int.Parse(kho.SelectedValue.ToString());
		...
		private void Loc()
		{
			...
			if (dr.Length==0)
			{
				for(int i=int.Parse(s_tu);i<=int.Parse(s_den);i++)
				{
                    ...
                    {
                        xxx = user + mmyy;
					    foreach(DataRow r in d.get_data("select distinct mabd from "+xxx+".d_tutructh where makp="+int.Parse(kho.SelectedValue.ToString())).Tables[0].Rows)
