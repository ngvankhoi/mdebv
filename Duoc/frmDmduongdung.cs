...
namespace Duoc
{
	...
	/// </summary>
	public class frmDmduongdung : System.Windows.Forms.Form
	{
		...
		public frmDmduongdung(AccessData acc,string tab,string title)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDmduongdung));
            ...
            this.label2.Location = new System.Drawing.Point(280, 505);
            ...
            this.ten.Location = new System.Drawing.Point(336, 505);
            this.ten.Name = "ten";
            ...
            this.label1.Location = new System.Drawing.Point(72, 505);
            ...
            this.ma.Location = new System.Drawing.Point(128, 505);
            this.ma.Name = "ma";
            ...
            this.Name = "frmDmduongdung";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Danh mục";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmduongdung_KeyDown);
            this.Load += new System.EventHandler(this.frmDmduongdung_Load);
		...
		private void frmDmduongdung_Load(object sender, System.EventArgs e)
		{
		...
		{
            dt = d.get_data("select stt,ten,nullif(viettat,' ') as viettat from " + user + "." + table + " order by stt").Tables[0];
		...
		{
			if (!kiemtra()) return ;
			if (!d.upd_dmduongdung(table,ma.Text,ten.Text,int.Parse(stt.Value.ToString())))
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			{
                d.execute_data("delete from " + user + "." + table + " where ten='" + ten.Text + "'");
				if (!d.bDanhmuc) d.writeXml("d_thongso","c01","1");
				load_grid();
			}
		}
		...
		private void frmDmduongdung_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
