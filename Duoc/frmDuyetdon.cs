...
namespace Duoc
{
	...
	public class frmDuyetdon : System.Windows.Forms.Form
	{
        ...
        private bool afterCurrentCellChanged, bSkip = false, bIncachdung, bGiaban_noi_ngoai, bKhoaso;
		...
		public frmDuyetdon(LibDuoc.AccessData acc,DataTable dt,int nhom,string kho,string ngay,int userid,string mmyy,int loai,string makho,string manguon,string suserid,string sloai,string tenkho)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            // butLuuin
            // 
            this.butLuuin.Enabled = false;
            this.butLuuin.Image = ((System.Drawing.Image)(resources.GetObject("butLuuin.Image")));
            this.butLuuin.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this.butLuuin.Location = new System.Drawing.Point(272, 464);
            this.butLuuin.Name = "butLuuin";
            this.butLuuin.Size = new System.Drawing.Size(75, 25);
            this.butLuuin.TabIndex = 6;
            ...
            this.butBoqua.Location = new System.Drawing.Point(347, 464);
            ...
            this.butLuu.Location = new System.Drawing.Point(197, 464);
            ...
            this.butIn.Location = new System.Drawing.Point(422, 464);
            ...
            this.chkPreview.Location = new System.Drawing.Point(544, 459);
            this.chkPreview.Name = "chkPreview";
            this.chkPreview.Size = new System.Drawing.Size(108, 17);
            this.chkPreview.TabIndex = 262;
            this.chkPreview.Text = "Xem trước khi khi";
		...
		private void frmDuyetdon_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                chkPreview.Checked = d.Thongso("xuatban_xemtruockhiin") == "1";
                //d.writeXml("d_thongso", "xuatban_xemtruockhiin", chkPreview.Checked ? "1" : "0");
            }
            catch { }
		...
		private void load_grid()
		{
            ...
            //sql += " where a.done=0 and a.madoituong=2 and " + m.for_ngay("a.ngay", stime) + " between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";//gam 05/11/2011
            sql += " where a.done=0 and a.madoituong in (select madoituong from medibv.doituong where mien=0) and " + m.for_ngay("a.ngay", stime) + " between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";//gam 25/11/2011
			...
			butLuuin.Enabled=butLuu.Enabled;
			dataGrid1.Focus();
			i_row=dataGrid1.CurrentRowIndex;
			load_items();
		}
			...
			for(int i=0;i<dr.Length;i++)
			{
				...
				if (o_id!=l_id)
				{
					...
					if (r!=null)
					{
                        ...
                        d.upd_ngtrull(s_mmyy, id, i_nhom, r["mabn"].ToString(), r["hoten"].ToString(), r["namsinh"].ToString(), s_ngay, r["mabs"].ToString(), (r["makp"].ToString() == "") ? 0 : int.Parse(r["makp"].ToString()), i_loai, i_userid, i_sotoa, decimal.Parse(r["maql"].ToString()), r["diachi"].ToString() + "^" + r["tenkp"].ToString(), r["tenbs"].ToString(),userid_vp);//Thuy 29.02.2012.....
		...
		private void printer(int toa,decimal l_id,decimal sothang)
		{
			...
			if (chkPreview.Checked)//d.bPreview)
			{
				frmReport f=new frmReport(d,ldt.Tables[0],i_userid,d_tenrpt,s_toa,_hoten,s_tenbs+"^"+s_tenkp,stuoi,s_ngay,s_userid+"^"+d_sotoa.ToString("#####"),s_chu,s_c8+"^"+_diachi+"^"+s_tenkp+"^"+s_tenkp,ghichu+"^"+_hen,s_chandoan+"^"+_phai+"^^"+s_diungthuoc);//gam 24/08/2011
				f.ShowDialog();
			}
			else
			{
		...
		private void butLuuin_Click(object sender, System.EventArgs e)
		{
            if (bKhoaso)
            {
                MessageBox.Show(lan.Change_language_MessageText("Số liệu tháng") + " " + s_mmyy.Substring(0, 2) + " " + lan.Change_language_MessageText("năm") + " " + s_mmyy.Substring(2, 2) + " " +
        ...
        private void butIn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (r1 != null)
                {
                    ...
                    frmReport f = new frmReport(d, dstmp.Tables[0],i_userid , tenfile, r1["hoten"].ToString(), stuoi, "", schandoan, r1["diachi"].ToString(), r1["tenbs"].ToString(), dstmp.Tables[0].Rows.Count.ToString(), r1["mabn"].ToString(), lydo,"");
                    f.ShowDialog(this);
                }
            }
            catch { }
