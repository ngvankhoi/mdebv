...
namespace Duoc
{
	...
	public class frmDMICD10 : System.Windows.Forms.Form
	{
		...
		public frmDMICD10(AccessData acc,string vICD, string vTen,bool chon)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(349, 360);
		...
		private void frmDMICD10_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				mFormat.f_LoadDG(dataGrid1,m.get_data("select CICD10,VVIET from "+m.user+".icd10"),new string[] {"Mã ICD","Tên bệnh tiếng việt                                                                                    .","Tên bệnh tiếng anh"},new string[] {"CICD10","VVIET"});
