...
namespace dllDanhmucMedisoft
{
	...
	public class frmBtdtt : System.Windows.Forms.Form
	{
		...
		private void AddGridTableStyle()
		{
            ...
            TextCol = new DataGridTextBoxColumn();//Thuy 15.05.2012
		...
		{
            ds = m.get_data("select matt,tentt,mavung,nvl(viettat,'') as viettat from " + user + ".btdtt where mavung='" + mavung.SelectedValue.ToString() + "'" + " order by matt");//Thuy 15.05.2012
		...
		private void ena_object(bool ena)
		{
			ma.Enabled=ena;
			ten.Enabled=ena;
            txtviettat.Enabled = ena;//Thuy 15.05.2012
			butThem.Enabled=!ena;
			butSua.Enabled=!ena;
			butLuu.Enabled=ena;
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			m.upd_btdtt("btdtt",mavung.SelectedValue.ToString(),ma.Text,ten.Text,txtviettat.Text);//Thuy 15.05.2012
			m.upd_btdtt("btdtt_add",mavung.SelectedValue.ToString(),ma.Text,ten.Text,txtviettat.Text);
			load_grid();
			ena_object(false);
		}
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			try
			{
                ...
                txtviettat.Text = dataGrid1[i, 2].ToString();//Thuy 15.05.2012
			}
			catch{}
		}
