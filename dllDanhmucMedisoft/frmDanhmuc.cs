...
namespace dllDanhmucMedisoft
{
	...
	public class frmDanhmuc : System.Windows.Forms.Form
	{
        ...
        public frmDanhmuc(AccessData acc, int _userid)
        {
            //
            // Required for Windows Form Designer support
            //
            ...
            lan.Changelanguage_to_English(this.Name.ToString(), this);
            m = acc;
            bAdminHethong = m.bAdminHethong(_userid);
            //
            // TODO: Add any constructor code after InitializeComponent call
            //
        }
		...
		private void InitializeComponent()
		{
            ...
            // label2
            // 
            this.label2.Location = new System.Drawing.Point(208, 461);
            ...
            this.ten.Location = new System.Drawing.Point(279, 461);
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(499, 21);
            this.ten.TabIndex = 3;
            ...
            this.butSua.Location = new System.Drawing.Point(279, 490);
            ...
            this.butLuu.Location = new System.Drawing.Point(349, 490);
            ...
            this.butBoqua.Location = new System.Drawing.Point(419, 490);
            ...
            this.butHuy.Location = new System.Drawing.Point(489, 490);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(559, 490);
...
"Đồng ý hủy thông tin này !"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                m.execute_data("delete from " + user + "." + sql.SelectedValue.ToString() + " where id=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 3].ToString()));
				load_grid(sql.SelectedValue.ToString());
			}
		}
...
"Nội dung đã nhập !"),LibMedi.AccessData.Msg);
        ...
        private int f_get_id()
        {
            int id = 0;
            for (int i = 1; i < 99999; i++)
            {
                id = i;
                DataRow dr = m.getrowbyid(dt, "id=" + id);
                if (dr == null) break;
            }
            return id;
        }
