...
namespace dllDanhmucMedisoft
{
	...
	/// </summary>
	public class frmDmphong : System.Windows.Forms.Form
	{
		...
		private decimal id;
		private int i_userid,i_nhomphonggiuong;
		...
		public frmDmphong(AccessData acc,int userid)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.dataGrid1.Size = new System.Drawing.Size(600, 296);
            ...
            this.ten.Location = new System.Drawing.Point(200, 312);
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(128, 21);
            this.ten.TabIndex = 4;
            ...
            this.butMoi.Location = new System.Drawing.Point(98, 342);
            ...
            this.butSua.Location = new System.Drawing.Point(168, 342);
            ...
            this.butLuu.Location = new System.Drawing.Point(238, 342);
            ...
            this.butBoqua.Location = new System.Drawing.Point(308, 342);
            ...
            this.butHuy.Location = new System.Drawing.Point(378, 342);
            ...
            this.makp.Location = new System.Drawing.Point(40, 4);
            this.makp.Name = "makp";
            this.makp.Size = new System.Drawing.Size(568, 21);
            ...
            // loai
            // 
            this.loai.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.loai.Location = new System.Drawing.Point(360, 312);
            this.loai.Name = "loai";
            this.loai.Size = new System.Drawing.Size(88, 21);
            ...
            this.label6.Text = "Loại viện phí :";
            this.label6.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            // 
            // loaivp
            // 
            this.loaivp.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.loaivp.BackColor = System.Drawing.SystemColors.HighlightText;
            this.loaivp.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            ...
            this.loaivp.Location = new System.Drawing.Point(520, 312);
            this.loaivp.Name = "loaivp";
            this.loaivp.Size = new System.Drawing.Size(88, 21);
            this.loaivp.TabIndex = 6;
            this.loaivp.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ten_KeyDown);
            // 
            // dichvu
            // 
            this.dichvu.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
            this.dichvu.AutoSize = true;
            this.dichvu.Enabled = false;
            this.dichvu.Location = new System.Drawing.Point(24, 338);
            this.dichvu.Name = "dichvu";
            this.dichvu.Size = new System.Drawing.Size(63, 17);
            this.dichvu.TabIndex = 7;
            this.dichvu.Text = "Dịch vụ";
            this.dichvu.UseVisualStyleBackColor = true;
            this.dichvu.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ten_KeyDown);
            // 
            // butKetthuc
            // 
            ...
            this.butKetthuc.Location = new System.Drawing.Point(448, 342);
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmphong_KeyDown);
		...
		private void frmDmphong_Load(object sender, System.EventArgs e)
		{
            user = m.user;
			i_nhomphonggiuong=m.iNhomphonggiuong;
			loaivp.DisplayMember="TEN";
			loaivp.ValueMember="ID";
            sql = "select * from " + user + ".v_loaivp";
			if (i_nhomphonggiuong!=0) sql+=" where id_nhom="+i_nhomphonggiuong;
			sql+=" order by stt";
			loaivp.DataSource=m.get_data(sql).Tables[0];

			loai.DisplayMember="TEN";
			loai.ValueMember="ID";
            loai.DataSource = m.get_data("select * from " + user + ".dmloaiphong order by stt").Tables[0];
		...
		{
            sql = "select a.*,b.ten as tenloai,c.ten as tenloaivp from " + user + ".dmphong a," + user + ".dmloaiphong b," + user + ".v_loaivp c where a.loai=b.id and a.loaivp=c.id and a.makp='" + makp.SelectedValue.ToString() + "' order by a.stt";
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                stt.Value = decimal.Parse(m.get_data("select max(stt) from " + user + ".dmphong where makp='" + makp.SelectedValue.ToString() + "'").Tables[0].Rows[0][0].ToString()) + 1;
			}
			catch{stt.Value=1;}
			ma.Text="";
			ten.Text="";
            dichvu.Checked = false;
			ena_object(true);
			stt.Focus();
		}
		...
		{
			if (!kiemtra()) return;
            if (id==0) id=m.get_capid(-32);
			if (!m.upd_dmphong(makp.SelectedValue.ToString(),id,stt.Value,ma.Text,ten.Text,int.Parse(loai.SelectedValue.ToString()),int.Parse(loaivp.SelectedValue.ToString()),i_userid))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật thông tin !"));
				return;
			}
            m.execute_data("update "+user+".dmphong set dichvu=" + ((dichvu.Checked) ? 1 : 0) + " where id=" + id);
			load_grid();
			ena_object(false);
		}
		...
		{
			if (id==0) return;
            if (m.get_data("select * from " + user + ".dmgiuong where idphong=" + id).Tables[0].Rows.Count > 0)
			{
				MessageBox.Show(lan.Change_language_MessageText("Phòng đang sử dụng !"),LibMedi.AccessData.Msg);
				return;
			}
			...
			{
                m.execute_data("delete from " + user + ".dmphong where id=" + id);
				load_grid();
			}
		}
		...
		private void ref_text()
		{
			try
			{
				...
				loai.SelectedValue=dataGrid1[i,4].ToString();
				loaivp.SelectedValue=dataGrid1[i,6].ToString();
                dichvu.Checked= dataGrid1[i, 8].ToString()=="1";
			}
			catch{}
		}
		...
		private void frmDmphong_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		{
			if (this.ActiveControl==makp) load_grid();
		}

		private void ma_Validated(object sender, System.EventArgs e)
		{
			if (ma.Text!="" && ten.Text=="") ten.Text=ma.Text;
		}
	}
}
