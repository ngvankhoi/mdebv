...
namespace dllDanhmucMedisoft
{
	...
	/// </summary>
	public class frmDmdienbien : System.Windows.Forms.Form
	{
		...
		public frmDmdienbien(AccessData acc,int userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDmdienbien));
            ...
            // label1
            // 
            this.label1.Location = new System.Drawing.Point(86, 340);
            ...
            this.ma.Location = new System.Drawing.Point(118, 340);
            this.ma.MaxLength = 2;
            this.ma.Name = "ma";
            ...
            // label2
            // 
            this.label2.Location = new System.Drawing.Point(238, 339);
            this.label2.Name = "label2";
            this.label2.Size = new System.Drawing.Size(62, 23);
            this.label2.TabIndex = 23;
            this.label2.Text = "Diễn biến :";
            ...
            this.txtviettat.Location = new System.Drawing.Point(195, 340);
            ...
            this.txtstt.Location = new System.Drawing.Point(49, 340);
            ...
            this.Name = "frmDmdienbien";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Danh mục diễn biến sau tai nạn thương tích";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmdienbien_KeyDown);
            this.Load += new System.EventHandler(this.frmDmdienbien_Load);
		...
		private void frmDmdienbien_Load(object sender, System.EventArgs e)
		{
            user = m.user; itable = m.tableid("", "dmdienbien");
			load_grid();
			AddGridTableStyle();
		...
		{
            dt = m.get_data("select ma,ten,stt,nvl(viettat,'') as viettat from " + user + ".dmdienbien order by ma").Tables[0];
		...
		{
			if (!kiemtra()) return ;
            if (m.get_data("select * from " + user + ".dmdienbien where ma='" + ma.Text + "'").Tables[0].Rows.Count != 0)
            {
            ...
            if (!m.upd_dmdiadiem("dmdienbien", ma.Text, ten.Text, txtstt.Text, txtviettat.Text))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin địa điểm !"));
				return;
			}
            m.upd_dmdiadiem("dmdienbien", ma.Text, ten.Text, txtstt.Text, txtviettat.Text);
			load_grid();
			ena_object(false);
		}
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy thông tin này !"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                ...
                m.upd_eve_upd_del(itable, i_userid, "del", m.fields(user + ".dmdienbien", "ma='" + ma.Text + "'"));
                m.execute_data("delete from " + user + ".dmdienbien where ma='" + ma.Text + "'");
				load_grid();
			}
		}
		...
		private void frmDmdienbien_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
