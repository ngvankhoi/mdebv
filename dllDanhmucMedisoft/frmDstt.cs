...
namespace dllDanhmucMedisoft
{
	...
	public class frmDstt : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butSua.Location = new System.Drawing.Point(251, 464);
            ...
            this.butLuu.Location = new System.Drawing.Point(321, 464);
            ...
            this.butBoqua.Location = new System.Drawing.Point(391, 464);
            ...
            this.butHuy.Location = new System.Drawing.Point(531, 464);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(601, 464);
            ...
            this.butIn.Location = new System.Drawing.Point(461, 464);
            ...
            this.chkkhongdung.Location = new System.Drawing.Point(40, 458);
            this.chkkhongdung.Name = "chkkhongdung";
            this.chkkhongdung.Size = new System.Drawing.Size(84, 17);
            this.chkkhongdung.TabIndex = 26;
            ...
            this.chkviewall.Location = new System.Drawing.Point(40, 474);
            this.chkviewall.Name = "chkviewall";
            this.chkviewall.Size = new System.Drawing.Size(91, 17);
            this.chkviewall.TabIndex = 27;
            this.chkviewall.Text = "Xem theo tỉnh";
            this.chkviewall.UseVisualStyleBackColor = true;
            this.chkviewall.Click += new System.EventHandler(this.chkviewall_Click);
            // 
            // frmDstt
            // 
        ...
        private void load_grid(string m_tuyen )
        {
            if (butThem.Enabled)
            {
                sql = "select * from " + user + "." + s_table + " where matinh='" + matt.SelectedValue.ToString() + "'";
                if(m_tuyen!="") sql += " and matuyen='" + matuyen.SelectedValue.ToString() + "'";
                sql += " order by mabv";
                ds = m.get_data(sql);
                dataGrid1.DataSource = ds.Tables[0];
            }
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
            maold = ma.Text;
			ena_object(true);
            ma.Enabled = false;// (s_table == "dmnoicapbhyt");
            if (ma.Enabled) ma.Focus();
            else ten.Focus();
		}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			m.upd_tenvien(s_table,ma.Text,ten.Text,diachi.Text,sodt.Text,matuyen.SelectedValue.ToString(),"9","9",mavung.SelectedValue.ToString(),matt.SelectedValue.ToString());
            m.execute_data("update " + user + "." + s_table + " set hide =" + (chkkhongdung.Checked ? "1" : "0") + " where mabv='" + ma.Text + "'");
			ena_object(false);
			load_grid();
		}
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			try
			{
                ...
                chkkhongdung.Checked = dataGrid1[i, 5].ToString() == "1";
			}
			catch{}
		}
		...
		private void matt_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			try
			{
                if (chkviewall.Checked) load_grid("");
                else load_grid();
			}
			catch{}
		}
        ...
        {
            sql = "alter table " + user + "." + s_table + " add hide numeric(1) default 0";
