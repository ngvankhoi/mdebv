...
namespace dllDanhmucMedisoft
{
	public class frmLoaikham : System.Windows.Forms.Form
	{
        ...
        //Tu:04/06/2011
        public frmLoaikham(AccessData acc, string filexml, string title, int userid,bool _badt)
        {
            InitializeComponent();
            m = acc; i_userid = userid; this.Text = title;
            ds.ReadXml("..//..//..//xml//" + filexml + ".xml");
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmLoaikham));
            ...
            this.butKetthuc.Location = new System.Drawing.Point(443, 342);
            ...
            this.butMoi.Location = new System.Drawing.Point(93, 342);
            ...
            this.butSua.Location = new System.Drawing.Point(163, 342);
            ...
            this.butLuu.Location = new System.Drawing.Point(233, 342);
            ...
            this.butHuy.Location = new System.Drawing.Point(373, 342);
		...
		{
            string sql = "";
            if (bbadt) sql = "select * from " + user + ".ba_danhmuc where id=" + int.Parse(loai.SelectedValue.ToString());
            else sql = "select * from " + user + ".ba_danhmuc where loai=" + int.Parse(loai.SelectedValue.ToString());
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            if (bbadt)
            {
                if (!m.upd_ba_danhmuc(int.Parse(loai.SelectedValue.ToString()), -1, 0, ten.Text))
                {
