...
namespace dllDanhmucMedisoft
{
	...
	/// </summary>
	public class frmDmnguyennhan : System.Windows.Forms.Form
	{
        ...
        private CheckBox chktngt;
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;

		public frmDmnguyennhan(AccessData acc,int userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDmnguyennhan));
            ...
            this.chktngt = new System.Windows.Forms.CheckBox();
            ...
            this.dataGrid1.Size = new System.Drawing.Size(594, 329);
            ...
            this.ma.Location = new System.Drawing.Point(101, 319);
            this.ma.MaxLength = 2;
            this.ma.Name = "ma";
            ...
            // label2
            // 
            this.label2.Location = new System.Drawing.Point(222, 318);
            ...
            this.ten.Location = new System.Drawing.Point(297, 319);
            this.ten.Name = "ten";
            ...
            this.txtviettat.Location = new System.Drawing.Point(172, 319);
            ...
            // label6
            // 
            this.label6.Location = new System.Drawing.Point(126, 319);
            ...
            this.txtstt.Location = new System.Drawing.Point(34, 319);
            ...
            // chktngt
            // 
            this.chktngt.AutoSize = true;
            this.chktngt.Location = new System.Drawing.Point(492, 343);
            this.chktngt.Name = "chktngt";
            this.chktngt.Size = new System.Drawing.Size(115, 17);
            this.chktngt.TabIndex = 4;
            this.chktngt.Text = "Tai nạn giao thông";
            this.chktngt.UseVisualStyleBackColor = true;
            // 
            // frmDmnguyennhan
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(608, 400);
            this.Controls.Add(this.chktngt);
            ...
            this.Name = "frmDmnguyennhan";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Danh mục nguyên nhân tai nạn";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmnguyennhan_KeyDown);
            this.Load += new System.EventHandler(this.frmDmnguyennhan_Load);
		...
		private void frmDmnguyennhan_Load(object sender, System.EventArgs e)
		{
            user = m.user; itable = m.tableid("", "dmnguyennhan");
			load_grid();
			AddGridTableStyle();
		...
		{
            dt = m.get_data("select ma,ten,stt,nvl(viettat,'') as viettat,tainangt from " + user + ".dmnguyennhan order by ma").Tables[0];
		...
		{
			if (!kiemtra()) return ;
            if (m.get_data("select * from " + user + ".dmnguyennhan where ma='" + ma.Text + "'").Tables[0].Rows.Count != 0)
            {
            ...
            if (!m.upd_dmnguyennhan("dmnguyennhan", ma.Text, ten.Text, txtstt.Text, txtviettat.Text,chktngt.Checked?1:0))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin địa điểm !"));
				return;
			}
            m.upd_dmdiadiem("dmnguyennhan", ma.Text, ten.Text, txtstt.Text, txtviettat.Text);
			load_grid();
			ena_object(false);
		}
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy thông tin này !"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                ...
                m.upd_eve_upd_del(itable, i_userid, "del", m.fields(user + ".dmnguyennhan", "ma='" + ma.Text + "'"));
                m.execute_data("delete from " + user + ".dmnguyennhan where ma='" + ma.Text + "'");
				load_grid();
			}
		}
		...
		private void ref_text()
		{
			try
			{
                ...
                chktngt.Checked=dataGrid1[i, 4].ToString()=="1"?true:false;
			}
			catch{}
		}
		...
		private void frmDmnguyennhan_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
