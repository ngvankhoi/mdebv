...
namespace dllDanhmucMedisoft
{
	...
	/// </summary>
	public class frmKygiayrv : System.Windows.Forms.Form
	{
		...
		public frmKygiayrv(AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKygiayrv));
            ...
            this.ma.Location = new System.Drawing.Point(113, 312);
            this.ma.Name = "ma";
            this.ma.Size = new System.Drawing.Size(202, 21);
            this.ma.TabIndex = 1;
            ...
            this.ten.Location = new System.Drawing.Point(369, 312);
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(255, 21);
            this.ten.TabIndex = 2;
            ...
            this.butMoi.Location = new System.Drawing.Point(120, 342);
            ...
            this.butSua.Location = new System.Drawing.Point(190, 342);
            ...
            this.butLuu.Location = new System.Drawing.Point(260, 342);
            ...
            this.butBoqua.Location = new System.Drawing.Point(330, 342);
            ...
            this.butHuy.Location = new System.Drawing.Point(400, 342);
            ...
            this.stt.Location = new System.Drawing.Point(32, 312);
            this.stt.Name = "stt";
            ...
            this.butKetthuc.Location = new System.Drawing.Point(470, 342);
            ...
            this.Name = "frmKygiayrv";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Danh mục ký giấy ra viện";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmKygiayrv_KeyDown);
            this.Load += new System.EventHandler(this.frmKygiayrv_Load);
		...
		private void frmKygiayrv_Load(object sender, System.EventArgs e)
		{
            user = m.user;
			load_grid();
			AddGridTableStyle();
		...
		{
            dt = m.get_data("select * from " + user + ".kyravien order by stt").Tables[0];
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			DataRow r;
			i_id=1;
			for(i_id=1;i_id<100;i_id++)
			{
				r=m.getrowbyid(dt,"id="+i_id);
				if (r==null) break;
			}
			stt.Value=i_id;
			ma.Text="";
		...
		{
			if (!kiemtra()) return ;
			if (!m.upd_kyravien(i_id,Convert.ToInt16(stt.Value),ma.Text,ten.Text))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật thông tin ký giấy ra viện !"));
				return;
			}
			load_grid();
			ena_object(false);
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			if (dt.Rows.Count==0) return;
			i_id=int.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber,0].ToString());
            if (m.get_data("select * from " + user + ".giayravien where kyravien=" + i_id).Tables[0].Rows.Count != 0)
			{
				MessageBox.Show(lan.Change_language_MessageText("Đã sử dụng không thể huỷ !"),LibMedi.AccessData.Msg);
				return;
			}
			...
			{
                m.execute_data("delete from " + user + ".kyravien where id=" + i_id);
				load_grid();
			}
		}
		...
		private void ref_text()
		{
			try
			{
				...
				i_id=int.Parse(dataGrid1[i,0].ToString());
				stt.Value=int.Parse(dataGrid1[i,1].ToString());
		...
		private void frmKygiayrv_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
