	...
	public class frmIndmpttt : System.Windows.Forms.Form
	{
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			if (pttt.Items.Count>0)
			{
				...
				sql+=" order by a.id_muc,a.mapt";
                f = new dllReportM.frmReport(m, m.get_data(sql), "DANH MỤC " + loai.Text.ToUpper(), "indmpttt.rpt");
			}
            else f = new dllReportM.frmReport(m, ds, "DANH MỤC " + loai.Text.ToUpper(), "indmpttt.rpt");
			f.ShowDialog(this);
		}
	}
}
