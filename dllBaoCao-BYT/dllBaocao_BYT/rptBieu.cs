...
namespace dllBaocao_BYT
{
	...
	public class rptBieu : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.benhan.Size = new System.Drawing.Size(303, 24);
		...
		private void bieu_02(bool prn)
		{
            ...
            foreach (DataRow r in ds.Tables[0].Select("c01+c02+c03+c04+c05+c06+c07+c08>0"))
            {
                ...
                for (int i = 0; i < ds.Tables[0].Columns.Count; i++) r1[i] = r[i].ToString();
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,dstmp,title.ToUpper(),"bieu_02.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_031(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_031.rpt");
					f.ShowDialog(this);
				}
			}
		}
		private void bieu_04(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_04.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_05(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_05.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_06(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_06.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_07(bool prn)
		{
			...
			if (ds.Tables[0].Rows.Count!=0)
			{
				...
				else
				{
					...
					{
						frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_07.rpt");
						f.ShowDialog(this);
					}
				}
			}
		...
		private void bieu_08(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_08.rpt");
					f.ShowDialog();
				}
			}
		}
		...
		private void bieu_091(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_091.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_092(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_092.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_101(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_101.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_1021(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_1021.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_1022(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_1022.rpt");
					f.ShowDialog(this);
				}
			}
		}
		private void bieu_103(bool prn)
		{
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),"bieu_103.rpt");
					f.ShowDialog(this);
				}
			}
		}
		private void bieu_11(bool prn)
		{
            if ((m.Mabv.Substring(0, 3) == "701"))
                ds = e.bieu_11_2010(s_tu, s_tu1, s_den, s_table, benhan.Checked, thongke.Checked, phatsinh.Checked);
            else
                ds = e.khbieu_15(s_tu, s_tu1, s_den, s_table, benhan.Checked, thongke.Checked, phatsinh.Checked, "bieu_11_1"); //Thanh Cuong
			string tenfile=(m.Mabv.Substring(0,3)=="701")?"bieu_11_18_2010.rpt":"bieu_11_2010.rpt";// Thanh Cuong
			...
			else
			{
				...
				{
					frmReport f=new frmReport(m,ds,title.ToUpper(),tenfile);
					f.ShowDialog(this);
				}
			}
		}
