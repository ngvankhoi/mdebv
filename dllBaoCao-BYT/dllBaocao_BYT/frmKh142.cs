...
namespace dllBaocao_BYT
{
	...
	/// </summary>
	public class frmKh142 : System.Windows.Forms.Form
	{
		...
		public frmKh142(AccessData acc,string hoten,int userid,int mabv)
		{
			//
        ...
        public frmKh142( string hoten, int userid, int mabv)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKh142));
            ...
            this.butMoi.Location = new System.Drawing.Point(186, 500);
            this.butMoi.Name = "butMoi";
            this.butMoi.Size = new System.Drawing.Size(74, 25);
            ...
            this.butSua.Location = new System.Drawing.Point(260, 500);
            this.butSua.Name = "butSua";
            this.butSua.Size = new System.Drawing.Size(74, 25);
            ...
            this.butLuu.Location = new System.Drawing.Point(334, 500);
            ...
            this.butBoqua.Location = new System.Drawing.Point(408, 500);
            this.butBoqua.Name = "butBoqua";
            this.butBoqua.Size = new System.Drawing.Size(74, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(556, 500);
            ...
            this.butHuy.Location = new System.Drawing.Point(482, 500);
            this.butHuy.Name = "butHuy";
            this.butHuy.Size = new System.Drawing.Size(74, 25);
            ...
            this.Load += new System.EventHandler(this.frmKh142_Load);
		...
		private void frmKh142_Load(object sender, System.EventArgs e)
		{
			...
			load_ngay();
			dt=m.get_data("select * from "+m.user+".khdm_142_dk").Tables[0];
			load_grid(false);
		...
		{
			if (dm)	ds=m.get_data("select * from "+m.user+".khdm_142 order by ma");
			else load_data();
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
				sql="select a.*,b.stt,b.ten from "+m.user+".khbieu_142 a,"+m.user+".khdm_142 b where a.ma=b.ma and a.id="+l_id+" order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		{
			ds=m.get_data("select * from "+m.user+".khdm_142 order by ma");
			DataRow[] dr;
			foreach(DataRow r in m.get_data("select * from "+m.user+".khbieu_142 where id="+l_id).Tables[0].Rows)
			{
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".khbieu_142 group by id,ngay order by ngay").Tables[0];
		}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from "+m.user+".khbieu_142 where id="+l_id);
					string exp="c01+c02+c03+c04+c05+c06+c07+c08+c09+c10+c11+c12+c13+c14+c15+c16+c17+c18+c19+c20>0";
					DataRow[] r=ds.Tables[0].Select(exp);
					Int16 iRec=Convert.ToInt16(r.Length);
					for(Int16 i=0;i<iRec;i++)
					{
						m.upd_kh142(l_id,int.Parse(r[i]["ma"].ToString()),ngay.Text,int.Parse(r[i]["c01"].ToString()),
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
            ...
            try
            {
                ...
                if (i_col >= 3 && i_col <= 22 && dataGrid1[i_row, i_col].ToString() != "")
