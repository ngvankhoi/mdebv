...
namespace dllBaocao_BYT
{
	...
	public class rptBieukh : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ky.TabIndex = 2;
            this.ky.SelectedIndexChanged += new System.EventHandler(this.ky_SelectedIndexChanged);
		...
		private void bieu_01(bool prn)
		{
			...
			if (ds.Tables[0].Rows.Count!=0)
			{
                ...
                sql += "sum(a.c05) as c05,sum(a.c06) as c06,sum(a.c07) as c07,sum(a.c08) as c08,sum(a.c09) as c09,sum(a.c10) as c10,sum(a.c11) as c11,sum(a.c12)as c12,sum(a.c13) as c13,sum(a.c14) as c14,sum(a.c15) as c15,sum(a.c16) as c16,sum(a.c17) as c17,sum(a.c18) as c18 ";
				...
				else
				{
					...
					{
                        ds.WriteXml("..//..//dataxml//khbieu_01.xml",XmlWriteMode.WriteSchema);
		...
		private void bieu_02(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_02.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_03(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_03.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_04(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_04.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_05(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_05.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_06(bool prn)
		{
			...
			if (ds.Tables[0].Rows.Count!=0)
			{
				...
				else
				{
                    ...
                    {
                        ds.WriteXml("..//..//dataxml//khbieu_06.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_07(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_07.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_08(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_08.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_09(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_09.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_10(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_10.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_11(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_11.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_121(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_121.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_122(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_122.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_141(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_141.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_142(bool prn)
		{
			...
			else
			{
                ...
                {
                    ds.WriteXml("..//..//dataxml//khbieu_142.xml", XmlWriteMode.WriteSchema);
		...
		private void bieu_143(bool prn)
		{
			...
			else
			{
				...
				{
                    ds.WriteXml("..//..//dataxml//khbieu_143.xml", XmlWriteMode.WriteSchema);
...
//			}
        ...
        private void ky_SelectedIndexChanged(object sender, EventArgs e)
        {
            int y =int.Parse( nam.Value.ToString());
            tu.Value = new DateTime(y, 1, 1);
            switch(ky.SelectedIndex)
            {
                case 0:
                den.Value=new DateTime(y,3,DateTime.DaysInMonth(y,3));    
                break;
                case 1:
                den.Value = new DateTime(y, 6, DateTime.DaysInMonth(y, 6));
                break;
                case 2:
                den.Value = new DateTime(y, 9, DateTime.DaysInMonth(y, 9));
                break;
                case 3:
                den.Value = new DateTime(y, 12, DateTime.DaysInMonth(y, 12));
                break;
            }
        }
        ...
        {
            ky_SelectedIndexChanged(sender, e);
        }
	}
}
