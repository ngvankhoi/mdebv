...
namespace dllBaocao_BYT
{
	...
	public class frmKh143 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butMoi.Location = new System.Drawing.Point(187, 519);
            ...
            this.butSua.Location = new System.Drawing.Point(257, 519);
            ...
            this.butLuu.Location = new System.Drawing.Point(327, 519);
            ...
            this.butBoqua.Location = new System.Drawing.Point(397, 519);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(537, 519);
            ...
            this.butHuy.Location = new System.Drawing.Point(467, 519);
		...
		private void frmKh143_Load(object sender, System.EventArgs e)
		{
			...
			load_ngay();
			dt=m.get_data("select * from "+m.user+".khdm_143_dk").Tables[0];
			load_grid(false);
		...
		{
			if (dm)	ds=m.get_data("select * from "+m.user+".khdm_143 order by ma");
			else load_data();
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
				sql="select a.*,b.stt,b.ten from "+m.user+".khbieu_143 a,"+m.user+".khdm_143 b where a.ma=b.ma and a.id="+l_id+" order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		{
			ds=m.get_data("select * from "+m.user+".khdm_143 order by ma");
			DataRow[] dr;
			foreach(DataRow r in m.get_data("select * from "+m.user+".khbieu_143 where id="+l_id).Tables[0].Rows)
			{
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".khbieu_143 group by id,ngay order by ngay").Tables[0];
		}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from "+m.user+".khbieu_143 where id="+l_id);
