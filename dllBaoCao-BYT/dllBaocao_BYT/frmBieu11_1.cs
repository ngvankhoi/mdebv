...
namespace dllBaocao_BYT
{
	...
	/// </summary>
	public class frmBieu11_1 : System.Windows.Forms.Form
	{
		...
		public frmBieu11_1(AccessData acc,string hoten,int userid,int mabv)
		{
			//
        ...
        public frmBieu11_1(string hoten, int userid, int mabv)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					...
					{
						m.upd_bieu11_1(l_id,int.Parse(r[i]["ma"].ToString()),ngay.Text,int.Parse(r[i]["c01"].ToString()),
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".bieu_11_1 group by id,ngay order by ngay").Tables[0];
		}
