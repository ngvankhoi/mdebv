...
DECLARE
    ...
    thuocsd cursor  (p_mabn varchar, p_maql numeric) is select a.id,a.mabn,a.mavaovien,a.maql,a.idkhoa,to_char(a.ngayylenh,'dd/mm/yyyy') as ngay, a.makp,b.madoituong, b.mabd, case when a.loai=3 then -1*b.soluong else b.soluong end as soluong,c.giaban,t.giamua,t.gianovat, a.traituyen from medibv0514.d_xuatsdll a, medibv0514.d_xuatsdct b,medibv0514.d_theodoi t,medibv.d_dmbd c where a.id=b.id and b.sttt=t.id and b.mabd=c.id and a.mabn=p_mabn and a.maql=p_maql;
begin
...
DECLARE
    ...
    thuocsd cursor  (p_mabn varchar, p_maql numeric) is select a.id,a.mabn,a.mavaovien,a.maql,a.idkhoa,to_char(b.ngayylenh,'dd/mm/yyyy') as ngay, a.makp,b.madoituong, b.mabd, case when a.loai=3 then -1*b.soluong else b.soluong end as soluong,c.giaban,t.giamua,t.gianovat, a.traituyen,b.gia_bh from medibv0514.d_xuatsdll a, medibv0514.d_xuatsdct b,medibv0514.d_theodoi t,medibv.d_dmbd c where a.id=b.id and b.sttt=t.id and b.mabd=c.id and a.mabn=p_mabn and a.maql=p_maql;
begin
    open thuocsd(d_mabn,d_maql);
    delete from medibv0514.d_tienthuoc where mabn=d_mabn and maql=d_maql and done=0;
    loop
...
DECLARE
    ...
    thuocsd cursor  (p_mabn varchar, p_maql numeric) is select a.id,a.mabn,a.mavaovien,a.maql,a.idkhoa,to_char(b.ngayylenh,'dd/mm/yyyy') as ngay, a.makp,b.madoituong, b.mabd, case when a.loai=3 then -1*b.soluong else b.soluong end as soluong,b.giaban,t.giamua,t.gianovat, a.traituyen,b.gia_bh,b.id_ktcao from medibv0514.d_xuatsdll a, medibv0514.d_xuatsdct b,medibv0514.d_theodoi t,medibv.d_dmbd c where a.id=b.id and b.sttt=t.id and b.mabd=c.id and a.mabn=p_mabn and a.maql=p_maql;
begin
    open thuocsd(d_mabn,d_maql);
    delete from medibv0514.d_tienthuoc where mabn=d_mabn and maql=d_maql and done=0;
    loop
