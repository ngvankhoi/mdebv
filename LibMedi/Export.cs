    ...
    public class Export
    {
        ...
        public DataSet bieu_02(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            ...
            if (benhan)
            {
                ...
                sql += " from xxx.benhanpk a," + user + ".btdbn aa," + user + ".btdkp_bv c," + user + ".doituong d , " + user + ".icd10 i ";
                sql += " where a.mabn=aa.mabn and a.makp=c.makp and a.madoituong=d.madoituong and a.maicd=i.cicd10 and length(trim(i.stt)) > 0 ";
                ...
                sql += " from xxx.benhancc a," + user + ".btdbn aa," + user + ".btdkp_bv c," + user + ".doituong d , " + user + ".icd10 i ";
                sql += " where a.mabn=aa.mabn and a.makp=c.makp and a.madoituong=d.madoituong and a.maicd=i.cicd10 and length(trim(i.stt)) > 0 ";
                sql += " and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                ...
                sql1 += " from " + user + ".benhanngtr a," + user + ".btdbn aa," + user + ".btdkp_bv c," + user + ".doituong d , " + user + ".icd10 i ";
                sql1 += " where a.mabn=aa.mabn and a.makp=c.makp and a.madoituong=d.madoituong and a.maicd=i.cicd10 and length(trim(i.stt)) > 0 ";
                ...
                //Tong so benh nhan nhap vien
                sql = "SELECT c.makp ma,sum(case when a.khoachuyen='01' then 1 else 0 end) C06";
                sql += " FROM " + m.user + ".NHAPKHOA a," + m.user + ".BTDKP_BV c," + m.user + ".BTDBN d," + m.user + ".BENHANDT e ";
                sql += " WHERE a.MAKP=c.MAKP and a.maql=e.maql and a.mabn=d.mabn and a.maba<20 ";
                sql += " and to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " GROUP BY c.makp";
                foreach (DataRow r in m.get_data(sql).Tables[0].Rows)
                {
                    ...
                    if (r1 == null)
                    {
                        r2 = m.getrowbyid(ds1.Tables[0], "makp='" + r["ma"].ToString().PadLeft(2, '0') + "'");
                        if (r2 != null)
        ...
        public DataSet bieu_02_bv(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            ds = new DataSet();
            string user = m.user;
            bool bBieu02_Khong_Hienthi_khoa_C66 = m.bBieu02_Khong_Hienthi_khoa_C66;
            DataRow[] dr;
            DataRow r1, r2;
            Int64 c02, c03, c04, c05, c06, c07, ma;
            ds = m.get_data("select * from " + user + ".dm_02 where ma<2 order by ma");
            ...
            if (benhan)
            {
                ...
                foreach (DataRow r in tmp.Tables[0].Rows)
                {
                    ...
                    if (dr.Length > 0)
                    {
                        ...
                        c04 = (c02 + c03 == 0) ? 1 : 0;
                        c05 = (r["nhantu"].ToString() == "1") ? 1 : 0;
                        if(bBieu02_Khong_Hienthi_khoa_C66)
                ...
                //
                //Tong so benh nhan nhap vien
                if (bBieu02_Khong_Hienthi_khoa_C66 == false) 
                {
                    sql = "SELECT c.makp ma,sum(case when a.khoachuyen='01' then 1 else 0 end) C06";
                    sql += " FROM " + m.user + ".NHAPKHOA a," + m.user + ".BTDKP_BV c," + m.user + ".BTDBN d," + m.user + ".BENHANDT e ";
                    sql += " WHERE a.MAKP=c.MAKP and a.maql=e.maql and a.mabn=d.mabn and a.maba<20 ";
        ...
        public DataSet bieu_031(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            DataRow[] dr;
            DataRow r1, r2;
            ...
            if (benhan)
            {
                ...
                sql += " and (to_date('" + s_den + "','dd/mm/yyyy')< to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') or b.ngay is null) then date_part('day',to_date('" + s_den + "','dd/mm/yyyy')-to_date('" + s_tu + "','dd/mm/yyyy'))+(case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then 1 else 0 end) else 1 end) else";//1 else";
                //vao<tu and (ra<=den)              => ra - tu
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')< to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date('" + s_tu + "','dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then 1 else 0 end) else 1 end) else";// case when b.ttlucrk in (5,6,7) then 0 else 1 end else ";
                //vao>=tu and (den<ra or ra is null)=> den-vao
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and (to_date('" + s_den + "','dd/mm/yyyy')< to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') or b.ngay is null) then date_part('day',to_date('" + s_den + "','dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy'))+(case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then 1 else 0 end) else 1 end) else";//1 else ";
                //vao>=tu and (ra<=den)             => ra - vao
                sql += " case when to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')) + (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then 1 else 0 end) else 1 end) end end end end) c15"; // case when b.ttlucrk in(5,6,7) then 0 else 1 end end end end end) c15";
                //nu
                ...
                //vao>=tu and (ra<=den)             => ra - vao
                sql += " case when to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then 1 else 0 end) else 1 end) end end end end else 0 end) c15_nu ";// case when b.ttlucrk in (5,6,7) then 0 else 1 end end end end end else 0 end) c15_nu";
        ...
        public DataSet bieu_031_bv(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            ...
            DataColumn dc;
            string user = m.user;
            int i_songaydt_congthem = m.iSongaydieutri_congthem;
            ds = m.get_data("select * from " + user+"."+s_table + " order by ma");
            m.delrec(ds.Tables[0], "ma>3");
            ds.AcceptChanges();
            dc = new DataColumn();
            ...
            if (benhan)
            {
                ...
                sql += "sum(case when a.khoachuyen='01' and e.madoituong=1 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " Between to_date('" + s_tu1 + "','dd/mm/yyyy') And to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end)  as C101,";
                sql += "sum(case when a.khoachuyen<>'01' and e.madoituong=1 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " Between to_date('" + s_tu1 + "','dd/mm/yyyy') And to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end)  as C102,";
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=1 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C06,";//ra vien
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=2 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C07,";//xin ve
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=3 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C08,";//bo ve
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=4 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C09,";//
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=5 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C10,";//chuyen khoa
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=6 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C11,";//chuyen vien
                sql += "Sum(case when b.ngay is null then 0 else case when b.ttlucrk=7 And " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end end)  as C12,";//tu vong
                sql += "sum(case when b.ngay is null or " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + ">to_date('" + s_den + "','dd/mm/yyyy') then 1 else 0 end)  as C13";
                sql += " FROM " + user + ".nhapkhoa a left join " + user + ".xuatkhoa b on a.id=b.id inner join " + user + ".btdkp_bv c on a.makp=c.makp inner join " + user + ".btdbn d on a.mabn=d.mabn inner join " + user + ".benhandt e on a.maql=e.maql ";
                sql += " WHERE a.maba<20 and e.loaiba=1 and length(d.namsinh)=4";
                foreach (DataRow r in m.get_data(sql + "GROUP BY c.makp ORDER BY c.makp").Tables[0].Rows)
                {
                    ...
                    if (dr.Length > 0)
                    {
                        dr[0]["c02"] = decimal.Parse(r["c03"].ToString());//dau ky
                        dr[0]["c03"] = decimal.Parse(dr[0]["c03"].ToString()) + decimal.Parse(r["c04"].ToString());//tong so bn dieu tri noi tru=dau ky+ moi vao
                        dr[0]["c04"] = decimal.Parse(dr[0]["c04"].ToString()) + decimal.Parse(r["c041"].ToString());
                        dr[0]["c05"] = decimal.Parse(dr[0]["c05"].ToString()) + decimal.Parse(r["c051"].ToString());
                        dr[0]["c10"] = decimal.Parse(dr[0]["c10"].ToString()) + decimal.Parse(r["c101"].ToString());
                        dr[0]["c12"] = decimal.Parse(dr[0]["c12"].ToString()) + decimal.Parse(r["c05"].ToString());
                        ...
                        dr[0]["c14"] = decimal.Parse(dr[0]["c14"].ToString()) + decimal.Parse(r["c052"].ToString());
                        dr[0]["c15"] = decimal.Parse(dr[0]["c15"].ToString()) + decimal.Parse(r["c102"].ToString());
                        //cuoi ky= dau ky + bn moi vao + khoa khac chuyen sang - (ravien+xinhve+bove+duave+chuyenvien+tuvong) 
                        dr[0]["c11"] = decimal.Parse(r["c03"].ToString()) + decimal.Parse(r["c04"].ToString()) + decimal.Parse(r["c05"].ToString()) - (decimal.Parse(r["c06"].ToString()) + decimal.Parse(r["c07"].ToString()) + decimal.Parse(r["c08"].ToString()) + decimal.Parse(r["c09"].ToString()) + decimal.Parse(r["c10"].ToString()) + decimal.Parse(r["c11"].ToString()) + decimal.Parse(r["c12"].ToString()));
                    }
                }
                //phai=1
                ...
                //vao<tu and (den<ra or ra is null) => den-tu
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')< to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and (to_date('" + s_den + "','dd/mm/yyyy')< to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') or b.ngay is null) then date_part('day',to_date('" + s_den + "','dd/mm/yyyy')-to_date('" + s_tu + "','dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end) else " + i_songaydt_congthem + " end) else";//1 else";
                //vao<tu and (ra<=den)              => ra - tu
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')< to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date('" + s_tu + "','dd/mm/yyyy')) + (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end)  else " + i_songaydt_congthem + " end) else";//+ case when b.ttlucrk in (5,6,7) then 0 else 1 end else ";
                //vao>=tu and (den<ra or ra is null)=> den-vao
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and (to_date('" + s_den + "','dd/mm/yyyy')< to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') or b.ngay is null) then date_part('day',to_date('" + s_den + "','dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end)  else 1 end) else";//+1 else ";
                //vao>=tu and (ra<=den)             => ra - vao
                sql += " case when to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')) + (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end)  else " + i_songaydt_congthem + " end) end end end end) c15 ";//+ case when b.ttlucrk in(5,6,7) then 0 else 1 end end end end end) c15";
                //nu
                sql += ",sum(case when d.phai=1 then ";
                //vao<tu and (den<ra or ra is null) => den-tu
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')< to_date('" + s_tu + "','dd/mm/yyyy') ";
                ...
                //vao>=tu and (den<ra or ra is null)=> den-vao
                sql += " case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and (to_date('" + s_den + "','dd/mm/yyyy')< to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy') or b.ngay is null) then date_part('day',to_date('" + s_den + "','dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end)  else " + i_songaydt_congthem + " end) else";//+1 else ";
                //vao>=tu and (ra<=den)             => ra - vao
                sql += " case when to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>= to_date('" + s_tu + "','dd/mm/yyyy') ";
                sql += " and to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')<=to_date('" + s_den + "','dd/mm/yyyy') then date_part('day',to_date(to_char(b.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')-to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy'))+ (case when to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')>=to_date('" + s_tu + "','dd/mm/yyyy') then (case when a.khoachuyen='01' then " + i_songaydt_congthem + " else 0 end) else " + i_songaydt_congthem + " end)  end end end end else 0 end) c15_nu ";//+ case when b.ttlucrk in (5,6,7) then 0 else 1 end end end end end else 0 end) c15_nu";
                sql += " from " + user + ".nhapkhoa a left join " + user + ".xuatkhoa b on a.id=b.id inner join " + user + ".benhandt c on a.maql=c.maql inner join " + user + ".btdbn d on a.mabn=d.mabn ";
                ...
                tongcong("ma>2", "1", 3);
                //r1 = m.getrowbyid(ds.Tables[0], "ma=1");
                foreach (DataRow r11 in ds.Tables[0].Select("ma=1 or ma=2", ""))
                {
                    //if (r1 != null)
                    //{
                        r11["c12"] = 0; r11["c13"] = 0; r11["c14"] = 0; r11["c15"] = 0;
                    //}
                }
                foreach (DataRow r in ds.Tables[0].Rows)
                {
        ...
        public DataSet bieu_04(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            ...
            if (benhan)
            {
                ...
                lds = m.get_data_mmyy(sql, s_tu1, s_den, false);
                if (lds == null || lds.Tables.Count <= 0) return ds;
                foreach (DataRow r in lds.Tables[0].Rows)
                {
                    so = (r["mapt"].ToString().Substring(0, 1) == "P") ? 1 : 10;
                    ma = Math.Min(int.Parse(r["loaipt"].ToString()) + so,18);
                    dr = ds.Tables[0].Select("ma=" + ma);
                    if (dr.Length > 0)
                    {
        ...
        public DataSet bieu_04_khoa(string s_makp, string s_tu, string s_tu1, string s_den, string s_table, int i_loaiba, bool time)
        {
            ...
            if (i_loaiba == 3)
            {
                sql_field = "select a.mapt,case when b.loaipt=9 then 8 else b.loaipt end as loaipt,a.tinhhinh,a.taibien,a.tuvong";
                sql_field += " from xxx.pttt a inner join " + user + ".dmpttt b on a.mapt = b.mapt";
                sql += sql_field;
                sql += " inner join " + user + ".benhandt c on a.maql=c.maql";
                sql += " where (c.loaiba=1 or c.loaiba is null)";
                sql += sql_dk + " and a.loaibn in (0,1)";
                sql += " union all ";
                sql += sql_field;
                sql += " inner join " + user + ".benhanngtr c on a.maql=c.maql";
                sql += " and a.maql>0 where a.loaibn in (0,1) ";
                sql += sql_dk ;
                sql += " union all ";
                sql += sql_field;
                sql += " inner join xxx.benhancc c on a.maql=c.maql";
                sql += " and a.maql>0 where a.loaibn in (3)";
                sql += sql_dk;
                sql += " union all ";
                sql += sql_field;
                sql += " left join xxx.benhanpk c on a.maql=c.maql";
                sql += " and a.maql>0 where a.loaibn in (2)";
                sql += sql_dk ;
                sql += " union all ";
                sql += sql_field;
                sql += " left join xxx.tiepdon c on a.maql=c.maql";
                sql += " and a.maql>0 where a.loaibn in (4)";
                sql += sql_dk ;
            }
            else if (i_loaiba == 1)
            {
        ...
        public DataSet bieu_11_2010(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            string user = m.user;
            DataRow[] dr;
            ds = m.get_data("select * from " + user + "." + s_table + " order by ma");
            ...
            if (thongke)
            {
                ...
                sql += "sum(a.c09) as c09,sum(a.c10) as c10,sum(a.c11) as c11,sum(a.c12) as c12";
                if (m.Mabv.Substring(0, 3) == "701") sql += ",sum(a.c041) as c041,sum(a.c051) as c051,sum(a.c15) as c15,sum(a.c16) as c16,sum(a.c17) as c17,sum(a.c18) as c18";
                sql += " from " + user + ".bieu_11_1 a," + user + ".dm_11 b where a.ma=b.ma ";
                sql += " and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by a.ma";
                foreach (DataRow r in m.get_data(sql).Tables[0].Rows)
                {
        ...
        public DataSet bieu_11_maumoi(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            string user = m.user;
            DataRow[] dr;
            ds = m.get_data("select * from " + user + "." + s_table + " order by ma");
            ...
            if (benhan)
            {
                sql = "SELECT d.STT,sum(case when b.loaiba=1 then 0 else 1 end) as c01,sum(case when b.loaiba!=1 and c.phai=1 then 1 else 0 end) as c19,sum(case when b.loaiba<>1 and to_number(to_char(sysdate,'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c02,";
                sql += "sum(case when b.loaiba<>1 and a.ttlucrv=7 then 1 else 0 end) as c03,";
                sql += "sum(case when b.loaiba=1 then 1 else 0 end) as c04,sum(case when b.loaiba=1 and c.phai=1 then 1 else 0 end) as c041,";
                sql += "sum(case when b.loaiba=1 and a.ttlucrv=7 then 1 else 0 end) as c05,";
                sql += "sum(case when b.loaiba=1 and c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c051,";
                sql += "sum(to_number(case when b.loaiba=1 then " + m.for_num_ngay("a.ngay") + "-" + m.for_num_ngay("b.ngay") + "+1 else 0 end)) as c06,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c07,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c08,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<15 and a.ttlucrv=7 then 1 else 0 end) as c09,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c10,";
                //sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<15 then " + m.for_num_ngay("a.ngay") + "-" + m.for_num_ngay("b.ngay") + "+1 else 0 end) as c11,";
                //sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<=4 then " + m.for_num_ngay("a.ngay") + "-" + m.for_num_ngay("b.ngay") + "+1 else 0 end) as c12,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c11,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c12,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c15,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)>60 and c.phai=1 then 1 else 0 end) as c16,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c17,";
                sql += "sum(case when b.loaiba=1 and to_number(to_char(b.ngay,'yyyy'))-to_number(c.namsinh)>60 and c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c18";
                //sql += " FROM " + user + ".XUATVIEN a," + user + ".BENHANDT b," + user + ".BTDBN c," + user + ".ICD10 d";
                //sql += " where a.MAQL = b.MAQL and a.MABN = c.MABN and a.MAICD = d.CICD10 and length(trim(d.stt))>0 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                //sql += "group by d.stt";
                sql += " FROM " + user + ".XUATVIEN a ";
                sql += " Inner join " + user + ".BENHANDT b on a.maql = b.maql ";
                sql += " Inner join " + user + ".BTDBN c on c.mabn = a.mabn ";
                sql += " Inner join " + user + ".ICD10 d on a.maICD = d.CICD10 ";
                sql += " where length(trim(d.stt))>0 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " and a.mabn in(select distinct mabn from " + user + ".nhapkhoa ) ";
                sql += "group by d.stt";
                sql += " union all ";
                sql += "SELECT d.STT,sum(1) as c01,sum(case when c.phai=1 then 1 else 0 end) as c19,sum(case when to_number(to_char(a.ngay,'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c02,";
                sql += "sum(case when a.ttlucrv=7 then 1 else 0 end) as c03,";
                sql += "sum(0) as c04,sum(0) as c041,";
                sql += "sum(0) as c05,";
                sql += "sum(0) as c051,";
                ...
                tmp = m.get_sum(tmp, new string[] { "stt" }, new string[] { "c01", "c02", "c03", "c04", "c041", "c05", "c051", "c06", "c07", "c08", "c09", "c10", "c11", "c12", "c15", "c16", "c17", "c18", "c19" });
                foreach (DataRow r in tmp.Tables[0].Rows)
                {
                    dr = ds.Tables[0].Select("stt='" + r["stt"].ToString() + "'");
                    if (dr.Length > 0)
                    {
                        dr[0]["c01"] = r["c01"].ToString(); dr[0]["c19"] = r["c19"].ToString();
                        dr[0]["c02"] = r["c02"].ToString();
                        dr[0]["c03"] = r["c03"].ToString();
                        dr[0]["c04"] = r["c04"].ToString();
                        dr[0]["c05"] = r["c05"].ToString();
                ...
                {
                    sql = "SELECT d.STT,sum(case when b.loaiba=3 then 0 else 1 end) as c04,";
                    sql += "sum(case when b.loaiba=1 and to_number(to_char(sysdate,'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c07";
                    sql += " FROM " + user + ".XUATVIEN a," + user + ".BENHANDT b," + user + ".BTDBN c," + user + ".ICD10 d," + user + ".cdnguyennhan e";
                    sql += " where a.MAQL = b.MAQL and a.MABN = c.MABN and a.maql=e.maql and e.MAICD = d.CICD10 and d.stt is not null and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                    sql += "group by d.stt";
                    tmp = m.get_data(sql);
            ...
            if (thongke)
            {
                sql = "select a.ma,sum(a.c01) as c01,sum(a.c19) as c19,sum(a.c02) as c02,sum(a.c03) as c03,sum(a.c04) as c04,sum(a.c041) as c041,sum(a.c051) as c051,";
                sql += "sum(a.c05) as c05,sum(a.c06) as c06,sum(a.c07) as c07,sum(a.c08) as c08,";
                sql += "sum(a.c09) as c09,sum(a.c10) as c10,sum(a.c11) as c11,sum(a.c12) as c12";
                if (m.Mabv.Substring(0, 3) == "701") sql += ",sum(a.c041) as c041,sum(a.c051) as c051,sum(a.c15) as c15,sum(a.c16) as c16,sum(a.c17) as c17,sum(a.c18) as c18";
                sql += " from " + user + ".bieu_11 a," + user + ".dm_11 b where a.ma=b.ma ";
        ...
        public DataSet kh_bieu_15_maumoi(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            string user = m.user;
            DataRow[] dr;
            ds = m.get_data("select * from " + user + "." + s_table + " order by ma");
        ...
        {
            if (ds_in == null) return;
            else if(ds_in.Tables.Count<=0) return;
            DataRow[] dr;
        ...
        public DataSet upd_ththbn_doituong(string tu, string den, string makp, bool time)
        {
            //linh
            //string stime = (time) ? "'" + m.f_ngaygio + "'" : "'" + m.f_ngay + "'";
            ...
            //
            string s_doituong = "";
            DataTable dtdt=m.get_data("select * from "+user+".doituong ").Tables[0];
            //
            dt = new DataTable();
            ...
            sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>= to_date('" + tu + "'," + stime + ") ";
            sql += " and (to_date('" + den + "'," + stime + ")< to_date(to_char(b.ngay," + stime + ")," + stime + ") or b.ngay is null) then date_part('day',to_date('" + den + "'," + stime + ")-to_date(to_char(a.ngay," + stime + ")," + stime + "))+1 else ";
            ...
            //Tinh ton cuoi ky theo doi tuong
            foreach (DataRow rdt in dtdt.Rows)
            {
                s_doituong += ", sum(case when aa.madoituong=" + rdt["madoituong"].ToString() + " then 1 else 0 end) as dt_" + rdt["madoituong"].ToString().PadLeft(2, '0');
                dc = new DataColumn();
                dc.ColumnName = "dt_" + rdt["madoituong"].ToString().PadLeft(2, '0');
                dc.DataType = Type.GetType("System.Decimal");
                dc.DefaultValue = 0;
                ds.Tables[0].Columns.Add(dc);
            }
            sql=" select a.makp ";
            sql+= s_doituong;
            sql+= " from " + user + ".benhandt aa inner join  " + user + ".nhapkhoa a on aa.maql=a.maql left join  " + user + ".xuatkhoa b on a.id=b.id inner join " + user + ".btdkp_bv c on a.makp=c.makp ";
            sql += " where b.ngay is null or to_date(to_char(b.ngay," + stime + ")," + stime + ")>to_date('" + den + "'," + stime + ")";
            sql += " group by a.makp ";
            dst = m.get_data(sql);
            foreach (DataRow r in dst.Tables[0].Rows)
            {
                ...
                if (r1 != null)
                {
                    foreach (DataRow r_dt in dtdt.Rows)
                    {
                        r1["dt_" + r_dt["madoituong"].ToString().PadLeft(2, '0')] = decimal.Parse(r1["dt_" + r_dt["madoituong"].ToString().PadLeft(2, '0')].ToString())+ decimal.Parse(r["dt_" + r_dt["madoituong"].ToString().PadLeft(2, '0')].ToString());
                    }
                }
            }
            ds.AcceptChanges();
        ...
        public DataSet upd_ththbn(string tu, string den, string makp, bool time)
        {
            ...
            //string stime = (time) ? "'" + m.f_ngaygio + "'" : "'" + m.f_ngay + "'";
            string stime = (time) ? "'dd/mm/yyyy hh24:mi'" : "'dd/mm/yyyy'";
            int i_songaydtcongthem = m.iSongaydieutri_congthem;
            if (time)
            {
                tu = tu + " " + m.sGiobaocao;
                den = den + " " + m.sGiobaocao;
            ...
            //vao<tu and (den<ra or ra is null) => den-tu
            sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")< to_date('" + tu + "'," + stime + ") ";
            sql += " and (to_date('" + den + "'," + stime + ")< to_date(to_char(b.ngay," + stime + ")," + stime + ") or b.ngay is null) then date_part('day',to_date('" + den + "'," + stime + ")-to_date('" + tu + "'," + stime + "))+ (case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>=to_date('" + tu + "'," + stime + ") then (case when a.khoachuyen='01' then " + i_songaydtcongthem + " else 0 end) else " + i_songaydtcongthem + " end)  else";//1 else";
            //vao<tu and (ra<=den)              => ra - tu
            sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")< to_date('" + tu + "'," + stime + ") ";
            sql += " and to_date(to_char(b.ngay," + stime + ")," + stime + ")<=to_date('" + den + "'," + stime + ") then date_part('day',to_date(to_char(b.ngay," + stime + ")," + stime + ")-to_date('" + tu + "'," + stime + ")) + (case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>=to_date('" + tu + "'," + stime + ") then (case when a.khoachuyen='01' then " + i_songaydtcongthem + " else 0 end)  else " + i_songaydtcongthem + " end) else";//+ case when b.ttlucrk in (5,6,7) then 0 else 1 end else ";
            //vao>=tu and (den<ra or ra is null)=> den-vao
            sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>= to_date('" + tu + "'," + stime + ") ";
            sql += " and (to_date('" + den + "'," + stime + ")< to_date(to_char(b.ngay," + stime + ")," + stime + ") or b.ngay is null) then date_part('day',to_date('" + den + "'," + stime + ")-to_date(to_char(a.ngay," + stime + ")," + stime + "))+ (case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>=to_date('" + tu + "'," + stime + ") then (case when a.khoachuyen='01' then " + i_songaydtcongthem + " else 0 end)  else " + i_songaydtcongthem + " end) else";//+1 else ";
            //vao>=tu and (ra<=den)             => ra - vao
            sql += " case when to_date(to_char(b.ngay," + stime + ")," + stime + ")>= to_date('" + tu + "'," + stime + ") ";
            sql += " and to_date(to_char(b.ngay," + stime + ")," + stime + ")<=to_date('" + den + "'," + stime + ") then date_part('day',to_date(to_char(b.ngay," + stime + ")," + stime + ")-to_date(to_char(a.ngay," + stime + ")," + stime + ")) + (case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>=to_date('" + tu + "'," + stime + ") then (case when a.khoachuyen='01' then " + i_songaydtcongthem + " else 0 end)  else " + i_songaydtcongthem + " end) end end end end) c15 ";//+ case when b.ttlucrk in(5,6,7) then 0 else 1 end end end end end) c15";
...
//        }
        ...
        public DataSet get_btpkham(string m_tu, string m_den, string m_makp, bool time)
        {
            string user=m.user,stime = (time) ? "'" + m.f_ngaygio + "'" : "'" + m.f_ngay + "'";
            if (time)
            {
        ...
        public DataSet get_btpkham_nguoi(string m_tu, string m_den, string m_makp, bool time)
        {
            string user=m.user,stime = (time) ? "'" + m.f_ngaygio + "'" : "'" + m.f_ngay + "'";
            if (time)
            {
        ...
        public DataSet get_btngtru(string m_tu, string m_den, string m_makp, bool time)
        {
            ...
            dsxml.ReadXml("..//..//..//xml//m_btpkham.xml");
            dsxml.Clear();
            sql = "select b.maicd,a.namsinh,'3' as loaiba,case when b.ttlucrv=0 then 1 else b.ttlucrv end as ttlucrv,"+
            "c.vviet as chandoan,count(*) as so";
            sql += " from " + user + ".btdbn a inner join xxx.benhanpk b on a.mabn=b.mabn inner join "+user+".icd10 c ";
            sql += " on b.maicd=c.cicd10 where b.mangtr<>0 ";
            if (m_tu != "")
                sql += " and " + m.for_ngay("b.ngay", stime) + " between to_date('" + m_tu + "'," + stime + ") and to_date('" + m_den + "'," + stime + ")";
            if (m_makp != "") sql += " and b.makp in (" + m_makp + ")";
            sql += " group by b.maicd,c.vviet,a.namsinh,loaiba,ttlucrv";
            sql += " union all ";
            sql += " select b.maicd,a.namsinh,'2' as loaiba,case when b.ttlucrv=0 then 1 else b.ttlucrv end as ttlucrv,"+
                " c.vviet as chandoan,count(*) as so";
            sql += " from " + user + ".btdbn a inner join " + user + ".benhanngtr b on a.mabn=b.mabn inner join " + user + ".icd10 c";
            sql += " on b.maicd=c.cicd10 where b.maql>0 ";
            if (m_tu != "")
                sql += " and " + m.for_ngay("b.ngay", stime) + " between to_date('" + m_tu + "'," + stime + ") and to_date('" + m_den + "'," + stime + ")";
            if (m_makp != "") sql += " and b.makp in (" + m_makp + ")";
            sql += " group by b.maicd,a.namsinh,loaiba,c.vviet,ttlucrv";
            ...
            foreach (DataRow r in ds.Tables[0].Rows)
            {
                string exp = "noidung='" + r["chandoan"].ToString() + "'";
                DataRow r1 = m.getrowbyid(dsxml.Tables[0], exp);
                tuoi = int.Parse(m_tu.Substring(6, 4)) - int.Parse(r["namsinh"].ToString());
                if (r1 == null)
                {
                    i++;
                    DataRow dr = dsxml.Tables[0].NewRow();
                    dr["noidung"] = r["chandoan"];
                    dr["id"] = i;
                    dr["loai"] = r["loaiba"];
                    dr["D01"]=0;
		            dr["D011"]=0;
                    ...
                    if (r["loaiba"].ToString() == "2")
                    {
                        dr["d01"] = decimal.Parse(r["so"].ToString());
                        if (tuoi < 15) dr["d02"] = decimal.Parse(r["so"].ToString());
                        if (tuoi < 6) dr["d03"] = decimal.Parse(r["so"].ToString());
                    }
                    if (r["loaiba"].ToString() == "3")
                    {
                        dr["d04"] =  decimal.Parse(r["so"].ToString());
                        if (tuoi < 15) dr["d05"] =  decimal.Parse(r["so"].ToString());
                        if (tuoi < 6) dr["d06"] = decimal.Parse(r["so"].ToString());
                    }
                    dr["d07"] = decimal.Parse(r["so"].ToString());
                    if (tuoi < 15) dr["d08"] =  decimal.Parse(r["so"].ToString());
                    if (tuoi < 6) dr["d09"] =  decimal.Parse(r["so"].ToString());
                ...
                //foreach (DataRow r1 in ds.Tables[0].Select(r["DK"].ToString()))
                {
                    if (r["loaiba"].ToString() == "2")
                    {
                        r1["d01"] = decimal.Parse(r1["d01"].ToString()) + decimal.Parse(r["so"].ToString());
                        if (tuoi < 15) r1["d02"] = decimal.Parse(r1["d02"].ToString()) + decimal.Parse(r["so"].ToString());
                        if (tuoi < 6) r1["d03"] = decimal.Parse(r1["d03"].ToString()) + decimal.Parse(r["so"].ToString());
                    }
                    if (r["loaiba"].ToString() == "3")
                    {
                        r["d04"] = decimal.Parse(r1["d04"].ToString()) + decimal.Parse(r["so"].ToString());
                        if (tuoi < 15) r1["d05"] = decimal.Parse(r1["d05"].ToString()) + decimal.Parse(r["so"].ToString());
                        if (tuoi < 6) r1["d06"] = decimal.Parse(r1["d06"].ToString()) + decimal.Parse(r["so"].ToString());
                    }
                    r1["d07"] = decimal.Parse(r1["d07"].ToString()) + decimal.Parse(r["so"].ToString());
                    if (tuoi < 15) r1["d08"] = decimal.Parse(r1["d08"].ToString()) + decimal.Parse(r["so"].ToString());
                    if (tuoi < 6) r1["d09"] = decimal.Parse(r1["d09"].ToString()) + decimal.Parse(r["so"].ToString());
                }
            }
            return dsxml;
        }
        // hien them xu ly bieu 15 kh moi
        public DataSet khbieu_15(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh, string s_table1)
        {
            DataRow[] dr;
            string user = m.user;
            ds = m.get_data("select * from " + user + "." + s_table + " order by ma");
            if (benhan)
            {
                ...
                //sql += "sum(case when to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<15 and a.ttlucrv=7 then 1 else 0 end) as c05,";
                //sql += "sum(case when to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06";
                sql = "SELECT d.STT,sum(decode(b.loaiba,1,0,1)) as c01,";//tong so 
                sql += "sum(case when c.phai=1 and b.loaiba <>1 then 1 else 0 end) as c02,";//trong do nu
                sql += "sum(case when (b.loaiba<>1 and to_number(nullif(to_char(now(),'yyyy'),0))-to_number(nullif(c.namsinh,0))<15) then 1 else 0 end) as c03,";//tre em
                sql += "sum(case when (a.ttlucrv=7 and b.loaiba<>1) then 1 else 0 end ) as c04,";//so tu vong
                sql += "sum(decode(b.loaiba,1,1,0)) as c05,";//dt noi tru
                sql += "sum(case when b.loaiba=1 and c.phai=1 then 1 else 0 end)as c06,";// trong do nu
                sql += "sum(case when b.loaiba=1 and a.ttlucrv=7 then 1 else 0 end) as c07,";//tong so tu vong
                sql += "sum(case when b.loaiba=1 and a.ttlucrv=7 and c.phai =1 then 1 else 0 end) as c08,";// trong do nu
                sql += "sum(case when b.loaiba=1 and to_number(nullif(to_char(now(),'yyyy'),0)) - to_number(nullif(c.namsinh,0))<15 then 1 else 0 end) as c09,";// tong so tre em duoi 15 tuoi
                sql += "sum(case when b.loaiba=1 and to_number(nullif(to_char(now(),'yyyy'),0)) - to_number(nullif(c.namsinh,0)) <5 then 1 else 0 end) as c10,";// tr e <5 tuoi
                sql += "sum(case when b.loaiba=1 and a.ttlucrv=7 and to_number(nullif(to_char(now(),'yyyy'),0))-to_number(nullif(c.namsinh,0)) < 15 then 1 else 0 end) as c11,";// tong so tu vong duoi 15
                sql += "sum(case when b.loaiba=1 and a.ttlucrv=7 and to_number(nullif(to_char(now(),'yyyy'),0))-to_number(nullif(c.namsinh,0)) <5 then 1 else 0 end) as c12 ";
                sql += " FROM " + user + ".XUATVIEN a," + user + ".BENHANDT b," + user + ".BTDBN c," + user + ".ICD10 d";
                sql += " where a.MAQL = b.MAQL and a.MABN = c.MABN and a.MAICD = d.CICD10 and b.loaiba=1 and length(trim(d.stt))>0 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                // sql += " and b.loaiba<>3 ";
                sql += "group by d.stt";
                ...
                // cong them vao benh nhan co loai benh an =3
                sql = "SELECT d.STT,sum(1) as c01,";//tong so 
                sql += "sum(case when c.phai=1 then 1 else 0 end) as c02,";//trong do nu
                sql += "sum(case when ( to_number(nullif(to_char(now(),'yyyy'),0))-to_number(nullif(c.namsinh,0)) <15) then 1 else 0 end) as c03,";//tre em
                sql += "sum(case when (b.ttlucrv=7 ) then 1 else 0 end ) as c04 ";//so tu vong
                sql += " FROM xxx.BENHANPK b," + user + ".BTDBN c," + user + ".ICD10 d";
                sql += " where b.mabn= c.MABN and b.MAICD = d.CICD10 and length(trim(d.stt))>0 and " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by d.stt";
                sql += " union all ";
                // benh an ngoaitru
                sql += " SELECT d.STT,sum(1) as c01,";
                sql += "sum(case when c.phai=1 then 1 else 0 end) as c02,";//trong do nu
                sql += " sum(case when to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<15 then 1 else 0 end) as c03,";
                sql += " sum(case when a.ttlucrv=7 then 1 else 0 end) as c04";
                sql += " FROM " + user + ".benhanngtr a," + user + ".BTDBN c," + user + ".ICD10 d";
                sql += " where a.MABN = c.MABN and a.MAICD = d.CICD10 and length(trim(d.stt))>0 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += "group by d.stt";
                sql += " union all ";
                ...
                sql += " where a.MABN = c.MABN and a.MAICD = d.CICD10 and length(trim(d.stt))>0 and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += "group by d.stt";
                DataSet temp1 = m.get_data_mmyy(sql, s_tu1, s_den, false);
                if (temp1 != null)
                {
                    foreach (DataRow r in temp1.Tables[0].Rows)
                    {
                        dr = ds.Tables[0].Select("stt='" + r["stt"].ToString() + "'");
                        if (dr.Length > 0)
                        {
            ...
            {
                sql = "select a.ma,sum(a.c01) as c01,sum(a.c02) as c02,sum(a.c03) as c03,sum(a.c04) as c04,";
                sql += "sum(a.c05) as c05,sum(a.c06) as c06,sum(a.c07) as c07,sum(a.c08) as c08,sum(a.c09) as c09,sum(a.c10) as c10,sum(a.c11) as c11,sum(a.c12) as c12";
                sql += " from " + user + "." + s_table1 + " a," + user + ".dm_11 b where a.ma=b.ma ";
                sql += " and " + m.for_ngay("a.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by a.ma";
                foreach (DataRow r in m.get_data(sql).Tables[0].Rows)
                {
        ...
        public DataSet upd_ththbn_ngtru(string tu, string den, string makp, int loaiba, bool time)
        {
            ...
            if (makp == "99")
            {
                sql = "select a.makp,a.madoituong, sum(";
                //--ngay vao < tu ngay VA (denngay < ngay ra or chua ra) --> denngay - tu ngay + 1 
                sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")< to_date('" + tu + "'," + stime + ") ";
                sql += " and (to_date('" + den + "'," + stime + ")< to_date(to_char(a.ngayrv," + stime + ")," + stime + ") or a.ngayrv is null) then date_part('day',to_date('" + den + "'," + stime + ")-to_date('" + tu + "'," + stime + "))+1 else";
                //--ngay vao < tu ngay VA ngay ra <=denngay --> ngay ra -tu ngay + (chuyen khoa?0:1)
                sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")< to_date('" + tu + "'," + stime + ") ";
                sql += " and to_date(to_char(a.ngayrv," + stime + ")," + stime + ")<=to_date('" + den + "'," + stime + ") then date_part('day',to_date(to_char(a.ngayrv," + stime + ")," + stime + ")-to_date('" + tu + "'," + stime + "))+ case when a.ttlucrv in (5) then 0 else 1 end else ";
                //--ngay vao >=tu ngay VA ngay ra > denngay or chua ra --> den ngay - ngay vao + (chuyen khoa?0:1)
                sql += " case when to_date(to_char(a.ngay," + stime + ")," + stime + ")>= to_date('" + tu + "'," + stime + ") ";
                sql += " and (to_date('" + den + "','dd/mm/yyyy')< to_date(to_char(a.ngayrv," + stime + ")," + stime + ") or a.ngayrv is null) then date_part('day',to_date('" + den + "'," + stime + ")-to_date(to_char(a.ngay," + stime + ")," + stime + "))+1 else ";
                //---ngay ra >= tu and ngayra <=den ngay -->ngay ra - ngay vao + (chuyen khoa?0:1)
                sql += " case when to_date(to_char(a.ngayrv," + stime + ")," + stime + ")>= to_date('" + tu + "'," + stime + ") ";
                sql += " and to_date(to_char(a.ngayrv," + stime + ")," + stime + ")<=to_date('" + den + "'," + stime + ") then date_part('day',to_date(to_char(a.ngayrv," + stime + ")," + stime + ")-to_date(to_char(a.ngay," + stime + ")," + stime + ")) + case when a.ttlucrv in(5) then 0 else 1 end end end end end) c15";
                sql += " from xxx.benhancc a ," + user + ".btdbn b ";
                sql += " where a.mabn=b.mabn and a.makp is not null ";
                sql += " and to_date(to_char(a.ngay," + stime + ")," + stime + ") <=to_date('" + den + "'," + stime + ") and (a.ngayrv is null or to_date(to_char(a.ngayrv," + stime + ")," + stime + ") >=to_date('" + tu + "'," + stime + "))";
                sql += " group by a.makp, a.madoituong";
                dst = m.get_data_mmyy(sql, m.DateToString("dd/MM/yyyy", m.StringToDate(tu.Substring(0, 10)).AddYears(-1)), den.Substring(0, 10), false);
            }
            else
            {
            ...
            foreach (DataRow r in dst.Tables[0].Rows)
            {
                ...
                if (r1 != null)
                {
                    ...
                    {
                        r1["c18"] = decimal.Parse(r1["c18"].ToString()) + decimal.Parse(r["c15"].ToString());
                    }
                    r1["c15"] = decimal.Parse(r1["c15"].ToString()) + decimal.Parse(r["c15"].ToString());
                    r1["c16"] = decimal.Parse(r1["c16"].ToString()) + decimal.Parse(r["c15"].ToString());
                }
            ...
            //    }
            //}
            #region bi thua - da lay o tren truong hop chua ra roi
            //if (makp == "99")
            //{
            //    if (time)
            //    {
        ...
        public DataSet kh_bieu_145(string s_tu, string s_tu1, string s_den, string s_table, bool benhan, bool thongke, bool phatsinh)
        {
            ...
            {
                //Noi tru
                sql = "SELECT coalesce(e.stt,9) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>19 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=60 then 1 else 0 end) as c13,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>19 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=60  and a.ttlucrv=7 then 1 else 0 end) as c14,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>19 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=60 then 1 else 0 end) as c15,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>19 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=60  and a.ttlucrv=7 then 1 else 0 end) as c16,";
                ...
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".BTDNN_BV d on c.mann=d.mann left join " + user + ".BTDNN e on d.mannbo=e.mann ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(e.stt,9)";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhanngtr a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".BTDNN_BV d on c.mann=d.mann left join " + user + ".BTDNN e on d.mannbo=e.mann ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(e.stt,9)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //if (tmp == null) tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //else tmp.Merge(m.get_data_mmyy(sql, s_tu1, s_den, false));
                upd_data(tmp);
                //phong kham
                sql = "SELECT coalesce(e.stt,9) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANPK a on b.maql=a.maql left join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".BTDNN_BV d on c.mann=d.mann left join " + user + ".BTDNN e on d.mannbo=e.mann ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(e.stt,9)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANCC a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".BTDNN_BV d on c.mann=d.mann left join " + user + ".BTDNN e on d.mannbo=e.mann ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(e.stt,9)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                upd_data(tmp);
                //dia diem: noi tru
                sql = "SELECT coalesce(d.stt,17) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c05, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c07, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c08,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>4 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=14 then 1 else 0 end) as c09,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMDIADIEM d on b.diadiem=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,17)";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".BENHANNGTR a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMDIADIEM d on b.diadiem=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,17)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANPK a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMDIADIEM d on b.diadiem=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,17)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANCC a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMDIADIEM d on b.diadiem=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,17)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                //bo phan: noi tru
                sql = "SELECT case when d.stt=0 or d.stt is null then 22 else d.stt end as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c05, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c07, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c08,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>4 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=14 then 1 else 0 end) as c09,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMbophan d on b.bophan=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by case when d.stt=0 or d.stt is null then 22 else d.stt end";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //if (tmp == null) tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //else tmp.Merge(m.get_data_mmyy(sql, s_tu1, s_den, false));
                upd_data(tmp);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".BENHANNGTR a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMbophan d on b.bophan=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by case when d.stt=0 or d.stt is null then 22 else d.stt end";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANPK a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMbophan d on b.bophan=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by case when d.stt=0 or d.stt is null then 22 else d.stt end";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.BENHANCC a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMbophan d on b.bophan=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by case when d.stt=0 or d.stt is null then 22 else d.stt end";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                //nguyen nhan: noi tru
                sql = "SELECT coalesce(d.stt,39) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c05, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c07, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c08,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>4 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=14 then 1 else 0 end) as c09,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMnguyennhan d on b.nguyennhan=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,39)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //if (tmp == null) tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //else tmp.Merge(m.get_data_mmyy(sql, s_tu1, s_den, false));
                upd_data(tmp);
                //nguyen nhan: ngoai tru
                sql = "SELECT coalesce(d.stt,39) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c05, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c07, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c08,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhanngtr a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMnguyennhan d on b.nguyennhan=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,39)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.benhanpk a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMnguyennhan d on b.nguyennhan=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,39)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.benhancc a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".DMnguyennhan d on b.nguyennhan=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,39)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn inner join " + user + ".DMngodoc d on b.ngodoc=d.ma ";
                sql += " where ";
                ...
                //xu tri: noi tru
                sql = "SELECT coalesce(d.stt,48) as stt,sum(to_number(case when c.phai=0 then 1 else 0 end)) as c01, sum(case when c.phai=0 and a.ttlucrv=7 then 1 else 0 end) as c02,";
                sql += "sum(to_number(case when c.phai=1 then 1 else 0 end)) as c03, sum(case when c.phai=1 and a.ttlucrv=7 then 1 else 0 end) as c04,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c05, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c06,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 then 1 else 0 end) as c07, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=4 and a.ttlucrv=7 then 1 else 0 end) as c08,";
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>4 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)<=14 then 1 else 0 end) as c09,";
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhandt dt on b.maql=dt.maql and dt.loaiba=1 left join " + user + ".XUATVIEN a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".dmxutri d on b.xutri=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,48)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //if (tmp == null) tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                //else tmp.Merge(m.get_data_mmyy(sql, s_tu1, s_den, false));
                upd_data(tmp);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join " + user + ".benhanngtr a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".dmxutri d on b.xutri=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,48)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.benhanpk a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".dmxutri d on b.xutri=d.ma ";
                sql += " where ";
                sql += " " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,48)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                sql += "sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c17, sum(case when c.phai=0 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c18,";
                sql += "sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 then 1 else 0 end) as c19, sum(case when c.phai=1 and to_number(to_char(now(),'yyyy'))-to_number(c.namsinh)>60 and a.ttlucrv=7 then 1 else 0 end) as c20";
                sql += " FROM xxx.TAINANTT b inner join xxx.benhancc a on b.maql=a.maql inner join " + user + ".BTDBN c on b.mabn=c.mabn left join " + user + ".dmxutri d on b.xutri=d.ma ";
                sql += " where ";
                sql += "  " + m.for_ngay("b.ngay", "'dd/mm/yyyy'") + " between to_date('" + s_tu1 + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
                sql += " group by coalesce(d.stt,48)";
                tmp = m.get_data_mmyy(sql, s_tu1, s_den, false);
                ...
                //tmp = m.get_sum(tmp, new string[] { "stt" }, new string[] { "c01", "c02", "c03", "c04", "c05", "c06", "c07", "c08", "c09", "c10", "c11", "c12", "c13", "c14", "c15", "c16", "c17", "c18", "c19", "c20", });
                upd_data(tmp);
            ...
            if (thongke)
            {
                ...
                foreach (DataRow r in m.get_data(sql).Tables[0].Rows)
                {
                    dr = tmp.Tables[0].Select("ma=" + int.Parse(r["ma"].ToString()));
                    if (dr.Length > 0)
                    {
                        dr[0]["c01"] = decimal.Parse(dr[0]["c01"].ToString()) + decimal.Parse(r["c01"].ToString());
                        dr[0]["c02"] = decimal.Parse(dr[0]["c02"].ToString()) + decimal.Parse(r["c02"].ToString());
            ...
            if (phatsinh) m.delrec(tmp.Tables[0], "c01+c02+c03+c04+c05+c06+c07+c08+c09+c10+c11+c12+c13+c14+c15+c16+c17+c18+c19+c20+c21+c22+c23+c24=0");
            tmp.AcceptChanges();
            return tmp;
        }
