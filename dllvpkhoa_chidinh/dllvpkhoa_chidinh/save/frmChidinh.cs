...
namespace dllvpkhoa_chidinh
{
	public class frmChidinh : System.Windows.Forms.Form
    {
        ...
        string s_manoidkkcb = "", s_mabv = "", s_tuoivao = "";
        ...
        private string nam, user, s_mabn, s_hoten, s_tuoi, s_ngay, tmp_ngay, s_makp, s_tenkp, sql, s_dvt, s_table, s_loaivp = "", s_mucvp = "", s_mabs, s_chandoan, s_maicd, s_chenhlech, s_gioitinh = "";
        ...
        ToolStripMenuItem chkmadt_def = new System.Windows.Forms.ToolStripMenuItem();
        ...
        public frmChidinh(LibMedi.AccessData acc,string mabn,string hoten,string tuoi,string ngay,string makp,string tenkp,int madoituong,int loai,long mavaovien,long maql,long idkhoa,int userid,string table,string thebhyt,string _nam,int loaiba,string _mabs,string _chandoan,string _maicd, int traituyen)
		{
			//
        ...
        //--linh
        public frmChidinh(LibMedi.AccessData acc, string mabn, string hoten, string tuoi, string ngay, string makp, string tenkp, int madoituong, int loai, long mavaovien, long maql, long idkhoa, int userid, string table, string thebhyt, string _nam, string loaiba, string _mabs, string _chandoan, bool badmin, int traituyen)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
		...
		private void InitializeComponent()
		{
            ...
            this.chkmadt_def = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.dataGrid1.Size = new System.Drawing.Size(622, 337);
            ...
            this.ghichu.Size = new System.Drawing.Size(783, 21);
            ...
            this.butGiaycamdoanCT.Size = new System.Drawing.Size(266, 22);
            ...
            this.butPhieukhambenhchupCT.Size = new System.Drawing.Size(266, 22);
            ...
            this.butGiayhoichan.Size = new System.Drawing.Size(266, 22);
            ...
            this.butInct.Size = new System.Drawing.Size(266, 22);
            ...
            this.chkXem.Size = new System.Drawing.Size(266, 22);
            ...
            this.chkXML.Size = new System.Drawing.Size(266, 22);
            ...
            this.chkIntheodot.Size = new System.Drawing.Size(266, 22);
            this.chkIntheodot.Text = "In cả đợt";
            this.chkIntheodot.Click += new System.EventHandler(this.chkIntheodot_Click);
            // 
            // chkmadt_def
            // 
            this.chkmadt_def.CheckOnClick = true;
            this.chkmadt_def.Name = "chkmadt_def";
            this.chkmadt_def.Size = new System.Drawing.Size(266, 22);
            this.chkmadt_def.Text = "Đối tượng khi vào";
            this.chkmadt_def.Click += new System.EventHandler(this.chkmadt_def_CheckedChanged);
            // 
            // chkTudongchonthongso
            // 
            this.chkTudongchonthongso.Name = "chkTudongchonthongso";
            this.chkTudongchonthongso.Size = new System.Drawing.Size(266, 22);
            ...
            this.tmn_hienthi_phuthu.Size = new System.Drawing.Size(266, 22);
        ...
        private void frmChidinh_Load(object sender, System.EventArgs e)
        {
            ...
            if (bChenhlechPK_chitinh_vaongaynghi) bChenhlechPK_chitinh_vaongaynghi = i_loaiba != 1 && i_loaiba != 4 && m.bNgaynghi(s_ngay);
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (tmp.Rows.Count > 0)
                {
                    ...
                    {
                        DataTable tmp_cl = m.getChidinh_chenhlech_dathanhtoan(s_ngay, long.Parse(tmp.Rows[0]["maql"].ToString()), int.Parse(tmp.Rows[0]["mavp"].ToString()));
        ...
        void save()
        {
            ...
            if (dr.Length > 0)
            {
                ...
                foreach (DataRow r1 in v.get_data(sql).Tables[0].Rows)
                {
                    ...
                    upd_data(int.Parse(r1["id_gia"].ToString()), decimal.Parse(r1["soluong"].ToString()), (int.Parse(r1["madoituong"].ToString()) == 0) ? _madt : int.Parse(r1["madoituong"].ToString()), 0, int.Parse(r1["id"].ToString()));//thay st bang 0: vi khai bao trong goi, gia phai tinh lai chi tiet tung mon
            ...
            else
            {
                ...
                int i_hoichan = int.Parse(rvp["hoichan"].ToString());
                int ixamlan = int.Parse(rvp["xamlan"].ToString());
                ...
                if (f_Kiemtra_ThemVienphi(int.Parse(mavp.Text.Trim())))//, s_giongay))//s_tghen
                {
                    if (ixamlan == 1)
                    {
                        MessageBox.Show(lan.Change_language_MessageText("Kỹ thuật này bắt buộc mở hồ sơ ngoại trú") + ".", "Medisoft 2007");//==> chuyển sang form khám bệnh xử lý, tại button chỉ định cận lâm sàng
                    ...
                    else
                    {
                        ...
                        i_trangthai = 0;
                        if (i_guimau == 1 || i_guinguoi == 1 || i_chuyenchungtu==1)//BINH 270711
                        {
        ...
        */
        private bool f_Kiemtra_ThemVienphi(int i_mavp)//, string s_gn)// string s_hen,//end linh
        {
                ...
                foreach (DataRow dr in m.get_data_mmyy(s_sql, s_ngay.Substring(0, 10), s_ngay.Substring(0, 10), true).Tables[0].Rows)
                {
                    ...
                    if (s_mavpxungdot.IndexOf(i_mavpxd.ToString() + ",") > -1)
                    {
                        DialogResult dl = MessageBox.Show(lan.Change_language_MessageText("Kỹ thuật này xung đột với") + " " + s_tenvpxungdot + "\n" +
                            "Bạn có muốn nhập thêm không?", " Medisoft 2007", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
            ...
            if (rvp != null)
            {
                ...
                if (s_gtvp.IndexOf(s_gioitinh) == -1 && s_gtvp != "")
                {
                    if(MessageBox.Show(lan.Change_language_MessageText("Giới tính không hợp lệ so với danh mục giá viện phí đã khai báo")+".\n"+
                        lan.Change_language_MessageText("Bạn có muốn nhập dịch vụ này không")+"?", "Medisoft 2007", 
            ...
            if (s_idvienphi_icd10 != "")
            {
                ...
                {
                    DialogResult dl = MessageBox.Show(lan.Change_language_MessageText("Chỉ định không phù hợp với chẩn đoán của ICD10. Bạn có đồng ý cho không? "), " Medisoft 2007", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);
                    if (dl == DialogResult.No)
                    {
                        ten.Focus();
                        return false;
       ...
       */
        ...
        private bool f_Kiemtrabatbuocthutien(string stendatabse,int ibatbuoctt)
        {
            ...
            if (ibatbuoctt == 1)
            {
                ...
                {
                    if (!m.upd_tiepdon_client(dr2["mabn"].ToString(), long.Parse(dr2["mavaovien"].ToString()), long.Parse(dr2["maql"].ToString()), dr2["makp"].ToString(), dr2["ngay"].ToString(), int.Parse(dr2["madoituong"].ToString()), dr2["sovaovien"].ToString(), dr2["tuoivao"].ToString(), dr2["done"].ToString(), int.Parse(dr2["bnmoi"].ToString()), int.Parse(dr2["noitiepdon"].ToString()), int.Parse(dr2["loai"].ToString()), i_userid, long.Parse(dr2["idchidinh"].ToString()), stendatabse))
                        return false;
                }
                ...
                {
                    if (!m.upd_benhanpk_client(dr3["mabn"].ToString(), long.Parse(dr3["mavaovien"].ToString()), long.Parse(dr3["maql"].ToString()), dr3["makp"].ToString(), dr3["ngay"].ToString(), int.Parse(dr3["dentu"].ToString()), int.Parse(dr3["nhantu"].ToString()), int.Parse(dr3["madoituong"].ToString()), dr3["chandoan"].ToString(), dr3["maicd"].ToString(), int.Parse(dr3["ttlucrv"].ToString()), dr3["mabs"].ToString(), dr3["sovaovien"].ToString(), int.Parse(dr3["bienchung"].ToString()), int.Parse(dr3["taibien"].ToString()), int.Parse(dr3["giaiphau"].ToString()), long.Parse(dr3["mangtr"].ToString()), i_userid, stendatabse))
                        return false;
                }
            }
            return true;
        ...
        */
        ...
        private void upd_data(int i_mavp, decimal d_soluong, int i_madt, decimal dongia, int idtrongoi)
        {
            ...
            string xxx = m.user + m.mmyy(s_ngay);
            bool b_chenhlechngaynghi = bChenhlechPK_chitinh_vaongaynghi;
            sql = " select to_char(a.ngay,'dd/mm/yyyy') as ngay,b.ten from xxx.v_chidinh a," + user + ".v_giavp b ";
            sql += " inner join " + user + ".v_loaivp c on b.id_loai=c.id ";
            sql += " where a.mavp=b.id and a.mavaovien=" + l_mavaovien + " and mabn='" + mabn.Text + "' and a.mavp=" + i_mavp + " and a.id<>" + l_id + " and a.madoituong=" + i_madt + " and c.id_nhom in(1,2,5)";
            ...
            if (r != null)
            {
                ...
                if (r["giaycamdoan"].ToString() == "1")
                {
                    MessageBox.Show(lan.Change_language_MessageText("Kỹ thuật") + ": " + r["ten"].ToString() + " " + 
                        lan.Change_language_MessageText("cần in giấy cam đoan cho bệnh nhân."), "Medisoft 2007");
                ...
                {
                    MessageBox.Show(lan.Change_language_MessageText("Kỹ thuật") + ": " + r["ten"].ToString() + " " + 
                        lan.Change_language_MessageText("cần in phiếu khám bệnh chụp CT Scanner có cản quang."), "Medisoft 2007");
                    in_phieukbctscanner(i_mavp);
                }
                if (r["hoichan"].ToString() == "1")
                {
                    MessageBox.Show(lan.Change_language_MessageText("Kỹ thuật") + ": " + r["ten"].ToString() + " " + 
                        lan.Change_language_MessageText("cần in biên bản hội chẩn chụp CT Scanner."), "Medisoft 2007");
                ...
                //    {
                //        long l_idtmp = long.Parse(ddr1["id"].ToString());
        ...
        private void upd_detail(bool chenhlech, int i_mavp, decimal d_soluong, decimal dongia, int idtrongoi, bool _bCheckgiaphuthu)
        {
            ...
            {   
                ...
                /// bCheckgiaphuthu
                /// i_doituonggiatheotg
                if (i_madoituongvao == 1 && i_kythuat == 0)
                {
                    if (dtdenngay > dtngayhuongktc)
                    {
                        DialogResult dl = MessageBox.Show(lan.Change_language_MessageText("Ngày hưởng KTC đang nhỏ hơn hơn ngày được hưởng. Nếu đồng ý thì đối tượng bệnh nhân lấy đối đượng khi vào viện."), "Medisoft 2007", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2);
                        if (dl == DialogResult.Yes)
                        {
                            if (!v.upd_chidinh(l_id, s_mabn, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, s_makp, int.Parse(madoituong.SelectedValue.ToString()), i_mavp, d_soluong, (dongia != 0) ? dongia : d_dongia, (dongia != 0) ? 0 : d_vattu, i_userid, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), l_idchidinh, (s_maicd == "" && chandoan.Text != "") ? "U00" : s_maicd, chandoan.Text, mabs.Text, i_loaiba, ghichu.Text))
                            {
                                ...
                                if (databaselink != "")
                                {
                                    if (m.get_data("select mmyy from " + user + ".table" + databaselink + " where mmyy='" + _mmyy + "'").Tables[0].Rows.Count > 0)
                                    {
                                        ...
                                        if (m.upd_btdbn(s_mabn, hoten.Text, s_ngaysinh, s_namsinh, i_phai, s_mann, s_madantoc, "", s_diachi, s_cholam, s_matt, s_maquan, s_mapxa, i_userid, s_chuyendi, ""))
                                        {
                                            ...
                                            v.upd_chidinh(l_id, s_mabn, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, s_makp, i_madoituong, i_mavp, d_soluong, d_dongia, 0, i_userid, -1, -1, l_idchidinh, s_maicd, chandoan.Text, s_mabs, i_loaiba, "Chi nhánh " + s_tenchinhanh + " chuyển đến", s_chuyendi);
                                            databaselink = databaselink == "" ? "" : "@" + databaselink;
                                            v.DatabseLinkName = "";
                                        }
                                    }
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (tmp.Rows.Count > 0)
                {
                    ...
                    if (tmp.Rows[0]["paid"].ToString() == "1" || tmp.Rows[0]["done"].ToString() == "1")//(dataGrid1[i_row,12].ToString()=="1" || dataGrid1[i_row,13].ToString()=="1")
                    {
                        ...
                        else
                        {
                            ...
                            {
                                MessageBox.Show(lan.Change_language_MessageText("Dịch vụ đã đượvc BHYT duyệt chi phí, không được hủy !"), LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                return;
                                //DialogResult dlg = MessageBox.Show(lan.Change_language_MessageText("Dịch vụ đã đượvc BHYT duyệt chi phí, Bạn có muốn hủy không !"), LibMedi.AccessData.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
				...
				if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy '"+s_tendv+"' ?"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
				{
                    ...
                    //
                    DataTable tmp1 = m.get_data("select * from " + user + m.mmyy(s_ngay) + ".v_chidinh where id in(" + l_id + ",-" + l_id + ")").Tables[0];
                    m.execute_data("delete from " + user + m.mmyy(s_ngay) + ".v_chidinh where id in(" + l_id + ",-" + l_id + ")");
                    if (tmp.Rows.Count > 0)
                    {
                        if (m.get_data("select id from " + user + ".v_giavp where chenhlech=1 and id=" + long.Parse(tmp1.Rows[0]["mavp"].ToString())).Tables[0].Rows.Count>0)
                        {
                            ...
                            sql += " and userid=" + long.Parse(tmp1.Rows[0]["userid"].ToString());
		...
		private void load_treeView()
		{
            ...
            //if (l_idkhoa==0)
            //{
				sql="select distinct a.ngay,a.maql,0 as idkhoa from "+s_table+" a,xxx.v_chidinh b where a.maql=b.maql";
				sql+=" and a.mabn='"+s_mabn+"'";
        ...
        private void btchuyen_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow r1 in ds.Tables[0].Select("chon=true"))
            {
                lidchidinh = long.Parse(r1["id"].ToString());
        ...
        void in_phieukbctscanner(int i_mavp)
        {
            ...
            if (s_idchidinh != "")
            {
                ...
                if (dstmp.Tables[0].Rows.Count > 0)
                {
                    dllvpkhoa_chidinh.frmKhambenhchupctcocq f = new dllvpkhoa_chidinh.frmKhambenhchupctcocq(m, s_mabn, l_mavaovien, l_maql, s_ngay, dstmp, s_maicd10, i_userid);
                    f.ShowInTaskbar = false;
                    f.ShowDialog();
                }
            }
        ...
        void in_bienbanhoichanctscanner(int i_mavp)
        {
            ...
            if (s_idchidinh != "")
            {
                ...
                if (dstmp.Tables[0].Rows.Count > 0)
                {
                    dllvpkhoa_chidinh.frmBienbanhoichancls f = new dllvpkhoa_chidinh.frmBienbanhoichancls(m, s_mabn, l_mavaovien, l_maql, s_ngay, dstmp, i_userid);
                    f.ShowInTaskbar = false;
                    f.ShowDialog();
                }
            }
        ...
        private void butGoi_Click(object sender, EventArgs e)
        {
            if (m.Thongso(chkTudongchonthongso.Name) == "1")
            {
                ...
                try
                {
                    l_duyet1 = long.Parse(d.get_data("select id from " + m.user + m.mmyy(s_ngay) + ".d_duyet where phieu=" + dtPhieu.Rows[0]["id"].ToString() + " and to_char(ngay,'dd/mm/yyyy')='" + s_ngay.Substring(0, 10) + "' and makp=" + drttKho["id"].ToString() + " and loai=2").Tables[0].Rows[0][0].ToString());
                }
                catch { l_duyet1 = 0; }
