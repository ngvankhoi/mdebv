...
namespace dllvpkhoa_chidinh
{
	...
	public class frmChonthongsovp : System.Windows.Forms.Form
	{
		...
		private string sql;
		public int i_buoi, i_khudt=0, i_chinhanh=0;
		...
		public frmChonthongsovp(LibMedi.AccessData acc,string makp, int _khudt)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butOk.Location = new System.Drawing.Point(75, 74);
            ...
            this.butCancel.Location = new System.Drawing.Point(146, 74);
            ...
            this.buoi.Location = new System.Drawing.Point(221, 12);
            this.buoi.Name = "buoi";
		...
		private void frmChonthongsovp_Load(object sender, System.EventArgs e)
		{
			...
			sql="select * from "+m.user+".btdkp_bv where 1=1 ";
            if (s_makp != "")
            {
