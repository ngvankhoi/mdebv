...
namespace dllvpkhoa_chidinh
{
	...
	public class frmVpkhoa : System.Windows.Forms.Form
	{
		...
		//
		private decimal o_id=0;//binh: de giu lai IDkhoa cua BN, khi kich nut bo qua thi lay lai ngay BN do
        private string s_masobenhanhan = "";
        ...
        private string s_ngay, s_makp, s_tenkp, sql, s_dvt, s_loaivp, s_mucvp, s_title, user, nam, s_ngayvao, xxx, s_denngay, s_chenhlech = "", i_nhomvp_pttt="";
        private int i_madoituong, i_tong = -1, i_done, i_paid, i_row = 0, i_userid, i_vienphi, i_buoi, v1, v2, i_traituyen=0;
        ...
        private bool bNew, bNhapten, bMadoituong, bTTngay, bHansd_thuoc, bChidinh_thutienlien, bChenhlech_doituong, bNhapPTTT_chidinh_vpkhoa_miengiam,bChidinh_lietke_kemgia=true, bAdminHethong=false;
        ...
        public frmVpkhoa(LibMedi.AccessData acc, string ngay, string makp, string tenkp, int userid, int buoi, string mabn)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		private void InitializeComponent()
		{
            ...
            this.dataGrid1.Size = new System.Drawing.Size(648, 379);
            ...
            this.list.Location = new System.Drawing.Point(557, 463);
            ...
            this.madoituong.Location = new System.Drawing.Point(64, 398);
            ...
            this.ten.Location = new System.Drawing.Point(268, 398);
            this.ten.Name = "ten";
            ...
            // label6
            // 
            this.label6.Location = new System.Drawing.Point(554, 398);
            ...
            this.soluong.Location = new System.Drawing.Point(618, 398);
            ...
            this.butLietke.Location = new System.Drawing.Point(138, 454);
            ...
            this.butMoi.Location = new System.Drawing.Point(208, 454);
            ...
            this.butSua.Location = new System.Drawing.Point(348, 454);
            ...
            this.butLuu.Location = new System.Drawing.Point(418, 454);
            ...
            this.butBoqua.Location = new System.Drawing.Point(488, 454);
            ...
            this.butHuy.Location = new System.Drawing.Point(558, 454);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(628, 454);
            ...
            this.listHoten.Location = new System.Drawing.Point(707, 498);
            ...
            this.butThem.Location = new System.Drawing.Point(278, 454);
            ...
            this.dongia.Location = new System.Drawing.Point(712, 398);
            ...
            this.ma.Location = new System.Drawing.Point(210, 398);
            this.ma.Name = "ma";
            ...
            this.tim.Location = new System.Drawing.Point(658, 373);
            this.tim.Name = "tim";
            ...
            this.chkmadt_def.Location = new System.Drawing.Point(668, 421);
            ...
            this.pic.Location = new System.Drawing.Point(659, 299);
            this.pic.Name = "pic";
            ...
            this.stgiam.Location = new System.Drawing.Point(210, 420);
            ...
            this.tylegiam.Location = new System.Drawing.Point(64, 420);
            ...
            this.lydogiam.Location = new System.Drawing.Point(372, 420);
            ...
            // label16
            // 
            this.label16.Location = new System.Drawing.Point(300, 420);
            ...
            // label11
            // 
            this.label11.Location = new System.Drawing.Point(101, 420);
            ...
            this.butCholai.Location = new System.Drawing.Point(686, 347);
            this.butCholai.Name = "butCholai";
            this.butCholai.Size = new System.Drawing.Size(77, 25);
            this.butCholai.TabIndex = 286;
		...
		private void frmVpkhoa_Load(object sender, System.EventArgs e)
		{
            ...
            if (!pic.Visible) this.treeView1.Size = new System.Drawing.Size(129, 290);
            ...
            //
            sql = "select a.mabn,b.hoten,a.id,c.mavaovien,a.maql,c.madoituong,d.sothe as sothe,b.nam,to_char(c.ngay,'dd/mm/yyyy') as ngay,coalesce(to_char(d.ngaygiahan,'dd/mm/yyyy'),to_char(d.denngay,'dd/mm/yyyy')) as denngay, d.traituyen ";//Thuy 04.01.2012
            ...
            //sql = "select a.id,"+s_ten+" as ten,a.ma,a.dvt,a.gia_th,a.gia_bh,a.gia_dv,a.gia_nn,a.bhyt,a.vattu_th,a.vattu_bh,a.vattu_dv,a.vattu_nn,a.locthe,a.trongoi,a.gia_cs,a.vattu_cs, b.id_nhom, a.chenhlech, a.bhyt_tt , a.sothe,a.batbuocthutien,a.coso,a.cosothay,a.phongthuchiencls,a.hoichan,a.giaycamdoan,a.tgtrakq,a.gioitinh,a.tutuoi,a.dentuoi ";
            ...
            dt = m.get_dmvp(s_ngay, s_loaivp, s_mucvp, v.iNgoaitru, b_ApDungQuanLyGiaVienPhiTheoThongTuLienTich15042012, false).Tables[0];
		...
		{//linh
            if (s_makp == "99")
            {
                sql = "select distinct a.mabn,b.hoten,a.mavaovien,a.maql,a.idkhoa,to_char(c.ngay,'dd/mm/yyyy') as ngayvao from " + xxx + ".v_vpkhoa a," + user + ".btdbn b," + xxx + ".benhancc c " +
                " where a.mabn=b.mabn and a.maql=c.maql and a.makp='" + s_makp + "' and to_char(a.ngay,'dd/mm/yyyy')='" + s_ngay + "' and a.buoi=" + i_buoi;
            }
            else
            {
                sql = "select distinct a.mabn,b.hoten,a.mavaovien,a.maql,a.idkhoa,to_char(c.ngay,'dd/mm/yyyy') as ngayvao from " + xxx + ".v_vpkhoa a," + user + ".btdbn b," + user + ".benhandt c " +
                    " where a.mabn=b.mabn and a.maql=c.maql and a.makp='" + s_makp + "' and to_char(a.ngay,'dd/mm/yyyy')='" + s_ngay + "' and a.buoi=" + i_buoi;
            }
			dtll=m.get_data(sql).Tables[0];
			cmbMabn.DataSource=dtll;
            if (s_masobenhanhan != "" && dtll.Rows.Count>0)
            {
                DataRow r=m.getrowbyid(dtll,"mabn='"+s_masobenhanhan+"'");
                if(r!=null)
                {
                    cmbMabn.SelectedValue=r["idkhoa"].ToString();
                    cmbMabn.Update();                   
                }
            }
            if (cmbMabn.Items.Count > 0)
            {
                ...
                s_ngayvao = dtll.Select("idkhoa='" + l_idkhoa.ToString() + "'")[0]["ngayvao"].ToString();
                ...
                {
                    dt = m.get_dmvp(s_ngay, s_loaivp, s_mucvp, v.iNgoaitru).Tables[0];
                }
            }
            else l_idkhoa = 0;
		}
		...
		private void load_grid()
		{
            ...
            sql += ", a.tylegiam, a.stgiam, a.lydogiam,e.hoten as user ";
            sql += " from " + xxx + ".v_vpkhoa a," + user + ".v_giavp b," + user + ".doituong c," + user + ".btdkp_bv d,"+user+".dlogin e ";
		...
		private void ref_text()
		{
			...
			{							
				...
				if (r!=null)
				{
                    ...
                    if (r["maql"].ToString().Trim() != "") l_maql = decimal.Parse(r["maql"].ToString());
                    if (r["idkhoa"].ToString().Trim() != "") l_idkhoa = decimal.Parse(r["idkhoa"].ToString());
		...
		private void ena_object(bool ena)
		{
            ...
            butCholai.Enabled = ena;//gam 28/11/2011
			butLuu.Enabled=ena;
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
            ...
            madoituong.Update();
            //
            if (s_masobenhanhan != "" && cmbMabn.Items.Count>0)
            {
                DataRow r=m.getrowbyid(dtll,"mabn='"+s_masobenhanhan+"'");
                if(r!=null)
                {
		...
		{
			if (!kiemtra()) return;
            if (ten.Text != "" && mavp.Text != "" && l_id >= 0)
			{
                int tmp_madt = int.Parse(madoituong.SelectedValue.ToString());
                bool bFound = false;
            ...
            if (r != null)
            {
                ...
                else
                {
                    ...
                    foreach (DataRow r1 in v.get_data("select * from " + xxx + ".v_vpkhoa where id=" + l_id).Tables[0].Rows)
                        d.upd_theodoicongno(d.delete, r1["mabn"].ToString(), decimal.Parse(r1["mavaovien"].ToString()), decimal.Parse(r1["maql"].ToString()), decimal.Parse(r1["idkhoa"].ToString()), int.Parse(r1["madoituong"].ToString()), decimal.Parse(r1["soluong"].ToString()) * (decimal.Parse(r1["dongia"].ToString()) + decimal.Parse(r1["vattu"].ToString())), "vienphi");
                }
        ...
        private void upd_data(int i_mavp, decimal sl, int i_madt)
        {
            bool bCont = true;
            string fie = "gia_bh";
            int s_doituong_chenhlech = (i_madt == i_tunguyen || i_madt == i_madoituong ) ? i_madoituong  : i_madt;//binh 050109
            ...
            int tmp_madt = i_madt;
            decimal d_tyle_traituyen = 1, d_dongia_goc=0;
            //
            r = m.getrowbyid(dt, "id=" + i_mavp);
            if (r != null)
            {
                ...
                //
                string gia = m.field_gia(i_madt.ToString());
                string giavt = "vattu_" + gia.Substring(4).Trim();
                decimal tygia = (gia.IndexOf("_nn") != -1) ? m.dTygia : 1;
                d_dongia_goc = decimal.Parse(r[gia].ToString());
                ...
                m.updrec_chidinh(ds.Tables[0], l_id, s_ngay, s_makp, s_tenkp, int.Parse(madoituong.SelectedValue.ToString()), madoituong.Text, i_mavp, r["ten"].ToString(), r["dvt"].ToString(), sl, d_dongia, d_vattu, i_paid, i_done, 0, 0, "", (tylegiam.Text.Trim() == "" ? 0 : decimal.Parse(tylegiam.Text)), (stgiam.Text.Trim() == "" ? 0 : decimal.Parse(stgiam.Text)), lydogiam.Text);
                //
                bCont = bCont && s_chenhlech.IndexOf((bChenhlech_doituong ? i_madoituong.ToString() : i_madt.ToString().Trim()) + ",") != -1
                ...
                if (i_madoituong == 1) bCont = bCont && (decimal.Parse(r["bhyt"].ToString()) > 0);
                //
                if (bCont)
                {
                    m.execute_data("update " + xxx + ".v_vpkhoa set dachenhlech=1 where id=" + l_id + " and mavp=" + i_mavp);
                    l_id = -l_id;
                    i_madt = i_tunguyen;
                    madoituong.SelectedValue = i_madt;
                    madoituong.Update();
                    //
                    gia = m.field_gia(i_madt.ToString());
                    giavt = "vattu_" + gia.Substring(4).Trim();
                    tygia = (gia.IndexOf("_nn") != -1) ? m.dTygia : 1;
                    //
                    d_dongia = decimal.Parse(r[gia].ToString()) * tygia - d_dongia;//
                    //
                    //if (decimal.Parse(r[gia].ToString()) > d_dongia_goc)
                    //    d_dongia = decimal.Parse(r[gia].ToString()) * tygia - d_dongia;//
                    //else
                    //    d_dongia = d_dongia_goc * tygia * (1 - d_tyle_traituyen);//
                    
                    d_vattu = decimal.Parse(r[giavt].ToString()) * tygia - d_vattu;
                    ...
                    v.upd_vpkhoa(l_id, mabn.Text, l_mavaovien, l_maql, l_idkhoa, s_ngay, s_makp, i_madt, i_mavp, sl, d_dongia, d_vattu, i_userid, i_buoi);
                    m.execute_data("update " + xxx + ".v_vpkhoa set tylegiam=" + (tylegiam.Text.Trim() == "" ? 0 : decimal.Parse(tylegiam.Text)) + ", stgiam=" + (stgiam.Text.Trim() == "" ? 0 : decimal.Parse(stgiam.Text)) + ", lydogiam='" + lydogiam.Text + "' where id=" + l_id);
                    d.upd_theodoicongno(d.insert, mabn.Text, l_mavaovien, l_maql, l_idkhoa, int.Parse(madoituong.SelectedValue.ToString()), sl * (d_dongia + d_vattu), "vienphi");
                    m.updrec_chidinh(ds.Tables[0], l_id, s_ngay, s_makp, s_tenkp, int.Parse(madoituong.SelectedValue.ToString()), madoituong.Text, i_mavp, r["ten"].ToString(), r["dvt"].ToString(), sl, d_dongia, d_vattu, i_paid, i_done, 0, 0, "", (tylegiam.Text.Trim() == "" ? 0 : decimal.Parse(tylegiam.Text)), (stgiam.Text.Trim() == "" ? 0 : decimal.Parse(stgiam.Text)), lydogiam.Text);
                    m.execute_data("update " + xxx + ".v_vpkhoa set dachenhlech=1 where id=" + l_id + " and mavp=" + i_mavp);
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (!bAdminHethong && m.bRavien(l_maql))
				{
					MessageBox.Show(lan.Change_language_MessageText("Người bệnh đã ra viện !"),LibMedi.AccessData.Msg);
                    try
                    {
				...
				{
                    string mmyy = d.mmyy(s_ngay);
                    int itable = m.tableid(mmyy, "v_vpkhoa");
                    ...
                    //                    
                    //                    
                    string s_field = d.f_get_select_field_mmyy(mmyy, "v_vpkhoa", "");
                    if (s_field != "")
                    {
                        sql = "insert into " + xxx + ".v_vpkhoa_huy select " + s_field + " from " + xxx + ".v_vpkhoa where id in(" + l_id + ",-" + l_id + ")";
                        m.execute_data(sql);
                    }
                    //
                    //
		...
		private void butLietke_Click(object sender, System.EventArgs e)
		{
            ...
            int tmp_madt = i_madoituong;
            int itable = m.tableid(d.mmyy(s_ngay), "v_vpkhoa");
            frmChonchidinh f = new frmChonchidinh(m, mabn.Text, i_madoituong, s_loaivp, s_mucvp, v.iNoitru, sothe.Text, v1, v2, true, l_mavaovien);
			f.ShowDialog(this);
			if (f.dt.Rows.Count>0)
			{
                // gam 18-04-2011
                //string s_mavp = "";
                //foreach (DataRow r_ct in f.dt.Rows)
                //{
                //    s_makp += r_ct["mavp"].ToString() +",";
                //}
                //s_mavp = s_mavp.Substring(0,s_mavp.Length-1);
                bool bFound = false;
                //madoituong.SelectedValue = i_madoituong.ToString(); l_id = 0;
                //if (!bLocdichvu && madoituong.SelectedValue.ToString() == "1")
                //{
                //    sql = "id in (" + s_mavp + ") and bhyt<>0";
                //    if (sothe.Text.Trim().Length > v1 + v2) sql += " and (locthe='' or locthe is null or locthe like '%" + sothe.Text.Trim().Substring(v1, v2) + "%')";
                //    if (m.getrowbyid(dt, sql) == null)
                //    {
				...
				foreach(DataRow r in f.dt.Rows)
				{
                    ...
                    {
                        DataRow rvp = m.getrowbyid(dt, "id=" + int.Parse(r["mavp"].ToString()));
                        if (rvp != null)
                        {
                            if (madoituong.SelectedValue.ToString() == "1" && sothe.Text.Trim() != "" && rvp["sothe"].ToString().Trim().Trim(',') != "")
                            {
                        ...
                        upd_data(int.Parse(r["mavp"].ToString()), 1);
                    }
				}
				m.updrec_vpkhoa(dtll,mabn.Text,hoten.Text,l_mavaovien,l_maql,l_idkhoa);
			}
		...
		private void mabn_Validated(object sender, System.EventArgs e)
		{
			...
			if (r!=null)
			{
                ...
                i_traituyen = (r["traituyen"].ToString() == "") ? 0 : int.Parse(r["traituyen"].ToString());//linh
                if (m.SoSanhNgay(s_ngayvaovienbenhnhantheothongtulientich, s_ngayvao) >= 0)
                {
                    dt = m.get_dmvp(s_ngayvao, s_loaivp, s_mucvp, v.iNgoaitru).Tables[0];
                }
            ...
            if (ten.Text != "" && mavp.Text != "" && l_id >= 0)
			{
                ...
                if (dr.Length > 0)
                {
                    ...
                    foreach (DataRow r1 in v.get_data(sql).Tables[0].Rows)
                    {
                        ...
                        else upd_data(int.Parse(r1["id_gia"].ToString()), decimal.Parse(r1["soluong"].ToString()), _madt);
                        bFound = true;
                    }
                    if (!bFound)
                    {
                        if (bChidinh_thutienlien)
                        {
                            upd_data(int.Parse(mavp.Text), decimal.Parse(soluong.Text), _madt);
                        }
                        else
                        {
                            upd_data(int.Parse(mavp.Text), decimal.Parse(soluong.Text));
        ...
        private void thongbao_(bool skip)
        {
            if (Tamung_min != 0)
            {
                string s = m.get_chiphi_mabn(mabn.Text,l_maql, 1, false);
        ...
        private bool get_nhomvp_pttt(int i_mavp)
        {
            ...
            DataRow dr = m.getrowbyid(dt, sexp);//"id=" + i_mavp + " and id_nhom in(" + i_nhomvp_pttt.Trim().Trim(','));
            bln = dr != null;
            return bln;
        }
        ...
        {
            string asql = " select lydogiam from " + xxx + ".v_vpkhoa where 1=2 ";
            DataSet lds = m.get_data(asql);
            bool bln = false;
            bln = (lds == null || lds.Tables.Count == 0);
            if (bln)
            {
                asql = "alter table " + xxx + ".v_vpkhoa add tylegiam numeric(5,2) default 0";
            ...
            asql = "select id from " + xxx + ".v_vpkhoa_huy where 1=2";
            lds = m.get_data(asql);
            bln = false;
            bln = (lds == null || lds.Tables.Count == 0);
            if (bln)
            {
                asql = "create table " + xxx + ".v_vpkhoa_huy as select * from " + xxx + ".v_vpkhoa where 1=2";
                m.execute_data(asql, false);
            }
        ...
        private void butCholai_Click(object sender, EventArgs e)
        {
            ...
            {
                m_ngay = treeView1.SelectedNode.Parent.Text;
            }
            else
            {
                m_ngay = treeView1.SelectedNode.Text;
            }
            m_sql = "select mavp,soluong,madoituong from xxx.v_vpkhoa a where a.maql=" + l_maql + 
                " and a.idkhoa=" + l_idkhoa + " and a.makp='"+s_makp+"' and to_char(a.ngay,'dd/MM/yyyy hh24:mi') = '"+m_ngay+"' and a.id > 0" ;//gam 05/12/2011
            foreach( DataRow r in m.get_data_mmyy(m_sql,s_ngayvao,s_ngay,false).Tables[0].Rows )
            {
                upd_data(int.Parse(r["mavp"].ToString()),decimal.Parse(r["soluong"].ToString() == "" ? "1" : 
                    r["soluong"].ToString()),int.Parse(r["madoituong"].ToString() == "" ? madoituong.SelectedIndex.ToString() : 
                    r["madoituong"].ToString()));
            }
