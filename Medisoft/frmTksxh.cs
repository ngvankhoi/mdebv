...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTksxh : System.Windows.Forms.Form
	{
        ...
        public frmTksxh(AccessData acc)
		{
			//
		...
		private void frmTksxh_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptTksxh.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmTksxh_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
