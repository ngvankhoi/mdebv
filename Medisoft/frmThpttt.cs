...
namespace Medisoft
{
	...
	/// </summary>
	public class frmThpttt : System.Windows.Forms.Form
	{
        ...
        public frmThpttt(AccessData acc)
		{
			//
		...
		private void frmThpttt_Load(object sender, System.EventArgs e)
		{
		...
		private void AddGridTableStyle()
		{
			...
			TextCol.HeaderText = "Phẫu thuật - thủ thuật";
			TextCol.Width = 500;
			ts.GridColumnStyles.Add(TextCol);
			dataGrid1.TableStyles.Add(ts);
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,this.Text.ToUpper()+" "+solieu.Text.ToUpper()+" "+tuden,"rptThpttt.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmThpttt_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
