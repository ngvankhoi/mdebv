...
namespace Medisoft
{
	...
	public class frmBtdpxa : System.Windows.Forms.Form
	{
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			m.upd_btdpxa("btdpxa",maqu.SelectedValue.ToString(),maqu.SelectedValue.ToString()+ma.Text,ten.Text,viettat.Text);
			m.upd_btdpxa("btdpxa_add",maqu.SelectedValue.ToString(),maqu.SelectedValue.ToString()+ma.Text,ten.Text,viettat.Text);
