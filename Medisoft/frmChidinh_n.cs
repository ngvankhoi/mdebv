...
namespace Medisoft
{
	...
	public class frmChidinh_n : System.Windows.Forms.Form
	{
        ...
        private string xxx, user, nam = "", s_ngay, s_makp, s_tenkp, sql, s_dvt, s_table, s_loaivp = "", s_mucvp = "", s_ngayvao = "", s_chenhlech, s_title="";
        private int i_madoituong, i_loai, i_done, i_paid, i_row = 0, i_userid, iChidinh, v1, v2, i_madoituongvao, i_tunguyen, i_vienphi, i_traituyen=0, i_nhomvp_pttt=0;
        ...
        private bool bAdminHethong = false;
		private DataRow r;
        ...
        private ToolStripMenuItem mnu_chkmadt_def;
		...
		public frmChidinh_n(LibMedi.AccessData acc,string ngay,string makp,string tenkp,int userid,string table,int loai,int loaiba,bool admin)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.mnu_chkmadt_def = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.mabn.Location = new System.Drawing.Point(48, 28);
            ...
            this.list.Location = new System.Drawing.Point(424, 456);
            ...
            this.butLietke.Location = new System.Drawing.Point(45, 434);
            ...
            this.butMoi.Location = new System.Drawing.Point(111, 434);
            ...
            this.butSua.Location = new System.Drawing.Point(233, 434);
            ...
            this.butLuu.Location = new System.Drawing.Point(294, 434);
            ...
            this.butBoqua.Location = new System.Drawing.Point(355, 434);
            ...
            this.butHuy.Location = new System.Drawing.Point(416, 434);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(599, 434);
            ...
            this.butNet.Location = new System.Drawing.Point(538, 434);
            ...
            this.listHoten.Location = new System.Drawing.Point(336, 460);
            ...
            this.cmbMabn.Location = new System.Drawing.Point(48, 28);
            ...
            this.butThem.Location = new System.Drawing.Point(172, 434);
            ...
            this.butIn.Location = new System.Drawing.Point(477, 434);
            ...
            this.listBS.Location = new System.Drawing.Point(526, 460);
            ...
            // mnu_chkmadt_def
            // 
            this.mnu_chkmadt_def.CheckOnClick = true;
            this.mnu_chkmadt_def.Name = "mnu_chkmadt_def";
            this.mnu_chkmadt_def.Size = new System.Drawing.Size(213, 22);
            this.mnu_chkmadt_def.Text = "Đối tượng khi vào";
            // 
            // mnu_thongbaochiphi
            // 
            this.mnu_thongbaochiphi.CheckOnClick = true;
            this.mnu_thongbaochiphi.Name = "mnu_thongbaochiphi";
            this.mnu_thongbaochiphi.Size = new System.Drawing.Size(213, 22);
            this.mnu_thongbaochiphi.Text = "Thông báo chi phí điều trị";
            ...
            this.tmn_xemlaichidinh.Size = new System.Drawing.Size(213, 22);
            ...
            this.mnu_writexml.Size = new System.Drawing.Size(213, 22);
            ...
            this.tmn_chenhlechmiengiam.Size = new System.Drawing.Size(213, 22);
		...
		private void frmChidinh_n_Load(object sender, System.EventArgs e)
		{
            ...
            mnu_thongbaochiphi.Checked = m.Thongso("thongbaochiphi_cd") == "1";
            bChuky = m.bChuky;
            user = m.user;
            ...
            mnu_chkmadt_def.Checked = !bMadoituong;
			iChidinh=m.iChidinh;
            ...
            sql = "select a.mabn,b.hoten,a.id,c.mavaovien,a.maql,c.madoituong,d.sothe,b.nam,to_char(c.ngay,'dd/mm/yyyy') as ngay,to_char(d.denngay,'dd/mm/yyyy') as denngay,e.mabs,e.chandoan,e.maicd, nvl(to_char(d.tungay,'dd/mm/yyyy'),to_char(c.ngay,'dd/mm/yyyy')) as tungay, nvl(d.traituyen,0) as traituyen ";
            ...
            sql += " a.vattu_nn,b.computer,b.computervp,a.trongoi,a.locthe,a.gia_cs,a.vattu_cs,a.chenhlech,a.gia_ksk,a.vattu_ksk, b.id_nhom ";
		...
		{
			sql="select distinct a.mabn,b.hoten,a.mavaovien,a.maql,a.idkhoa from "+xxx+".v_chidinh a,"+user+".btdbn b where a.mabn=b.mabn and a.makp='"+s_makp+"' and to_char(a.ngay,'dd/mm/yyyy')='"+s_ngay.Substring(0,10)+"'";
		...
		private void load_grid(long maql,long idkhoa)
		{
		...
		private void ref_text()
		{
			try
			{
                ...
                l_maql = (dataGrid1[i_row, 14].ToString() == "") ? 0 : long.Parse(dataGrid1[i_row, 14].ToString());
                l_idkhoa = (dataGrid1[i_row, 15].ToString() == "") ? 0 : long.Parse(dataGrid1[i_row, 15].ToString());
                l_mavaovien = (dataGrid1[i_row, 20].ToString() == "") ? 0 : long.Parse(dataGrid1[i_row, 20].ToString());
		...
		private void ena_object(bool ena)
		{
			...
			ghichu.Enabled=tenbs.Enabled=chandoan.Enabled=ma.Enabled=ena;
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			ena_object(false);
            if(Tamung_min!=0 && mnu_thongbaochiphi.Checked) thongbao(false);
		}
        ...
        private void upd_detail(bool chenhlech, int i_mavp, decimal d_soluong, decimal dongia, int idtrongoi)
        {
            ...
            if (r != null)
            {
                ...
                if (!v.upd_chidinh(l_id, mabn.Text, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, s_makp, int.Parse(madoituong.SelectedValue.ToString()), i_mavp, d_soluong, (dongia != 0) ? dongia : d_dongia, (dongia != 0) ? 0 : d_vattu, i_userid, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), l_idchidinh, (maicd.Text == "" && chandoan.Text != "") ? "U00" : maicd.Text, chandoan.Text, mabs.Text, i_loaiba,ghichu.Text))
                {
                ...
                m.updrec_chidinh(ds.Tables[0], l_id, s_ngay, s_makp, s_tenkp, int.Parse(madoituong.SelectedValue.ToString()), madoituong.Text, i_mavp, r["ten"].ToString(), r["dvt"].ToString(), d_soluong, (dongia != 0) ? dongia : d_dongia, (dongia != 0) ? 0 : d_vattu, 0, 0, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), r["ma"].ToString(), (maicd.Text == "" && chandoan.Text != "") ? "U00" : maicd.Text, chandoan.Text, mabs.Text, i_loaiba, ghichu.Text, d_tylegiam, d_stgiam , lydogiam.Text);
                ...
                {
                    l_id = v.get_id_chidinh;
                    v.upd_chidinh(l_id, mabn.Text, l_mavaovien, l_maql, l_idkhoa, s_ngay, i_loai, s_makp, cl_doituong, i_mavp, d_soluong, dg_giam, vt_giam, i_userid, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), l_idchidinh, (maicd.Text == "" && chandoan.Text != "") ? "U00" : maicd.Text, chandoan.Text, mabs.Text, i_loaiba,ghichu.Text);
                    m.execute_data("update " + user + m.mmyy(s_ngay) + ".v_chidinh set done=0,hide=1, traituyen=" + i_traituyen + " where done=0 and id=" + l_id);
                    m.updrec_chidinh(ds.Tables[0], l_id, s_ngay, s_makp, s_tenkp, cl_doituong, cl_tendoituong, i_mavp, r["ten"].ToString(), r["dvt"].ToString(), d_soluong, dg_giam, vt_giam, 0, 0, int.Parse(tinhtrang.SelectedValue.ToString()), int.Parse(thuchien.SelectedValue.ToString()), r["ma"].ToString(), (maicd.Text == "" && chandoan.Text != "") ? "U00" : maicd.Text, chandoan.Text, mabs.Text, i_loaiba, ghichu.Text, (tylegiam.Text.Trim() == "" ? 0 : decimal.Parse(tylegiam.Text)), (stgiam.Text.Trim() == "" ? 0 : decimal.Parse(stgiam.Text)), lydogiam.Text);
                }
            }
        }
		...
		private void butLietke_Click(object sender, System.EventArgs e)
		{
			...
			frmChonchidinh f=new frmChonchidinh(m,mabn.Text,i_madoituong,s_loaivp,s_mucvp,i_loai,sothe.Text,v1,v2,false);
			f.ShowDialog(this);
		...
		private void load_treeView()
		{
			...
			if (l_idkhoa==0)
			{
				sql="select distinct a.ngay,b.mavaovien,a.maql,0 as idkhoa from "+s_table+" a,xxx.v_chidinh b where a.maql=b.maql";
			...
			{
				sql="select distinct a.ngay,b.mavaovien,a.maql,a.id as idkhoa from "+s_table+" a,xxx.v_chidinh b where a.id=b.idkhoa";
				sql+=" and a.mabn='"+mabn.Text+"'";
				if (iChidinh==2) sql+=" and a.maql='"+l_maql+"'";
				else if (iChidinh==3) sql+=" and a.id='"+l_idkhoa+"'";
				sql+=" order by a.ngay desc";
			}
            dtngay = (iChidinh > 1) ? m.get_data_mmyy(sql,s_ngayvao,s_ngay.Substring(0,10),false).Tables[0] : m.get_data_nam(nam, sql).Tables[0];
		...
		private void upd_data(int i_mavp,decimal d_soluong)
		{
			...
			if (r!=null)
			{
                ...
                m.execute_data("update " + m.user + m.mmyy(s_ngay.Substring(0, 10)) + ".v_chidinh set traituyen=" + i_traituyen + ",tylegiam=" + (tylegiam.Text.Trim() == "" ? 0 : decimal.Parse(tylegiam.Text)) + ",stgiam=" + (stgiam.Text.Trim() == "" ? 0 : decimal.Parse(stgiam.Text)) + ",lydogiam='" + lydogiam.Text + "'  where id =" + l_id);
                if (bChidinh_exp_txt) m.exp_chidinh(m.mmyy(s_ngay), l_id.ToString(), "0");
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
            ...
            {
                s_id += r1["id"].ToString() + ",";
                if(bChidinh_dain_khongchohuy)m.execute_data("update " + xxx + ".v_chidinh set lan=lan+1 where id=" + long.Parse(r1["id"].ToString()));
            }

            if (s_id == "" && bChidinh_dain_khongchohuy)
            {
                foreach (DataRow r1 in ds.Tables[0].Rows)
                    m.execute_data("update " + xxx + ".v_chidinh set lan=lan+1 where id=" + long.Parse(r1["id"].ToString()));
            }
            //
        ...
        private void thongbao(bool skip)
        {
            if (Tamung_min != 0)
            {
                ...
                decimal conlai = chiphi - tamung - bhyttra;
