...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTklay : System.Windows.Forms.Form
	{
        ...
        public frmTklay(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTklay));
            ...
            this.mann.Name = "mann";
            this.mann.Size = new System.Drawing.Size(158, 21);
            ...
            this.maqu.Name = "maqu";
            this.maqu.Size = new System.Drawing.Size(158, 21);
            ...
            this.maphuongxa.Size = new System.Drawing.Size(227, 21);
            ...
            this.label18.Location = new System.Drawing.Point(483, 60);
            ...
            this.solieu.Size = new System.Drawing.Size(158, 21);
            ...
            this.butTim.Size = new System.Drawing.Size(97, 25);
            ...
            this.butIn.Location = new System.Drawing.Point(355, 488);
            this.butIn.Name = "butIn";
            this.butIn.Size = new System.Drawing.Size(81, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(436, 488);
            ...
            this.Text = "Danh sách bệnh lây và các bệnh quan trọng";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmTklay_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTklay_KeyDown);
		...
		private void frmTklay_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
			...
			load_quan();
			load_pxa();
			dsxml.ReadXml("..//..//..//xml//bclay.xml");
			dssl.ReadXml("..//..//..//xml//t_lay.xml");
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
            ...
            {
                //string m_tuoi = dotuoi.SelectedValue.ToString();
                //if (m_tuoi.IndexOf(">") > -1)
                //{
                //    sql += " and to_number(to_char(now(),'yyyy'),'0000')-to_number(a.namsinh,'0000')" + m_tuoi;
                //}
                //else
                //{
                //    int i1 = int.Parse(m_tuoi.Substring(0, m_tuoi.IndexOf("-")));
                //    int i2 = int.Parse(m_tuoi.Substring(m_tuoi.IndexOf("-") + 1));
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptTklay.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmTklay_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
