...
namespace Medisoft
{
	...
	/// </summary>
	public class frmCls_denghi : System.Windows.Forms.Form
	{
		...
		public frmCls_denghi(AccessData acc,string loai,string table,int _so,string title,bool admin)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCls_denghi));
            ...
            this.ten.Name = "ten";
            this.ten.Size = new System.Drawing.Size(568, 21);
            this.ten.TabIndex = 1;
            ...
            this.Name = "frmCls_denghi";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Đề nghị";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCls_denghi_KeyDown);
            this.Load += new System.EventHandler(this.frmCls_denghi_Load);
		...
		private void frmCls_denghi_Load(object sender, System.EventArgs e)
		{
            user = m.user;
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			{
                MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin đề nghị !"));
				return;
			}
			load_grid();
			ena_object(false);
		...
		private void frmCls_denghi_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
