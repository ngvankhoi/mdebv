...
namespace Medisoft
{
	...
	/// </summary>
	public class frmLeDanhmuc : System.Windows.Forms.Form
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmLeDanhmuc));
            ...
            this.butMoi.Location = new System.Drawing.Point(47, 342);
            ...
            this.butSua.Location = new System.Drawing.Point(117, 342);
            ...
            this.butLuu.Location = new System.Drawing.Point(187, 342);
            ...
            this.butBoqua.Location = new System.Drawing.Point(257, 342);
            ...
            this.butHuy.Location = new System.Drawing.Point(327, 342);
            ...
            this.Name = "frmLeDanhmuc";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Nội dung";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmLeDanhmuc_KeyDown);
            this.Load += new System.EventHandler(this.frmLeDanhmuc_Load);
		...
		private void frmLeDanhmuc_Load(object sender, System.EventArgs e)
		{
			load_grid();
			AddGridTableStyle();
		...
		{
			sql="select * from "+s_tables+" order by id";
		...
		{
			if (!kiemtra()) return;
            if (id==0) id=m.get_capid(i_capid);
			if (!m.upd_le_danhmuc(s_tables,id,ma.Text,ten.Text))
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			{
				m.execute_data("delete from "+s_tables+" where id="+id);
				load_grid();
			}
		}
		...
		private void frmLeDanhmuc_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void ma_Validated(object sender, System.EventArgs e)
		{
			if (id==0 && ma.Text!="")
			{
				...
				if (r!=null)
				{
					MessageBox.Show(lan.Change_language_MessageText("Mã số đã nhập !"),LibMedi.AccessData.Msg);
					return;
				}
