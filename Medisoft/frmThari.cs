...
namespace Medisoft
{
	...
	/// </summary>
	public class frmThari : System.Windows.Forms.Form
	{
		...
		public frmThari(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThari));
            ...
            this.label18.Location = new System.Drawing.Point(599, 60);
            ...
            this.butTim.Location = new System.Drawing.Point(211, 490);
            ...
            this.butIn.Location = new System.Drawing.Point(301, 490);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(481, 490);
            ...
            this.butBieudo.Location = new System.Drawing.Point(391, 490);
            this.butBieudo.Name = "butBieudo";
            this.butBieudo.Size = new System.Drawing.Size(90, 25);
            ...
            this.Text = "Tổng hợp ARI";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmThari_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmThari_KeyDown);
		...
		private void frmThari_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
			...
			dssl.ReadXml("..//..//..//xml//th_ari.xml");
			dsdt.ReadXml("..//..//..//xml//dotuoi.xml");
			dsxml.ReadXml("..//..//..//xml//bcari.xml");
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptThari.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmThari_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
