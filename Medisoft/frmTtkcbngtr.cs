...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTtkcbngtr : System.Windows.Forms.Form
	{
		...
		private string user,sql,s_thetrongtinh,s_thetunguyen,s_tunguyen;
		...
		public frmTtkcbngtr(LibMedi.AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTtkcbngtr));
            ...
            this.butIn.Location = new System.Drawing.Point(52, 88);
            ...
            this.Name = "frmTtkcbngtr";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Bảng thanh toán chi phí KCB ngoại trú";
            this.Load += new System.EventHandler(this.frmTtkcbngtr_Load);
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			{
				dllReportM.frmReport f=new dllReportM.frmReport(m,dsxml.Tables[0],"rptkcbbhytngtr.rpt",(tu.Text==den.Text)?"Ngày "+tu.Text:"Từ ngày "+tu.Text+" đến "+den.Text,madoituong.Text,loaidt.Text,"","","","","","","");
				f.ShowDialog();
			}
		}
