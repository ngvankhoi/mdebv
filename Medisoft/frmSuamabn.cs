...
namespace Medisoft
{
	...
	/// </summary>
	public class frmSuamabn : System.Windows.Forms.Form
	{
		...
		public frmSuamabn(LibMedi.AccessData acc,int userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmSuamabn));
            ...
            this.chkMamoi = new System.Windows.Forms.CheckBox();
            this.SuspendLayout();
            // 
            // label1
            // 
            ...
            this.mabn2.Size = new System.Drawing.Size(74, 21);
            ...
            this.hoten.Location = new System.Drawing.Point(238, 11);
            ...
            this.mabn4.MaxLength = 8;
            this.mabn4.Name = "mabn4";
            this.mabn4.Size = new System.Drawing.Size(58, 21);
            ...
            this.butSua.Location = new System.Drawing.Point(193, 137);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(265, 137);
            ...
            this.lhoten.Location = new System.Drawing.Point(193, 91);
            this.lhoten.Name = "lhoten";
            this.lhoten.Size = new System.Drawing.Size(327, 23);
            this.lhoten.TabIndex = 16;
            this.lhoten.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            // 
            // chkMamoi
            // 
            this.chkMamoi.AutoSize = true;
            this.chkMamoi.Checked = true;
            this.chkMamoi.CheckState = System.Windows.Forms.CheckState.Checked;
            this.chkMamoi.Location = new System.Drawing.Point(98, 117);
            this.chkMamoi.Name = "chkMamoi";
            this.chkMamoi.Size = new System.Drawing.Size(119, 17);
            this.chkMamoi.TabIndex = 23;
            this.chkMamoi.Text = "Kiểm tra Mã BN mới";
            this.chkMamoi.UseVisualStyleBackColor = true;
            // 
            // frmSuamabn
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(528, 170);
            this.Controls.Add(this.chkMamoi);
            ...
            this.Name = "frmSuamabn";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Sửa mã người bệnh";
            this.Load += new System.EventHandler(this.frmSuamabn_Load);
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
			if (!kiemtra()) return;
			macu=mabn1.Text+mabn2.Text;
            mamoi = mabn3.Text + mabn4.Text.PadLeft(6, '0');
			if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý sửa mã người bệnh ")+macu+lan.Change_language_MessageText(" thành ")+mamoi,LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question,MessageBoxDefaultButton.Button2)==DialogResult.Yes)
			{
                if (chkMamoi.Checked)
                {
                    if (m.get_data("select mabn from " + user + ".btdbn where mabn='" + mamoi + "'").Tables[0].Rows.Count > 0)
                    {
                        MessageBox.Show(lan.Change_language_MessageText("Mã người bệnh ") + mamoi + lan.Change_language_MessageText(" đang tồn tại không thể sửa được !"), LibMedi.AccessData.Msg);
                        mabn3.Focus();
                        return;
                    }
                }
				try
				{
                    ...
                    m.upd_eve_upd_del(itable, i_userid, "upd", m.fields(user + ".btdbn", "mabn='" + macu + "'"));
                    foreach (DataRow r in m.get_data("select a.*,to_char(a.ngaysinh,'dd/mm/yyyy') as ns from " + user + ".btdbn a where a.mabn='" + macu + "'").Tables[0].Rows)
                    {
                        m.upd_btdbn(mamoi, r["hoten"].ToString(), r["ns"].ToString(), r["namsinh"].ToString(), int.Parse(r["phai"].ToString()), r["mann"].ToString(), r["madantoc"].ToString(), r["sonha"].ToString(), r["thon"].ToString(), r["cholam"].ToString(), r["matt"].ToString(), r["maqu"].ToString(), r["maphuongxa"].ToString(), int.Parse(r["userid"].ToString()), r["nam"].ToString());
                        break;
                    }
                    int i = 0;
                    while (i < nam.Trim().Length)
                    {
                        ...
                        if (m.bMmyy(mmyy))
                        {
                            foreach (DataRow r in dsxml.Tables[0].Select("loai=1"))
                            {
                                str = "update " + r["table"].ToString().Trim() + " set mabn='" + mamoi + "' where mabn='" + macu + "'";
                    ...
                    foreach (DataRow r in dsxml.Tables[0].Select("loai=0"))
                        m.execute_data("update " + user + "." + r["table"].ToString().Trim() + " set mabn='" + mamoi + "' where mabn='" + macu + "'");
                    m.execute_data("delete from " + user + ".btdbn where mabn='" + macu + "'");
				}
				catch{}
		...
		private void frmSuamabn_Load(object sender, System.EventArgs e)
		{
            user = m.user;
            bQuanly_Theo_Chinhanh = m.bQuanly_Theo_Chinhanh;
			dsxml.ReadXml("..//..//..//xml//m_suamabn.xml");
