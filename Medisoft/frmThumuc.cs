...
namespace Medisoft
{
	...
	public class frmThumuc : System.Windows.Forms.Form
	{
		...
		public frmThumuc(string s,string title,int loai)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butOk.Location = new System.Drawing.Point(105, 328);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(177, 328);
		...
		private void butOk_Click(object sender, System.EventArgs e)
		{
			...
			{
                m.upd_thongso(9, thumuc.Text.ToString().Trim(), thumuc.Text.ToString().Trim(), thumuc.Text.ToString().Trim());
				backup f;
