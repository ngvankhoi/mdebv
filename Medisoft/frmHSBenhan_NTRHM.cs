...
namespace Medisoft
{
	public class frmHSBenhan_NTRHM : System.Windows.Forms.Form
    {
        #region Khai bao
        ...
        public frmHSBenhan_NTRHM(LibMedi.AccessData acc,string _makp,string _tenkp,string _mabs,int userid,string _nhomkho,string suserid,bool _soluutru,bool _sovaovien,bool _admin,int _loai,int _maba,int _mabv)
		{
			InitializeComponent();
        ...
        public frmHSBenhan_NTRHM(LibMedi.AccessData acc, string _makp, string _tenkp, string _mabs, int userid, string _nhomkho, string suserid, bool _soluutru, bool _sovaovien, bool _admin, int _loai, int _maba, int _mabv,int _i_chinhanh)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
            lan.Changelanguage_to_English(this.Name.ToString(), this);
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmHSBenhan_NTRHM));
            ...
            this.butChon.Location = new System.Drawing.Point(716, 1);
            ...
            "Giấy chuyển viện",
            "Xem hồ sơ bệnh án"});
            this.xem.Location = new System.Drawing.Point(429, 2);
            this.xem.Name = "xem";
            ...
            this.barChuyengiuong.Click += new System.EventHandler(this.barChuyengiuong_Click);
            // 
            // toolStripSeparator2
            // 
            ...
            this.butChuyenphong.Location = new System.Drawing.Point(132, 687);
            ...
            this.butKemtheo.Location = new System.Drawing.Point(761, 228);
            ...
            this.butKethuc.Location = new System.Drawing.Point(4, 259);
            ...
            this.butHinh.Location = new System.Drawing.Point(3, 238);
            ...
            this.butLoc.Location = new System.Drawing.Point(4, 110);
            ...
            this.butPhanung.Location = new System.Drawing.Point(3, 194);
            ...
            this.butRa.Location = new System.Drawing.Point(109, 302);
            ...
            this.butPttt.Location = new System.Drawing.Point(3, 173);
            ...
            this.butDausinhton.Location = new System.Drawing.Point(4, 152);
            ...
            this.butDich.Location = new System.Drawing.Point(4, 131);
            ...
            this.butVao.Location = new System.Drawing.Point(2, 302);
            ...
            this.butChamsoc.Location = new System.Drawing.Point(4, 68);
            ...
            this.butAn.Location = new System.Drawing.Point(4, 280);
            ...
            "Trang 1",
            "Trang 2"});
            this.chonin.Location = new System.Drawing.Point(0, 326);
            ...
            this.butMau.Location = new System.Drawing.Point(4, 89);
            ...
            this.butDieutri.Location = new System.Drawing.Point(4, 46);
            ...
            this.butKhoa.Location = new System.Drawing.Point(4, 3);
            ...
            this.butChidinh.Location = new System.Drawing.Point(4, 24);
            ...
            this.mabn.Name = "mabn";
            this.mabn.Size = new System.Drawing.Size(77, 21);
            ...
            this.icd_kemtheo.Location = new System.Drawing.Point(163, 228);
            ...
            this.tk_phuongphap.Location = new System.Drawing.Point(24, 290);
            ...
            this.label75.Location = new System.Drawing.Point(8, 272);
            ...
            this.label64.Location = new System.Drawing.Point(8, 192);
            ...
            this.label66.Location = new System.Drawing.Point(24, 227);
            ...
            this.cd_kemtheo.Location = new System.Drawing.Point(224, 228);
            ...
            this.pgoi.Location = new System.Drawing.Point(780, 3);
            this.pgoi.Name = "pgoi";
            ...
            this.Name = "frmHSBenhan_NTRHM";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Hồ sơ bệnh án";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmHSBenhan_NTRHM_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmHSBenhan_NTRHM_KeyDown);
		...
		private void frmHSBenhan_NTRHM_Load(object sender, System.EventArgs e)
		{
		...
		private void icd_kkb_Validated(object sender, System.EventArgs e)
		{
			if (icd_kkb.Text!="")
			{
				...
				{
                    dllvpkhoa_chidinh.frmDMICD10 f = new dllvpkhoa_chidinh.frmDMICD10(m, "icd10", icd_kkb.Text, cd_kkb.Text, true);
					f.ShowDialog();
					if (f.mICD!="")
					{
						cd_kkb.Text=f.mTen;
		...
		private void icd_kemtheo_Validated(object sender, System.EventArgs e)
		{
			if (icd_kemtheo.Text!="")
			{
				...
				{
                    dllvpkhoa_chidinh.frmDMICD10 f = new dllvpkhoa_chidinh.frmDMICD10(m, "icd10", icd_kemtheo.Text, cd_kemtheo.Text, true);
					f.ShowDialog();
					if (f.mICD!="")
					{
		...
		private void list_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
            ...
            if (e.KeyCode == Keys.Escape)
            {
                ...
                this.groupBox1.Size = new Size(206, 254);
            }
		}
				...
				foreach(DataRow r in ds1.Tables[0].Rows)
				{
					...
					if (bFile)
					{
						...
						try
						{
                            ...
                            if (image.Length == 0)
                            {
                                file = new FileStream("bangrhm_01.bmp", System.IO.FileMode.Open, System.IO.FileAccess.Read);
		...
		private void frmHSBenhan_NTRHM_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			switch (e.KeyCode)
			{
				case Keys.F5:
        ...
        private void butHinh_Click(object sender, EventArgs e)
        {
            ...
            frmBARHM f = new frmBARHM(m, l_maql, ngay.Text);
            f.ShowDialog();
        }

        private void barChuyengiuong_Click(object sender, EventArgs e)
        {
