...
namespace Medisoft
{
	...
	public class frmChonkhoa : System.Windows.Forms.Form
	{
        ...
        private int i_khudt = 0, i_chinhanh=0;
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;

		public frmChonkhoa(AccessData acc,string makp,int _khudt, int _chinhanh)
		{
			//
		...
		{
			string sql="select * from "+m.user+".btdkp_bv where makp<>'01' and loai=0 and kehoach>0 ";
            if (s_makp != "")
            {
