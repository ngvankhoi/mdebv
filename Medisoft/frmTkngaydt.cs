...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTkngaydt : System.Windows.Forms.Form
	{
        ...
        public frmTkngaydt(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTkngaydt));
            ...
            this.butTim.Location = new System.Drawing.Point(209, 272);
            this.butTim.Name = "butTim";
            this.butTim.Size = new System.Drawing.Size(98, 25);
            ...
            this.butKetthuc.Size = new System.Drawing.Size(97, 25);
            ...
            this.Name = "frmTkngaydt";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Tổng hợp theo ngày điều trị";
            this.Load += new System.EventHandler(this.frmTkngaydt_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTkngaydt_KeyDown);
		...
		private void frmTkngaydt_Load(object sender, System.EventArgs e)
		{
			dt=m.get_data("select cicd10,vviet from "+m.user+".icd10 order by cicd10").Tables[0];
			dsxml.ReadXml("..//..//..//xml//t_icd10.xml");
			dsdt.ReadXml("..//..//..//xml//dotuoi.xml");
			dssl.ReadXml("..//..//..//xml//t_ngaydt.xml");
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                ds = m.get_sum(ds, new string[] { "maicd" }, new string[] { "tso","nu","c01", "c02", "c03","c04","c05" });
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptTkngaydt.rpt");
				f.ShowDialog();
			}
		...
		private void frmTkngaydt_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
