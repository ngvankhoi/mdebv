...
namespace Medisoft
{
	...
	public class frmKskdoan : System.Windows.Forms.Form
	{
		...
		private long l_doan=0, l_donvi=0, l_muc=0,l_save=0;
		...
		private void InitializeComponent()
		{
            ...
            this.butMoi.Location = new System.Drawing.Point(175, 499);
            ...
            this.butSua.Location = new System.Drawing.Point(237, 499);
            ...
            this.butLuu.Location = new System.Drawing.Point(299, 499);
            ...
            this.butBoqua.Location = new System.Drawing.Point(361, 499);
            ...
            this.butHuy.Location = new System.Drawing.Point(485, 499);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(547, 499);
            ...
            this.butdvthem.Location = new System.Drawing.Point(285, 73);
            this.butdvthem.Name = "butdvthem";
            this.butdvthem.Size = new System.Drawing.Size(45, 19);
            ...
            this.butdvsua.Location = new System.Drawing.Point(332, 73);
            this.butdvsua.Name = "butdvsua";
            this.butdvsua.Size = new System.Drawing.Size(45, 19);
            ...
            this.butdvxoa.Location = new System.Drawing.Point(379, 73);
            this.butdvxoa.Name = "butdvxoa";
            this.butdvxoa.Size = new System.Drawing.Size(45, 19);
            ...
            this.butmucxoa.Location = new System.Drawing.Point(742, 73);
            this.butmucxoa.Name = "butmucxoa";
            this.butmucxoa.Size = new System.Drawing.Size(45, 19);
            ...
            this.butmucsua.Location = new System.Drawing.Point(696, 73);
            this.butmucsua.Name = "butmucsua";
            this.butmucsua.Size = new System.Drawing.Size(45, 19);
            ...
            this.butmucthem.Location = new System.Drawing.Point(650, 73);
            this.butmucthem.Name = "butmucthem";
            this.butmucthem.Size = new System.Drawing.Size(45, 19);
            ...
            this.butdsxoa.Location = new System.Drawing.Point(378, 243);
            this.butdsxoa.Name = "butdsxoa";
            this.butdsxoa.Size = new System.Drawing.Size(45, 19);
            ...
            this.butdssua.Location = new System.Drawing.Point(331, 243);
            this.butdssua.Name = "butdssua";
            this.butdssua.Size = new System.Drawing.Size(45, 19);
            ...
            this.butdsthem.Location = new System.Drawing.Point(284, 243);
            this.butdsthem.Name = "butdsthem";
            this.butdsthem.Size = new System.Drawing.Size(45, 19);
            ...
            this.butctxoa.Location = new System.Drawing.Point(743, 181);
            this.butctxoa.Name = "butctxoa";
            this.butctxoa.Size = new System.Drawing.Size(45, 19);
            ...
            this.butctthem.Location = new System.Drawing.Point(697, 181);
            this.butctthem.Name = "butctthem";
            this.butctthem.Size = new System.Drawing.Size(45, 19);
            ...
            this.butFile.Location = new System.Drawing.Point(237, 243);
            this.butFile.Name = "butFile";
            this.butFile.Size = new System.Drawing.Size(45, 19);
            ...
            this.butIn.Location = new System.Drawing.Point(423, 499);
		...
		private void butHuy_Click(object sender, EventArgs e)
		{
			...
			if (MessageBox.Show("Đồng ý hủy\n" + cmbten.Text, LibMedi.AccessData.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
                foreach (DataRow r in m.get_data("select * from " + user + ".kskmuc where iddoan=" + l_doan).Tables[0].Rows)
                    m.execute_data("delete from " + user + ".kskmucct where id=" + long.Parse(r["id"].ToString()));
                ...
                foreach (DataRow r in m.get_data("select * from " + user + ".kskdonvi where iddoan=" + l_doan).Tables[0].Rows)
                    m.execute_data("delete from " + user + ".kskbtdbn where iddonvi=" + long.Parse(r["id"].ToString()));
		...
		private void butdvsua_Click(object sender, EventArgs e)
		{
			if (dt1.Rows.Count > 0)
			{
				frmDonvi f = new frmDonvi(m, l_doan,long.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber,0].ToString()), i_userid, dt1, cmbten.Text);
				f.ShowDialog();
				if (f.bOk) load_donvi();               
			}
		}
		...
		private void butdvxoa_Click(object sender, EventArgs e)
		{
			if (dt1.Rows.Count > 0)
			{
				...
				{
                    sql = "delete from " + user + ".kskdonvi where id=" + long.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 0].ToString());
					m.execute_data(sql);
                    sql = "delete from " + user + ".kskbtdbn where iddonvi=" + long.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 0].ToString());
					m.execute_data(sql);
					load_donvi();
					load_danhsach();
				}
		...
		private void butmucxoa_Click(object sender, EventArgs e)
		{
			if (dt3.Rows.Count > 0)
			{
				...
				{
                    sql = "delete from " + user + ".kskmucct where id=" + long.Parse(dataGrid3[dataGrid3.CurrentCell.RowNumber, 0].ToString());
					m.execute_data(sql);
                    sql = "delete from " + user + ".kskmuc where id=" + long.Parse(dataGrid3[dataGrid3.CurrentCell.RowNumber, 0].ToString());
					m.execute_data(sql);
					load_muc();
					load_mucct();
				}
		...
		private void butctthem_Click(object sender, EventArgs e)
		{
			...
			if (f.dt.Rows.Count > 0)
			{
				...
				foreach (DataRow r in f.dt.Rows)
				{
					...
					if (r1!=null)
						m.upd_kskmucct(l_muc, long.Parse(r["mavp"].ToString()), stt++, decimal.Parse(r["dongia"].ToString()), decimal.Parse(r["vattu"].ToString()),"");
				}
				load_mucct();
			}
		}
		...
		private void butctxoa_Click(object sender, EventArgs e)
		{
			if (dt4.Rows.Count > 0)
			{
				try
				{
					...
					{
                        sql = "delete from " + user + ".kskmucct where id=" + l_muc + " and mavp=" + long.Parse(dataGrid4[dataGrid4.CurrentCell.RowNumber, 0].ToString());
						m.execute_data(sql);
		...
		private void upd_kskmucct()
		{
			...
			foreach (DataRow r in dt4.Rows)
				m.upd_kskmucct(long.Parse(r["id"].ToString()), long.Parse(r["mavp"].ToString()), decimal.Parse(r["stt"].ToString()),(r["gia_nv"].ToString()=="")?0:decimal.Parse(r["gia_nv"].ToString()),(r["gia_ngv"].ToString()=="")?0:decimal.Parse(r["gia_ngv"].ToString()), r["ghichu"].ToString());
		}
		...
		private void butIn_Click(object sender, EventArgs e)
		{
			...
			if (s.Length > 1)
			{
				...
				foreach (DataRow r in m.get_data(sql).Tables[0].Rows)
				{
					...
					//
					if (m.get_data("select id from " + xxx + ".kskketqua where mabn='" + r["mabn"].ToString() + "' and iddonvi=" + long.Parse(r["iddonvi"].ToString())).Tables[0].Rows.Count==0)
					{
						l_id = m.get_id_kskketqua;
						m.upd_kskketqua(s_mmyy, l_id, long.Parse(r["iddonvi"].ToString()), r["mabn"].ToString(), _ngay,"",i_loai,"", i_userid);
						foreach (DataRow r1 in dsxml.Tables[0].Select("mabn='"+r["mabn"].ToString()+"'","stt"))
							m.upd_kskchitiet(s_mmyy, l_id, int.Parse(r1["stt"].ToString()), long.Parse(r1["mavp"].ToString()), r1["ten"].ToString(), decimal.Parse(r1["dongia"].ToString()), 0, "", "", "");
					}
					//
				}
