...
namespace Medisoft
{
	...
	public class frmHaophi : System.Windows.Forms.Form
	{
		...
		public frmHaophi(string ngay,string makho,string makp,int nhom,int loai,int phieu,int imakp,int userid,string mmyy,decimal duyet,string title,string msg,int sudungthuoc,string manguon,bool thuoc,string _tenkp,string _tenphieu,int somay)
		{
			//
            ...
            s_tenkp = _tenkp; s_tenphieu = _tenphieu; this.Text = title; if (m.bBogo) tv.GanBogo(this, textBox111);
			//
		...
		private void InitializeComponent()
		{
            ...
            this.tenbd.Location = new System.Drawing.Point(276, 412);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(561, 485);
            ...
            this.butHuy.Location = new System.Drawing.Point(491, 485);
            ...
            this.butBoqua.Location = new System.Drawing.Point(421, 485);
            ...
            this.butXoa.Location = new System.Drawing.Point(351, 485);
            ...
            this.butThem.Location = new System.Drawing.Point(281, 485);
            ...
            this.butLuu.Location = new System.Drawing.Point(211, 485);
            ...
            this.butSua.Location = new System.Drawing.Point(141, 485);
            ...
            this.butMoi.Location = new System.Drawing.Point(1, 485);
            ...
            this.butChuyen.Location = new System.Drawing.Point(631, 485);
            ...
            this.butGoi.Location = new System.Drawing.Point(71, 485);
		...
		private void frmHaophi_Load(object sender, System.EventArgs e)
		{
			...
			s_makhocstt=d.get_makho(i_nhom,2,(bThuoc)?1:2);
			bCstt=d.bcstt_haophi(i_nhom);
            f_soluong = d.format_soluong(i_nhom);
			i_haophi=d.iHaophi;i_phieucstt=i_phieu;
            ...
            else sql = "select * from " + user + ".d_dmnguon where id=0 or nhom=" + i_nhom + " order by stt";
		...
		{
			sql="select a.stt,e.doituong,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,b.tenhc,b.dang,f.ten as tenkho,a.slyeucau as soluong,a.madoituong,a.makho,'' as cachdung,b.mahc,a.manguon,a.tutruc,0 as idvpkhoa,1 as solan,1 as lan,0 as done,i.hoten ";//ThanhCuong 01/03/2012 Thêm user
            sql += " from " + xxx + ".d_haophict a left join " + user + ".dlogin i on a.userid=i.id," + user + ".d_dmbd b," + user + ".d_doituong e," + user + ".d_dmkho f where a.mabd=b.id and a.madoituong=e.madoituong and a.makho=f.id and a.id=" + l_id + " order by a.stt";//ThanhCuong 01/03/2012 Thêm user
		...
		{
			mabn.Text=d.get_stt_haophi(i_nhom,i_makp,s_mmyy);
			ghichu.Text="";l_id=0;
			dsxoa.Clear();
		}
		...
		{
			sql="select a.*,t.manguon,t.nhomcc,t.handung,t.losx,t.giamua,t.giaban,b.ten as tennguon,c.ten as tennhomcc from "+xxx+".d_tutrucct a,"+user+".d_dmnguon b,"+user+".d_dmnx c,"+xxx+".d_theodoi t where a.sttt=t.id and t.manguon=b.id and t.nhomcc=c.id and a.makp="+i_makp;
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			foreach(DataRow r1 in dtct.Rows)
			{
                ...
                {
                    m.upd_eve_tables(s_ngay, itable, i_userid, "upd");
                    m.upd_eve_upd_del(s_ngay, itable, i_userid, "upd", l_id.ToString() + "^" + r1["stt"].ToString() + "^" + r1["madoituong"].ToString() + "^" + r1["makho"].ToString() + "^" + r1["mabd"].ToString() + "^" + r1["soluong"].ToString() + "^" + "0" + "^" + r1["manguon"].ToString() + "^" + r1["tutruc"].ToString());
                }
                else m.upd_eve_tables(s_ngay, itable, i_userid, "ins");
				d.upd_haophict(s_mmyy,l_id,int.Parse(r1["stt"].ToString()),int.Parse(r1["madoituong"].ToString()),int.Parse(r1["makho"].ToString()),int.Parse(r1["mabd"].ToString()),decimal.Parse(r1["soluong"].ToString()),0,int.Parse(r1["manguon"].ToString()),int.Parse(r1["tutruc"].ToString()),decimal.Parse(i_userid.ToString()));
			...
			if (dtct.Select("soluong>0 and tutruc=1").Length>0)
			{
                ...
                {
                    m.upd_eve_tables(s_ngay, itable, i_userid, "upd");
                    m.upd_eve_upd_del(s_ngay, itable, i_userid, "upd", l_id.ToString() + "^" + i_nhom.ToString() + "^" + mabn.Text + "^" + "0" + "^" + "0" + "^" + "0" + "^" + s_ngay + "^" + "2" + "^" + i_phieucstt.ToString() + "^" + i_makp.ToString() + "^" + i_userid.ToString() + "^" + l_id.ToString() + "^" + "1" + "^" + i_makp.ToString() + "^" + "0" + "^" + "0" + "^" + "");
                }
				if (!d.upd_xuatsdll(s_mmyy,l_id,i_nhom,mabn.Text,0,0,0,s_ngay,2,i_phieucstt,i_makp,i_userid,l_id,1,i_makp,0,0,"",s_ngay,0,""))
				{
					MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin phiếu lĩnh !"),d.Msg);
					return;
				}
				d.get_xuatsdct_cstt(s_mmyy,dtct.Select("soluong>0 and tutruc=1","stt"),i_makp,i_makp,1,l_id,"",0,0,0,2,1,s_ngay,i_nhom,s_ngay,0,"");
			}
			#endregion
			}
		...
		private bool upd_table(DataTable dt)
		{
			...
			d.updrec_haophict(dt,int.Parse(stt.Text),madoituong.Text,i_mabd,mabd.Text,tenbd.Text,tenhc.Text,dang.Text,makho.Text,d_soluong,int.Parse(madoituong.SelectedValue.ToString()),int.Parse(makho.SelectedValue.ToString()),mahc.Text,int.Parse(manguon.SelectedValue.ToString()),tutruc,dtton);
			return true;
		}
			...
			if (d.bTinnhan(i_nhom))
			{
				foreach(DataRow r in dtkho.Rows)
					if (r["computer"].ToString()!="")
						d.netsend(d.sDomain(i_nhom),r["computer"].ToString().Trim(),"DUYET PHIEU HAO PHI KHOA "+m.khongdau(s_tenkp)+" PHIEU "+m.khongdau(s_tenphieu));
			}
        ...
        private void butGoi_Click(object sender, EventArgs e)
        {
            ...
            frmChongoi f = new frmChongoi(m,(bThuoc)? -1:-2, i_nhom);
            f.ShowDialog();
            if (f.dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow r in f.dt.Rows)
                {
                    ...
                    if (r1 != null)
                    {
                        ...
                        d.updrec_dutruct("-", dtct, d.get_stt(dtct),"Hao phí", i_mabd, r["ma"].ToString(), r["ten"].ToString(), r["tenhc"].ToString(), r["dang"].ToString(), r1["tenkho"].ToString(), d_soluong, int.Parse(madoituong.SelectedValue.ToString()), int.Parse(r1["makho"].ToString()), r["cachdung"].ToString(), r["mahc"].ToString(), int.Parse(r1["manguon"].ToString()),0, 0, 1, 1, dtton, 0);
                    }
                }
                if (i_mabd != 0 && s != "")
