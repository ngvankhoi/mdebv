...
namespace Medisoft
{
	...
	public class frmIntenvien : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butIn.Location = new System.Drawing.Point(43, 136);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(135, 136);
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			sql+=" order by a.mabv";
			ds=m.get_data(sql);
			frmReport f=new frmReport(m,ds,this.Text.ToUpper(),"tenvien.rpt");
			f.ShowDialog();
		}
	}
}
