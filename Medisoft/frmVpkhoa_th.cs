...
namespace Medisoft
{
	...
	public class frmVpkhoa_th : System.Windows.Forms.Form
	{
		...
		private long l_maql=0,l_idkhoa=0,l_mavaovien=0,l_id;
		private decimal d_soluong,d_dongia,d_vattu;
		private bool bMadoituong,bTTngay;
		...
		public frmVpkhoa_th(LibMedi.AccessData acc,string ngay,string mabn,long mavaovien,long maql,long idkhoa,int kp,string makp,int userid,int madoituong,int buoi)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butLietke.Location = new System.Drawing.Point(110, 333);
            ...
            this.butMoi.Location = new System.Drawing.Point(177, 333);
            ...
            this.butLuu.Location = new System.Drawing.Point(301, 333);
            ...
            this.butBoqua.Location = new System.Drawing.Point(363, 333);
            ...
            this.butHuy.Location = new System.Drawing.Point(425, 333);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(487, 333);
		...
		private void ref_text()
		{
			try
			{
				...
				l_maql=long.Parse(dataGrid1[i_row,13].ToString());
				l_idkhoa=long.Parse(dataGrid1[i_row,14].ToString());
			}
			catch{}
		}
			...
			if (ten.Text!="" && mavp.Text!="")
			{
                ...
                else
                {
    				...
    				foreach(DataRow r in v.get_data("select * from "+xxx+".v_vpkhoa where id="+l_id).Tables[0].Rows)
                        d.upd_theodoicongno(d.delete, r["mabn"].ToString(), long.Parse(r["mavaovien"].ToString()), long.Parse(r["maql"].ToString()), long.Parse(r["idkhoa"].ToString()), int.Parse(r["madoituong"].ToString()), decimal.Parse(r["soluong"].ToString()) * (decimal.Parse(r["dongia"].ToString()) + decimal.Parse(r["vattu"].ToString())), "vienphi");
				}
