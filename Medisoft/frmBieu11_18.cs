...
namespace Medisoft
{
	...
	/// </summary>
	public class frmBieu11_18 : System.Windows.Forms.Form
	{
		...
		public frmBieu11_18(AccessData acc,string hoten,int userid,int mabv)
		{
			//
        ...
        public frmBieu11_18(string hoten, int userid, int mabv)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		private void InitializeComponent()
		{
            ...
            this.butSua.Location = new System.Drawing.Point(281, 500);
            ...
            this.butLuu.Location = new System.Drawing.Point(351, 500);
            ...
            this.butBoqua.Location = new System.Drawing.Point(421, 500);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(561, 500);
            ...
            this.butHuy.Location = new System.Drawing.Point(491, 500);
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					...
					{
						m.upd_bieu11_18(l_id,int.Parse(r[i]["ma"].ToString()),ngay.Text,int.Parse(r[i]["c01"].ToString()),
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from  "+m.user+".bieu_11 group by id,ngay order by id").Tables[0];
		}
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			if (cmbNgay.Items.Count==0) return;
			if (MessageBox.Show(
lan.Change_language_MessageText("Đồng ý hủy thông tin này ?"),AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
				l_id=decimal.Parse(cmbNgay.SelectedValue.ToString());
				m.execute_data("delete from  "+m.user+".bieu_11 where id="+l_id);
				load_ngay();
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					MessageBox.Show(
lan.Change_language_MessageText("Số liệu không hợp lệ !"),AccessData.Msg);
