...
namespace Medisoft
{
	...
	public class frmTamung : System.Windows.Forms.Form
	{
		...
		private int i_madoituong,i_done,i_row=0,i_userid,i_loai,i_loaibn,i_vienphi;
		...
		private void InitializeComponent()
		{
            ...
            this.butMoi.Location = new System.Drawing.Point(148, 427);
            ...
            this.butSua.Location = new System.Drawing.Point(270, 427);
            ...
            this.butLuu.Location = new System.Drawing.Point(331, 427);
            ...
            this.butBoqua.Location = new System.Drawing.Point(392, 427);
            ...
            this.butHuy.Location = new System.Drawing.Point(455, 427);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(577, 427);
            ...
            this.butThem.Location = new System.Drawing.Point(209, 427);
            ...
            this.listHoten.Location = new System.Drawing.Point(672, 456);
            ...
            this.butIn.Location = new System.Drawing.Point(516, 427);
            ...
            this.chkXem.Location = new System.Drawing.Point(16, 424);
            ...
            this.chkXML.Location = new System.Drawing.Point(707, 424);
		...
		{
			sql="select distinct a.mabn,b.hoten,a.mavaovien,a.maql,a.idkhoa from "+user+mmyy+".v_tamungcd a,"+user+".btdbn b ";
		...
		private void load_grid(string ngay,long idkhoa)
		{
			sql="select a.id,to_char(a.ngay,'dd/mm/yyyy hh24:mi') as ngay,a.makp,d.tenkp,a.madoituong,c.doituong,a.ten,";
            sql+="a.sotien,a.done,a.maql,a.idkhoa,a.mavaovien";
			sql+=" from "+user+mmyy+".v_tamungcd a,"+user+".doituong c,"+user+".btdkp_bv d ";
			sql+=" where a.madoituong=c.madoituong and a.makp=d.makp ";
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (ten.Text!="" && st>0)
			{
				...
				if (!v.upd_tamungcd(l_id,mabn.Text,l_mavaovien,l_maql,l_idkhoa,s_ngay,i_loai,i_loaibn,s_makp,int.Parse(madoituong.SelectedValue.ToString()),ten.Text,st,i_userid))
				{
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
            ...
            sql+=" g.tenpxa, h.sothe, h.tungay, h.denngay, h.mabv, i.tenbv, a.* ";
			...
			if (chkXem.Checked)
			{
				dllReportM.frmReport f=new dllReportM.frmReport(m,lds,s_ngay.Substring(0,10),"rptChidinh_tu.rpt");
				f.ShowDialog();
			}
			else print.Printer(m,lds,"rptChidinh_tu.rpt",s_ngay.Substring(0,10),1);
			//
			lds.Dispose();
			//
		}
