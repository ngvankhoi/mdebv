...
{
	/// <summary>
	/// Summary description for frmThuoc_mabn.
	/// </summary>
	public class frmThuoc_mabn : System.Windows.Forms.Form
	{
		...
		public frmThuoc_mabn(LibMedi.AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThuoc_mabn));
            ...
            this.butTim.Location = new System.Drawing.Point(277, 478);
            this.butTim.Name = "butTim";
            this.butTim.Size = new System.Drawing.Size(87, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(439, 478);
            ...
            this.butIn.Location = new System.Drawing.Point(364, 478);
            ...
            this.Name = "frmThuoc_mabn";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Danh sách người bệnh sử dụng thuốc & vật tư";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmThuoc_mabn_Load);
		...
		private void frmThuoc_mabn_Load(object sender, System.EventArgs e)
		{
			...
			dsll.ReadXml("..//..//..//xml//m_thuoc_mabn.xml");
			AddGridTableStyle();
		...
		private void AddGridTableStyle()
		{
			...
			Col=new DataGridTextBoxColumn();
			Col.MappingName = "ngayrv";
			Col.HeaderText = "Ngày ra";
			Col.Width = 100;
			ts.GridColumnStyles.Add(Col);
			dataGrid1.TableStyles.Add(ts);

			Col=new DataGridTextBoxColumn();
			Col.MappingName = "chandoan";
			Col.HeaderText = "Chẩn đoán";
			Col.Width = 300;
			ts.GridColumnStyles.Add(Col);
			dataGrid1.TableStyles.Add(ts);
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
			...
			{
                sql = "select a.mabn,a.hoten,a.namsinh,d.tenkp,b.maql,to_char(b.ngay,'dd/mm/yyyy hh24:mi') as ngayvv,";
                sql += " case when e.ngay is null then to_char(now(),'dd/mm/yyyy') else to_char(e.ngay,'dd/mm/yyyy') end as den,";
                sql += " case when e.ngay is null then ' ' else to_char(e.ngay,'dd/mm/yyyy hh24:mi') end ngayrv,nullif(c.chandoan,e.chandoan) as chandoan";
                sql += " from " + user + ".btdbn a inner join " + user + ".benhandt b on a.mabn=b.mabn inner join " + user + ".nhapkhoa c on b.maql=c.maql inner join " + user + ".btdkp_bv d on c.makp=d.makp left join " + user + ".xuatkhoa e on c.id=e.id";
                sql += " where b.maql>0 and b.loaiba<>3";
                ...
                sql += " order by c.makp,c.ngay desc";
			}
			else
			{
                sql = "select a.mabn,a.hoten,a.namsinh,d.tenkp,b.maql,to_char(b.ngay,'dd/mm/yyyy hh24:mi') as ngayvv,";
                sql += " case when c.ngay is null then to_char(now(),'dd/mm/yyyy') else to_char(c.ngay,'dd/mm/yyyy') end as den,";
                sql += " case when c.ngay is null then ' ' else to_char(c.ngay,'dd/mm/yyyy hh24:mi') end ngayrv,nullif(c.chandoan,b.chandoan) as chandoan";
                sql += " from " + user + ".btdbn a inner join " + user + ".benhandt b on a.mabn=b.mabn left join " + user + ".xuatvien c on b.maql=c.maql inner join " + user + ".btdkp_bv d on b.makp=d.makp";
                sql += " where b.maql>0 and b.loaiba<>3";
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			osheet.Cells[2,4]="Ngày ra :"+dataGrid1[dataGrid1.CurrentCell.RowNumber,6].ToString();
			osheet.Cells[3,1]="Chẩn đoán :"+dataGrid1[dataGrid1.CurrentCell.RowNumber,7].ToString().Trim();
			oxl.Visible=true;
		}
