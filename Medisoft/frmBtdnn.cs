...
namespace Medisoft
{
	...
	public class frmBtdnn : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(424, 365);
            ...
            this.tennn.Location = new System.Drawing.Point(150, 312);
            this.tennn.Name = "tennn";
            this.tennn.Size = new System.Drawing.Size(451, 21);
            ...
            this.butSua.Location = new System.Drawing.Point(176, 365);
            ...
            this.butLuu.Location = new System.Drawing.Point(238, 365);
            ...
            this.butBoqua.Location = new System.Drawing.Point(300, 365);
            ...
            this.butHuy.Location = new System.Drawing.Point(362, 365);
            ...
            this.mannts.Size = new System.Drawing.Size(257, 21);
            this.mannts.TabIndex = 3;
		...
		{
            dt = m.get_data("select a.mann,a.tennn,b.tennn as tennnbo,a.mannbo,a.mannts,c.ten as tennnts from " + user + ".btdnn_bv a inner join " + user + ".btdnn b on a.mannbo=b.mann left join " + user + ".tusatnghenghiep c on a.mannts=c.id order by a.mann").Tables[0];
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (!m.upd_btdnn_bv("btdnn_bv",mann.Text,tennn.Text,mannbo.SelectedValue.ToString()))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật thông tin nghề nghiệp !"));
				return;
			}
			m.upd_btdnn_bv("btdnn_add",mann.Text,tennn.Text,mannbo.SelectedValue.ToString());
