...
{
	/// <summary>
	/// Summary description for frmChidinh_ksk.
	/// </summary>
	public class frmChidinh_ksk : System.Windows.Forms.Form
	{
		...
		public frmChidinh_ksk(AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmChidinh_ksk));
            ...
            this.butOK.Location = new System.Drawing.Point(332, 508);
            this.butOK.Name = "butOK";
            this.butOK.Size = new System.Drawing.Size(66, 25);
            ...
            this.butCancel.Location = new System.Drawing.Point(400, 508);
            ...
            this.Name = "frmChidinh_ksk";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Chọn dịch vụ";
            this.Load += new System.EventHandler(this.frmChidinh_ksk_Load);
            this.ResumeLayout(false);

		}
		#endregion

		private void frmChidinh_ksk_Load(object sender, System.EventArgs e)
		{
			user = m.user;
			dsgia=m.get_data("select * from "+user+".v_giavp");
			taotable();
			load();
		}
		...
		private void load()
		{
			sql="select distinct a.* from "+user+".v_loaivp a,"+user+".v_giavp b where a.id=b.id_loai";
			sql+=" order by a.stt";
			foreach(DataRow r in m.get_data(sql).Tables[0].Rows)
			{
				...
				sql="select * from "+user+".v_giavp where id_loai="+int.Parse(r["id"].ToString());
				sql+=" order by stt";
				foreach(DataRow r1 in m.get_data(sql).Tables[0].Rows)
				{
					...
					Addchkbox(r1["ten"].ToString(),r1["id"].ToString(),t,l,r1["gia_th"].ToString(),r1["gia_dv"].ToString(),new EventHandler(chkEvent));
					t+=32;
					j++;
				}
				tab.AutoScroll=true;
