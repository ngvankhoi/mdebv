...
namespace Medisoft
{
	...
	/// </summary>
	public class frmThsxh : System.Windows.Forms.Form
	{
		...
		public frmThsxh(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThsxh));
            ...
            this.butTim.Location = new System.Drawing.Point(230, 488);
            ...
            this.butIn.Location = new System.Drawing.Point(309, 488);
            this.butIn.Name = "butIn";
            this.butIn.Size = new System.Drawing.Size(79, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(480, 488);
            ...
            this.butBieudo.Location = new System.Drawing.Point(388, 488);
            this.butBieudo.Name = "butBieudo";
            this.butBieudo.Size = new System.Drawing.Size(92, 25);
            ...
            this.Text = "Tổng hợp bệnh sốt xuất huyết";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmThsxh_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmThsxh_KeyDown);
		...
		private void frmThsxh_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
            ...
            if (dotuoi.SelectedIndex != -1)
            {
                ...
                //if (m_tuoi.IndexOf(">") != -1)
                //    sql += " and to_number(to_char(now(),'yyyy'),'0000')-to_number(c.namsinh,'0000')>" + int.Parse(m_tuoi.Substring(1));
                //else
                //{
			...
			{
				r=m.getrowbyid(dsxml.Tables[0],"ma='"+r1["stt"].ToString()+"'");
				if (r!=null)
				{
					r1["nhom"]=r["ma"].ToString();
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptThsxh.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmThsxh_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
