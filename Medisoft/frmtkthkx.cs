...
namespace Medisoft
{
	...
	/// </summary>
	public class frmtkthkx : System.Windows.Forms.Form
	{
		...
		public frmtkthkx(AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmtkthkx));
            ...
            this.butIN.Location = new System.Drawing.Point(52, 49);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(129, 49);
            ...
            this.Text = "Thống kê tổng hợp khám khúc xạ";
            this.Load += new System.EventHandler(this.frmtkthkx_Load);
		...
		private void frmtkthkx_Load(object sender, System.EventArgs e)
		{
