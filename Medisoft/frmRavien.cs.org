		...
		private void mabn_Validated(object sender, System.EventArgs e)
		{
            ...
            foreach (DataRow r in m_ds.Tables[0].Select("","maql desc"))//.Rows)
            {
                ...
                if (i_loaiba == 1)
                {
                    ...
                    maso += m.get_maql_ngoaitru(ngayvv.Text.Substring(0, 10), (ngayra.Text != "") ? ngayra.Text.Substring(0, 10) : m.ngayhienhanh_server.Substring(0, 10), l_maql);
                maso += m.get_maql_Capve_noitru(ngayvv.Text, l_mavaovien);
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (hoten.Text!="")
			{
                ...
                if (bQuanLyPhongGiuongTuDong)
                {
                    ...
                    m.TongHopTienGiuong(mabn.Text, l_mavaovien, l_maql, int.Parse(madoituong.SelectedValue.ToString()), ngayvv.Text, ngayra.Text, _tungay, _denngay, dtvp);
                }
