...
namespace Medisoft
{
	public class frmTkkhambenh : System.Windows.Forms.Form
    {
        #region Khai bao
        ...
        private string user;
        private bool bClear = true, bBHYT_Phanbiet_NVBenhvien=false;
        ...
        private CheckBox chkNvienbv;
		private System.ComponentModel.IContainer components;
        private int i_chinhanh = 0;
        private CheckBox chkInthuoc;
        private CheckBox chkXml;
        private string sql = "";
        #endregion

        public frmTkkhambenh(AccessData acc, int _chinhanh)
		{
			InitializeComponent();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTkkhambenh));
            ...
            this.chkNvienbv = new System.Windows.Forms.CheckBox();
            this.chkInthuoc = new System.Windows.Forms.CheckBox();
            ...
            this.dataGrid1.Size = new System.Drawing.Size(447, 375);
            ...
            this.butTim.Location = new System.Drawing.Point(289, 529);
            ...
            this.butIn.Location = new System.Drawing.Point(361, 529);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(433, 529);
            ...
            this.makp.Name = "makp";
            this.makp.Size = new System.Drawing.Size(153, 116);
            ...
            this.mabs.Name = "mabs";
            this.mabs.Size = new System.Drawing.Size(195, 21);
            ...
            this.dataGrid2.Location = new System.Drawing.Point(461, 146);
            ...
            this.dataGrid2.Size = new System.Drawing.Size(344, 375);
            this.dataGrid2.TabIndex = 257;
            // 
            // loaidt
            // 
            ...
            this.chkDonthuoc.Location = new System.Drawing.Point(428, 144);
            this.chkDonthuoc.Name = "chkDonthuoc";
            this.chkDonthuoc.Size = new System.Drawing.Size(142, 17);
            this.chkDonthuoc.TabIndex = 259;
            ...
            this.butTuongtac.Location = new System.Drawing.Point(703, 527);
            this.butTuongtac.Name = "butTuongtac";
            this.butTuongtac.Size = new System.Drawing.Size(109, 25);
            ...
            this.chkNgoaitru.Location = new System.Drawing.Point(567, 143);
            this.chkNgoaitru.Name = "chkNgoaitru";
            this.chkNgoaitru.Size = new System.Drawing.Size(112, 17);
            this.chkNgoaitru.TabIndex = 273;
            this.chkNgoaitru.Text = "Ngoại trú tái khám";
            ...
            // chkNvienbv
            // 
            this.chkNvienbv.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.chkNvienbv.AutoSize = true;
            this.chkNvienbv.Location = new System.Drawing.Point(608, 532);
            this.chkNvienbv.Name = "chkNvienbv";
            this.chkNvienbv.Size = new System.Drawing.Size(92, 17);
            this.chkNvienbv.TabIndex = 275;
            this.chkNvienbv.Text = "Nhân viên BV";
            this.chkNvienbv.UseVisualStyleBackColor = true;
            this.chkNvienbv.Visible = false;
            // 
            // chkInthuoc
            // 
            this.chkInthuoc.AutoSize = true;
            this.chkInthuoc.Location = new System.Drawing.Point(682, 143);
            this.chkInthuoc.Name = "chkInthuoc";
            this.chkInthuoc.Size = new System.Drawing.Size(65, 17);
            this.chkInthuoc.TabIndex = 276;
            this.chkInthuoc.Text = "In thuốc";
            this.chkInthuoc.UseVisualStyleBackColor = true;
            // 
            // chkXml
            // 
            this.chkXml.AutoSize = true;
            this.chkXml.Location = new System.Drawing.Point(748, 143);
            this.chkXml.Name = "chkXml";
            this.chkXml.Size = new System.Drawing.Size(48, 17);
            this.chkXml.TabIndex = 277;
            ...
            this.Controls.Add(this.chkInthuoc);
            this.Controls.Add(this.chkNvienbv);
            ...
            this.Text = "Danh sách bệnh nhân vào khám bệnh";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmTkkhambenh_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkkhambenh_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTkkhambenh_KeyDown);
		...
		private void frmTkkhambenh_Load(object sender, System.EventArgs e)
		{
            ...
            chkNvienbv.Visible = bBHYT_Phanbiet_NVBenhvien;
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
            ...
            ds = m.get_Khambenh(tu.Text, den.Text, mabn.Text, hoten.Text.Replace("'", "''"), ngaysinh.Text, phai.SelectedIndex, sonha.Text, thon.Text.Replace("'", "''"),
				...
				(dotuoi.SelectedIndex==-1)?"":dotuoi.SelectedValue.ToString(),chkmaicd.Checked,soluutru.Text,i_userid,time.Checked,(mabs.SelectedIndex!=-1)?mabs.SelectedValue.ToString():"",loai.SelectedIndex,bnmoi.SelectedIndex,(loaidt.SelectedIndex!=-1)?loaidt.Text.Substring(0,1):"",sothe.Text, chkNgoaitru.Checked,i_traituyen,chkNvienbv.Checked, i_chinhanh);
            //Tu:08/08/2011 thêm cột cân nặng
            try { ds.Tables[0].Columns.Add("cannang", typeof(string)); }
            catch { }
            DataTable dt = m.get_data_mmyy("select maql,cannang from xxx.dausinhton", tu.Text, den.Text, false).Tables[0];
            try
            {
                foreach (DataRow r in ds.Tables[0].Rows)
                {

                    DataRow dr = m.getrowbyid(dt, "maql=" + r["maql"].ToString());
                    r["cannang"] = dr["cannang"].ToString();
                }
            }
            catch { }
            //end Tu
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                try
                {
                    ds.Tables[0].Columns.Add("thuoc");
                }
                catch { }
                if (chkInthuoc.Checked)
                {
                    ...
                    foreach (DataRow r in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            s_thuoc = "";
                            dttmp = load_thuoc_in(r["mabn"].ToString(), r["ngay"].ToString(), decimal.Parse(r["maql"].ToString()));
                            foreach (DataRow r1 in dttmp.Rows)
                            {
                                s_thuoc += r1["ten"].ToString().Trim() + " - " + float.Parse(r1["soluong"].ToString().Trim()).ToString();
                                if (r1["dang"].ToString().Trim() != "") s_thuoc += r1["dang"].ToString().Substring(0, 1);
                                s_thuoc += ", ";
                            }
                            r["thuoc"] = s_thuoc.Trim().Trim(',');
                        }
                        catch { }
                    }
                }
                ...
                if (chkXml.Checked)
                {
                    ...
                    ds.WriteXml("..\\..\\dataxml\\rptTkkhambenh.xml", XmlWriteMode.WriteSchema);
                }
                //End Khuong
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,this.Text.ToUpper()+" "+_ngay.ToUpper(),"rptTkkhambenh.rpt");
				f.ShowDialog();
			}
			catch(Exception exx){}
		}
		...
		private void frmTkkhambenh_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			if (bClear)
			{
				bClear=false;
		...
		private void frmTkkhambenh_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                l_maql=decimal.Parse(dataGrid1[i,26].ToString());
			}
		...
		private void load_thuoc(string s_mabn,string s_ngay,decimal l_maql)
		{
			...
			string sql="select b.stt,trim(c.ten)||' '||c.hamluong as ten,c.dang,b.slyeucau as soluong,b.cachdung,c.tenhc,b.mabd from "+xxx+".d_thuocbhytll a,"+xxx+".d_thuocbhytct b,"+user+".d_dmbd c";
			sql+=" where a.id=b.id and b.mabd=c.id and a.mabn='"+s_mabn+"' and to_char(a.ngay,'dd/mm/yyyy')='"+s_ngay+"'";
            if (chkDonthuoc.Checked) sql += " and a.maql=" + l_maql;
			sql+=" union all ";
			sql+=" select b.stt,trim(c.ten)||' '||c.hamluong as ten,c.dang,b.soluong,b.cachdung,c.tenhc,b.mabd from "+xxx+".d_toathuocll a,"+xxx+".d_toathuocct b,"+user+".d_dmthuoc c";
			sql+=" where a.id=b.id and b.mabd=c.id and a.mabn='"+s_mabn+"' and to_char(a.ngay,'dd/mm/yyyy')='"+s_ngay+"'";
            if (chkDonthuoc.Checked) sql += " and a.maql=" + l_maql;
            //sql += " union all ";
            //sql += " select b.stt,trim(c.ten) as ten,c.dang,b.soluong,b.cachdung,c.tenhc,b.mabd from " + xxx + ".d_toathuocll a," + xxx + ".d_toathuocct b," + user + ".d_dmthuoc c";
            //sql += " where a.id=b.id and b.mabd=c.id and a.mabn='" + s_mabn + "' and to_char(a.ngay,'dd/mm/yyyy')='" + s_ngay + "'";
            //if (chkDonthuoc.Checked) sql += " and a.maql=" + l_maql;
			dst=m.get_data(sql);
			dataGrid2.DataSource=dst.Tables[0];
        ...
        private void butTuongtac_Click(object sender, EventArgs e)
        {
            ...
            //string s_tenhc1 = t.get_tenhc(dtdmbd, dst.Tables[0]);
            ...
            //else
            //{
            //    MessageBox.Show(lan.Change_language_MessageText("Không tìm thấy tương tác", "Thông báo - Tương tác thuốc");
            //}
            //dtdmbd.Dispose();
            //dtdmhc.Dispose();
        }
        ...
        {
            //cbtraituyen.Enabled = madoituong.SelectedValue.ToString() == "1";

        }

        private DataTable load_thuoc_in(string s_mabn, string s_ngay, decimal l_maql)
        {
            dataGrid2.DataSource = null;
            string xxx = user + m.mmyy(s_ngay);
            string sql = "select b.stt,trim(c.ten)||' '||c.hamluong as ten,c.dang,b.slyeucau as soluong,b.cachdung,c.tenhc,b.mabd from " + xxx + ".d_thuocbhytll a," + xxx + ".d_thuocbhytct b," + user + ".d_dmbd c";
            ...
            if (chkDonthuoc.Checked) sql += " and a.maql=" + l_maql;
            sql += " union all ";
            sql += " select b.stt,trim(c.ten)||' '||c.hamluong as ten,c.dang,b.soluong,b.cachdung,c.tenhc,b.mabd from " + xxx + ".d_toathuocll a," + xxx + ".d_toathuocct b," + user + ".d_dmbd c";
            sql += " where a.id=b.id and b.mabd=c.id and a.mabn='" + s_mabn + "' and to_char(a.ngay,'dd/mm/yyyy')='" + s_ngay.Substring(0,10) + "'";
            if (chkDonthuoc.Checked) sql += " and a.maql=" + l_maql;
            //sql += " union all ";
            //sql += " select b.stt,trim(c.ten) as ten,c.dang,b.soluong,b.cachdung,c.tenhc,b.mabd from " + xxx + ".d_toathuocll a," + xxx + ".d_toathuocct b," + user + ".d_dmthuoc c";
