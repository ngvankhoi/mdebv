...
namespace Medisoft
{
	...
	public class frmCongkhai : System.Windows.Forms.Form
	{
        ...
        private bool bQuanly_thuocmo = false, bQuanly_Theo_Chinhanh=false;
        private System.Windows.Forms.CheckBox chkInDongTrang;
		...
		public frmCongkhai(LibDuoc.AccessData acc, string makp,bool admin,int loaiba,string suserid,int userid)
		{
            ...
            d = acc; b_makp = makp; i_loaiba = loaiba; tenuser = suserid; i_userid = userid;
		...
		private void InitializeComponent()
		{
            ...
            this.chkInDongTrang = new System.Windows.Forms.CheckBox();
            ...
            this.butIn.Location = new System.Drawing.Point(649, 80);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(719, 80);
            ...
            this.butTiep.Location = new System.Drawing.Point(579, 80);
            ...
            this.diachi.Size = new System.Drawing.Size(237, 22);
            ...
            this.dataGrid1.Size = new System.Drawing.Size(789, 424);
            ...
            this.lblpt.Size = new System.Drawing.Size(10, 10);
            ...
            this.tenkp.Size = new System.Drawing.Size(110, 22);
            ...
            this.chkThuoc.Location = new System.Drawing.Point(629, 539);
            ...
            this.chkExcel.Location = new System.Drawing.Point(629, 556);
            ...
            this.txtTieude.Size = new System.Drawing.Size(204, 22);
            ...
            this.cmbDoituong.Location = new System.Drawing.Point(385, 79);
            ...
            this.label14.Location = new System.Drawing.Point(297, 83);
            ...
            this.chkInnhieuphieu.Location = new System.Drawing.Point(144, 82);
            ...
            this.ngaysinh.Font = new System.Drawing.Font("Tahoma", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.ngaysinh.Location = new System.Drawing.Point(414, 555);
            this.ngaysinh.Name = "ngaysinh";
            this.ngaysinh.Size = new System.Drawing.Size(40, 22);
            this.ngaysinh.TabIndex = 269;
            ...
            this.chkNgay.Location = new System.Drawing.Point(333, 539);
            this.chkNgay.Name = "chkNgay";
            this.chkNgay.Size = new System.Drawing.Size(137, 21);
            this.chkNgay.TabIndex = 270;
            this.chkNgay.Text = "Lấy số liệu theo ngày";
            // 
            // chkInDongTrang
            // 
            this.chkInDongTrang.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.chkInDongTrang.Checked = true;
            this.chkInDongTrang.CheckState = System.Windows.Forms.CheckState.Checked;
            this.chkInDongTrang.Location = new System.Drawing.Point(629, 522);
            this.chkInDongTrang.Name = "chkInDongTrang";
            this.chkInDongTrang.Size = new System.Drawing.Size(158, 19);
            this.chkInDongTrang.TabIndex = 271;
            this.chkInDongTrang.Text = "In thêm cột trống";
            this.chkInDongTrang.Visible = false;
            // 
            // frmCongkhai
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(799, 575);
            this.Controls.Add(this.chkInDongTrang);
		...
		private void frmCongkhai_Load(object sender, System.EventArgs e)
		{
            ...
            bQuanly_thuocmo = m.bQuanly_thuocmo;//gam 09/09/2011
            ...
            chkInDongTrang.Visible = i_loaiba == 2;
		}
		...
		private void m2_Validated(object sender, System.EventArgs e)
		{
            ...
            {
                m2.Text = m2.Text.PadLeft(i_maxlength_mabn - 2, '0');
            }
            else
            {
            ...
            DataRow r_n = m.get_data("select nam from "+user+".btdbn where mabn='"+s_mabn+"'").Tables[0].Rows[0];
            string[] s_mmyy = r_n["nam"].ToString().Split('+');
			if (chkKhoa.Checked && i_loaiba==1)
			{
				...
				sql+=" b.sonha,b.thon,f.tentt,g.tenquan,h.tenpxa,i.soluutru,c.chandoan as chandoanrv,b.cholam,j.sovaovien ";
                sql += ",to_char(b.ngaysinh,'dd/mm/yyyy') as ngaysinh ";//gam 23/09/2011
			...
			else
			{
                ...
                else if (i_loaiba == 4)
                {
                    bool flag = true;
                    string usermmyy = "";
                    for (int j = 0; j < s_mmyy.Length - 1; j++)
                    {
                        usermmyy = user + s_mmyy[j].ToString();
                        if (m.bMmyy(s_mmyy[j].ToString()) == false) continue;
                        ...
                        sql += " from " + usermmyy + ".benhancc a inner join " + user + ".btdbn b on a.mabn=b.mabn";
                        sql += " inner join " + user + ".btdkp_bv d on a.makp=d.makp ";
                        sql += " left join " + user + ".bhyt e on a.maql=e.maql ";
                        sql += " inner join " + user + ".btdtt f on b.matt=f.matt ";
                        sql += " inner join " + user + ".btdquan g on b.maqu=g.maqu ";
			...
			foreach(DataRow r in ds.Tables[0].Rows)
			{
				if (i==1)
				{
                    ...
                    ngaysinh.Text = r["ngaysinh"].ToString();
                    //
				}
				i++;
		...
		{
            m2.Text = hoten.Text = namsinh.Text = phai.Text = ngayra.Text = chandoan.Text = sothe.Text = diachi.Text = soluutru.Text = ngaysinh.Text = "";//gam 23/09/2011
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
            ...
            //    chkDoituong.Checked = true;
            //if (!bThanhtoan_khoa && !chkThuoc.Checked) m.get_thanhtoan(l_maql,l_id,ngayvao.Text,ngayra.Text,i_loaiba,m.bThanhtoan_khoa,tenuser,i_userid);
			gan_data();            
            if (chkExcel.Checked)
            {
        ...
        private void gan_data()
        {
            ...
            if (chkInDongTrang.Checked && i_loaiba==2)
            {
                DateTime datengay = m.StringToDate(tmp_ngay.Substring(6,2)+"/"+tmp_ngay.Substring(4,2)+"/"+tmp_ngay.Substring(0,4));
                DateTime newdatengay;
                for (int j = 1; j < 7; j++)
                {
                    dc = new DataColumn();
                    newdatengay = datengay.AddDays(j);
                    dc.ColumnName = "C_" + newdatengay.Year.ToString() + newdatengay.Month.ToString().PadLeft(2, '0') + newdatengay.Day.ToString().PadLeft(2, '0');
                    dc.DataType = Type.GetType("System.Decimal");
                    dt.Columns.Add(dc);
                    col++;
                }
            ...
            {               
                ...
                foreach (DataRow r in ds1.Tables[0].Select("true", "ngay,sttnhom,nhomvp,tenbd"))
                {
                    for (int i = 3; i < dt.Columns.Count - 6; i++)
                    {
                        ...
                        {
                            updrec_p_congkhai_doituong(dt, r["loai"].ToString(), r["stt"].ToString(), r["nhomvp"].ToString(), r["mabd"].ToString(), r["tenbd"].ToString(), r["dangbd"].ToString(), double.Parse(r["soluong"].ToString()), double.Parse(r["dongia"].ToString()), i, r["doituong"].ToString(),int.Parse(r["sttnhom"].ToString()),int.Parse(r["loaipttt"].ToString()));
                            break;
                        }
                    }
                }
            ...
            else
            {
                ...
                foreach (DataRow r in ds1.Tables[0].Select("true", "ngay,sttnhom,nhomvp,tenbd"))
                {
                    for (int i = 3; i < dt.Columns.Count - 6; i++)
                    {
                        if (r["ngay"].ToString() == dt.Columns[i].ToString().Substring(2, 8))
                        {
                            updrec_p_congkhai(dt, r["loai"].ToString(), r["stt"].ToString(), r["nhomvp"].ToString(), r["mabd"].ToString(), r["tenbd"].ToString(), r["dangbd"].ToString(), double.Parse(r["soluong"].ToString()), double.Parse(r["dongia"].ToString()), i, int.Parse(r["sttnhom"].ToString()), r["doituong"].ToString(), int.Parse(r["loaipttt"].ToString()));
                            break;
                        }
                    }
                }
		...
		private void sort()
		{
            ...
            foreach (DataRow r in dt1.Select("true", "sttnhom,nhomvp,loaipttt,tenbd"))//gam 09/09/2011 them loaipttt
			{
				if (r["nhomvp"].ToString()!=nhomvp)
				{
					...
					r1["tongso"]=0;
					r1["dongia"]=0;
                    r1["loaipttt"] = r["loaipttt"].ToString();//gam 09/09/2011
        ...
        private void sort2(string s_doituong)
        {
            ...
            foreach (DataRow r in dt1.Select("doituong='" + s_doituong + "'", "sttnhom,nhomvp,loaipttt,tenbd"))
            {
                if (r["nhomvp"].ToString() != nhomvp)
                {
                    r1 = dttam2.NewRow();
		...
		private void imp_excel()
		{
            try
            {
                ...
                try { dt.Columns.Remove("loaipttt"); }
                catch { }
                string sql, tenpt = "";
                sql = "select a.tenpt,to_char(a.ngay,'dd/mm/yyyy') as ngay,c.ten as loaipt,a.somat,a.molaimien from xxx.pttt a," + user + ".dmpttt b," + user + ".loaipttt c where a.mapt=b.mapt and b.loaipt=c.ma and a.mabn='" + m1.Text + m2.Text + "'";
                sql += " and " + m.for_ngay("a.ngay", stime) + " between to_date('" + ngayvao.Text.Substring(0, 10) + "'," + stime + ") and to_date('" + ngayra.Text.Substring(0, 10) + "'," + stime + ")";
                ...
                string ten = "";
                double ftc = 0;
                osheet.Cells[i_rowbegin, 1] = "Số TT"; //osheet.Cells[8, 1] = "TT";
                int icol_sol = 7;
                //if (chkDoituong.Checked) icol_sol = 7;
                for (i = 1; i < cot - icol_sol; i++)
                {
                    ten = dt.Columns[i].ColumnName.ToString();
                    if (i > 2 && ten.Length >= 10) ten = "'" + ten.Substring(8, 2).PadLeft(2, '0') + "/" + ten.Substring(6, 2).PadLeft(2, '0');//+"/"+ten.Substring(2,4);
                    else if (i > 2 && ten.Length < 10) ten = "";

                                            //else ten = (i == 1) ? "Tên thuốc,hàm lượng" : "Đơn vị";
                    else ten = (i == 1) ? "Tên thuốc (nồng độ/ hàm lượng)" : "Đơn vị";
                ...
                if (chkDoituong.Checked)
                {
                    osheet.Cells[i_rowbegin, i + 4] = "Đối tượng";
                    osheet.Cells[i_rowbegin, i + 5] = "Ghi chú";
                    //osheet.get_Range(i_rowbegin, i + 4).Borders.LineStyle = XlBorderWeight.xlHairline;
                    
                }
                osheet.Cells[i_rowbegin, i + 4] = "Ghi chú";            
                int stt = 1, tt;
                icol_sol = 4;
                ...
                osheet.Cells[dong, 2] = "Tổng số khoản thuốc dùng";
                dong = dong + 1;
                osheet.get_Range(m.getIndex(0) + dong.ToString(), m.getIndex(cot) + dong.ToString()).Font.Bold = true;
                osheet.Cells[dong, 2] = "Người bệnh/\nNgười nhà ký tên";
                int line = dong + 1;
                osheet.get_Range(d.getIndex(0) + i_rowbegin.ToString(), d.getIndex(cot - 3) + dong.ToString()).Borders.LineStyle = XlBorderWeight.xlHairline;
                ...
                osheet.Cells[1, 11] = "MS: 11D/BV - 01";//gam 05/01/2011
                osheet.Cells[2, 11] = "Số: " + m_sovaovien;
                //Khuong sua cho van phuc, xuat theo tieu de nhap tren form
                osheet.Cells[2, 3] = txtTieude.Text;
                ...
                if ((cmbDoituong.SelectedText.Trim() == "" && chkInnhieuphieu.Checked) || cmbDoituong.SelectedText.Trim() != "")
                {
                    ...
                    osheet.get_Range("C4", "D4").Borders.LineStyle = XlBorderWeight.xlHairline;
                }
                osheet.Cells[3, 1] = "Khoa :" + tenkp.Text;
                osheet.Cells[4, 1] = "Họ tên người bệnh :" + hoten.Text.Trim() + " (" + m1.Text + m2.Text + ")";
                //osheet.Cells[6, 6] = "Năm sinh: "+(ngaysinh.Text != "" ? ngaysinh.Text : namsinh.Text)+", "+"Tuổi: " + tuoi.ToString().Trim() + ", Giới tính: " + phai.Text;//gam 23/09/2011 thêm thông tin năm sinh
                osheet.Cells[4, 3] = "Tuổi: " + tuoi.ToString().Trim() + ", Giới tính: " + phai.Text;
                //osheet.Cells[7, 1] = "Địa chỉ: " + diachi.Text.Trim() + ", Số thẻ " + sothe.Text.Trim();// +" Buồng : " + " Giường :";//gam 05/01/2011
                ...
                osheet.Cells[5, 1] = "Số Giường: " + m_giuong + ". Buồng: " + m_phong + ", Ngày vào: " + ngayvao.Text.Trim();
                osheet.Cells[6, 1] = "Chẩn đoán : " + chandoan.Text.Trim() + ", Ngày ra :" + ngayra.Text.Trim();
                //Tu:10/08/2011
                ...
                //    decimal songaydt = m.songay(m.StringToDate(s_ngay), m.StringToDate(ngayvao.Text.Substring(0, 10)), 1);
                //    osheet.Cells[8, 6] = "Tổng số ngày điều trị : " + songaydt;
                //    break;
                //}
                //end Tu
        ...
        private void imp_excel2()
        {
            try
            {
                ...
                try { dsPhieu.Tables[0].Columns.Remove("STTNHOM"); dsPhieu.Tables[0].Columns.Remove("loai"); }
                catch { }
                try { dsPhieu.Tables[0].Columns.Remove("loaipttt");  }
                catch { }
                ...
                foreach (System.Data.DataTable dtt in dsPhieu.Tables)
                {
                    ...
                    int i, j, be = 12, cot = dtt.Columns.Count , dong = dtt.Rows.Count;
                    int tuoi = int.Parse(DateTime.Now.Year.ToString()) - int.Parse(namsinh.Text.ToString());
                    string ten = "";
                    double ftc = 0;
                    int i_rowbegin = 10;//8
                    osheet.Cells[i_rowbegin, 1] = "Số TT"; //osheet.Cells[8, 1] = "TT";
                    int icol_sol = 5;
                    if (chkDoituong.Checked) icol_sol = 6;
                    for (i = 1; i < cot - icol_sol; i++)
                    {
                    ...
                    int stt = 1, tt;
                    icol_sol = 2;
                    if (chkDoituong.Checked) icol_sol = 3;
                    for (i = 0; i < dong; i++)
                    {
                        tt = i + be;
                    ...
                    osheet.get_Range(d.getIndex(cot - 6) + i_rowbegin.ToString(), d.getIndex(cot - 4) + dong.ToString()).NumberFormat = "#,##0.00";
                    dong += 4;
                    osheet.get_Range(m.getIndex(0) + "10", m.getIndex(cot - 4) + dong.ToString()).EntireColumn.AutoFit();
                    osheet.Cells[line, 1] = tenpt;
                    //osheet.Cells[line+3,1]=nhomvp;
                    //if (chkThuoc.Checked)
                    //{
                    ...
                    //}
                    //else osheet.Cells[line + 3, cot - 6] = "Y TÁ HÀNH CHÁNH";
                    osheet.Cells[1, 1] = "Bộ y tế (Sở Y tế): "+m.Syte;
                    osheet.Cells[2, 1] = "BV: "+m.Tenbv;
                    osheet.Cells[1, 11] = "MS: 11D/BV - 01";
                    osheet.Cells[2, 11] = "Số: " + m_sovaovien;
                    //Khuong sua cho van phuc, xuat theo tieu de nhap tren form
                    ...
                    //osheet.Cells[6,1]="Số giường :"+"";
                    //osheet.Cells[6,3]="Số lưu trữ :"+soluutru.Text;//"Buồng :";
                    //osheet.Cells[7, 1] = "Số giường: " + m_giuong + ". Buồng: " + m_phong + ", Ngày vào: " + ngayvao.Text.Trim() + ", Ngày ra :" + ngayra.Text.Trim() + ", Tạm ứng: " + d_sttamung.ToString("###,###,###.0#");
                    osheet.Cells[7, 1] = "Số giường: " + m_giuong + ". Buồng: " + m_phong + ", Ngày vào: " + ngayvao.Text.Trim();
                    osheet.Cells[8, 1] = "Chẩn đoán : " + chandoan.Text.Trim() + ". Ngày ra :" + ngayra.Text.Trim();
		...
		public DataSet get_congkhai(string d_tu, string d_den, string d_mabn, decimal d_maql,decimal d_id,string maso)
		{
				...
				for(int j=itu;j<=iden;j++)
				{
					...
					if (m.bMmyy(mmyy))
					{
						...
						sql=" insert into "+user+".t_congkhai "+
							" select c.makp,"+l_maql+" as maql,a.mabd,to_char(a.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*case when d.loai=0 then a.giamua else a.giaban end) as sotien,case when d.loai=0 then a.giamua else a.giaban end as dongia,0 as loai,a.madoituong,aa.loaipttt "+
                            " from " + xxx + ".d_tienthuoc a, " + xxx + ".d_xuatsdll aa," + user + ".d_dmbd b," + user + ".d_duockp c," + user + ".d_doituong d "+
                            "where a.mabd=b.id and a.id=aa.id and a.makp=c.id and a.madoituong=d.madoituong and a.mabn='" + d_mabn + "'";
                        ...
                        if (chkNgay.Checked)//gam 23/11/2011
                        {
                        ...
                        sql += " group by c.makp,a.mabd,to_char(a.ngay,'yyyymmdd'),case when d.loai=0 then a.giamua else a.giaban end,a.madoituong,aa.loaipttt";
						d.execute_data(sql);
						if (bCapve || i_loaiba==2 || i_loaiba == 4)
						{
							sql=" insert into "+user+".t_congkhai "+
								" select k.makp,"+l_maql+" as maql,a.mabd,to_char(k.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*t.giamua) as sotien,t.giamua as dongia,0 as loai,a.madoituong ,to_number('0') as loaipttt  "+
							...
							d.execute_data(sql);
							// Không lấy cls từ bhytcls
                            //sql=" insert into "+user+".t_congkhai "+
                            //    " select k.makp," + l_maql + " as maql,a.mavp as mabd,to_char(k.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*a.dongia) as sotien,a.dongia,1 as loai,a.madoituong ,to_number('0') as loaipttt " +
                        ...
                        {
                            sql = " insert into " + user + ".t_congkhai " +
                                " select a.makp," + l_maql + " as maql,a.mavp as mabd,to_char(a.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*(a.dongia+a.vattu-a.stgiam)) as sotien,a.dongia+a.vattu-a.stgiam as dongia,1 as loai,a.madoituong ,to_number('0') as loaipttt " +
            ...
            sql = " select f.stt,f.ten as nhomvp,a.loai,a.mabd,trim(b.ten)||' '||b.hamluong as tenbd, " +
               " b.dang as dangbd,a.ngay,a.soluong,a.dongia,a.sotien,a.loaipttt " +
            ...
            sql += " union all";
            sql += "  select f.stt,f.ten as nhomvp,a.loai,a.mabd,b.ten as tenbd,b.dvt as dangbd,a.ngay,a.soluong,a.dongia,a.sotien,a.loaipttt " +
            ...
            sql = " select d.stt,d.ten || (case when a.loaipttt=2 then ' TRONG MỔ' else (case when a.loaipttt=1 or a.loaipttt=1 then ' TRƯỚC VÀ SAU MỔ' else '' end) end) as nhomvp,a.loai,a.mabd,trim(b.ten)||' '||b.hamluong as tenbd, " +
            ...
            sql += " union all";
            sql += "  select d.stt,d.ten || (case when a.loaipttt=2 then ' TRONG MỔ' else (case when a.loaipttt=1 or a.loaipttt=1 then ' TRƯỚC VÀ SAU MỔ' else '' end) end) as nhomvp,a.loai,a.mabd,b.ten as tenbd,b.dvt as dangbd,a.ngay,a.soluong,a.dongia,a.sotien,e.doituong, " +
                "(case when d.stt=13 then 1 else (case when d.stt=4 then 2 else(case when d.stt=1 then 3 else(case when d.stt=5 then 4 else(case when d.stt=6 then 5 else(case when d.stt=8 then 7 else(case when d.stt=2 then 8 else(case when d.stt=3 or d.stt=14 then 9 else(case when d.stt=9 then 10 else(case when d.stt=11 then 11 else(case when d.stt=7 then 12 else(case when d.stt=12 then 13 else d.stt end)end)end)end)end)end)end)end)end)end)end)end) as sttnhom" +
                ",a.loaipttt " +
        ...
        public DataSet get_congkhai_doituong(string d_tu, string d_den, string d_mabn, decimal d_maql, decimal d_id, string maso)
        {
            int haophi = d.iHaophi;
            maso = d_maql.ToString() + ",";
            string _ngayvv = ngayvv.Text;
                ...
                for (int j = itu; j <= iden; j++)
                {
                    ...
                    if (m.bMmyy(mmyy))
                    {
                        ...
                        sql = " insert into " + user + ".t_congkhai1 " +
                            " select c.makp," + l_maql + " as maql,a.mabd,to_char(a.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*case when d.loai=0 then a.giamua else a.giaban end) as sotien,case when d.loai=0 then a.giamua else a.giaban end as dongia,0 as loai, a.madoituong,aa.loaipttt " +
                            " from " + xxx + ".d_tienthuoc a," + xxx + ".d_xuatsdll aa," + user + ".d_dmbd b," + user + ".d_duockp c," + user + ".d_doituong d where a.mabd=b.id and a.id=aa.id and a.makp=c.id and a.madoituong=d.madoituong and a.mabn='" + d_mabn + "'";
                        //if (i_loaiba==1) sql+=" and a.maql="+d_maql;
                        if (d_id != 0)
                        {
                            sql += " and a.idkhoa=" + d_id;
                        ...
                        {
                            sql = " insert into " + user + ".t_congkhai1 " +
                                " select k.makp," + l_maql + " as maql,a.mabd,to_char(k.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*t.giamua) as sotien,t.giamua as dongia,0 as loai, k.maphu as madoituong ,to_number('0') as loaipttt" +
                                " from " + xxx + ".bhytkb k," + xxx + ".bhytthuoc a," + user + ".d_dmbd b," + xxx + ".d_theodoi t where k.id=a.id and a.sttt=t.id and a.mabd=b.id and k.mabn='" + d_mabn + "'";
                            //if (bCapve && i_loaiba==1) sql+=" and k.maql="+d_maql;
                            if (chkNgay.Checked)
                            {
                            ...
                            if (maso != "") sql += " and k.maql in (" + maso.Substring(0, maso.Length - 1) + ")";
                            //if (cmbDoituong.SelectedIndex >= 0) sql += " and k.maphu=" + cmbDoituong.SelectedValue.ToString();//gam 11/08/2011 thay a.maphu=k.maphu
                            if (cmbDoituong.SelectedValue.ToString() !="0") sql += " and k.maphu=" + cmbDoituong.SelectedValue.ToString();//Thuy 24.02.2012
                            sql += " group by k.makp,a.mabd,to_char(k.ngay,'yyyymmdd'),t.giamua, k.maphu";
                            d.execute_data(sql);

                            //Chỉ lấy từ v_chidinh ko lấy bất cứ cls nào lên từ bhyt cls
                            //sql = " insert into " + user + ".t_congkhai1 " +
                            //    " select k.makp," + l_maql + " as maql,a.mavp as mabd,to_char(k.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*a.dongia) as sotien,a.dongia,1 as loai, k.maphu as madoituong ,to_number('0') as loaipttt" +
                            //    " from " + xxx + ".bhytkb k," + xxx + ".bhytcls a," + user + ".v_giavp b where k.id=a.id and a.mavp=b.id and k.mabn='" + d_mabn + "'";
                            ////if (bCapve && i_loaiba==1) sql+=" and k.maql="+d_maql;
                            //if (chkNgay.Checked)
                            //{
                            ...
                            //}
                            //if (maso != "") sql += " and k.maql in (" + maso.Substring(0, maso.Length - 1) + ")";
                            //if (cmbDoituong.SelectedIndex >= 0 && cmbDoituong.SelectedValue.ToString() != "0") sql += " and k.maphu=" + cmbDoituong.SelectedValue.ToString();//gam 11/08/2011 thay a.maphu=k.maphu
                        ...
                        if (!chkThuoc.Checked)
                        {
                            ...
                            if (m.bChidinh_vienphi)
                            {
                                sql = " insert into " + user + ".t_congkhai1 " +
                                    " select a.makp," + l_maql + " as maql,a.mavp as mabd,to_char(a.ngay,'yyyymmdd') as ngay,sum(a.soluong) as soluong,sum(a.soluong*(a.dongia+a.vattu-a.stgiam)) as sotien,a.dongia+a.vattu-a.stgiam as dongia,1 as loai, a.madoituong,to_number('0') as loaipttt " +
                                    " from " + xxx + ".v_chidinh a," + user + ".v_giavp b where a.mavp=b.id and a.mabn='" + d_mabn + "'";
                                //if (bCapve || i_loaiba == 2) sql += " and a.paid=1 ";
                                //if (i_loaiba == 1) sql += " and a.maql=" + d_maql;
                                if (d_id != 0)
                                {
                                    sql += " and a.idkhoa=" + d_id;
            ...
            sql = " select d.stt,d.ten || (case when a.loaipttt=2 then ' TRONG MỔ' else (case when a.loaipttt=1 or a.loaipttt=1 then ' TRƯỚC VÀ SAU MỔ' else '' end) end) as nhomvp,a.loai,a.mabd,trim(b.ten)||' '||b.hamluong as tenbd, " +
                ...
                " union all select d.stt,d.ten || (case when a.loaipttt=2 then ' TRONG MỔ' else (case when a.loaipttt=1 or a.loaipttt=1 then ' TRƯỚC VÀ SAU MỔ' else '' end) end) as nhomvp,a.loai,a.mabd,b.ten as tenbd,b.dvt as dangbd,a.ngay,a.soluong,a.dongia,a.sotien, e.doituong, " +
                "(case when d.stt=13 then 1 else (case when d.stt=4 then 2 else(case when d.stt=1 then 3 else(case when d.stt=5 then 4 else(case when d.stt=6 then 5 else(case when d.stt=8 then 7 else(case when d.stt=2 then 8 else(case when d.stt=3 or d.stt=14 then 9 else(case when d.stt=9 then 10 else(case when d.stt=11 then 11 else(case when d.stt=7 then 12 else(case when d.stt=12 then 13 else d.stt end)end)end)end)end)end)end)end)end)end)end)end) as sttnhom"+
                ",a.loaipttt" +//gam 09/09/2011
            ...
            try
            {
                if (this.ActiveControl == ngayvv)
                {
                    if (ngayvv.Items.Count > 0)
                    {
                        ...
                        l_mavaovien = decimal.Parse(dsngay.Tables[0].Rows[ngayvv.SelectedIndex]["mavaovien"].ToString());
		...
		public void updrec_p_congkhai (System.Data.DataTable dt,string loai,string stt,string nhomvp,string mabd,string tenbd,string dangbd,double soluong,double dongia,int i,int sttnhom,string doituong,int loaipttt)
		{
        ...
        public void updrec_p_congkhai_doituong(System.Data.DataTable dt, string loai, string stt, string nhomvp, string mabd, string tenbd, string dangbd, double soluong, double dongia, int i, string doituong,int sttnhom,int loaipttt)
        {
            string exp = "mabd='" + mabd + "'" + " and dongia=" + dongia;
            exp += " and doituong='" + doituong + "'";
            DataRow r = m.getrowbyid(dt, exp);
            if (r == null)
            {
                ...
                nrow["loai"] = loai;
                nrow["stt"] = stt;
                nrow["nhomvp"] = nhomvp.ToString().ToUpper();
                nrow["mabd"] = mabd;
                nrow["tenbd"] = tenbd;
                nrow["dangbd"] = dangbd;
                for (int k = 3; k < dt.Columns.Count - 5; k++) nrow[k] = 0;
                nrow[i] = soluong;
                nrow["tongso"] = soluong;
                nrow["dongia"] = dongia;
                nrow["thanhtien"] = soluong * dongia;
