...
namespace Medisoft
{
	...
	/// </summary>
	public class frmThicd10 : System.Windows.Forms.Form
	{
		...
		private DataSet dsve=new DataSet();
        ...
        public frmThicd10(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThicd10));
            ...
            this.mann.Name = "mann";
            this.mann.Size = new System.Drawing.Size(198, 21);
            ...
            this.maphuongxa.Location = new System.Drawing.Point(680, 60);
            this.maphuongxa.Name = "maphuongxa";
            this.maphuongxa.Size = new System.Drawing.Size(104, 21);
            ...
            this.label18.Location = new System.Drawing.Point(601, 60);
            ...
            this.butTim.Location = new System.Drawing.Point(184, 488);
            this.butTim.Name = "butTim";
            this.butTim.Size = new System.Drawing.Size(84, 25);
            ...
            this.butIn.Location = new System.Drawing.Point(268, 488);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(532, 488);
            ...
            this.butBieudo.Location = new System.Drawing.Point(352, 488);
            this.butBieudo.Name = "butBieudo";
            this.butBieudo.Size = new System.Drawing.Size(96, 25);
            ...
            this.Name = "frmThicd10";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Tổng hợp theo ICD10";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmThicd10_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmThicd10_KeyDown);
		...
		private void frmThicd10_Load(object sender, System.EventArgs e)
		{
			...
			dsve.ReadXml("..//..//..//xml//ve_icd10.xml");
			dssl.ReadXml("..//..//..//xml//th_icd10.xml");
		...
		private void butTim_Click(object sender, System.EventArgs e)
		{
			...
			if (tu.Text!="")
				sql+=" and "+m.for_ngay("c.ngay","'"+m.f_ngay+"'")+" between to_date('"+tu.Text+"','dd/mm/yyyy') and to_date('"+den.Text+"','dd/mm/yyyy')";
            ...
            ds = m.get_sum(ds, new string[] { "ma" }, new string[] { "c01", "c02", "c03" });
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,this.Text.ToUpper()+" "+solieu.Text.ToUpper()+" "+tuden,"rptThicd10.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmThicd10_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
				...
				try
				{
					...
					foreach(DataRow r in ds.Tables[0].Rows)
					{
						if (r[ve.SelectedValue.ToString()].ToString()!="0")
						{
							...
							title(r["ten"].ToString(),r["ma"].ToString(),i,i*26+8,decimal.Parse(r[ve.SelectedValue.ToString()].ToString()));//40
							i++;
						}
					}
					ucChart1.Refresh();		
