...
namespace Medisoft
{
	...
	/// </summary>
	public class frmDmmaicd : System.Windows.Forms.Form
	{
		...
		public frmDmmaicd(AccessData acc)
		{
			//
		...
		private void frmDmmaicd_Load(object sender, System.EventArgs e)
		{
...
//			listicd.DataSource=m.get_data("select CICD10,VVIET,VANH from icd10").Tables[0];
		...
		{
            dt = m.get_data("select a.ma,b.vviet from " + m.user + ".dmicd10 a," + m.user + ".icd10 b where a.ma=b.cicd10 order by a.ma").Tables[0];
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			{
                m.execute_data("delete from " + m.user + ".dmicd10 where ma='" + ma.Text + "'");
				load_grid();
			}
		}
		...
		private void frmDmmaicd_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
