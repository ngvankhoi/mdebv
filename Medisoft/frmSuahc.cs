...
namespace Medisoft
{
	...
	public class frmSuahc : System.Windows.Forms.Form
	{
		...
		private string nam,user,s_userid,s_mabn,s_msg;
		...
		private void InitializeComponent()
		{
            ...
            this.mabn2.Location = new System.Drawing.Point(63, 16);
            ...
            this.hoten.Location = new System.Drawing.Point(179, 16);
            ...
            this.butTiep.Location = new System.Drawing.Point(230, 186);
            ...
            this.butLuu.Location = new System.Drawing.Point(300, 186);
            ...
            this.butBoqua.Location = new System.Drawing.Point(370, 186);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(440, 186);
            ...
            this.tentqx.Location = new System.Drawing.Point(479, 61);
            ...
            this.tqx.Location = new System.Drawing.Point(429, 61);
            this.tqx.Name = "tqx";
            ...
            this.tenpxa.Size = new System.Drawing.Size(105, 21);
            ...
            this.pdienthoai.Size = new System.Drawing.Size(698, 25);
            ...
            this.dt_email.Size = new System.Drawing.Size(146, 21);
            ...
            // butKiemtra
            // 
            this.butKiemtra.Image = global::Medisoft.Properties.Resources.refresh;
            this.butKiemtra.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this.butKiemtra.Location = new System.Drawing.Point(154, 186);
            this.butKiemtra.Name = "butKiemtra";
            this.butKiemtra.Size = new System.Drawing.Size(76, 25);
            this.butKiemtra.TabIndex = 259;
            this.butKiemtra.Text = "      &Cập nhật";
            this.butKiemtra.UseVisualStyleBackColor = true;
            this.butKiemtra.Visible = false;
		...
		private void frmSuahc_Load(object sender, System.EventArgs e)
		{
            ...
            if (m.bAdminHethong(i_userid))
                butKiemtra.Visible = true;
			if (m_mabn!="") 
			{
        ...
        private void butKiemtra_Click(object sender, EventArgs e)
        {
            ...
            {
                string s_hotenkdau = "";
                while (m.get_data("select mabn from " + user + ".btdbn where hotenkdau='' and hoten <> '' limit 1").Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow r in m.get_data("select mabn,hoten from " + user + ".btdbn where hotenkdau='' and hoten <> '' limit 100").Tables[0].Rows)
                    {
                        s_hotenkdau = m.Hoten_khongdau(r["hoten"].ToString().Replace("'",""));
                        m.execute_data("update " + user + ".btdbn set hotenkdau='"+s_hotenkdau+"' where mabn='"+r["mabn"].ToString()+"'");
                    }
                }
                MessageBox.Show(lan.Change_language_MessageText("Thành công !"));
            }
            catch( Exception ex) { }
        }
	}
