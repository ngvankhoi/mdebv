...
namespace Medisoft
{
	...
	/// </summary>
	public class frmDmbcicd : System.Windows.Forms.Form
	{
		...
		public frmDmbcicd(AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDmbcicd));
            ...
            this.butKetthuc.Location = new System.Drawing.Point(465, 341);
            ...
            this.butMoi.Location = new System.Drawing.Point(98, 341);
            ...
            this.butLuu.Location = new System.Drawing.Point(168, 341);
            ...
            this.butBoqua.Location = new System.Drawing.Point(308, 341);
            ...
            this.butHuy.Location = new System.Drawing.Point(238, 341);
            ...
            // butDelAll
            // 
            this.butDelAll.Image = ((System.Drawing.Image)(resources.GetObject("butDelAll.Image")));
            this.butDelAll.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this.butDelAll.Location = new System.Drawing.Point(378, 341);
            this.butDelAll.Name = "butDelAll";
            this.butDelAll.Size = new System.Drawing.Size(87, 25);
            this.butDelAll.TabIndex = 21;
            this.butDelAll.Text = "&Hủy tất cả";
            this.butDelAll.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            ...
            this.Name = "frmDmbcicd";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Khai báo mã ICD10 ";
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmbcicd_KeyDown);
            this.Load += new System.EventHandler(this.frmDmbcicd_Load);
		...
		private void frmDmbcicd_Load(object sender, System.EventArgs e)
		{
            user = m.user;
//			listicd.DisplayMember="VVIET";
//			listicd.ValueMember="VVIET";
//			listicd.DataSource=m.get_data("select CICD10,VVIET,VANH from icd10").Tables[0];
			load_grid();
			AddGridTableStyle();
		...
		{
			dt=m.get_data("select * from "+user+".bctheoicd order by ma").Tables[0];
		...
		{
			if (!kiemtra()) return ;
			if (!m.upd_baocao("bctheoicd",ma.Text,ten.Text))
			{
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			{
				m.execute_data("delete from "+user+".bctheoicd where ma='"+ma.Text+"'");
				load_grid();
			}
		}
		...
		private void frmDmbcicd_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		{
			if (ten.Text!="") ma.Text=m.get_cicd10(ten.Text);
		...
		private void butDelAll_Click(object sender, System.EventArgs e)
		{
			if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy tất cả thông tin này !"),AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
				m.execute_data("delete from "+user+".bctheoicd");
				load_grid();
			}
		}
	}
