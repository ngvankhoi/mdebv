...
namespace Medisoft
{
	public class frmBARHM : System.Windows.Forms.Form
    {
        #region Khai bao
        ...
        private string thumucpic, s_ngay, f1 = "", filebmp = "bangrhm_01.bmp", xxx;
        ...
        public frmBARHM(AccessData acc,decimal maql,string ngay)
		{
			InitializeComponent();
        ...
        public frmBARHM(AccessData acc, decimal maql, string ngay,bool _badt)
        {
            InitializeComponent();
            lan.Read_Language_to_Xml(this.Name.ToString(), this);
            lan.Changelanguage_to_English(this.Name.ToString(), this);
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmBARHM));
            ...
            this.pic1.Name = "pic1";
            this.pic1.Size = new System.Drawing.Size(528, 216);
            ...
            this.chkXML.Location = new System.Drawing.Point(444, 432);
            ...
            this.chkXem.Location = new System.Drawing.Point(444, 454);
            ...
            this.Load += new System.EventHandler(this.frmBARHM_Load);
		...
		private void frmBARHM_Load(object sender, System.EventArgs e)
		{
            if (bbadt)
            {
			...
			bool bFound=false;
			foreach(DataRow r in m.get_data("select * from "+xxx+".bavv_rhm where maql="+l_maql).Tables[0].Rows)
			{
                try
                {
                    image = new byte[0];
                    ...
                    catch { map = new Bitmap("bangrhm_01.bmp"); }
                    picture(pic1, f1);
                    //
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			fstr.Read(image,0,System.Convert.ToInt32(fstr.Length));
			fstr.Close();
			m.upd_bavv_rhm(s_ngay,l_maql,image,nhanxet.Text,chandoan.Text);
			butIn.Focus();
		}
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			if (ds.Tables[0].Rows.Count>0)
			{
				...
				else print.Printer(m,ds,"rptBaRHM.rpt","",1,1);
			}
		}
