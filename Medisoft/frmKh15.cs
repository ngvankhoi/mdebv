...
namespace Medisoft
{
	...
	public class frmKh15 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butMoi.Location = new System.Drawing.Point(149, 501);
            ...
            this.butSua.Location = new System.Drawing.Point(229, 501);
            ...
            this.butLuu.Location = new System.Drawing.Point(309, 501);
            ...
            this.butBoqua.Location = new System.Drawing.Point(389, 501);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(549, 501);
            ...
            this.butHuy.Location = new System.Drawing.Point(469, 501);
		...
		private void frmKh15_Load(object sender, System.EventArgs e)
		{
			...
			load_ngay();
			dt=m.get_data("select * from "+m.user+".kh_dm_15_dk").Tables[0];
			load_grid(false);
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
				sql="select a.*,b.stt,b.ten,b.icd10 from "+m.user+".kh_bieu_15 a,"+m.user+".dm_11 b where a.ma=b.ma and a.id="+l_id+" order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		private void load_value(bool load)
		{
			...
			DataRow[] dr;
			foreach(DataRow r in m.get_data("select * from "+m.user+".kh_bieu_15 where id="+l_id).Tables[0].Rows)
			{
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from "+m.user+".kh_bieu_15 where id="+l_id);
					...
					for(Int16 i=0;i<iRec;i++)
					{
						m.upd_kh15(l_id,int.Parse(r[i]["ma"].ToString()),ngay.Text,int.Parse(r[i]["c01"].ToString()),
							...
							int.Parse(r[i]["c05"].ToString()),int.Parse(r[i]["c06"].ToString()),i_userid);
					}
				}
				ena_object(false);
				decimal id=l_id;
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".kh_bieu_15 group by id,ngay order by ngay").Tables[0];
		}
