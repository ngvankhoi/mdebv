...
namespace Medisoft
{
	...
	public class frmDmthuoc : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.butHuy.Location = new System.Drawing.Point(362, 497);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(422, 497);
            ...
            this.butLuu.Location = new System.Drawing.Point(301, 497);
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				long id=long.Parse(dataGrid1[i,1].ToString());
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			foreach(DataRow r in dt.Rows)
			{
                ...
                m.execute_data("update " + user + ".d_dmthuoc set stt=" + int.Parse(r["stt"].ToString()) + ",hide=" + iHide + " where id=" + long.Parse(r["id"].ToString()));
			}
			butKetthuc.Focus();
		}
	}
