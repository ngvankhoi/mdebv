...
namespace Medisoft
{
	...
	public class frmXemtutructh : System.Windows.Forms.Form
	{
		...
		private void AddGridTableStyle()
		{
			...
			TextCol.Width = (d.bQuanlynguon(i_nhom) || i_loai==2)?80:0;
			...
			TextCol.Width = (d.bHoatchat && i_loai==1)?200:270;
			ts.GridColumnStyles.Add(TextCol);
			dataGrid1.TableStyles.Add(ts);
			...
			TextCol.Width = (d.bHoatchat && i_loai==1)?200:0;
			ts.GridColumnStyles.Add(TextCol);
			dataGrid1.TableStyles.Add(ts);
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			...
			sql+=" from "+xxx+".d_tutructh a,"+user+".d_dmbd b,"+user+".d_dmhang c,"+user+".d_dmnhom d";
			sql+=" where a.mabd=b.id and b.mahang=c.id and b.manhom=d.id";
            if (i_kho != 0) sql += " and a.makho=" + i_kho;//gam 29/08/2011
            sql += " and a.makp="+i_makp+" order by d.stt,b.ten";
			dllReportM.frmReport f1=new dllReportM.frmReport(m,d.get_data(sql).Tables[0],"d_cstt_khoa.rpt",s_tenkp,"Tháng "+s_mmyy.Substring(0,2)+" Năm 20"+s_mmyy.Substring(2),"","","","","","","","");
			f1.ShowDialog(this);
		}
	}
}
