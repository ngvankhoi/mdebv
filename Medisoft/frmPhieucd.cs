...
namespace Medisoft
{
	...
	/// </summary>
	public class frmPhieucd : System.Windows.Forms.Form
	{
		...
		private string mmyy,s_userid,s_makp,s_mabn,s_msg,s_ngayvv,sql,s_madoituong,s_cls,s_hinh,user,xxx,nam,s_dongthem="",s_trasau="",s_may,sGiocapcuu_tu,sGiocapcuu_den,ddd="",sGiosun_tu,sGiosun_den;
		private int i_userid,i_loai=0,itable;
        private DataRow r3, r4;
        private decimal cp_save = 0;
		...
		private int songay=30,iTreem6,iTreem15,iKhamnhi,idvung,idloai;
        ...
        private bool b_khambenh, b_trongngoai, bChandoan,bDanhsach_chidinh,bLoad_ketqua,bLetet;
		...
		public frmPhieucd(LibMedi.AccessData acc,string makp,string hoten,int userid,string _madoituong,string cls,string _may)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPhieucd));
            ...
            this.butTiep.Location = new System.Drawing.Point(2, 514);
            ...
            this.butLuu.Location = new System.Drawing.Point(72, 514);
            ...
            this.butBoqua.Location = new System.Drawing.Point(426, 514);
            ...
            this.butHuy.Location = new System.Drawing.Point(142, 514);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(636, 514);
            ...
            this.canquang.Location = new System.Drawing.Point(61, 420);
            ...
            this.gayme.Location = new System.Drawing.Point(2, 419);
            ...
            this.butIn.Location = new System.Drawing.Point(356, 514);
            ...
            // chkXem
            // 
            this.chkXem.Location = new System.Drawing.Point(649, 483);
            ...
            // butHinh
            // 
            this.butHinh.Location = new System.Drawing.Point(368, 546);
            ...
            this.butInnhan.Location = new System.Drawing.Point(212, 514);
            ...
            this.listkhoa.ForeColor = System.Drawing.SystemColors.ActiveCaptionText;
            ...
            this.butPrev.Location = new System.Drawing.Point(496, 514);
            ...
            this.butNext.Location = new System.Drawing.Point(566, 514);
            ...
            // chkidcls
            // 
            this.chkidcls.Location = new System.Drawing.Point(649, 498);
            ...
            this.butFind.Location = new System.Drawing.Point(282, 514);
            ...
            this.listLoai.Location = new System.Drawing.Point(571, 543);
            ...
            // chkAnh
            // 
            this.chkAnh.Location = new System.Drawing.Point(649, 468);
            this.chkAnh.Name = "chkAnh";
            this.chkAnh.Size = new System.Drawing.Size(128, 16);
            this.chkAnh.TabIndex = 320;
            ...
            this.Name = "frmPhieucd";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Medisoft";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmPhieucd_KeyDown);
            this.Load += new System.EventHandler(this.frmPhieucd_Load);
		...
		private void frmPhieucd_Load(object sender, System.EventArgs e)
		{
            ...
            sGiosun_tu = "11:30"; sGiosun_den = "04:00";
            dtletet = m.get_data("select * from " + user + ".letet").Tables[0];
            if (m.Mabv_so == 701424) pmat.Visible = true; bDanhsach_chidinh = m.bDanhsach_bsbvchidinh; sGiocapcuu_tu = m.sGiocapcuu_tu; sGiocapcuu_den = m.sGiocapcuu_den;
            ...
            foreach (DataRow r1 in m.get_data(sql).Tables[0].Rows)
                s_trasau += r1["madoituong"].ToString().Trim().PadLeft(2,'0') + ",";
            ...
            bsth.Enabled = false;
            tenbsth.Enabled = false;
            ytaphu.Enabled = false;
            tenytaphu.Enabled = false;
            //canquang.Enabled = false;
            madia.Enabled = false;
            soluongphim.Enabled = false;
            idvungdg.Enabled = false;
            maloai.Enabled = false;
            phanloai.Enabled = false;
		}
		...
		private void mabn3_Validated(object sender, System.EventArgs e)
		{
			...
			if (mabn3.Text=="")
			{
				...
				if (bTudong) 
				{
                    string s_ngayht = m.ngayhienhanh_server;
                    DateTime dt = m.StringToDate(s_ngayht.Substring(0, 10));
                    ddd = dt.DayOfWeek.ToString().Substring(0, 3);
                    DataRow r = m.getrowbyid(dtletet, "ngay='" + s_ngayht.Substring(0, 5) + "'");
                    bLetet = r != null;
                    string _gio = s_ngayht.Substring(11);
                    int hh1, hh2, hh3, mm1, mm2, mm3;
                    hh1 = int.Parse(_gio.Substring(0, 2));
                    mm1 = int.Parse(_gio.Substring(3, 2));
                    hh2 = int.Parse(m.sGiocapcuu_tu.Substring(0, 2));
                    mm2 = int.Parse(m.sGiocapcuu_tu.Substring(3, 2));
                    hh3 = int.Parse(m.sGiocapcuu_den.Substring(0, 2));
                    mm3 = int.Parse(m.sGiocapcuu_den.Substring(3, 2));
                    if (bLetet || ddd == "Sun" || hh1 > hh2 || (hh1 == hh2 && mm1 > mm2) || hh1 < hh3 || (hh1 == hh3 && mm1 < mm3))
                    {
                        bCapso = true;
			...
			if (l_id!=0)
			{
				...
				foreach(DataRow r in m.get_data(sql).Tables[0].Rows)
				{
                    ...
                    if (idvp.Text != "")
                    {
                        ...
                        sql += " and a.mabn='" + mabn2.Text.Trim() + mabn3.Text.Trim() + "'";
		...
		private void frmPhieucd_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			switch (e.KeyCode)
			{
                case Keys.F3:
		...
		private void emp_text(bool skip)
		{
            ...
            hoten.Text = ""; ngaysinh.Text = ""; cp_save = 0;
		...
		private void butTiep_Click(object sender, System.EventArgs e)
		{
            if (cp.Text != "")
            {
                if (decimal.Parse(cp.Text) != cp_save)
                {
                    if (MessageBox.Show(lan.Change_language_MessageText("Bạn có muốn cập nhật thay đổi ?"), LibMedi.AccessData.Msg, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
		...
		private bool kiemtra()
		{
            ...
            {
                string s=m.Kiemtra_idcls(ngayvv.Text, i_loai, mabn2.Text.Trim() + mabn3.Text.Trim(), idcls.Text);
                if (s!="")
                {
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            cp_save = (cp.Text != "") ? decimal.Parse(cp.Text) : 0;
			if (sender!=null)
			{
				ena_but(false);
				butTiep.Focus();
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			if (l_id!=0)
			{
				...
				{
                    if (m.bKetqua_cls(ngayvv.Text,l_id))//(ten.Text != "")
                    {
                        MessageBox.Show(lan.Change_language_MessageText("ID : ") + idcls.Text + "\n"+lan.Change_language_MessageText("Đã có kết quả, không được hủy !"), LibMedi.AccessData.Msg);
                        return;
                    }
                    if (idvp.Text != "")
                    {
        ...
        private void bscd_TextChanged(object sender, EventArgs e)
        {
            if (this.ActiveControl == bscd && bDanhsach_chidinh)
            {
                ...
                listbscd.BrowseToThon(bscd, bscd, makp);
            }
        }
