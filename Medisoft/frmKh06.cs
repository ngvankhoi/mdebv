...
namespace Medisoft
{
	...
	public class frmKh06 : System.Windows.Forms.Form
	{
        ...
        public frmKh06(string hoten, int userid, int mabv)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKh06));
            ...
            this.butSua.Location = new System.Drawing.Point(240, 500);
            this.butSua.Name = "butSua";
            this.butSua.Size = new System.Drawing.Size(76, 25);
            ...
            this.butLuu.Location = new System.Drawing.Point(316, 500);
            ...
            this.butBoqua.Location = new System.Drawing.Point(392, 500);
            this.butBoqua.Name = "butBoqua";
            this.butBoqua.Size = new System.Drawing.Size(76, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(544, 500);
            this.butKetthuc.Name = "butKetthuc";
            this.butKetthuc.Size = new System.Drawing.Size(87, 25);
            ...
            this.butHuy.Location = new System.Drawing.Point(468, 500);
            this.butHuy.Name = "butHuy";
            this.butHuy.Size = new System.Drawing.Size(76, 25);
            ...
            this.Text = "Tình hình nhân lực y tế của toàn huyện";
		...
		private void frmKh06_Load(object sender, System.EventArgs e)
		{
			...
			load_ngay();
			dt=m.get_data("select * from "+m.user+".kh_dm_06_dk").Tables[0];
			load_grid(false);
		...
		{
			if (dm)	ds=m.get_data("select * from "+m.user+".kh_dm_06 order by ma");
			else load_data();
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
				sql="select a.*,b.stt,b.ten from "+m.user+".kh_bieu_06 a,"+m.user+".kh_dm_06 b where a.ma=b.ma and a.id="+l_id+" order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		{
			ds=m.get_data("select * from "+m.user+".kh_dm_06 order by ma");
			DataRow[] dr;
			foreach(DataRow r in m.get_data("select * from "+m.user+".kh_bieu_06 where id="+l_id).Tables[0].Rows)
			{
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".kh_bieu_06 group by id,ngay order by ngay").Tables[0];
		}
		...
		{
			DataTable dt1=m.get_data("select * from "+m.user+".kh_bieu_06 order by ngay desc").Tables[0];
			if (dt1.Rows.Count!=0)
			{
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from "+m.user+".kh_bieu_06 where id="+l_id);
		...
		private void AddGridTableStyle()
		{
			...
			TextCol1.HeaderText = "Cán bộ y tế tại các cơ sở trong huyện";
			TextCol1.Width = 328;
			TextCol1.ReadOnly=true;
			ts.GridColumnStyles.Add(TextCol1);
			dataGrid1.TableStyles.Add(ts);
