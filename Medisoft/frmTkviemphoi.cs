...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTkviemphoi : System.Windows.Forms.Form
	{
        ...
        public frmTkviemphoi(AccessData acc)
		{
			//
		...
		private void frmTkviemphoi_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
			...
			dssl.ReadXml("..//..//..//xml//t_viemphoi.xml");
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptTkviemphoi.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmTkviemphoi_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
