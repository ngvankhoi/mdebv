...
namespace Medisoft
{
	...
	/// </summary>
	public class frmThviemphoi : System.Windows.Forms.Form
	{
        ...
        public frmThviemphoi(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmThviemphoi));
            ...
            this.butTim.Location = new System.Drawing.Point(224, 488);
            this.butTim.Name = "butTim";
            this.butTim.Size = new System.Drawing.Size(85, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(489, 488);
            ...
            this.butBieudo.Location = new System.Drawing.Point(395, 488);
            ...
            this.Name = "frmThviemphoi";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Tổng hợp bệnh viêm phổi";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmThviemphoi_Load);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.frmTkravien_MouseMove);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmThviemphoi_KeyDown);
		...
		private void frmThviemphoi_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
			...
			dssl.ReadXml("..//..//..//xml//th_viemphoi.xml");
			dsdt.ReadXml("..//..//..//xml//dotuoi.xml");
			dsxml.ReadXml("..//..//..//xml//bcviemphoi.xml");
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptThviemphoi.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmThviemphoi_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
