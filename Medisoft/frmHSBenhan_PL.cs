	...
	public class frmHSBenhan_PL : System.Windows.Forms.Form
    {
		...
		private void list_DoubleClick(object sender, System.EventArgs e)
		{
            ...
            if (r != null)
            {
                ...
                //    get_mabn(r["mabn"].ToString(), decimal.Parse(r["maql"].ToString()));
            }
		...
		{
            frmDausinhton_pk f = new frmDausinhton_pk(m, s_makp, l_maql, m.user + m.mmyy(ngay.Text) + ".benhancc", 4, mabn.Text, (decimal)l_mavaovien, ngayvk.Text, mabs.Text);//
			f.ShowDialog(this);
		}
        ...
        private void butgoibenh_Click(object sender, EventArgs e)
        {
            ...
            //if (bBangDienPhongKham) 
                m.goi_kham(ngayvk.Text, "99", sott, sott, true);
            string input = "";
