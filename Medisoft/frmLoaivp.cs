...
namespace Medisoft
{
	...
	/// </summary>
	public class frmLoaivp : System.Windows.Forms.Form
	{
		...
		public frmLoaivp(LibMedi.AccessData acc,int userid)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmLoaivp));
            ...
            this.dataGrid1.Size = new System.Drawing.Size(776, 453);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(586, 480);
            ...
            // label1
            // 
            this.label1.Location = new System.Drawing.Point(98, 446);
            ...
            this.ma.Location = new System.Drawing.Point(148, 446);
            this.ma.MaxLength = 30;
            this.ma.Name = "ma";
            this.ma.Size = new System.Drawing.Size(116, 21);
            this.ma.TabIndex = 1;
            ...
            // label2
            // 
            this.label2.Location = new System.Drawing.Point(264, 446);
            ...
            this.ten.Location = new System.Drawing.Point(320, 446);
            this.ten.Name = "ten";
            ...
            this.butMoi.Location = new System.Drawing.Point(126, 480);
            this.butMoi.Name = "butMoi";
            this.butMoi.Size = new System.Drawing.Size(92, 25);
            ...
            this.butSua.Location = new System.Drawing.Point(218, 480);
            this.butSua.Name = "butSua";
            this.butSua.Size = new System.Drawing.Size(92, 25);
            ...
            this.butLuu.Location = new System.Drawing.Point(310, 480);
            this.butLuu.Name = "butLuu";
            this.butLuu.Size = new System.Drawing.Size(92, 25);
            ...
            this.butBoqua.Location = new System.Drawing.Point(402, 480);
            this.butBoqua.Name = "butBoqua";
            this.butBoqua.Size = new System.Drawing.Size(92, 25);
            ...
            this.butHuy.Location = new System.Drawing.Point(494, 480);
            this.butHuy.Name = "butHuy";
            this.butHuy.Size = new System.Drawing.Size(92, 25);
            ...
            // label3
            // 
            this.label3.Location = new System.Drawing.Point(0, 446);
            ...
            this.stt.Location = new System.Drawing.Point(52, 446);
            ...
            // label4
            // 
            this.label4.Location = new System.Drawing.Point(570, 446);
            ...
            this.nhom.Location = new System.Drawing.Point(618, 446);
            this.nhom.Name = "nhom";
            this.nhom.Size = new System.Drawing.Size(166, 21);
            ...
            this.Load += new System.EventHandler(this.frmLoaivp_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmLoaivp_KeyDown);
		...
		private void frmLoaivp_Load(object sender, System.EventArgs e)
		{
            user = m.user;
			nhom.DisplayMember="TEN";
			nhom.ValueMember="MA";
			nhom.DataSource=m.get_data("select * from "+user+".ct_nhomvp order by stt").Tables[0];
			load_grid();
			AddGridTableStyle();
			ref_text();
		}
		...
		{
            dt = m.get_data("select a.*,b.ten as tennhom from " + user + ".ct_loaivp a," + user + ".ct_nhomvp b where a.id_nhom=b.ma order by a.stt").Tables[0];
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			try
			{
                stt.Value = decimal.Parse(m.get_data("select max(stt) from " + user + ".ct_loaivp").Tables[0].Rows[0][0].ToString()) + 1;
			}
			catch{stt.Value=1;}
			l_id=0;
			ma.Text="";
		...
		{
			l_id=decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber,5].ToString());
			ena_object(true);
			stt.Focus();
		}
		...
		{
			if (!kiemtra()) return ;
			l_id=(l_id!=0)?l_id:v.get_id_loaivp;
			if (!m.upd_ct_loaivp(l_id,int.Parse(nhom.SelectedValue.ToString()),int.Parse(stt.Value.ToString()),ma.Text,ten.Text,i_userid,System.Environment.MachineName))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật thông tin loại viện phí !"),LibVienphi.AccessData.Msg);
				return;
			}
			load_grid();
			ena_object(false);
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
            ...
            if (m.get_data("select * from " + user + ".ct_giavp where id_loai=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 5].ToString())).Tables[0].Rows.Count != 0)
			{
				MessageBox.Show(lan.Change_language_MessageText("Loại viện phí đang sử dụng không cho phép hủy !"),LibVienphi.AccessData.Msg);
				return;
			}
			...
			{
                m.execute_data("delete from " + user + ".ct_loaivp where id=" + decimal.Parse(dataGrid1[dataGrid1.CurrentCell.RowNumber, 5].ToString()));
				load_grid();
			}
		}
		...
		private void ref_text()
		{
			try
			{
				...
				nhom.SelectedValue=dataGrid1[i,4].ToString();
			}
			catch{}
		}
		...
		private void frmLoaivp_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
