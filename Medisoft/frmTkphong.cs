...
namespace Medisoft
{
	...
	/// </summary>
	public class frmTkphong : System.Windows.Forms.Form
	{
		...
		public frmTkphong(AccessData acc)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            this.label7.Location = new System.Drawing.Point(511, 11);
            ...
            this.madantoc.Location = new System.Drawing.Point(712, 36);
            this.madantoc.Name = "madantoc";
            this.madantoc.Size = new System.Drawing.Size(72, 21);
            ...
            this.mann.Name = "mann";
            this.mann.Size = new System.Drawing.Size(174, 21);
            ...
            this.maqu.Name = "maqu";
            this.maqu.Size = new System.Drawing.Size(174, 21);
            ...
            this.maphuongxa.Location = new System.Drawing.Point(573, 60);
            this.maphuongxa.Name = "maphuongxa";
            this.maphuongxa.Size = new System.Drawing.Size(211, 21);
            ...
            this.label11.Location = new System.Drawing.Point(656, 36);
            ...
            "Nam",
            "Nữ"});
            this.phai.Location = new System.Drawing.Point(573, 12);
            this.phai.Name = "phai";
            ...
            this.dotuoi.Location = new System.Drawing.Point(712, 12);
            this.dotuoi.Name = "dotuoi";
            this.dotuoi.Size = new System.Drawing.Size(72, 21);
            ...
            this.solieu.Size = new System.Drawing.Size(174, 21);
            ...
            this.butTim.Location = new System.Drawing.Point(276, 488);
            this.butTim.Name = "butTim";
            this.butTim.Size = new System.Drawing.Size(75, 25);
            ...
            this.butIn.Location = new System.Drawing.Point(351, 488);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(426, 488);
            ...
            this.ttlucrv.Location = new System.Drawing.Point(573, 36);
            ...
            this.Text = "Danh sách bệnh phỏng";
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTkphong_KeyDown);
		...
		private void frmTkphong_Load(object sender, System.EventArgs e)
		{
            if (Screen.PrimaryScreen.WorkingArea.Width > 800) this.WindowState = System.Windows.Forms.FormWindowState.Normal;
			ttlucrv.DisplayMember="TEN";
			ttlucrv.ValueMember="MA";
			ttlucrv.DataSource=m.get_data("select * from "+m.user+".ttxk where rakhoa=0 order by ma").Tables[0];
		...
		{
			string sql=solieu.SelectedValue.ToString().Replace("xxx",m.user);
			if (tu.Text!="")
			...
			if (dotuoi.SelectedIndex!=-1)
				sql+=" and to_number(to_char(sysdate,'yyyy'))-to_number(a.namsinh)"+dotuoi.SelectedValue.ToString();
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,solieu.Text.ToUpper()+" "+tuden,"rptTkphong.rpt");
				f.ShowDialog();
			}
			catch{}
		...
		private void frmTkphong_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void solieu_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			try
			{
				...
				makp.SelectedIndex=-1;
				ttlucrv.Enabled=solieu.SelectedIndex==1;
			}
			catch{}
		}
