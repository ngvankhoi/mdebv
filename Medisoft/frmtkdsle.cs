...
namespace Medisoft
{
	...
	/// </summary>
	public class frmtkdsle : System.Windows.Forms.Form
	{
Language lan = new Language();Bogotiengviet tv = new Bogotiengviet();private System.Windows.Forms.TextBox textBox111 = new System.Windows.Forms.TextBox();
		...
		public frmtkdsle(AccessData acc)
		{
			//
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmtkdsle));
            ...
            this.butIN.Location = new System.Drawing.Point(39, 140);
            this.butIN.Name = "butIN";
            this.butIN.Size = new System.Drawing.Size(88, 28);
            ...
            this.makp.Location = new System.Drawing.Point(56, 32);
            this.makp.Name = "makp";
            ...
            this.Text = "Thống kê danh sách khám lé";
            this.Load += new System.EventHandler(this.frmtkdsle_Load);
		...
		private void frmtkdsle_Load(object sender, System.EventArgs e)
		{
		...
		private void butIN_Click(object sender, System.EventArgs e)
		{
			...
			ds.Clear();
			sql="select a.mabn,b.hoten,to_char(a.ngay,'dd/mm/yyyy') as ngay,d.ten as tenkp,";
			...
			sql+=" from le_thuchien a,btdbn b,doituong c,le_sohoso d";
			sql+=" where a.mabn=b.mabn and a.madoituong=c.madoituong and a.sohoso=d.id";
			...
			{
				dllReportM.frmReport f=new dllReportM.frmReport(m,ds,"KHÁM LÉ"+","+((tu.Text==den.Text)?"Ngày :"+tu.Text:"Từ ngày "+tu.Text+" đến "+den.Text),"rpttkdsle.rpt");
				f.ShowDialog();
			}
		}
	}
