...
namespace Medisoft
{
	...
	public class rptBieukh : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // thongke
            // 
            this.thongke.Location = new System.Drawing.Point(8, 64);
            ...
            // benhan
            // 
            this.benhan.Location = new System.Drawing.Point(8, 90);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(209, 197);
            ...
            this.groupBox1.Controls.Add(this.benhan);
            ...
            this.chkmau2010.Location = new System.Drawing.Point(169, 90);
            this.chkmau2010.Name = "chkmau2010";
            this.chkmau2010.Size = new System.Drawing.Size(78, 24);
            this.chkmau2010.TabIndex = 13;
            ...
            this.butXem.Location = new System.Drawing.Point(65, 197);
		...
		{
			ds=m.get_data("select id from "+user+".kh_bieu_01 where "+m.for_ngay("ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')"+" order by ngay desc");
			if (ds.Tables[0].Rows.Count!=0)
			{
				...
				sql+=" from "+user+".kh_bieu_01 a,"+user+".kh_dm_01 b where a.ma=b.ma and a.id="+l_id;
				sql+=" order by a.ma";
				...
				{
					if (prn) p.Printer(m,ds,"kh_bieu_01.rpt",title.ToUpper(),2);
					else
					{
						dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_01.rpt");
						f.ShowDialog(this);
					}
				}
			}
		...
		private void bieu_02(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_02.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_03(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_03.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_04(bool prn)
		{
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_04.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_04.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_05(bool prn)
		{
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_05.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_05.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		{
			ds=m.get_data("select id from "+user+".kh_bieu_06 where "+m.for_ngay("ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')"+" order by ngay desc");
			if (ds.Tables[0].Rows.Count!=0)
			{
				decimal l_id=decimal.Parse(ds.Tables[0].Rows[0][0].ToString());
				sql="select a.ma,b.stt,b.ten,a.c01,a.c02,a.c03,a.c04,";
				...
				{
					if (prn) p.Printer(m,ds,"kh_bieu_06.rpt",title.ToUpper(),2);
					else
					{
						dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_06.rpt");
						f.ShowDialog(this);
					}
				}
			}
		...
		private void bieu_07(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_07 a,"+user+".kh_dm_07 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_07.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_07.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_08(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_08 a,"+user+".kh_dm_08 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
				ds=m.get_data("select * from "+user+"."+s_table+" order by ma");
				DataRow[] dr;
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_08.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_08.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_09(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_09 a,"+user+".kh_dm_09 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_09.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_09.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_10(bool prn)
		{
			...
			sql+="sum(a.c25) as c25,sum(a.c26) as c26,sum(a.c27) as c27,sum(a.c28) as c28,";
			sql+="sum(a.c29) as c29,sum(a.c30) as c30";
			sql+=" from "+user+".kh_bieu_10 a,"+user+".kh_dm_10 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_10.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_10.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_11(bool prn)
		{
			...
			sql+="sum(a.c13) as c13,sum(a.c14) as c14,sum(a.c15) as c15,sum(a.c16) as c16,";
			sql+="sum(a.c17) as c17,sum(a.c18) as c18,sum(a.c19) as c19,sum(a.c20) as c20";
			sql+=" from "+user+".kh_bieu_11 a,"+user+".kh_dm_11 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_11.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_11.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_121(bool prn)
		{
			...
			sql+="sum(a.c13) as c13,sum(a.c14) as c14,sum(a.c15) as c15,sum(a.c16) as c16,";
			sql+="sum(a.c17) as c17";
			sql+=" from "+user+".kh_bieu_121 a,"+user+".kh_dm_121 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_121.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_121.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_122(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_122 a,"+user+".kh_dm_122 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_122.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_122.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_123(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_123.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_124(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_124.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_131(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_131 a,"+user+".kh_dm_131 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_131.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_131.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_132(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_132.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_133(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_133.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_141(bool prn)
		{
			...
			sql+="sum(a.c21) as c21,sum(a.c22) as c22,sum(a.c23) as c23,sum(a.c24) as c24,";
			sql+="sum(a.c25) as c25,sum(a.c26) as c26,sum(a.c27) as c27,sum(a.c28) as c28";
			sql+=" from "+user+".kh_bieu_141 a,"+user+".kh_dm_141 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_141.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_141.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_142(bool prn)
		{
			...
			sql+=" from "+user+".kh_bieu_142 a,"+user+".kh_dm_142 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_142.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_142.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_143(bool prn)
		{
			...
			sql+="sum(a.c17) as c17,sum(a.c18) as c18,sum(a.c19) as c19,sum(a.c20) as c20,";
			sql+="sum(a.c21) as c21,sum(a.c22) as c22";
			sql+=" from "+user+".kh_bieu_143 a,"+user+".kh_dm_143 b where a.ma=b.ma ";
			sql+=" and "+m.for_ngay("a.ngay","'dd/mm/yyyy'")+" between to_date('" + s_tu + "','dd/mm/yyyy') and to_date('" + s_den + "','dd/mm/yyyy')";
			sql+=" group by a.ma,b.stt,b.ten order by a.ma";
			if (bPhatsinh)	ds=m.get_data(sql);
			else
			...
			{
				if (prn) p.Printer(m,ds,"kh_bieu_143.rpt",title.ToUpper(),2);
				else
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_143.rpt");
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_144(bool prn)
		{
			...
			else
			{
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,ds,title.ToUpper(),"kh_bieu_144.rpt");
					f.ShowDialog(this);
				}
			}
		}
...
//			}
			...
			else
			{
                ...
                try
                {
                    ...
                    ds.WriteXml("..//..//dataxml//kh_bieu_145.xml", XmlWriteMode.WriteSchema);
                }
                catch { }
                dsxml = ds.Copy();
				...
				{
					dllReportM.frmReport f=new dllReportM.frmReport(m,dsxml,title.ToUpper(),"kh_bieu_145.rpt",d01,d02,d03,d04,d05,d06,d07,d08,d09,d10);
					f.ShowDialog(this);
				}
			}
		}
		...
		private void bieu_15(bool prn)
		{
            ...
            else
            {
                ...
                {
                    dllReportM.frmReport f = new dllReportM.frmReport(m, ds, title.ToUpper(), "kh_bieu_15.rpt");
                    f.ShowDialog(this);
                }
            }                        
		}

        private void bieu_15_2010(bool prn)
        {           
            //Mau moi
            ds = e.kh_bieu_15_maumoi(s_tu, s_tu1, s_den, s_table, benhan.Checked, thongke.Checked, phatsinh.Checked);
            if (m.getrowbyid(ds.Tables[0], "c01+c02+c03+c04+c05+c06>0") == null)
                MessageBox.Show(lan.Change_language_MessageText("Không có số liệu !"), LibMedi.AccessData.Msg);
            else
            {
                if (prn) p.Printer(m, ds, "kh_bieu_15_mau2010.rpt", title.ToUpper(), 2);
                else
                {
                    dllReportM.frmReport f = new dllReportM.frmReport(m, ds, title.ToUpper(), "kh_bieu_15_mau2010.rpt");
                    f.ShowDialog(this);
                }
            }
        }
		...
		private void print(bool prn)
		{
			...
			switch (i_bieu)
			{
				...
				case 145: bieu_145(prn);
					break;
				case 15: 
                    if(chkmau2010.Checked) bieu_15_2010(prn);
                    else bieu_15(prn);
					break;
			}
		}
