...
namespace libxTutruc
{
	...
	public class frmXtutruc : System.Windows.Forms.Form
	{
		...
		private string user,xxx,nam,s_ngayvv,s_makho,s_makp,s_ngay,sql,s_mmyy,s_msg,s_manguon,s_nguon_doituong,s_title,s_nhom_doituong,s_mabn,s_tenkp,s_tenphieu,s_mabs,s_denngay="",f_soluong,s_madoituong="",s_makho_doituong;
		private decimal l_id=0,l_duyet=0,l_maql,l_idkhoa,l_idvpkhoa,l_mavaovien;
        private decimal d_soluongcu, d_soluong, d_soluongton, Tamung_min=0, chiphi=0,tamung=0;
        private bool bNew, bEdit, bDausinhton, bDiungthuoc, bNhapten, bMadoituong, bTrucoso, bRead, bTTngay, bLockytu, bSolan, bTru_tonao, bPhonggiuong, bMabd_madoituong, bHansd_thuoc, bThongbaoChiphi = false, bMessage_doituong=false;
		private LibList.List listDmbd;
		private LibList.List listHoten;
		private LibList.List listNv;
		private LibList.List listCachdung;
        private int d_LoaiPTTT = 0;
		...
		private void InitializeComponent()
		{
            ...
            this.dataGrid1.Size = new System.Drawing.Size(616, 415);
            ...
            this.tenbd.Location = new System.Drawing.Point(304, 454);
            ...
            this.tenhc.Location = new System.Drawing.Point(56, 477);
            ...
            this.lTenhc.Location = new System.Drawing.Point(-13, 477);
            ...
            this.mabd.Location = new System.Drawing.Point(213, 454);
            this.mabd.Name = "mabd";
            ...
            this.lTen.Location = new System.Drawing.Point(260, 454);
            this.lTen.Name = "lTen";
            ...
            this.lMabd.Location = new System.Drawing.Point(169, 454);
            ...
            this.dang.Location = new System.Drawing.Point(304, 477);
            this.dang.Mask = "";
            ...
            this.ldvt.Location = new System.Drawing.Point(256, 476);
            this.ldvt.Name = "ldvt";
            ...
            this.madoituong.Location = new System.Drawing.Point(56, 454);
            ...
            this.label20.Location = new System.Drawing.Point(373, 477);
            ...
            this.makho.Location = new System.Drawing.Point(412, 477);
            ...
            this.manguon.Location = new System.Drawing.Point(544, 477);
            ...
            this.label22.Location = new System.Drawing.Point(502, 477);
            ...
            this.vpkhoa.Location = new System.Drawing.Point(5, 503);
            ...
            this.label23.Location = new System.Drawing.Point(88, 499);
		...
		{
			sql="select a.stt,e.doituong,a.mabd,b.ma,trim(b.ten)||' '||b.hamluong as ten,nullif(b.tenhc,' ') as tenhc,b.dang,f.ten as tenkho,a.slyeucau as soluong,a.madoituong,a.makho,nullif(a.cachdung,' ') as cachdung,b.mahc,' ' as diung,a.manguon,1 as tutruc,a.idvpkhoa,a.solan,a.lan,0 as done ";
            sql += " , to_number('0') as slxuat, a.id "; 
            //sql += " from " + xxx + ".d_xtutrucct a," + user + ".d_dmbd b," + user + ".d_doituong e," + user + ".d_dmkho f ";
            ...
            sql += " left join " + xxx + ".d_xuatsdct j on a.id=j.id and a.stt=j.stt ";
            sql += " where a.mabd=b.id and a.madoituong=e.madoituong and a.makho=f.id ";
		...
		private void ref_text()
		{
			try
			{
                ...
                i_done = int.Parse(dataGrid1[i, 16].ToString());
			...
			else
			{
                ...
                if (hoten.Text == "")
                {
                    foreach (DataRow r2 in m.get_hiendien_all(s_ngay, mabn.Text).Tables[0].Rows)
                    {
                        ...
                        l_mavaovien = long.Parse(r2["mavaovien"].ToString());
                        l_maql = long.Parse(r2["maql"].ToString());
                        l_idkhoa = long.Parse(r2["id"].ToString());
		...
		private void butSua_Click(object sender, System.EventArgs e)
		{
			...
			if (s_makp!="")
			{
                ...
                //}
                //i_madoituong = int.Parse(r["madoituong"].ToString());
                //i_madoituong = m.get_madoituong(l_maql);
                //if (i_madoituong == 0) i_madoituong = m.get_madoituong(l_maql, s_ngay);
			}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            if (l_duyet == 0)
            {
                ...
                d_LoaiPTTT = Get_LoaiPTTT(l_duyet);
                d.upd_duyet(s_mmyy, l_duyet, i_nhom, s_ngay, i_loai, i_phieu, i_makp, 0, i_userid, i_makhoa, d_LoaiPTTT);
            ...
            else d.upd_duyet(s_mmyy, l_duyet, i_nhom, s_ngay, i_loai, i_phieu, i_makp, 0, i_userid, i_makhoa, d_LoaiPTTT);
			d.upd_dausinhton(s_mmyy,l_id,l_idkhoa,l_id,(bDausinhton)?ngay.Text:s_ngay,mabs.Text,manv.Text,(mach.Text!="")?decimal.Parse(mach.Text):0,(nhietdo.Text!="")?decimal.Parse(nhietdo.Text):0,huyetap.Text,(nhiptho.Text!="")?decimal.Parse(nhiptho.Text):0,(cannang.Text!="")?int.Parse(cannang.Text):0,phong.Text,giuong.Text,ghichu.Text,s_mabn);
			...
			if (!d.upd_xuatsdll(s_mmyy,l_id,i_nhom,mabn.Text,l_mavaovien,l_maql,l_idkhoa,s_ngay,i_loai,i_phieu,i_makp,i_userid,l_id,1,i_makhoa,0,0,"",s_ngay,d_LoaiPTTT,mabs.Text))
			{
            ...
            //
			d.get_xuatsdct_cstt(s_mmyy,dtct.Select("soluong>0 and idvpkhoa=0","stt"),i_makp,i_makhoa,0,l_id,mabn.Text,l_mavaovien,l_maql,l_idkhoa,i_loai,1,s_ngay,i_nhom,s_ngay,i_traituyen,mabs.Text );
            if (bFound)
            {
                ...
                {
                    sql = "update " + user + s_mmyy + ".d_tienthuoc set done=" + int.Parse(r1["done"].ToString()) + ",idttrv=" + long.Parse(r1["idttrv"].ToString());
			...
			#endregion
            //if (!kiemtrasoluong(d.get_data("select mabd,sum(soluong) as soluong from "+xxx+".d_xuatsdct where id=" + l_id + " group by mabd").Tables[0], load_thuoc()))
            //{
            //    MessageBox.Show("Số lượng không đủ trong tủ trực !", LibMedi.AccessData.Msg);
            //    del();
        ...
        {
            sql = "select mabd,sum(slyeucau) as soluong from "+xxx+".d_xtutrucct where id=" + l_id + "group by mabd";
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                if (kiemtra_vienphi())
                {
                    MessageBox.Show("Những thuốc này người bệnh " + hoten.Text + " đã thanh toán !", LibMedi.AccessData.Msg);
                    return;
                }
        ...
        private void gc_cachdung()
        {
            if (moilan.Text != "")
            {
                d_soluongcu = (soluong.Text != "") ? decimal.Parse(soluong.Text) : 0;
                r = d.getrowbyid(dtton, "ma='" + mabd.Text + "'");
        ...
        private void butIn_Click(object sender, EventArgs e)
        {
            ...
            //frmReport f = new frmReport(m, tmp, "ylenh_cstt.rpt", mabn.Text, hoten.Text, tenbs.Text, tennv.Text, s_ngay.Substring(0, 10), s_tenkp, s_tuoi, s_phai, s_tenphieu,phong.Text+"/"+giuong.Text);
            //f.ShowDialog();
        }
        ...
        private int Get_LoaiPTTT(decimal aIDDuyet)
        {
            string asql = "select * from " + xxx + ".d_duyet where id=" + aIDDuyet;
            ...
            try
            {
                ...
                {
                    a_IDPTTT = int.Parse(lds.Tables[0].Rows[0]["loaipttt"].ToString());
                }
            }
            catch { a_IDPTTT = 0; }
            return a_IDPTTT;
