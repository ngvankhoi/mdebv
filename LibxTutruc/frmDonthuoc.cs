...
namespace libxTutruc
{
	...
	public class frmDonthuoc : System.Windows.Forms.Form
	{
		...
		private void frmDonthuoc_Load(object sender, System.EventArgs e)
		{
            ...
            sql = " select '0' as nhom,0 as loai,' ' as makp,' ' as mabn,null hoten,0 as madoituong, 0 as ma ,0 as dongia, 0 as soluong , 0 as giaban ";//from " + m.user + ".d_loaiphieu where 1=2 ";
            ds = m.get_data(sql);
        ...
        private void get_data()
        {
            ...
            sql += " from xxx.d_duyet a,xxx.d_dutrull b,xxx.d_dausinhton c," + user + ".d_duockp d,"+ user + ".dmphong e,"+ user +".dmgiuong f " ;
            sql += "," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.id=b.idduyet and b.id=c.id and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) "+
                "and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+) and c.giuong=f.ma(+) and f.idphong=e.id(+) ";
            ...
            sql += " union all ";
            sql += "select distinct b.id, b.mabn,c.mabs,e.ten as phong,c.giuong, bh.sothe, bh.tungay, bh.denngay, bh.mabv, bh.traituyen, bv.tenbv, nk.maicd, nk.chandoan ";
            sql += " from xxx.d_duyet a,xxx.d_xtutrucll b, xxx.d_dausinhton c," + user + ".d_duockp d," + user + ".dmphong e," + user + ".dmgiuong f ";
            sql += "," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.id=b.idduyet and b.id=c.id and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) "+
                "and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+) and c.giuong=f.ma(+) and f.idphong=e.id(+) ";
            if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
            ...
            sql += " union all ";
            sql += "select distinct b.id, b.mabn,c.mabs,e.ten as phong,c.giuong , bh.sothe, bh.tungay, bh.denngay, bh.mabv, bh.traituyen, bv.tenbv, nk.maicd, nk.chandoan ";
            sql += " from xxx.d_duyet a,xxx.d_hoantrall b,xxx.d_dausinhton c," + user + ".d_duockp d," + user + ".dmphong e," + user + ".dmgiuong f ";
            sql += "," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.id=b.idduyet and b.id=c.id and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) "+
                "and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+) and c.giuong=f.ma(+) and f.idphong=e.id(+) ";
            if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
            ...
            sql += " from xxx.v_chidinh b," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where b.maql=nk.maql and b.maql=bh.maql and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv and b.idkhoa=nk.id(+) ";
            sql += " and to_date(to_char(b.ngay," + stime + ")," + stime + ") between to_date('" + m.DateToString("dd/MM/yyyy", dt1) + "'," + stime + ") and to_date('" + m.DateToString("dd/MM/yyyy", dt2) + "'," + stime + ")";
            //
            sql += " union all ";
            ...
            sql += " from xxx.v_vpkhoa b," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where b.maql=nk.maql and b.maql=bh.maql and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv and b.idkhoa=nk.id ";
            sql += " and to_date(to_char(b.ngay," + stime + ")," + stime + ") between to_date('" + m.DateToString("dd/MM/yyyy", dt1) + "'," + stime + ") and to_date('" + m.DateToString("dd/MM/yyyy", dt2) + "'," + stime + ")";
            // gam 26-04-2011
            ...
            if (s_loai != "3,")
            {
                if (s_loai == "" || s_loai.IndexOf("1,") != -1)
                {
                    ...
                    sql += " ,z.giaban, b.idduyet ";
                    sql += " from " + user + ".btdbn a,xxx.d_xuatsdll b,xxx.d_xuatsdct c,xxx.d_theodoi z," + user + ".d_duockp d," + user + ".d_loaiphieu e," + user + ".d_doituong f,xxx.d_dutrull g,xxx.d_duyet t," + user + ".d_dmbd bd";
                    sql += " ";
                    sql += " where a.mabn=b.mabn and b.id=c.id and c.sttt=z.id and b.idduyet=g.id and g.idduyet=t.id and b.makhoa=d.id and b.phieu=e.id and c.madoituong=f.madoituong and c.mabd=bd.id ";
                    if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
                ...
                if (s_loai == "" || s_loai.IndexOf("2,") != -1)
                {
                    ...
                    sql += " sum(c.soluong) as soluong";
                    sql += " ,z.giaban, b.idduyet ";
                    sql += " from " + user + ".btdbn a,xxx.d_xuatsdll b,xxx.d_xuatsdct c," + user + ".d_duockp d," + user + ".d_loaiphieu e," + user + ".d_doituong f,xxx.d_xtutrucll g,xxx.d_duyet t,xxx.d_theodoi z, " + user + ".d_dmbd bd";
                    sql += " where a.mabn=b.mabn and b.id=c.id and c.sttt=z.id and b.idduyet=g.id and g.idduyet=t.id and b.makhoa=d.id and b.phieu=e.id and c.madoituong=f.madoituong and c.mabd=bd.id ";
                    if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
                    if (s_madoituong != "") sql += " and c.madoituong in (" + s_madoituong.Substring(0, s_madoituong.Length - 1) + ")";
                    if (s_mabn != "") sql += " and b.mabn in (" + s_mabn.Substring(0, s_mabn.Length - 1) + ")";
            ...
            if (s_loai == "" || s_loai.IndexOf("3,") != -1)
            {
                ...
                sql += " ,z.giaban, b.idduyet ";
                sql += " from " + user + ".btdbn a,xxx.d_xuatsdll b,xxx.d_xuatsdct c,xxx.d_theodoi z," + user + ".d_duockp d," + user + ".d_loaiphieu e," + user + ".d_doituong f,xxx.d_hoantrall g,xxx.d_duyet t," + user + ".d_dmbd bd";
                sql += " where a.mabn=b.mabn and b.id=c.id and c.sttt=z.id and b.idduyet=g.id and g.idduyet=t.id and b.makhoa=d.id and b.phieu=e.id and c.madoituong=f.madoituong and c.mabd=bd.id ";
                if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
                if (s_madoituong != "") sql += " and c.madoituong in (" + s_madoituong.Substring(0, s_madoituong.Length - 1) + ")";
                if (s_mabn != "") sql += " and b.mabn in (" + s_mabn.Substring(0, s_mabn.Length - 1) + ")";
            ...
            {
                sql = "select '1' as nhom,0 as loai,b.makp,a.mabn,trim(a.hoten)||' ,Giới tính :'||case when a.phai=0 then 'Nam' else 'Nữ' end||', Năm sinh :'||a.namsinh as hoten,b.madoituong,b.mavp as ma,(b.dongia+b.vattu) as dongia,sum(b.soluong) as soluong, (b.dongia+b.vattu) as giaban, to_number('0') as idduyet";
		...
		private void upd_data(DataTable dta,string makp,string madoituong,string mabn,string hoten,string nhom,int loai,string ma,string dongia,string soluong, decimal giaban, decimal l_idxuat)
		{
		...
		private void sort(DataTable t1,DataTable t2)
		{
			...
			foreach(DataRow r in ds.Tables[0].Select("true","makp,madoituong,mabn,nhom,loai"))
			{
                ...
                upd_data((j % 2 == 0) ? t2 : t1, r["makp"].ToString(), r["madoituong"].ToString(), r["mabn"].ToString(), r["hoten"].ToString(), r["nhom"].ToString(), int.Parse(r["loai"].ToString()), r["ma"].ToString(), r["dongia"].ToString(), r["soluong"].ToString(), decimal.Parse(r["giaban"].ToString()), (r["idduyet"].ToString() == "") ? 0 : long.Parse(r["idduyet"].ToString()));
			}
		}
		...
		private void butXem_Click(object sender, System.EventArgs e)
		{
			...
			{
				dllReportM.frmReport f=new dllReportM.frmReport(m,dsxml,title,(chkCachdung.Checked)?"rpt_donthuoc_cd.rpt":"rpt_donthuoc.rpt");
				f.ShowDialog();
			}
		...
		private void butIn_Click(object sender, System.EventArgs e)
		{
            ...
            if (dsxml.Tables[0].Rows.Count > 0)
            {
                ...
                print.Printer(m, dsxml, (chkCachdung.Checked) ? "rpt_donthuoc_cd.rpt" : "rpt_donthuoc.rpt", title, (chkCachdung.Checked) ? 2 : 1);
            }
            else MessageBox.Show(lan.Change_language_MessageText("Không có số liệu !"), LibMedi.AccessData.Msg);
		}
		...
		private void butDanhsach_Click(object sender, System.EventArgs e)
		{
            ...
            sql+=" from xxx.d_duyet a,xxx.d_dutrull b,"+user+".btdbn c,"+user+".d_duockp d";
            sql += "," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv , " + user + ".nhapkhoa nk ";
			sql+=" where a.id=b.idduyet and b.mabn=c.mabn and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+)";
			if (s_makp!="") sql+=" and d.makp in ("+s_makp.Substring(0,s_makp.Length-1)+")";
			if (s_loai!="") sql+=" and a.loai in ("+s_loai.Substring(0,s_loai.Length-1)+")";
			if (s_phieu!="") sql+=" and a.phieu in ("+s_phieu.Substring(0,s_phieu.Length-1)+")";
            sql += " and to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')  between to_date('" + m.DateToString("dd/MM/yyyy", dt1) + "'," + stime + ") and to_date('" + m.DateToString("dd/MM/yyyy", dt2) + "'," + stime + ")";
			sql+=" union ";// all ";
            sql += "select distinct b.mabn,c.hoten, bh.sothe, bh.tungay, bh.denngay, bh.mabv, bh.traituyen, bv.tenbv, nk.maicd, nk.chandoan  ";
            sql += " from xxx.d_duyet a,xxx.d_xtutrucll b," + user + ".btdbn c," + user + ".d_duockp d," + user + ".bhyt bh ," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.id=b.idduyet and b.mabn=c.mabn and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+)";
			if (s_makp!="") sql+=" and d.makp in ("+s_makp.Substring(0,s_makp.Length-1)+")";
			if (s_loai!="") sql+=" and a.loai in ("+s_loai.Substring(0,s_loai.Length-1)+")";
			if (s_phieu!="") sql+=" and a.phieu in ("+s_phieu.Substring(0,s_phieu.Length-1)+")";
			...
			sql+=" union ";// all ";
            sql += "select distinct b.mabn,c.hoten, bh.sothe, bh.tungay, bh.denngay, bh.mabv, bh.traituyen, bv.tenbv, nk.maicd, nk.chandoan  ";
            sql += " from xxx.d_duyet a,xxx.d_hoantrall b," + user + ".btdbn c," + user + ".d_duockp d," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.id=b.idduyet and b.mabn=c.mabn and a.makhoa=d.id and b.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1)and bh.mabv=bv.mabv(+) and b.idkhoa=nk.id(+) ";
			if (s_makp!="") sql+=" and d.makp in ("+s_makp.Substring(0,s_makp.Length-1)+")";
			if (s_loai!="") sql+=" and a.loai in ("+s_loai.Substring(0,s_loai.Length-1)+")";
			if (s_phieu!="") sql+=" and a.phieu in ("+s_phieu.Substring(0,s_phieu.Length-1)+")";
            ...
            sql += " from xxx.v_chidinh a," + user + ".btdbn c," + user + ".btdkp_bv d," + user + ".bhyt bh," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.mabn=c.mabn and a.makp=d.makp and a.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv(+) and a.idkhoa=nk.id(+) ";
            if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
            sql += " and to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')  between to_date('" + m.DateToString("dd/MM/yyyy", dt1) + "'," + stime + ") and to_date('" + m.DateToString("dd/MM/yyyy", dt2) + "'," + stime + ")";
            //
            //vp khoa
            ...
            sql += " from xxx.v_vpkhoa a," + user + ".btdbn c," + user + ".btdkp_bv d," + user + ".bhyt bh ," + user + ".dmnoicapbhyt bv, " + user + ".nhapkhoa nk ";
            sql += " where a.mabn=c.mabn and a.makp=d.makp and a.maql=bh.maql(+) and (bh.sudung is null or bh.sudung=1) and bh.mabv=bv.mabv(+) and a.idkhoa=nk.id(+) ";
            if (s_makp != "") sql += " and d.makp in (" + s_makp.Substring(0, s_makp.Length - 1) + ")";
            sql += " and to_date(to_char(a.ngay,'dd/mm/yyyy'),'dd/mm/yyyy')  between to_date('" + m.DateToString("dd/MM/yyyy", dt1) + "'," + stime + ") and to_date('" + m.DateToString("dd/MM/yyyy", dt2) + "'," + stime + ")";
