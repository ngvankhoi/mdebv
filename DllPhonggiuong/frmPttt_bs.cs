...
namespace DllPhonggiuong
{
	public class frmPttt_bs : System.Windows.Forms.Form
	{
		...
		public frmPttt_bs(LibMedi.AccessData acc,long id)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmPttt_bs));
			...
			this.butKetthuc.Location = new System.Drawing.Point(434, 264);
			...
			this.butHuy.Location = new System.Drawing.Point(358, 264);
			...
			this.butBoqua.Location = new System.Drawing.Point(282, 264);
			...
			this.butLuu.Location = new System.Drawing.Point(206, 264);
			...
			this.butSua.Location = new System.Drawing.Point(130, 264);
			...
			this.butMoi.Location = new System.Drawing.Point(54, 264);
		...
		private void frmDiungthuoc_Load(object sender, System.EventArgs e)
		{
			...
			loai.ValueMember="ID";
			loai.DataSource=m.get_data("select * from pttt_loai order by id").Tables[0];
			load_grid();
			AddGridTableStyle();
		...
		{
			sql="select a.*,b.ten as tenloai,c.hoten as tenbs from pttt_bs a,pttt_loai b,dmbs c ";
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			{
				m.execute_data("delete from pttt_bs where mabs='"+mabs.Text+"' and id="+l_id);
