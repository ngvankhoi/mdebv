...
{
	public class frmDmloaiphong : System.Windows.Forms.Form
	{
		...
		public frmDmloaiphong(AccessData acc,int userid)
		{
			InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDmloaiphong));
			...
			this.butKetthuc.Location = new System.Drawing.Point(397, 342);
			...
			this.ten.Location = new System.Drawing.Point(224, 312);
			this.ten.Name = "ten";
			this.ten.Size = new System.Drawing.Size(288, 21);
			this.ten.TabIndex = 2;
			this.ten.Text = "";
			...
			this.butLuu.Location = new System.Drawing.Point(188, 342);
			...
			this.butBoqua.Location = new System.Drawing.Point(259, 342);
			...
			this.butHuy.Location = new System.Drawing.Point(329, 342);
			...
			this.Name = "frmDmloaiphong";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Danh mục loại phòng";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDmloaiphong_KeyDown);
			this.Load += new System.EventHandler(this.frmDmloaiphong_Load);
		...
		private void frmDmloaiphong_Load(object sender, System.EventArgs e)
		{
            s_user = m.user;
			load_grid();
			AddGridTableStyle();
		...
		{
            sql = "select * from " + s_user + ".dmloaiphong order by stt";
		...
		private void butMoi_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                stt.Value = decimal.Parse(m.get_data("select max(stt) from " + s_user + ".dmloaiphong").Tables[0].Rows[0][0].ToString()) + 1;
			}
			catch{stt.Value=1;}
			ma.Text="";
			ten.Text="";
		...
		{
			if (!kiemtra()) return;
            if (id==0) id=m.get_capid(-31);
			if (!m.upd_dmloaiphong(id,stt.Value,ma.Text,ten.Text,i_userid))
			{
		...
		{
			if (id==0) return;
            if (m.get_data("select * from " + s_user + ".dmphong where loai=" + id).Tables[0].Rows.Count > 0)
			{
				MessageBox.Show("Loại phòng đang sử dụng !",LibMedi.AccessData.Msg);
				return;
			}
			...
			{
                m.execute_data("delete from " + s_user + ".dmloaiphong where id=" + id);
				load_grid();
			}
		}
		...
		private void frmDmloaiphong_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
