...
namespace DllPhonggiuong
{
	public class frmXuatkhoa : System.Windows.Forms.Form
	{
		...
		private string s_userid,nam="",s_makp,s_tenkhoa,s_mabn,s_msg,s_ngayvv,s_ngayvk,s_ngayrk,m_nguyennhan,m_phainu,m_sosinh,s_ngayde,s_ngaybong,para,s_noicap,user,s_madoituong,s_mavt;
		private int i_userid,i_mabv,i_maba;
		...
		private System.Windows.Forms.Label l_chuyenkhoa;
		private System.Windows.Forms.Label l_thuthuat;
		private System.Windows.Forms.Label l_phauthuat;
		private System.Windows.Forms.Label l_tresosinh;
		private System.Windows.Forms.Label l_tuvong;
		private int songay=30,iTreem6,iTreem15;
		private bool b_Edit=false,b_Hoten=false,bSankhoa,bBong,bUngbuou,bNhi,bSosinh,bTamthan,b_bacsi,bHanhchinh,bLuutru_Mabn,bAdmin,bNhapsoluutru,bMabame,bKhamthai,bTiepdon,bChuyenkhoasan,bTress_bame,b101204,bKiemtra;
		private System.Windows.Forms.TextBox songaydt;
		private System.Windows.Forms.CheckBox giaiphau;
		private System.Windows.Forms.ToolTip toolTip2;
		private System.ComponentModel.IContainer components;
		private bool b_sovaovien,b_soluutru,bDenngay_sothe,bChandoan,bSoluutru_icd10,bSoluutru_sovaovien,bSoluutru,bHTDT_ngoaitru,bSoluutru_xuatvien,bChiphi_xuatkhoa,bThanhtoan_khu,bDanhmuc_nhathuoc,bDuyet,bPhonggiuong,bNdot,bSankhoa_tresosinh,bNgayra_ngayvao_1;
		...
		private string s_icd_noichuyenden,s_icd_kkb,s_icd_vaokhoa,s_icd_chinh,s_icd_kemtheo,s_icd_nguyennhan,s_mabv,s_madstt,sql,mmyy;
		...
		private System.Windows.Forms.Label l_lichhen;
		private System.Windows.Forms.CheckBox lichhen;
		...
		private System.Windows.Forms.Label l_thuoc;
		private System.Windows.Forms.Label lblme;
		private System.Windows.Forms.Label l_cls;
		private DataTable dticd=new DataTable();
	
		public frmXuatkhoa(LibMedi.AccessData acc,string makp,string hoten,int userid,int mabv,bool sovaovien,bool soluutru,string _madoituong,string _mabn,string _mavt)
		{
			InitializeComponent();
			lan.Read_Language_to_Xml(this.Name.ToString(),this);
			lan.Changelanguage_to_English(this.Name.ToString(),this);
			m=acc;s_makp=makp;s_userid=hoten;s_madoituong=_madoituong;s_mavt=_mavt;
			i_userid=userid;i_mabv=mabv;b_sovaovien=sovaovien;b_soluutru=soluutru;s_mabn=_mabn;
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmXuatkhoa));
			...
			this.l_chuyenkhoa = new System.Windows.Forms.Label();
			this.l_thuthuat = new System.Windows.Forms.Label();
			this.l_phauthuat = new System.Windows.Forms.Label();
			this.l_tresosinh = new System.Windows.Forms.Label();
			this.l_tuvong = new System.Windows.Forms.Label();
			...
			this.l_lichhen = new System.Windows.Forms.Label();
			...
			this.l_thuoc = new System.Windows.Forms.Label();
			...
			this.giuong.Location = new System.Drawing.Point(400, 358);
			...
			this.label38.Location = new System.Drawing.Point(314, 358);
			...
			this.tenketqua.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.tenketqua.Location = new System.Drawing.Point(544, 358);
			this.tenketqua.Name = "tenketqua";
			this.tenketqua.Size = new System.Drawing.Size(112, 21);
			...
			this.ketqua.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.ketqua.Location = new System.Drawing.Point(525, 358);
			...
			this.label39.Location = new System.Drawing.Point(468, 358);
			...
			this.tenttlucrv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.ttlucrv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.icd_chinh.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.icd_nguyennhan.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.tenloaibv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.loaibv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.tenbs.Location = new System.Drawing.Point(149, 450);
			...
			this.songaydt.Location = new System.Drawing.Point(280, 358);
			...
			this.label51.Location = new System.Drawing.Point(200, 358);
			...
			// chuyenkhoa
			// 
			this.chuyenkhoa.BackColor = System.Drawing.SystemColors.Control;
			this.chuyenkhoa.Enabled = false;
			this.chuyenkhoa.Location = new System.Drawing.Point(40, 600);
			this.chuyenkhoa.Name = "chuyenkhoa";
			this.chuyenkhoa.Size = new System.Drawing.Size(16, 24);
			this.chuyenkhoa.TabIndex = 122;
			this.chuyenkhoa.Visible = false;
			// 
			// thuthuat
			// 
			this.thuthuat.BackColor = System.Drawing.Color.Transparent;
			this.thuthuat.Enabled = false;
			this.thuthuat.Location = new System.Drawing.Point(658, 365);
			...
			this.phauthuat.Location = new System.Drawing.Point(658, 381);
			...
			// tuvong
			// 
			this.tuvong.BackColor = System.Drawing.Color.Transparent;
			this.tuvong.Enabled = false;
			this.tuvong.Location = new System.Drawing.Point(658, 412);
			this.tuvong.Name = "tuvong";
			this.tuvong.Size = new System.Drawing.Size(16, 14);
			this.tuvong.TabIndex = 125;
			// 
			// taibien
			// 
			this.taibien.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.taibien.Location = new System.Drawing.Point(658, 454);
			...
			this.bienchung.Location = new System.Drawing.Point(10, 492);
			...
			this.tresosinh.Location = new System.Drawing.Point(658, 396);
			...
			// label54
			// 
			this.label54.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, (System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Underline), System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.label54.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.label54.Location = new System.Drawing.Point(8, 337);
			...
			this.butTiep.Location = new System.Drawing.Point(154, 500);
			...
			this.butLuu.Location = new System.Drawing.Point(231, 500);
			...
			this.butBoqua.Location = new System.Drawing.Point(308, 500);
			...
			this.butIn.Location = new System.Drawing.Point(128, 592);
			...
			// l_chuyenkhoa
			// 
			this.l_chuyenkhoa.Cursor = System.Windows.Forms.Cursors.Hand;
			this.l_chuyenkhoa.ForeColor = System.Drawing.SystemColors.HotTrack;
			this.l_chuyenkhoa.Image = ((System.Drawing.Bitmap)(resources.GetObject("l_chuyenkhoa.Image")));
			this.l_chuyenkhoa.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_chuyenkhoa.Location = new System.Drawing.Point(0, 568);
			this.l_chuyenkhoa.Name = "l_chuyenkhoa";
			this.l_chuyenkhoa.TabIndex = 150;
			this.l_chuyenkhoa.Text = "        Chuyển khoa";
			this.l_chuyenkhoa.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_chuyenkhoa.Visible = false;
			this.l_chuyenkhoa.Click += new System.EventHandler(this.l_chuyenkhoa_Click);
			// 
			// l_thuthuat
			// 
			...
			this.l_thuthuat.Location = new System.Drawing.Point(670, 365);
			this.l_thuthuat.Name = "l_thuthuat";
			this.l_thuthuat.Size = new System.Drawing.Size(146, 14);
			this.l_thuthuat.TabIndex = 151;
			this.l_thuthuat.Text = "       Đơn thuốc mua ngoài";
			...
			// l_tresosinh
			// 
			this.l_tresosinh.Cursor = System.Windows.Forms.Cursors.Hand;
			this.l_tresosinh.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.l_tresosinh.Image = ((System.Drawing.Bitmap)(resources.GetObject("l_tresosinh.Image")));
			this.l_tresosinh.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_tresosinh.Location = new System.Drawing.Point(670, 396);
			this.l_tresosinh.Name = "l_tresosinh";
			this.l_tresosinh.Size = new System.Drawing.Size(100, 14);
			this.l_tresosinh.TabIndex = 153;
			this.l_tresosinh.Text = "       Trẻ sơ sinh";
			this.l_tresosinh.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_tresosinh.Click += new System.EventHandler(this.l_tresosinh_Click);
			// 
			// l_tuvong
			// 
			this.l_tuvong.Cursor = System.Windows.Forms.Cursors.Hand;
			this.l_tuvong.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.l_tuvong.Image = ((System.Drawing.Bitmap)(resources.GetObject("l_tuvong.Image")));
			this.l_tuvong.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_tuvong.Location = new System.Drawing.Point(670, 412);
			this.l_tuvong.Name = "l_tuvong";
			this.l_tuvong.Size = new System.Drawing.Size(100, 14);
			this.l_tuvong.TabIndex = 154;
			this.l_tuvong.Text = "       Tử vong";
			this.l_tuvong.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_tuvong.Click += new System.EventHandler(this.l_tuvong_Click);
			// 
			// giaiphau
			// 
			this.giaiphau.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.giaiphau.Location = new System.Drawing.Point(658, 494);
			...
			this.pnhi.Controls.AddRange(new System.Windows.Forms.Control[] {
																			   ...
																			   this.nhi_hoten_bo,
																			   this.label14});
			this.pnhi.Location = new System.Drawing.Point(0, 536);
			this.pnhi.Name = "pnhi";
			...
			this.label66.Location = new System.Drawing.Point(96, -2);
			...
			this.ss_hoten_me.Location = new System.Drawing.Point(256, 0);
			...
			this.ss_ns_me.Location = new System.Drawing.Point(464, 0);
			...
			this.label58.Location = new System.Drawing.Point(376, -2);
			...
			this.label56.Location = new System.Drawing.Point(496, -2);
			...
			this.label57.Location = new System.Drawing.Point(192, -2);
			...
			this.pvaovien.Controls.AddRange(new System.Windows.Forms.Control[] {
																				   ...
																				   this.label53,
																				   this.khamthai});
			this.pvaovien.Location = new System.Drawing.Point(-8, 152);
			...
			this.lblme.Location = new System.Drawing.Point(176, 6);
			this.lblme.Name = "lblme";
			this.lblme.Size = new System.Drawing.Size(0, 13);
			this.lblme.TabIndex = 213;
			// 
			// cd_vaokhoa
			// 
			...
			this.label26.Location = new System.Drawing.Point(-18, 90);
			...
			this.nhantu.Location = new System.Drawing.Point(281, 22);
			...
			this.label20.Location = new System.Drawing.Point(204, 22);
			...
			this.makp.Location = new System.Drawing.Point(281, 45);
			this.makp.Name = "makp";
			...
			// pungbuou_r
			// 
			this.pungbuou_r.Controls.AddRange(new System.Windows.Forms.Control[] {
																					 this.giaidoan_r,
																					 this.m_r,
																					 this.n_r,
																					 this.t_r,
																					 ...
																					 this.label18,
																					 this.label36});
			this.pungbuou_r.Location = new System.Drawing.Point(0, 520);
			...
			this.giaidoan_r.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.giaidoan_r.Text = "";
			// 
			// m_r
			// 
			this.m_r.BackColor = System.Drawing.SystemColors.HighlightText;
			this.m_r.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.n_r.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.t_r.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.treeView1.Location = new System.Drawing.Point(665, 176);
			this.treeView1.Name = "treeView1";
			this.treeView1.SelectedImageIndex = -1;
			this.treeView1.Size = new System.Drawing.Size(120, 80);
			this.treeView1.TabIndex = 207;
			this.treeView1.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.treeView1_AfterSelect);
			// 
			// pkhoaden
			// 
			this.pkhoaden.Controls.AddRange(new System.Windows.Forms.Control[] {
																				   this.tenkhoaden,
																				   this.khoaden,
																				   this.label65});
			this.pkhoaden.Location = new System.Drawing.Point(0, 552);
			...
			this.treeView2.Size = new System.Drawing.Size(120, 72);
			this.treeView2.TabIndex = 208;
			this.treeView2.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.treeView2_AfterSelect);
			// 
			// lkhoa
			// 
			this.lkhoa.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, (System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Underline), System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.lkhoa.ForeColor = System.Drawing.SystemColors.Highlight;
			...
			this.gphaubenh.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.gphaubenh.Location = new System.Drawing.Point(658, 515);
			...
			this.l_tainantt.Location = new System.Drawing.Point(670, 427);
			...
			this.tainantt.Location = new System.Drawing.Point(658, 427);
			...
			this.ngayrv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.ngayrv.Location = new System.Drawing.Point(109, 358);
			this.ngayrv.Mask = "##/##/#### ##:##";
			this.ngayrv.Name = "ngayrv";
			this.ngayrv.Size = new System.Drawing.Size(94, 21);
			...
			this.cmbTaibien.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.cmbTaibien.Location = new System.Drawing.Point(658, 475);
			...
			this.cd_chinh.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.cd_nguyennhan.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// l_lichhen
			// 
			this.l_lichhen.BackColor = System.Drawing.Color.Transparent;
			this.l_lichhen.Cursor = System.Windows.Forms.Cursors.Hand;
			this.l_lichhen.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.l_lichhen.Image = ((System.Drawing.Bitmap)(resources.GetObject("l_lichhen.Image")));
			this.l_lichhen.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_lichhen.Location = new System.Drawing.Point(670, 443);
			this.l_lichhen.Name = "l_lichhen";
			this.l_lichhen.Size = new System.Drawing.Size(100, 14);
			this.l_lichhen.TabIndex = 235;
			this.l_lichhen.Text = "       Lịch hẹn";
			this.l_lichhen.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lichhen
			// 
			this.lichhen.BackColor = System.Drawing.Color.Transparent;
			this.lichhen.Enabled = false;
			this.lichhen.Location = new System.Drawing.Point(658, 443);
			...
			// butVienphi
			// 
			this.butVienphi.BackColor = System.Drawing.SystemColors.Control;
			this.butVienphi.Enabled = false;
			this.butVienphi.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.butVienphi.ForeColor = System.Drawing.SystemColors.HotTrack;
			this.butVienphi.Image = ((System.Drawing.Bitmap)(resources.GetObject("butVienphi.Image")));
			this.butVienphi.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butVienphi.Location = new System.Drawing.Point(385, 500);
			this.butVienphi.Name = "butVienphi";
			this.butVienphi.Size = new System.Drawing.Size(172, 28);
			...
			// chkIn
			// 
			this.chkIn.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.chkIn.Checked = true;
			this.chkIn.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkIn.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.chkIn.Location = new System.Drawing.Point(656, -1);
			...
			this.chkIn.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			...
			this.psankhoa.Controls.AddRange(new System.Windows.Forms.Control[] {
																				   ...
																				   this.label10,
																				   this.label68});
			this.psankhoa.Location = new System.Drawing.Point(1, 528);
			...
			// thuoc
			// 
			this.thuoc.BackColor = System.Drawing.Color.Transparent;
			this.thuoc.Enabled = false;
			this.thuoc.Location = new System.Drawing.Point(658, 350);
			this.thuoc.Name = "thuoc";
			this.thuoc.Size = new System.Drawing.Size(16, 14);
			this.thuoc.TabIndex = 237;
			// 
			// l_thuoc
			// 
			this.l_thuoc.Cursor = System.Windows.Forms.Cursors.Hand;
			this.l_thuoc.ForeColor = System.Drawing.SystemColors.ActiveCaption;
			this.l_thuoc.Image = ((System.Drawing.Bitmap)(resources.GetObject("l_thuoc.Image")));
			this.l_thuoc.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_thuoc.Location = new System.Drawing.Point(670, 350);
			this.l_thuoc.Name = "l_thuoc";
			this.l_thuoc.Size = new System.Drawing.Size(146, 14);
			this.l_thuoc.TabIndex = 238;
			this.l_thuoc.Text = "       Đơn thuốc dược phát";
			this.l_thuoc.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.l_thuoc.Click += new System.EventHandler(this.l_thuoc_Click);
			// 
			// l_cls
			// 
			...
			this.l_cls.Location = new System.Drawing.Point(531, 341);
			this.l_cls.Name = "l_cls";
			this.l_cls.Size = new System.Drawing.Size(125, 14);
			this.l_cls.TabIndex = 239;
		...
		{
			bThanhtoan_khu=m.bThanhtoan_khu;bDanhmuc_nhathuoc=m.bDanhmuc_nhathuoc;bDuyet=m.bDuyet_donve;bPhonggiuong=m.bPhonggiuong;bNdot=m.bThanhtoan_ndot;bNgayra_ngayvao_1=m.bNgayra_ngayvao_1;
			b101204=m.Mabv_so==101204 || m.bNgoaitru_noitru;bSoluutru_icd10=m.bSoluutru_icd10;bSoluutru_sovaovien=m.bSoluutru_sovaovien;bSoluutru=m.bSoluutru_nam;bSankhoa_tresosinh=m.bSankhoa_tresosinh;
			if (b101204) m.upd_ttxk(8,"Chuyển HTĐT",0);
			bKiemtra=d.bKiemtra_phat_thuhoi(m.nhom_duoc);
			s_tenkhoa="";lblme.Text="";bHTDT_ngoaitru=m.bHTDT_ngoaitru;bSoluutru_xuatvien=m.bSoluutru_nam_xuatvien;
			foreach(DataRow r in d.get_data("select tenkp from btdkp_bv where makp='"+s_makp+"'").Tables[0].Rows) s_tenkhoa=r["tenkp"].ToString();
			bChiphi_xuatkhoa=m.bChiphi_xuatkhoa; bTress_bame=m.bTress_bame;bChandoan=m.bChandoan_icd10;tentb.DisplayMember="TEN";
			...
			pkhoaden.Top=472;
			user=m.user;
			mmyy=m.mmyy(m.ngayhienhanh_server);
			load_dm();
		...
		{
			if (l_maql==0 || !m.bMmyy(m.mmyy(m.ngayhienhanh_server))) return;
			thuoc.Checked=m.get_data("select * from "+d.user+m.mmyy(m.ngayhienhanh_server)+".d_thuocbhytll where nhom="+m.nhom_duoc+" and maql="+l_maql).Tables[0].Rows.Count!=0;
		...
		private void load_thuocdan()
		{
			...
			thuthuat.Checked=m.get_data(sql).Tables[0].Rows.Count!=0;
...
//			l_thuthuat.ForeColor=(thuthuat.Checked)?Color.FromArgb(255,0,0):Color.FromArgb(0,0,255);
		...
		private void load_dm()
		{
			...
			tenkp.DataSource=m.get_data("select * from btdkp_bv where loai=0 and makp<>'"+s_makp+"'"+" order by makp").Tables[0];
			try
			{
			...
			tenketqua.DataSource=m.get_data("select * from ketqua order by ma").Tables[0];
			tenketqua.SelectedIndex=-1;
			
			if (b101204) sql="select * from ttxk order by ma";
			else sql="select * from ttxk where ma<8 order by ma";
			tenttlucrv.DisplayMember="TEN";
			tenttlucrv.ValueMember="MA";
			tenttlucrv.DataSource=m.get_data(sql).Tables[0];
			...
			tenloaibv.DataSource=m.get_data("select * from loaibv order by ma").Tables[0];
			...
			gphaubenh.DataSource=m.get_data("select * from gphaubenh").Tables[0];

			cmbTaibien.DisplayMember="TEN";
			cmbTaibien.ValueMember="MA";
			cmbTaibien.DataSource=m.get_data("select * from taibien").Tables[0];
		}

		private void load_khoaden()
		{
			tenkhoaden.DataSource=m.get_data("select * from btdkp_bv where loai=0 and makp<>'01' and makp<>'"+s_makp+"'"+" order by makp").Tables[0];
		}
		...
		{
			if (maloai=="3")
				tenbv.DataSource=m.get_data("select * from tenvien where substr(maloai,1,1)='2' and mabv like '"+mabv.Text+"%'"+" and mabv<>'"+m.Mabv+"'"+" order by mabv").Tables[0];
			else
				tenbv.DataSource=m.get_data("select * from tenvien where mabv like '"+mabv.Text+"%'"+" and mabv<>'"+m.Mabv+"'"+" order by mabv").Tables[0];
		}
		...
		{
			if (this.ActiveControl==tenba) load_tenba();
		}

		private void load_tenba()
		{
			try
			{
				maba.Text=tenba.SelectedValue.ToString();
				this.Text="Xuất khoa "+m.get_data("select tenkp from btdkp_bv where makp='"+s_makp+"'").Tables[0].Rows[0][0].ToString()+"\\"+tenba.Text.Trim()+" < Người cập nhật : "+s_userid.Trim()+" >";
		...
		private bool load_vk(bool skip)
		{
			ena_but(true);
			bool ret=false;
			string sql="select * from nhapkhoa where makp='"+s_makp+"'"+" and maql="+l_maql;
			if (skip) sql+=" and to_char(ngay,'dd/mm/yyyy hh24:mi')='"+ngayvk.Text+"'";
			...
			if (ret)
			{
				...
				foreach(DataRow r in m.get_data("select a.mabs,b.hoten from nhapkhoa a,dmbs b where a.mabs=b.ma and a.id="+l_id).Tables[0].Rows)
				{
					mabs.Text=r["mabs"].ToString();tenbs.SelectedValue=mabs.Text;
					break;
				}
			}
			s_icd_vaokhoa=icd_vaokhoa.Text;
		...
		{
			ena_but(true);
			foreach(DataRow r in m.get_data("select * from xuatkhoa where id="+l_id).Tables[0].Rows)
			{
				ngayrv.Text=m.DateToString("dd/MM/yyyy HH:mm",DateTime.Parse(r["ngay"].ToString()));
				...
				s_ngayrk=ngayrv.Text;
				if (!bAdmin) ena_but(false);
			}			
			if (ngayrv.Text!="")
			{
				foreach(DataRow r in m.get_data("select * from cdnguyennhan where id="+l_id).Tables[0].Rows)
				{
					cd_nguyennhan.Text=r["chandoan"].ToString();
					icd_nguyennhan.Text=r["maicd"].ToString();
				}

				foreach(DataRow r in m.get_data("select * from cdkemtheo where loai=3 and id="+l_id+" order by stt").Tables[0].Rows)
				{
				...
				if (loaibv.Enabled)
				{
					foreach(DataRow r in m.get_data("select * from chuyenvien where maql="+l_maql).Tables[0].Rows)
					{
				...
				if (ttlucrv.Text=="5") tenkhoaden.SelectedValue=m.get_khoaden(l_id);
				try
				{
					if (bLuutru_Mabn) soluutru.Text=mabn2.Text+mabn3.Text;
					else if (bSoluutru_sovaovien) soluutru.Text=sovaovien.Text;
					else soluutru.Text=m.get_data("select soluutru from xuatvien where maql="+l_maql).Tables[0].Rows[0][0].ToString();
				}
				catch{}
			}
			else
			{
				ngayrv.Text=m.Ngaygio_hienhanh;
			}
			s_icd_chinh=icd_chinh.Text;
			s_icd_nguyennhan=icd_nguyennhan.Text;
			s_icd_kemtheo=icd_kemtheo.Text;
...
//				if (sothe.Text=="" && int.Parse(so.Substring(0,2))>0) load_bhyt();
		...
		private void tenbv_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode==Keys.Enter)
			{
				try
				{
					...
					if (loaibv.Text!="3" && m.get_data("select maloai from tenvien where mabv='"+mabv.Text+"'").Tables[0].Rows[0][0].ToString().Substring(0,1)=="2")
		...
		private void icd_chinh_Validated(object sender, System.EventArgs e)
		{
			...
			{
				if (cd_chinh.Text=="" && icd_chinh.Text==icd_vaokhoa.Text) cd_chinh.Text=cd_vaokhoa.Text;
				else
				{
		...
		private void icd_nguyennhan_Validated(object sender, System.EventArgs e)
		{
			if (icd_nguyennhan.Text!=s_icd_nguyennhan)
			{
				...
				{
					frmDMICD10 f=new frmDMICD10(m,"icd10",icd_nguyennhan.Text,cd_nguyennhan.Text,true);
					f.ShowDialog();
					if (f.mICD!="")
					{
		...
		{
			if (ngayrv.Text=="") ngayrv.Text=m.Ngaygio_hienhanh;
			if (ngayrv.Text!=s_ngayrk)
			{
				ngayrv.Text=ngayrv.Text.Trim();

				string sql="select * from nhapkhoa where makp='"+s_makp+"'"+" and maql="+l_maql;
				sql+=" and to_char(ngay,'dd/mm/yyyy hh24:mi')='"+ngayvk.Text+"'";
				if (m.get_data(sql).Tables[0].Rows.Count==0)
				{
					MessageBox.Show(lan.Change_language_MessageText("Bệnh nhân này chưa nhập khoa {")+ngayvk.Text+"}",s_msg);
					butBoqua_Click(sender,e);
					return;
				}
				if (ngayrv.Text.Length<16)
				{
					MessageBox.Show(lan.Change_language_MessageText("Yêu cầu nhập Ngày và giờ ra khoa !"),s_msg);
					ngayrv.Focus();
					return;
				}
				...
				ngayrv.Text=m.Ktngaygio(ngayrv.Text,16);
				if (!m.bNgaygio(ngayrv.Text,ngayvk.Text))
				{
				...
				if (ngayde.Text!="")
				{
					if (!m.bNgaygio(ngayrv.Text,ngayde.Text))
					{
						MessageBox.Show(lan.Change_language_MessageText("Ngày ra khoa không được nhỏ hơn ngày để(mỗ) !"),s_msg);
						ngayrv.Focus();
						return;
					}
				}
			...
			else if (!bNhapsoluutru) soluutru.Text="";
		...
		{
			thuoc.Checked=false;
			l_thuoc.ForeColor=Color.FromArgb(0,0,255);
			tuvong.Checked=false;
			l_tuvong.ForeColor=Color.FromArgb(0,0,255);
			...
			tresosinh.Checked=false;
			l_tresosinh.ForeColor=Color.FromArgb(0,0,255);
		...
		private bool kiemtra()
		{
			...
			if (ngayrv.Text!="")
			{
				...
				{
					string s_mmyy="",s_ngay=m.ngayhienhanh_server;
					sql="select mmyy from d_table ";
					...
					sql="select to_char(ngay,'dd/mm/yyyy hh24:mi') as ngay from "+m.user+"d"+s_mmyy+".d_tienthuoc where mabn='"+s_mabn+"' and maql="+l_maql+" order by ngay";
					tmp=m.get_data(sql).Tables[0];
					if (tmp.Rows.Count>0)
					{
						if (!m.bNgaygio(ngayrv.Text,tmp.Rows[0]["ngay"].ToString()))
						{
							MessageBox.Show("Ngày giờ ra viện không hợp lệ \nSo với ngày duyệt thuốc là :"+tmp.Rows[0]["ngay"].ToString(),LibMedi.AccessData.Msg);
							ngayrv.Focus();
							return false;
						}					
					}
...
//				}
			...
			if (!b101204)
			{
				if(tenttlucrv.SelectedValue.ToString()=="5" && !bNdot && !bThanhtoan_khu)
				{
					if (m.get_thvpll(m.mmyy(ngayrv.Text),l_maql))
					{
			...
			if ((ttlucrv.Text == "5" || ttlucrv.Text == "8") && m.get_data("select * from xuatvien where maql=" + l_maql).Tables[0].Rows.Count > 0)
			{
				MessageBox.Show("Người bệnh đã xuất viện không được sửa tình trạng !", LibMedi.AccessData.Msg);
				ttlucrv.Focus();
				return false;
			}
			if (ngayrv.Text!="" && (bSoluutru_icd10 || bSoluutru) && !(ttlucrv.Text=="5" || ttlucrv.Text=="8") && !bSoluutru_xuatvien)
			{
				if (m.get_data("select * from xuatvien where maql="+l_maql).Tables[0].Rows.Count==0)
				{
					if (bSoluutru_icd10) soluutru.Text=m.get_soluutru(l_maql,icd_chinh.Text,ngayrv.Text);
					else if (!bSoluutru_xuatvien) soluutru.Text=m.get_soluutru(ngayrv.Text);
					soluutru.Update();
				}
			}
			if (ngayrv.Text!="" && tenba.SelectedValue.ToString()=="BSA" && bSankhoa_tresosinh && ttlucrv.Text!="5" && ttlucrv.Text!="8")
			{
				if (m.get_data("select * from tresosinh where maql="+l_maql).Tables[0].Rows.Count==0)
				{
					MessageBox.Show("Chưa nhập thông tin trẻ sơ sinh !",LibMedi.AccessData.Msg);
					return false;
				}
			}
			return true;
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (ngayrv.Text!="")
			{
				...
				if (m.get_data("select * from xuatkhoa where id="+l_id).Tables[0].Rows.Count>0)
				{
					m.upd_eve_tables(itable, i_userid, "upd");
					m.upd_eve_upd_del(itable, i_userid, "upd",l_id.ToString()+"^"+ngayrv.Text+"^"+ketqua.Text+"^"+ttlucrv.Text+"^"+cd_chinh.Text.Trim()+"^"+icd_chinh.Text+"^"+mabs.Text+"^"+((bienchung.Checked)?"1":"0")+"^"+((taibien.Checked)?cmbTaibien.SelectedValue.ToString():"0")+"^"+((giaiphau.Checked)?gphaubenh.SelectedValue.ToString():"0")+"^"+i_userid.ToString());
				}
				else
				{
					...
					if (bPhonggiuong)
					{
						...
						double songay=0;
						foreach(DataRow r1 in m.get_data("select id,to_char(tu,'dd/mm/yyyy hh24:mi') as tu,dongia,idgiuong,madoituong from theodoigiuong where idkhoa="+l_id+" and soluong=0").Tables[0].Rows)
						{
							songay=(bNgayra_ngayvao_1)?m.songaygiuong(m.StringToDateTime(ngayrv.Text),m.StringToDateTime(r1["tu"].ToString()),1,int.Parse(r1["idgiuong"].ToString())):Math.Max(1,m.songay(m.StringToDateTime(ngayrv.Text),m.StringToDateTime(r1["tu"].ToString()),0));
							m.upd_theodoigiuong(long.Parse(r1["id"].ToString()),ngayrv.Text,1,songay);
							v.upd_vpkhoa(m.mmyy(m.ngayhienhanh_server),long.Parse(r1["id"].ToString()),s_mabn,l_maql,l_id,ngayrv.Text,s_makp,int.Parse(r1["madoituong"].ToString()),int.Parse(r1["idgiuong"].ToString()),Convert.ToDecimal(songay),decimal.Parse(r1["dongia"].ToString()),0,i_userid,0);
							m.execute_data("update dmgiuong set soluong=soluong-1,tinhtrang=0 where id="+int.Parse(r1["idgiuong"].ToString()));
							m.upd_eve_tables(itable,i_userid,"upd");
				...
				if (!m.upd_xuatkhoa(l_id,ngayrv.Text,int.Parse(ketqua.Text),int.Parse(ttlucrv.Text),cd_chinh.Text,icd_chinh.Text,mabs.Text,(bienchung.Checked)?1:0,(taibien.Checked)?int.Parse(cmbTaibien.SelectedValue.ToString()):0,(giaiphau.Checked)?int.Parse(gphaubenh.SelectedValue.ToString()):0,i_userid))
				{
					MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin ra khoa !"),s_msg);
					return;
				}
				if (ttlucrv.Text=="5" || (ttlucrv.Text=="8" && !bHTDT_ngoaitru))
				{
					string s_khoaden=(ttlucrv.Text=="5")?khoaden.Text:s_makp;
					if (!m.upd_chuyenkhoa(l_id,s_mabn,l_maql,s_makp,ngayrv.Text,s_khoaden,cd_chinh.Text,icd_chinh.Text,i_userid))
					{
					...
					if(id_new<=0) id_new=m.get_capid(2);
					m.upd_hiendien(id_new,s_mabn,l_maql,s_khoaden,ngayrv.Text,s_makp,0,0);
				}
				else
				{
					DataTable dt1=m.get_data("select to_char(ngay,'dd/mm/yyyy hh24:mi') as ngay from pttt where maql="+l_maql+" order by ngay desc,id desc").Tables[0];
					if (dt1.Rows.Count!=0)
					{
						string s_ngaypt=dt1.Rows[0][0].ToString();
						if (!m.bNgaygio(ngayrv.Text,s_ngaypt))
						{
					...
					{
						m.upd_eve_tables(itable, i_userid, "upd");
						m.upd_eve_upd_del(itable, i_userid, "upd",s_mabn+"^"+l_maql.ToString()+"^"+s_makp+"^"+ngayrv.Text+"^"+ketqua.Text+"^"+ttlucrv.Text+"^"+cd_chinh.Text.Trim()+"^"+icd_chinh.Text+"^"+mabs.Text+"^"+soluutru.Text+"^"+((bienchung.Checked)?"1":"0")+"^"+((taibien.Checked)?cmbTaibien.SelectedValue.ToString():"0")+"^"+((giaiphau.Checked)?gphaubenh.SelectedValue.ToString():"0")+"^"+i_userid.ToString());
					}
					else m.upd_eve_tables(itable, i_userid, "ins");
					if (!m.upd_xuatvien(s_mabn,l_maql,s_makp,ngayrv.Text,int.Parse(ketqua.Text),int.Parse(ttlucrv.Text),cd_chinh.Text,icd_chinh.Text,mabs.Text,soluutru.Text,(bienchung.Checked)?1:0,(taibien.Checked)?int.Parse(cmbTaibien.SelectedValue.ToString()):0,(giaiphau.Checked)?int.Parse(gphaubenh.SelectedValue.ToString()):0,i_userid))
					{
						MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin ra viện !"),s_msg);
						return;
					}
					foreach(DataRow r in m.get_data("select * from cdkemtheo where id="+l_id).Tables[0].Rows)
						m.upd_cdkemtheo(l_id,l_maql,4,r["chandoan"].ToString(),r["maicd"].ToString(),int.Parse(r["stt"].ToString()));
					//binh					
				...
				else m.execute_data("delete from cdnguyennhan where id="+l_id);
				if (cd_kemtheo.Text!="") m.upd_cdkemtheo(l_id,l_maql,3,cd_kemtheo.Text,icd_kemtheo.Text,1);
				else m.execute_data("delete from cdkemtheo where stt=1 and loai=3 and id="+l_id);
				if (loaibv.Enabled && loaibv.Text!="") m.upd_chuyenvien(l_maql,mabv.Text,int.Parse(loaibv.Text));
				else m.execute_data("delete from chuyenvien where maql="+l_maql);
			}
			upd_khac();
			try
			{
			...
			ena_but(false);
			if (tenttlucrv.SelectedValue.ToString()=="8" && bHTDT_ngoaitru) upd_ngoaitru();
			if (bChiphi_xuatkhoa)
			{
				bool b1khu=true;
				if (bThanhtoan_khu)
				{
					...
					b1khu=m.get_data(sql).Tables[0].Rows.Count<2;
				}
				if ((tenttlucrv.SelectedValue.ToString()!="8" || bHTDT_ngoaitru) && tenttlucrv.SelectedValue.ToString()!="5" && !bNdot && !bTress_bame && b1khu)
				{
					if (bDuyet)
					{
						if (!m.get_thvpll(m.mmyy(ngayrv.Text),l_maql)) butVienphi_Click(null,null);
					}
					else if (!thuoc.Checked) if (!m.get_thvpll(m.mmyy(ngayrv.Text),l_maql)) butVienphi_Click(null,null);
				}
			}
			butTiep.Focus();
		}

		private void upd_ngoaitru()
		{
			string so=m.sothe(int.Parse(tendoituong.SelectedValue.ToString()));
			l_maql=m.get_maql(2,s_mabn,s_makp,ngayrv.Text,true);
			if (!m.upd_lienhe(l_maql,sonha.Text,thon.Text,cholam.Text,matt.Text,maqu1.Text+maqu2.Text,mapxa1.Text+mapxa2.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),0,0))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin hành chính !"),s_msg);
				return;
			}
			if (!m.upd_benhandt(s_mabn,l_maql,s_makp,ngayrv.Text,int.Parse(dentu.Text),int.Parse(nhantu.Text),1,int.Parse(tendoituong.SelectedValue.ToString()),cd_kkb.Text,icd_kkb.Text,mabs.Text,sovaovien.Text,2,i_userid,true,l_maql))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin vào viện !"),s_msg);
				return;
			}
			l_id=m.get_id(l_maql,khoaden.Text,ngayrv.Text);
			if (!m.upd_nhapkhoa(l_id,s_mabn,l_maql,s_makp,20,ngayrv.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),"","01",cd_chinh.Text,icd_chinh.Text,mabs.Text,1,i_userid))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật được thông tin vào viện !"),s_msg);
				return;
			}
		...
		private void ngayvv_Validated(object sender, System.EventArgs e)
		{
			...
			if (ngayvv.Text!=s_ngayvv || cd_kkb.Text=="")
			{
				ref_check();
				try
				{
				...
				else
				{
					...
					MessageBox.Show(lan.Change_language_MessageText("Bệnh nhân chưa nhập viện ngày {")+ngayvv.Text+"}",s_msg);
					butBoqua_Click(null,null);
				}
			}
		}
		...
		private void l_chuyenkhoa_Click(object sender, System.EventArgs e)
		{
			...
			frmChuyenkhoa f=new frmChuyenkhoa(m,s_mabn,hoten.Text,namsinh.Text,s_makp,l_maql,i_userid,i_maba,mabs.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),giuong.Text,ngayvv.Text,ngayrv.Text,(ngayrv.Text!="")?s_makp:"","");
			f.ShowDialog(this);
			load_chuyenkhoa();
		}
		...
		private void l_tuvong_Click(object sender, System.EventArgs e)
		{
			...
			frmTuvong f=new frmTuvong(m,s_mabn,hoten.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),ngayrv.Text,songaydt.Text,l_maql,i_userid);
			f.ShowDialog();
			load_tuvong();
		}
		...
		private void l_phauthuat_Click(object sender, System.EventArgs e)
		{
			...
			frmPttt f=new frmPttt(m,s_makp,s_mabn,hoten.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),phai.Text,sonha.Text.Trim()+" "+thon.Text,sothe.Text,giuong.Text,ngayvv.Text,cd_vaokhoa.Text,icd_vaokhoa.Text,"P",i_userid,ngayrv.Text,"","","","","",0,0,0,0,0,"",0);
			f.ShowDialog();
			load_phauthuat();
		}
		...
		private void l_thuthuat_Click(object sender, System.EventArgs e)
		{
			...
			if (bDanhmuc_nhathuoc)
			{
				...
				string s_mmyy=m.mmyy(ngayrv.Text);
				if (!m.bMmyy(s_mmyy)) d.tao_user_mmyy(s_mmyy,i_userid);
				...
				//
				string s_makho=d.get_dmkho(7).Trim(),s_ngay=ngayrv.Text,s_ngayht=m.ngayhienhanh_server;
				DataTable dtletet=m.get_data("select * from letet").Tables[0];
				...
				if (s_makho!="")
				{
					sql="select * from d_dmkho where id in ("+s_makho.Substring(0,s_makho.Length-1)+")";
				...
				//
				frmBaohiem f=new frmBaohiem(false,s_mabn,7,s_mmyy,ngayrv.Text,m.nhom_nhathuoc,i_userid,"Đơn thuốc mua ngoài",l_maql,hoten.Text,namsinh.Text,sothe.Text,s_tenkhoa,tenbs.Text,icd_chinh.Text,cd_chinh.Text,2,s_makp,mabs.Text,tendoituong.Text,sonha.Text.Trim()+" "+thon.Text.Trim()+","+tenpxa.Text.Trim()+"-"+tenquan.Text.Trim()+"-"+tentinh.Text.Trim(),nam,1,s_makho,s_madoituong,s_noicap,phai.Text);
				f.ShowDialog(this);
				load_thuocdan();
			}
			else
			{
				frmToathuoc f2=new frmToathuoc(m,s_mabn,hoten.Text,tuoi.Text+" "+loaituoi.Text,ngayrv.Text,s_makp,s_tenkhoa,mabs.Text,tenbs.Text,cd_chinh.Text,icd_chinh.Text,l_maql,i_userid,sonha.Text.Trim()+" "+thon.Text.Trim()+" "+tenpxa.Text.Trim()+","+tenquan.Text.Trim()+","+tentinh.Text.Trim(),phai.Text);
				f2.ShowDialog(this);
				load_thuocdan();
			}
		}
...
//			}
		...
		private void ss_hoten_me_Validated(object sender, System.EventArgs e)
		{
			//			if (ss_hoten_me.Text=="")
			//			{
			//				MessageBox.Show("Nhập họ tên mẹ !",s_msg);
			//				ss_hoten_me.Focus();
			//				return;
			//			}
		...
		private void cd_nguyennhan_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				if (bChandoan || icd_nguyennhan.Text=="")
				{
		...
		private void delete_hiendien_do_chuyenkhoa(string s_mabn, long s_maql, string s_noichuyen)
		{
			...
			if(dt.Rows.Count>0)
			{
				sql="delete from hiendien where id="+dt.Rows[0]["id"].ToString();
				m.execute_data(sql);
			}
			dt.Dispose();
		}
		private long get_id_hiendien_do_chuyenkhoa(string s_mabn, long s_maql, string s_noichuyen)
		{
			long lid=0;
			sql="select * from hiendien where mabn='"+s_mabn+"' and maql="+s_maql+" and noichuyen='" +s_noichuyen+"' and nhapkhoa=0 and xuatkhoa=0 order by id desc";
			DataTable dt=m.get_data(sql).Tables[0];
		...
		private string bHiendien(long m_maql, string s_makp)
		{
			try
			{
				return m.get_data("select trim(b.tenkp)||' '||to_char(a.ngay,'dd/mm/yyyy hh24:mi') from hiendien a,btdkp_bv b where a.makp=b.makp and a.nhapkhoa=1 and a.xuatkhoa=0 and a.maql="+m_maql+" and a.makp!='"+s_makp+"'").Tables[0].Rows[0][0].ToString();
			}
			catch{return "";}
		}
		...
		private bool Get_def_inttrv()
		{
			...
			if(File.Exists("..\\..\\..\\xml\\d_def_inttrv.xml")==false)
			{
				sql="select 1 def_inttrv from dual";
				ds=m.get_data(sql);
				ds.WriteXml("..\\..\\..\\xml\\d_def_inttrv.xml",XmlWriteMode.WriteSchema);
				return true;
			}
			else
			{
		...
		private void butVienphi_Click(object sender, System.EventArgs e)
		{
			...
			DataSet dsxml=m.get_thanhtoan(l_maql,l_id,ngayvv.Text,ngayrv.Text,1,s_userid,s_makp);
			...
			if (dsxml.Tables[0].Rows.Count>0)
			{
				...
				else MessageBox.Show("Đã chuyển số liệu xuống phòng thanh toán.","Xuất khoa",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
			}
		...
		private void tentb_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode==Keys.Enter || e.KeyCode==Keys.Tab)
			{
				...
				if (tentb.SelectedIndex!=-1) matb.Text=tentb.SelectedValue.ToString();
				SendKeys.Send("{Tab}");
			}
		}
		...
		{
			if (ngayrv.Text=="" || ttlucrv.Text=="5") return;
			string s_mabs=mabs.Text,s_tenbs=tenbs.Text,s_maicd=icd_chinh.Text,s_chandoan=cd_chinh.Text;
//			if (s_mabs=="")
//			{
//				l_id=m.get_id(l_maql,s_makp,ngayvk.Text);
//				foreach(DataRow r in m.get_data("select a.mabs,b.hoten from nhapkhoa a,dmbs b where a.mabs=b.ma and a.id="+l_id).Tables[0].Rows)
//				{
//					s_mabs=r["mabs"].ToString();s_tenbs=r["hoten"].ToString();
//					break;
//				}
//			}
			s_mabn=mabn2.Text+mabn3.Text;
...
//			if (m.get_data("select * from d_thuocbhytll where maql="+l_maql).Tables[0].Rows.Count==0)
//			{
//				thuoc.Checked=true;
//				if (!kiemtra()) return;
//				butLuu_Click(null,null);
//			}
			...
			frmBaohiem f=new frmBaohiem(false,s_mabn,(madoituong.Text=="1")?5:6,s_mmyy,ngayrv.Text,m.nhom_duoc,i_userid,"Đơn thuốc dược phát",l_maql,hoten.Text,namsinh.Text,sothe.Text,s_tenkhoa,s_tenbs,(icd_chinh.Text!="")?s_maicd:icd_vaokhoa.Text,(cd_chinh.Text!="")?s_chandoan:cd_vaokhoa.Text,int.Parse(madoituong.Text),s_makp,s_mabs,tendoituong.Text,(cholam.Text.Trim()!="")?cholam.Text:sonha.Text.Trim()+" "+thon.Text.Trim()+","+tenpxa.Text.Trim()+"-"+tenquan.Text.Trim()+"-"+tentinh.Text.Trim(),nam,1,"","",s_noicap,phai.Text);
			f.ShowDialog(this);
			if (m.get_data("select * from "+d.user+s_mmyy+".d_thuocbhytll where maql="+l_maql+" and to_char(ngay,'dd/mm/yyyy')='"+ngayrv.Text.Substring(0,10)+"'").Tables[0].Rows.Count>0)
			{
				m.upd_tiepdon_mmyy(s_mabn,l_maql,s_makp,ngayrv.Text,int.Parse(madoituong.Text),sovaovien.Text,tuoi.Text.PadLeft(3,'0')+loaituoi.SelectedIndex.ToString(),0,i_userid,LibMedi.AccessData.Khambenh,0,l_maql);
				m.upd_sukien(ngayrv.Text,s_mabn,l_maql,LibMedi.AccessData.Khambenh,l_maql);
				if (sothe.Text!="") m.upd_bhyt(ngayrv.Text,s_mabn,l_maql,sothe.Text,denngay.Text,s_noicap);
			}
			load_baohiem();
		}
		...
		{
			string s="";
			foreach(DataRow r in m.get_data("select madoituong from d_dmphieu where id="+loai).Tables[0].Rows) 
				s=r["madoituong"].ToString().Trim();
			if (s!="")
			{
				if (m.get_data("select * from d_dmphieu where id="+loai+" and madoituong like '%"+madoituong.Text.Trim()+",%'").Tables[0].Rows.Count==0)
				{
					MessageBox.Show("Đối tượng \n"+tendoituong.Text+"\nKhông được cấp thuốc !",LibMedi.AccessData.Msg);
					return false;
				}
			}
			return true;
