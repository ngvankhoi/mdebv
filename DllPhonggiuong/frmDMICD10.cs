...
namespace DllPhonggiuong
{
	public class frmDMICD10 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.btChon.Location = new System.Drawing.Point(264, 360);
			this.btChon.Name = "btChon";
			this.btChon.Size = new System.Drawing.Size(80, 28);
			...
			this.butKetthuc.Location = new System.Drawing.Point(351, 360);
			this.butKetthuc.Name = "butKetthuc";
			this.butKetthuc.Size = new System.Drawing.Size(81, 28);
		...
		private void frmDMICD10_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				mFormat.f_LoadDG(dataGrid1,m.get_data("select CICD10,VVIET from "+s_table),new string[] {"Mã ICD","Tên bệnh tiếng việt                                                                                    .","Tên bệnh tiếng anh"},new string[] {"CICD10","VVIET"});
