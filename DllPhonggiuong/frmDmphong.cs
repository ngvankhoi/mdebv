...
namespace DllPhonggiuong
{
	public class frmDmphong : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDmphong));
			...
			this.butMoi.Size = new System.Drawing.Size(68, 28);
			...
			this.butSua.Size = new System.Drawing.Size(66, 28);
			...
			this.butLuu.Location = new System.Drawing.Point(236, 342);
			this.butLuu.Name = "butLuu";
			this.butLuu.Size = new System.Drawing.Size(69, 28);
			...
			this.butBoqua.Location = new System.Drawing.Point(307, 342);
			...
			this.butHuy.Location = new System.Drawing.Point(377, 342);
			this.butHuy.Name = "butHuy";
			this.butHuy.Size = new System.Drawing.Size(66, 28);
			...
			this.loaivp.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.dichvu.Location = new System.Drawing.Point(24, 336);
			this.dichvu.Name = "dichvu";
			this.dichvu.Size = new System.Drawing.Size(64, 16);
		...
		private void frmDmphong_Load(object sender, System.EventArgs e)
		{
            ...
            sql = "select * from " + s_user + ".v_loaivp";
			...
			loai.ValueMember="ID";
            loai.DataSource = m.get_data("select * from " + s_user + ".dmloaiphong order by stt").Tables[0];
			makp.DisplayMember="TENKP";
			makp.ValueMember="MAKP";
            makp.DataSource = m.get_data("select * from " + s_user + ".btdkp_bv where makp<>'01' and loai in (0,4) order by loai,makp").Tables[0];
			load_grid();
			AddGridTableStyle();
		...
		{
            sql = "select a.*,b.ten as tenloai,c.ten as tenloaivp from " + s_user + ".dmphong a, " + s_user + ".dmloaiphong b, " + s_user + ".v_loaivp c where a.loai=b.id and a.loaivp=c.id and a.makp='" + makp.SelectedValue.ToString() + "' order by a.stt";
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
            ...
            m.execute_data("update " + s_user + ".dmphong set dichvu=" + ((dichvu.Checked) ? 1 : 0) + " where id=" + id);
			load_grid();
			ena_object(false);
		}
		...
		{
			if (id==0) return;
            if (m.get_data("select * from " + s_user + ".dmgiuong where idphong=" + id).Tables[0].Rows.Count > 0)
			{
				MessageBox.Show("Phòng đang sử dụng !",LibMedi.AccessData.Msg);
				return;
			}
			...
			{
                m.execute_data("delete from " + s_user + ".dmphong where id=" + id);
				load_grid();
			}
		}
