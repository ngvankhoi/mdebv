...
namespace DuTruKhoTTB
{
	...
	public class frmChongoi : System.Windows.Forms.Form
	{
		...
		public frmChongoi(LibTTB.AccessData acc,int loai,int nhom)
		{
			//
            ...
            ttb = acc; i_loai = loai; i_nhom = nhom; if (ttb.bBogo) tv.GanBogo(this, textBox111);
			//
		...
		private void InitializeComponent()
		{
            ...
            this.butKetthuc.Location = new System.Drawing.Point(289, 348);
            ...
            this.dataGrid2.Size = new System.Drawing.Size(567, 334);
            ...
            this.lmabs.Size = new System.Drawing.Size(417, 21);
            ...
            this.butTiep.Size = new System.Drawing.Size(68, 25);
            ...
            this.tim.Location = new System.Drawing.Point(460, 2);
            this.tim.Name = "tim";
		...
		{
            sql = "select * from " + user + ".ttb_theodonll where mabs='' and ghichu<>'' and stt="+i_loai+" order by ghichu";
		...
		private void load_chitiet()
		{
            ...
            sql+="b.soluong,b.cachdung,a.mahc ";
            sql += " from " + user + ".ttb_dmbd a," + user + ".ttb_theodonct b,"+user+".ttb_dmhang c ";
