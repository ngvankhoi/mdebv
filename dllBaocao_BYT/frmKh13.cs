...
namespace dllBaocao_BYT
{
	...
	public class frmKh13 : System.Windows.Forms.Form
	{
        ...
        private void kiemtranhap(int row)
        {
            ...
            if (row >= 2 && row <= 6)
            {
                if (decimal.Parse(dataGrid1[3, 3].ToString()) + decimal.Parse(dataGrid1[4, 3].ToString()) + decimal.Parse(dataGrid1[5, 3].ToString()) + decimal.Parse(dataGrid1[6, 3].ToString()) > decimal.Parse(dataGrid1[2, 3].ToString()))
                {
            ...
            if (row >= 10 && row <= 12)
            {
                if (decimal.Parse(dataGrid1[10, 3].ToString()) > decimal.Parse(dataGrid1[1, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
                }
                if (decimal.Parse(dataGrid1[11, 3].ToString()) + decimal.Parse(dataGrid1[12, 3].ToString()) > decimal.Parse(dataGrid1[10, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (row >= 14 && row <= 15)
            {
                if (decimal.Parse(dataGrid1[15, 3].ToString()) > decimal.Parse(dataGrid1[14, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (decimal.Parse(dataGrid1[16, 3].ToString()) > decimal.Parse(dataGrid1[14, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[17, 3].ToString()) > decimal.Parse(dataGrid1[16, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[18, 3].ToString()) > decimal.Parse(dataGrid1[16, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[19, 3].ToString()) > decimal.Parse(dataGrid1[16, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[20, 3].ToString()) > decimal.Parse(dataGrid1[19, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (row >= 20 && row <= 23)
            {
                if (decimal.Parse(dataGrid1[21, 3].ToString()) + decimal.Parse(dataGrid1[22, 3].ToString()) + decimal.Parse(dataGrid1[23, 3].ToString()) > decimal.Parse(dataGrid1[20, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (decimal.Parse(dataGrid1[24, 3].ToString()) > decimal.Parse(dataGrid1[19, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (row >= 24 && row <= 27)
            {
                if (decimal.Parse(dataGrid1[25, 3].ToString()) + decimal.Parse(dataGrid1[26, 3].ToString()) + decimal.Parse(dataGrid1[27, 3].ToString()) > decimal.Parse(dataGrid1[24, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (decimal.Parse(dataGrid1[28, 3].ToString()) > decimal.Parse(dataGrid1[16, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (decimal.Parse(dataGrid1[29, 3].ToString()) + decimal.Parse(dataGrid1[30, 3].ToString()) + decimal.Parse(dataGrid1[31, 3].ToString()) > decimal.Parse(dataGrid1[28, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[32, 3].ToString()) > decimal.Parse(dataGrid1[28, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (decimal.Parse(dataGrid1[33, 3].ToString()) > decimal.Parse(dataGrid1[16, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (row >= 33 && row <= 36)
            {
                if (decimal.Parse(dataGrid1[34, 3].ToString()) + decimal.Parse(dataGrid1[35, 3].ToString()) + decimal.Parse(dataGrid1[36, 3].ToString()) > decimal.Parse(dataGrid1[33, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (decimal.Parse(dataGrid1[40, 3].ToString()) > decimal.Parse(dataGrid1[39, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[41, 3].ToString()) > decimal.Parse(dataGrid1[39, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (decimal.Parse(dataGrid1[43, 3].ToString()) > decimal.Parse(dataGrid1[42, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (decimal.Parse(dataGrid1[44, 3].ToString()) > decimal.Parse(dataGrid1[42, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            ...
            if (row >= 47 && row <= 51)
            {
                if (decimal.Parse(dataGrid1[48, 3].ToString()) > decimal.Parse(dataGrid1[47, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
                }
                if (decimal.Parse(dataGrid1[49, 3].ToString()) + decimal.Parse(dataGrid1[50, 3].ToString()) + decimal.Parse(dataGrid1[51, 3].ToString()) > decimal.Parse(dataGrid1[48, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (row >= 52 && row <= 56)
            {
                if (decimal.Parse(dataGrid1[53, 3].ToString()) > decimal.Parse(dataGrid1[52, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
                }
                if (decimal.Parse(dataGrid1[54, 3].ToString()) + decimal.Parse(dataGrid1[55, 3].ToString()) + decimal.Parse(dataGrid1[56, 3].ToString()) > decimal.Parse(dataGrid1[53, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (row >= 57 && row <= 61)
            {
                if (decimal.Parse(dataGrid1[58, 3].ToString()) > decimal.Parse(dataGrid1[57, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
                }
                if (decimal.Parse(dataGrid1[59, 3].ToString()) + decimal.Parse(dataGrid1[60, 3].ToString()) + decimal.Parse(dataGrid1[61, 3].ToString()) > decimal.Parse(dataGrid1[58, 3].ToString()))
                {
                    MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    dataGrid1[row, 3] = 0;
                    return;
            ...
            if (decimal.Parse(dataGrid1[64, 3].ToString()) > decimal.Parse(dataGrid1[63, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[66, 3].ToString()) > decimal.Parse(dataGrid1[65, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
            }
            if (decimal.Parse(dataGrid1[69, 3].ToString()) > decimal.Parse(dataGrid1[68, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, 3] = 0;
                return;
