...
namespace dllBaocao_BYT
{
	...
	/// </summary>
	public class frmKh124 : System.Windows.Forms.Form
	{
		...
		public frmKh124(AccessData acc,string hoten,int userid,int mabv)
		{
			//
        ...
        public frmKh124( string hoten, int userid, int mabv)
        {
            //
            // Required for Windows Form Designer support
            //
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKh124));
            ...
            this.butMoi.Size = new System.Drawing.Size(81, 25);
            ...
            this.butSua.Size = new System.Drawing.Size(81, 25);
            ...
            this.butLuu.Location = new System.Drawing.Point(317, 500);
            this.butLuu.Name = "butLuu";
            this.butLuu.Size = new System.Drawing.Size(81, 25);
            ...
            this.butBoqua.Size = new System.Drawing.Size(81, 25);
            ...
            this.butKetthuc.Location = new System.Drawing.Point(560, 500);
            ...
            this.butHuy.Size = new System.Drawing.Size(81, 25);
            ...
            this.Text = "Biểu 12.4//Công tác khám chữa bệnh và dịch vụ y tế";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.frmKh124_Load);
		...
		private void frmKh124_Load(object sender, System.EventArgs e)
		{
			...
			load_ngay();
			dt=m.get_data("select * from "+m.user+".kh_dm_124_dk").Tables[0];
			load_grid(false);
		...
		{
			if (dm)	ds=m.get_data("select * from "+m.user+".kh_dm_124 order by ma");
			else load_data();
		...
		private void load_data()
		{
			if (bPhatsinh)
			{
				sql="select a.*,b.stt,b.ten from "+m.user+".kh_bieu_124 a,"+m.user+".kh_dm_124 b where a.ma=b.ma and a.id="+l_id+" order by a.ma";
				ds=m.get_data(sql);
			}
			else
			{
		...
		{
			ds=m.get_data("select * from "+m.user+".kh_dm_124 order by ma");
			DataRow[] dr;
			foreach(DataRow r in m.get_data("select * from "+m.user+".kh_bieu_124 where id="+l_id).Tables[0].Rows)
			{
		...
		{
			cmbNgay.DataSource=m.get_data("select ID,to_char(ngay,'dd/mm/yyyy') as NGAY from "+m.user+".kh_bieu_124 group by id,ngay order by ngay").Tables[0];
		}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if (ds.HasChanges())
				{
					m.execute_data("delete from "+m.user+".kh_bieu_124 where id="+l_id);
					...
					{
						m.upd_kh124(l_id,int.Parse(r[i]["ma"].ToString()),ngay.Text,int.Parse(r[i]["c01"].ToString()),
