...
namespace DLLPrintchidinh
{
	...
	public class frmDMPhieucd : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDMPhieucd));
            ...
            this.panel2.Controls.Add(this.lbRefresh);
            ...
            this.panel4.Controls.Add(this.butMoi);
            ...
            this.panel4.Controls.Add(this.butInchiphi);
            ...
            this.butLuu.Location = new System.Drawing.Point(80, 4);
            ...
            this.butSua.Location = new System.Drawing.Point(155, 4);
            ...
            this.butHuy.Location = new System.Drawing.Point(230, 4);
            ...
            this.butBoqua.Location = new System.Drawing.Point(305, 4);
            ...
            this.butInchiphi.Location = new System.Drawing.Point(380, 4);
            this.butInchiphi.Name = "butInchiphi";
            this.butInchiphi.Size = new System.Drawing.Size(75, 28);
            this.butInchiphi.TabIndex = 5;
            this.butInchiphi.Text = "       &In";
            this.butInchiphi.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this.butInchiphi.UseVisualStyleBackColor = false;
            ...
            this.butKetthuc.Location = new System.Drawing.Point(455, 4);
            ...
            this.lbTitle.Text = " KHAI BÁO REPORT PHIẾU CHỈ ĐỊNH";
		...
		private void f_Load_DG()
		{
			...
			{
				DataSet ads = null;
				string asql="select reportname ten from medibv.cd_phieucd order by reportname";
		...
		private void f_print()
		{
			try
			{
				...
				string sql="select * from medibv.cd_phieucd order by reportname";
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(aid=="")
				{
					if(m_m.get_data("select reportname from medibv.cd_phieucd where lower(trim(reportname))='"+txtTen.Text.Trim().ToLower()+"'").Tables[0].Rows.Count>0)
					{
				...
				{
					if(m_m.get_data("select reportname from medibv.cd_phieucd where lower(trim(reportname))='"+txtTen.Text.Trim().ToLower()+"' and lower(trim(reportname))<>'"+aid+"'").Tables[0].Rows.Count>0)
					{
						MessageBox.Show(this,"Đã tồn tại, chọn tên khác","Thông báo",MessageBoxButtons.OK,MessageBoxIcon.Information);
						txtTen.Focus();
						return;
				...
				if(aid!="")
				{
					m_m.execute_data("delete from medibv.cd_phieucd where lower(trim(reportname))='"+aid.ToLower().Trim()+"'");
					m_m.execute_data("update medibv.cd_thongsophieucd set report='"+txtTen.Text.Trim().ToLower()+"' where lower(trim(report))='"+aid.ToLower().Trim()+"'");
				}
				else
				{
				}
				...
				if(txtTen.Text.Trim()!="")
				{
					m_m.execute_data("insert into medibv.cd_phieucd (reportname) values('"+txtTen.Text.Trim().ToLower()+"')");
				}
				f_Load_DG();
				f_resizeDG();
			...
			try
			{
				if(txtTen.Tag.ToString()!="")
				{
					if(MessageBox.Show(this,"Đồng ý xoá?","Thông báo",MessageBoxButtons.YesNo,MessageBoxIcon.Question,MessageBoxDefaultButton.Button1)==DialogResult.Yes)
					{
                        ...
                        if (m_m.get_data("select * from medibv.cd_thongsophieucd where lower(trim(report))='" + txtTen.Tag.ToString().Trim().ToLower() + "'").Tables[0].Rows.Count > 0)
                        {
                            MessageBox.Show("Report này đã dùng không thể xóa", "thông báo");

                        }
                        else
                        {
                            m_m.execute_data("delete from medibv.cd_phieucd where lower(trim(reportname))='" + txtTen.Tag.ToString().Trim().ToLower() + "'");
                            f_Load_DG();
                            butMoi_Click(null, null);
                        }
		...
		private void DataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				DataRow []rs = dv.Table.Select("ten='"+ DataGrid1[DataGrid1.CurrentRowIndex,0].ToString().Trim()+"'");
				if(rs.Length>0)
				{
