...
namespace Medisoft
{
	...
	/// </summary>
	public class frmDMThongsophieucd : System.Windows.Forms.Form
	{
		private string m_userid="";
		private string m_report="";
		private bool m_chosuacauhinh=true;
		...
		public frmDMThongsophieucd(string v_userid, string v_report)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmDMThongsophieucd));
			...
			this.lbTitle.Size = new System.Drawing.Size(674, 45);
			...
			// butMay
			// 
			this.butMay.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			...
			this.butMay.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.butMay.ForeColor = System.Drawing.Color.Blue;
			this.butMay.Image = ((System.Drawing.Bitmap)(resources.GetObject("butMay.Image")));
			...
			// butUnmap
			// 
			this.butUnmap.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			this.butUnmap.BackColor = System.Drawing.SystemColors.Control;
			this.butUnmap.Cursor = System.Windows.Forms.Cursors.Hand;
			this.butUnmap.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.butUnmap.ForeColor = System.Drawing.Color.Navy;
			this.butUnmap.Image = ((System.Drawing.Bitmap)(resources.GetObject("butUnmap.Image")));
			...
			// butMap
			// 
			this.butMap.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			this.butMap.BackColor = System.Drawing.SystemColors.Control;
			this.butMap.Cursor = System.Windows.Forms.Cursors.Hand;
			this.butMap.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.butMap.ForeColor = System.Drawing.Color.Navy;
			this.butMap.Image = ((System.Drawing.Bitmap)(resources.GetObject("butMap.Image")));
			...
			this.dataGrid2.Location = new System.Drawing.Point(422, 31);
			...
			// butIn
			// 
			this.butIn.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			this.butIn.Size = new System.Drawing.Size(57, 28);
			...
			// butKetthuc
			// 
			this.butKetthuc.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			this.butKetthuc.Location = new System.Drawing.Point(646, 4);
			this.butKetthuc.Name = "butKetthuc";
			this.butKetthuc.Size = new System.Drawing.Size(87, 28);
			...
			// butLuu
			// 
			this.butLuu.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			this.butLuu.Location = new System.Drawing.Point(529, 4);
			this.butLuu.Name = "butLuu";
			this.butLuu.Size = new System.Drawing.Size(58, 28);
			...
			// cbReport
			// 
			this.cbReport.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			// panel3
			// 
			this.panel3.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			// txtTim
			// 
			this.txtTim.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			this.txtTim.BackColor = System.Drawing.Color.White;
			this.txtTim.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txtTim.Font = new System.Drawing.Font("Microsoft Sans Serif", 8F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.txtTim.Location = new System.Drawing.Point(673, 32);
			this.txtTim.MaxLength = 100;
			this.txtTim.Name = "txtTim";
			this.txtTim.Size = new System.Drawing.Size(69, 20);
		...
		private void f_Load_DG1()
		{
			try
			{
				...
				string asql="select a.id, a.mavp, b.ten tenvp, c.ten tenloai, d.ten tennhom from cd_thongsophieucd a, v_giavp b, v_loaivp c, v_nhomvp d where to_number(nvl(a.mavp,0))=b.id(+) and b.id_loai=c.id and c.id_nhom=d.ma(+) and lower(trim(a.report))=lower('"+areport.Trim()+"') order by id";
				...
				{
					m_m.execute_data("create table cd_thongsophieucd(id varchar2(10), report varchar2(100), mavp varchar2(10), val varchar2(100))");
					ads=m_m.get_data(asql);
				}
		...
		private void f_Load_DG2()
		{
			try
			{
				AddGridTableStyle2(m_m.get_data("select to_char(a.id) id, a.ma, a.ten, b.ten ten_loai, c.ten ten_nhom from v_giavp a, v_loaivp b, v_nhomvp c where a.id_loai=b.id and b.id_nhom=c.ma order by a.ten, b.ten,c.ten"));
				f_resizeDG2();
			}
			catch
			{
		...
		private void f_print()
		{
			try
			{
				...
				string sql="select * from cd_thongsophieucd order by report";					
		...
		private void f_Load_CB_Phieu()
		{
			try
			{
				...
				asql="select reportname ten from cd_phieucd "+aexp+" order by reportname";
				DataSet ads = null;
				ads = m_m.get_data(asql);
				try
				{
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(butMap.Enabled)
				{
					m_m.execute_data("delete from cd_thongsophieucd where mavp is null");
					m_m.execute_data("delete from cd_thongsophieucd where lower(trim(report))=lower('"+areport+"')");
					foreach(DataRow r in dv.Table.Rows)
					{
						if(r["id"].ToString().ToString()!="")
						{
							m_m.execute_data("insert into cd_thongsophieucd(id,report,mavp,val) values('"+r["id"].ToString()+"','"+cbReport.SelectedValue.ToString().Trim().ToLower()+"','"+r["mavp"].ToString()+"','')");
						}
					}
				}
