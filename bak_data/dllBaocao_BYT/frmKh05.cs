...
namespace dllBaocao_BYT
{
	...
	public class frmKh05 : System.Windows.Forms.Form
	{
        ...
        {
            long ts = long.Parse(dataGrid1[row, 9].ToString()) + long.Parse(dataGrid1[row, 10].ToString()) + long.Parse(dataGrid1[row, 11].ToString()) + long.Parse(dataGrid1[row, 12].ToString()) + long.Parse(dataGrid1[row, 13].ToString()) + long.Parse(dataGrid1[row, 14].ToString());
            ...
            if (long.Parse(dataGrid1[row, 6].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            ...
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) < ts)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            ...
            if (long.Parse(dataGrid1[row, 12].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            ...
            if (long.Parse(dataGrid1[row, 14].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
