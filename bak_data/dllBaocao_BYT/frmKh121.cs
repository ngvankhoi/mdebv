...
namespace dllBaocao_BYT
{
	...
	public class frmKh121 : System.Windows.Forms.Form
	{
        ...
        void kiemtranhap(int col, int row)
        {
            ...
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) + long.Parse(dataGrid1[row, 9].ToString()) > long.Parse(dataGrid1[row, 7].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) + long.Parse(dataGrid1[row, 9].ToString()) > long.Parse(dataGrid1[row, 7].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
