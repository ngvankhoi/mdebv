...
namespace dllBaocao_BYT
{
	...
	public class frmKh01 : System.Windows.Forms.Form
	{
        ...
        {
            if (long.Parse(dataGrid1[row_index, col_index].ToString()) < 0)
            {
                MessageBox.Show("Không chấp nhận số âm !", LibMedi.AccessData.Msg);
                dataGrid1[row_index, col_index] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row_index, 6].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()) || (long.Parse(dataGrid1[row_index, 6].ToString()) + long.Parse(dataGrid1[row_index, 7].ToString()) + long.Parse(dataGrid1[row_index, 8].ToString()) + long.Parse(dataGrid1[row_index, 9].ToString())) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
            ...
            if (long.Parse(dataGrid1[row_index, 7].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 8].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 9].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 10].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 11].ToString()) > long.Parse(dataGrid1[row_index, 10].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 12].ToString()) > long.Parse(dataGrid1[row_index, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 13].ToString()) > long.Parse(dataGrid1[row_index, 12].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 14].ToString()) > long.Parse(dataGrid1[row_index, 12].ToString()) || (long.Parse(dataGrid1[row_index, 14].ToString()) + long.Parse(dataGrid1[row_index, 16].ToString()) + long.Parse(dataGrid1[row_index, 18].ToString())) > long.Parse(dataGrid1[row_index, 12].ToString()))
            {
                MessageBox.Show("Không hợp lệ !  ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 15].ToString()) > long.Parse(dataGrid1[row_index, 14].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 16].ToString()) > long.Parse(dataGrid1[row_index, 12].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 17].ToString()) > long.Parse(dataGrid1[row_index, 16].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
            if (long.Parse(dataGrid1[row_index, 18].ToString()) > long.Parse(dataGrid1[row_index, 12].ToString()))
            {
                MessageBox.Show("Không hợp lệ ! ", "Medisoft 2003");
                dataGrid1[row_index, col_index] = 0; return;
            }
