	...
	public class frmBieu04 : System.Windows.Forms.Form
	{
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					if (long.Parse(dataGrid1[i_row,i_col].ToString())>long.Parse(dataGrid1[i_row,3].ToString()) || (long.Parse(dataGrid1[i_row,4].ToString())+long.Parse(dataGrid1[i_row,5].ToString()))>long.Parse(dataGrid1[i_row,3].ToString()) || (long.Parse(dataGrid1[i_row,7].ToString())+long.Parse(dataGrid1[i_row,8].ToString())+long.Parse(dataGrid1[i_row,9].ToString()))>long.Parse(dataGrid1[i_row,6].ToString()) || (long.Parse(dataGrid1[i_row,11].ToString())+long.Parse(dataGrid1[i_row,12].ToString()))>long.Parse(dataGrid1[i_row,10].ToString()))
					{
						MessageBox.Show(lan.Change_language_MessageText("Số liệu không hợp lệ !"),LibMedi.AccessData.Msg);
						dataGrid1[i_row,i_col]=0;
					}
