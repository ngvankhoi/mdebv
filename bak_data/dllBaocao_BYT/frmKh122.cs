...
namespace dllBaocao_BYT
{
	...
	public class frmKh122 : System.Windows.Forms.Form
	{
        ...
        void kiemtranhap(int col, int row)
        {
            ...
            if (long.Parse(dataGrid1[row, 4].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) + long.Parse(dataGrid1[row, 5].ToString()) > long.Parse(dataGrid1[row, 3].ToString()))
            {
            ...
            if (long.Parse(dataGrid1[row, 5].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) + long.Parse(dataGrid1[row, 5].ToString()) > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            ...
            if (long.Parse(dataGrid1[row, 7].ToString()) < 0 || long.Parse(dataGrid1[row, 7].ToString()) + long.Parse(dataGrid1[row, 8].ToString()) > long.Parse(dataGrid1[row, 6].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) + long.Parse(dataGrid1[row, 7].ToString()) > long.Parse(dataGrid1[row, 6].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
