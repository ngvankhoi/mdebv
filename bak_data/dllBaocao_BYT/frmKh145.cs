	...
	public class frmKh145 : System.Windows.Forms.Form
	{
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if (long.Parse(dataGrid1[i_row,4].ToString())>long.Parse(dataGrid1[i_row,3].ToString())
					|| long.Parse(dataGrid1[i_row,6].ToString())>long.Parse(dataGrid1[i_row,5].ToString())
					|| long.Parse(dataGrid1[i_row,8].ToString())>long.Parse(dataGrid1[i_row,7].ToString())
					|| long.Parse(dataGrid1[i_row,10].ToString())>long.Parse(dataGrid1[i_row,9].ToString())
					|| long.Parse(dataGrid1[i_row,12].ToString())>long.Parse(dataGrid1[i_row,11].ToString())
					|| long.Parse(dataGrid1[i_row,14].ToString())>long.Parse(dataGrid1[i_row,13].ToString())
					|| long.Parse(dataGrid1[i_row,16].ToString())>long.Parse(dataGrid1[i_row,15].ToString())
					|| long.Parse(dataGrid1[i_row,18].ToString())>long.Parse(dataGrid1[i_row,17].ToString())
					|| long.Parse(dataGrid1[i_row,20].ToString())>long.Parse(dataGrid1[i_row,19].ToString())
					|| long.Parse(dataGrid1[i_row,22].ToString())>long.Parse(dataGrid1[i_row,21].ToString()))
				{
