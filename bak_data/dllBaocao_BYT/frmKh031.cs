                    ...
                    case 1:// thuoc linh vuc y te quan ly
                        ...
                        if (dr.Length != 0)
                        {
                            for (int i = 0; i < dr.Length; i++)
                            {
                                try
                                {
                                    l_tong += long.Parse(dr[i][i_col].ToString());
                                }
                                catch { }
                            }
            ...
            for (int k = 3; k < ds.Tables[0].Columns.Count - 1; k++)
            {
                ...
                if (dr.Length != 0)
                {
                    for (int i = 0; i < dr.Length; i++)
                    {
                        try
                        {
                            l_tong += long.Parse(dr[i][k].ToString());
                        }
                        catch { }
                    }
