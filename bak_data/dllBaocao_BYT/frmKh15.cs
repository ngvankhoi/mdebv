...
namespace dllBaocao_BYT
{
	...
	public class frmKh15 : System.Windows.Forms.Form
	{
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if (exp!="")
				{
					...
					{
						//if (long.Parse(dataGrid1[i_row,5].ToString())>long.Parse(dataGrid1[i_row,4].ToString())	|| long.Parse(dataGrid1[i_row,6].ToString())>long.Parse(dataGrid1[i_row,4].ToString()) || long.Parse(dataGrid1[i_row,7].ToString())>long.Parse(dataGrid1[i_row,6].ToString()) || long.Parse(dataGrid1[i_row,8].ToString())>long.Parse(dataGrid1[i_row,6].ToString()) || long.Parse(dataGrid1[i_row,9].ToString())>long.Parse(dataGrid1[i_row,8].ToString())	|| long.Parse(dataGrid1[i_row,9].ToString())>long.Parse(dataGrid1[i_row,7].ToString()))
		...
		private void sum(string exp,string stt,int k)
		{
            ...
            for (Int16 i = 0; i < iRec; i++) l_tong += long.Parse(r[i][k].ToString() == "" ? "0" : r[i][k].ToString());
