...
namespace dllBaocao_BYT
{
	...
	public class frmKh10 : System.Windows.Forms.Form
	{
        ...
        void kiemtranhap(int col, int row)
        {
            ...
            if (long.Parse(dataGrid1[row, 5].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) < l_row)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 6].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) < l_row)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 7].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) < l_row)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) < l_row)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) < l_row)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
