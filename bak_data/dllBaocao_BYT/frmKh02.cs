...
namespace dllBaocao_BYT
{
	...
	public class frmKh02 : System.Windows.Forms.Form
	{
        ...
        {
            long tt = long.Parse(dataGrid1[row, 4].ToString()) + long.Parse(dataGrid1[row, 5].ToString()) + long.Parse(dataGrid1[row, 6].ToString()) + long.Parse(dataGrid1[row, 7].ToString()) + long.Parse(dataGrid1[row, 8].ToString()) + long.Parse(dataGrid1[row, 9].ToString());
            long tc = long.Parse(dataGrid1[row, 11].ToString()) + long.Parse(dataGrid1[row, 12].ToString()) + long.Parse(dataGrid1[row, 13].ToString()) + long.Parse(dataGrid1[row, 14].ToString()) + long.Parse(dataGrid1[row, 15].ToString()) + long.Parse(dataGrid1[row, 16].ToString()) + long.Parse(dataGrid1[row, 17].ToString()) + long.Parse(dataGrid1[row, 18].ToString());
            if (long.Parse(dataGrid1[row, col].ToString()) < 0)
            {
            ...
            if (long.Parse(dataGrid1[row, 4].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 5].ToString()) < 0 || long.Parse(dataGrid1[row, 5].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 6].ToString()) < 0 || long.Parse(dataGrid1[row, 6].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 7].ToString()) < 0 || long.Parse(dataGrid1[row, 7].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0 || long.Parse(dataGrid1[row, 9].ToString()) > long.Parse(dataGrid1[row, 3].ToString()) || long.Parse(dataGrid1[row, 3].ToString()) < tt)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 10].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 11].ToString()) < 0 || long.Parse(dataGrid1[row, 11].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 12].ToString()) < 0 || long.Parse(dataGrid1[row, 12].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 13].ToString()) < 0 || long.Parse(dataGrid1[row, 13].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 14].ToString()) < 0 || long.Parse(dataGrid1[row, 14].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 15].ToString()) < 0 || long.Parse(dataGrid1[row, 15].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 16].ToString()) < 0 || long.Parse(dataGrid1[row, 16].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 17].ToString()) < 0 || long.Parse(dataGrid1[row, 17].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            }
            if (long.Parse(dataGrid1[row, 18].ToString()) < 0 || long.Parse(dataGrid1[row, 18].ToString()) > long.Parse(dataGrid1[row, 10].ToString()) || long.Parse(dataGrid1[row, 10].ToString()) < tc)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
