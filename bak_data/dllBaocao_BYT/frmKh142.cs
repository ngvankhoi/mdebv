...
namespace dllBaocao_BYT
{
	...
	public class frmKh142 : System.Windows.Forms.Form
	{
        ...
        {
            //long l_row = long.Parse(dataGrid1[row,5].ToString())+long.Parse(dataGrid1[row,6].ToString())+long.Parse(dataGrid1[row,7].ToString())+long.Parse(dataGrid1[row,8].ToString())+long.Parse(dataGrid1[row,9].ToString());
            ...
            if (long.Parse(dataGrid1[row, 5].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            ...
            if (long.Parse(dataGrid1[row, 7].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0;
                return;
            ...
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            if (long.Parse(dataGrid1[row, 11].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            ...
            if (long.Parse(dataGrid1[row, 13].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            ...
            if (long.Parse(dataGrid1[row, 15].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            ...
            if (long.Parse(dataGrid1[row, 17].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            ...
            if (long.Parse(dataGrid1[row, 19].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            ...
            if (long.Parse(dataGrid1[row, 21].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            if (long.Parse(dataGrid1[row, 22].ToString()) < 0 || long.Parse(dataGrid1[row, 22].ToString()) > long.Parse(dataGrid1[row, 21].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
            //			if(long.Parse(dataGrid1[row,23].ToString())<0)
            //			{		
            //				MessageBox.Show("Không hợp lệ !",LibMedi.AccessData.Msg,MessageBoxButtons.OK,MessageBoxIcon.Error);
            //				dataGrid1[row,col] =0;return ;
            //			}
            //			if(long.Parse(dataGrid1[row,24].ToString())<0 || long.Parse(dataGrid1[row,24].ToString())> long.Parse(dataGrid1[row,23].ToString()) )
            //			{		
            //				MessageBox.Show("Không hợp lệ !",LibMedi.AccessData.Msg,MessageBoxButtons.OK,MessageBoxIcon.Error);
            //				dataGrid1[row,col] =0;return ;
            //			}
