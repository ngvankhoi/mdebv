		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if (long.Parse(dataGrid1[i_row,4].ToString())>long.Parse(dataGrid1[i_row,3].ToString()) 
					...
					|| long.Parse(dataGrid1[i_row,7].ToString())>long.Parse(dataGrid1[i_row,5].ToString()) 
					|| long.Parse(dataGrid1[i_row,8].ToString())>long.Parse(dataGrid1[i_row,6].ToString()) 
					...
					|| long.Parse(dataGrid1[i_row,11].ToString())>long.Parse(dataGrid1[i_row,9].ToString()) 
					|| long.Parse(dataGrid1[i_row,12].ToString())>long.Parse(dataGrid1[i_row,10].ToString()) 
					...
					|| long.Parse(dataGrid1[i_row,24].ToString())>long.Parse(dataGrid1[i_row,23].ToString()) 
					|| long.Parse(dataGrid1[i_row,26].ToString())>long.Parse(dataGrid1[i_row,25].ToString()) 
					|| long.Parse(dataGrid1[i_row,28].ToString())>long.Parse(dataGrid1[i_row,27].ToString()) 
					|| long.Parse(dataGrid1[i_row,30].ToString())>long.Parse(dataGrid1[i_row,29].ToString()))
				{
