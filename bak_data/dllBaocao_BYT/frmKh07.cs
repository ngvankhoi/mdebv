...
namespace dllBaocao_BYT
{
	...
	public class frmKh07 : System.Windows.Forms.Form
	{
        ...
        {
            long l_tong = long.Parse(dataGrid1[row, 6].ToString()) + long.Parse(dataGrid1[row, 7].ToString()) + long.Parse(dataGrid1[row, 8].ToString());
            ...
            if (long.Parse(dataGrid1[row, 4].ToString()) < 0)
            {
            ...
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;

            }
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0 || long.Parse(dataGrid1[row, 9].ToString()) > l_tong)
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            ...
            if (long.Parse(dataGrid1[row, 11].ToString()) < 0 || long.Parse(dataGrid1[row, 11].ToString()) > long.Parse(dataGrid1[row, 10].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return;
            }
