...
//			}
		...
		private void dataGrid1_CurrentCellChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					long tc=long.Parse(dataGrid1[i_row,4].ToString())+long.Parse(dataGrid1[i_row,5].ToString())+long.Parse(dataGrid1[i_row,6].ToString());
					if (long.Parse(dataGrid1[i_row,i_col].ToString())>long.Parse(dataGrid1[i_row,3].ToString()) || tc>long.Parse(dataGrid1[i_row,3].ToString()))
					{
						MessageBox.Show(lan.Change_language_MessageText("Số liệu không hợp lệ !"),LibMedi.AccessData.Msg);
						dataGrid1[i_row,i_col]=0;
					}
