...
namespace dllBaocao_BYT
{
	...
	public class frmKh04 : System.Windows.Forms.Form
	{
        ...
        {
            long l_cot = long.Parse(dataGrid1[row, 5].ToString()) + long.Parse(dataGrid1[row, 7].ToString()) + long.Parse(dataGrid1[row, 9].ToString()) +
                long.Parse(dataGrid1[row, 11].ToString()) + long.Parse(dataGrid1[row, 13].ToString()) + long.Parse(dataGrid1[row, 15].ToString()) +
                long.Parse(dataGrid1[row, 17].ToString()) + long.Parse(dataGrid1[row, 19].ToString());
            if (long.Parse(dataGrid1[14, col].ToString()) < long.Parse(dataGrid1[15, col].ToString()))
            {
            ...
            if (long.Parse(dataGrid1[row, 4].ToString()) < 0 || long.Parse(dataGrid1[row, 4].ToString()) > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 5].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 6].ToString()) < 0 || long.Parse(dataGrid1[row, 6].ToString()) > long.Parse(dataGrid1[row, 5].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 7].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 8].ToString()) < 0 || long.Parse(dataGrid1[row, 8].ToString()) > long.Parse(dataGrid1[row, 7].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 9].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 10].ToString()) < 0 || long.Parse(dataGrid1[row, 10].ToString()) > long.Parse(dataGrid1[row, 9].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 11].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 12].ToString()) < 0 || long.Parse(dataGrid1[row, 12].ToString()) > long.Parse(dataGrid1[row, 11].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;

            }
            if (long.Parse(dataGrid1[row, 13].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 14].ToString()) < 0 || long.Parse(dataGrid1[row, 14].ToString()) > long.Parse(dataGrid1[row, 13].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 15].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 16].ToString()) < 0 || long.Parse(dataGrid1[row, 16].ToString()) > long.Parse(dataGrid1[row, 15].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 17].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 18].ToString()) < 0 || long.Parse(dataGrid1[row, 18].ToString()) > long.Parse(dataGrid1[row, 17].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 19].ToString()) < 0 || l_cot > long.Parse(dataGrid1[row, 3].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
            if (long.Parse(dataGrid1[row, 20].ToString()) < 0 || long.Parse(dataGrid1[row, 20].ToString()) > long.Parse(dataGrid1[row, 19].ToString()))
            {
                MessageBox.Show("Không hợp lệ !", LibMedi.AccessData.Msg, MessageBoxButtons.OK, MessageBoxIcon.Error);
                dataGrid1[row, col] = 0; return false;
            }
