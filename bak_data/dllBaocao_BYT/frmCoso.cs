...
namespace dllBaocao_BYT
{
	...
	public class frmCoso : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.cmbLoaibv = new System.Windows.Forms.ComboBox();
            ...
            this.dataGrid1.Size = new System.Drawing.Size(867, 320);
            ...
            // cmbLoaibv
            // 
            this.cmbLoaibv.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.cmbLoaibv.BackColor = System.Drawing.SystemColors.HighlightText;
            this.cmbLoaibv.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this.cmbLoaibv.DropDownWidth = 200;
            this.cmbLoaibv.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cmbLoaibv.Location = new System.Drawing.Point(681, 311);
            this.cmbLoaibv.Name = "cmbLoaibv";
            this.cmbLoaibv.Size = new System.Drawing.Size(194, 21);
            this.cmbLoaibv.TabIndex = 26;
            // 
            // label4
            // 
            this.label4.Location = new System.Drawing.Point(618, 311);
            ...
            this.Controls.Add(this.cmbLoaibv);
		...
		private void frmCoso_Load(object sender, System.EventArgs e)
		{
            ...
            try
            {
                cmbLoaibv.DisplayMember = "TEN";
                cmbLoaibv.ValueMember = "ID";
                DataSet ds1 = new DataSet();
                ds1.ReadXml("..\\..\\..\\xml\\dmloaicoso.xml", XmlReadMode.ReadSchema);
                cmbLoaibv.DataSource = ds1.Tables[0].DefaultView;
            }
            catch (Exception er)
            {
                MessageBox.Show("Lỗi:" + er.Message, "dmloaicoso.xml");
            }
			load_grid();
			AddGridTableStyle();
		...
		{
            dt = m.get_data("select a.ma,a.ten,a.tuyen,b.ten as tentuyen,a.idloaicoso as id from " + user + ".dmcoso a," + user + ".dmtuyen b where a.tuyen=b.ma order by a.ma").Tables[0];
...
//			}
		...
		private void butLuu_Click(object sender, System.EventArgs e)
		{
			...
			if (!m.upd_dmcoso(int.Parse(ma.Text),ten.Text,int.Parse(makp.SelectedValue.ToString()),int.Parse(cmbLoaibv.SelectedValue.ToString())))
			{
				MessageBox.Show(lan.Change_language_MessageText("Không cập nhật thông tin cơ sở y tế !"));
				return;
			}
            // hien cap nhat theo bieu moi
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_02");
            m.sort_stt("khdm_02");

            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "KHDM_05");
            m.sort_stt05("KHDM_05");
            //		
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "KHDM_06");
            m.sort_stt05("KHDM_06");
            //
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "KHDM_07");
            m.sort_stt05("KHDM_07");

            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "KHDM_08");
            m.sort_stt05("KHDM_08");
            //
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_09");
            m.sort_stt05("khdm_09");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_11");
            m.sort_danhmuc("khdm_11");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_121");
            m.sort_stt05("khdm_121");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_122");
            m.sort_stt05("khdm_122");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_141");
            m.sort_danhmuc("khdm_141");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_142");
            m.sort_danhmuc("khdm_142");
            m.upd_danhmuc(int.Parse(ma.Text), "", ten.Text, "khdm_143");
...
//			m.sort_stt("kh_dm_143");
		...
		private void butHuy_Click(object sender, System.EventArgs e)
		{
			...
			if (MessageBox.Show(lan.Change_language_MessageText("Đồng ý hủy thông tin này !"),LibMedi.AccessData.Msg,MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
			{
                ...
                m.execute_data("delete from " + user + ".khdm_03 where sttt=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_02 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_05 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_06 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_07 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_08 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_09 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_11 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_121 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_122 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_141 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_142 where ma=" + int.Parse(ma.Text));
                m.execute_data("delete from " + user + ".khdm_143 where ma=" + int.Parse(ma.Text));
		...
		private void ref_text()
		{
			try
			{
                ...
                cmbLoaibv.SelectedValue = dataGrid1[i, 4].ToString();
			}
			catch{}
		}
